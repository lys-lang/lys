  ...
  (func $support::test::mustEqual (param $given f64) (param $expected f64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::f64.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_10 (i64.const 0x0000000000000079) (local.get $given))
                (call $support::env::printf_10 (i64.const 0x0000000000000094) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_1 (param $given f32) (param $expected f32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::f32.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_8 (i64.const 0x00000000000000b5) (local.get $given))
                (call $support::env::printf_8 (i64.const 0x00000000000000d0) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_2 (param $given i64) (param $expected i64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u64.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_6 (i64.const 0x00000000000000f1) (call $system::core::u64.as_7 (call $system::core::u64.>> (local.get $given) (i32.const 32))))
                (call $support::env::printf_6 (i64.const 0x0000000000000114) (call $system::core::u64.as_7 (call $system::core::u64.>> (local.get $expected) (i32.const 32))))
                (call $support::env::printf_6 (i64.const 0x000000000000013d) (call $system::core::u64.&_2 (local.get $given) (call $system::core::i32.as_3 (i32.const 4294967295))))
                (call $support::env::printf_6 (i64.const 0x0000000000000160) (call $system::core::u64.&_2 (local.get $expected) (call $system::core::i32.as_3 (i32.const 4294967295))))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_3 (param $given i64) (param $expected i64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i64.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_6 (i64.const 0x0000000000000189) (call $system::core::u64.as_7 (call $system::core::u64.>> (call $system::core::i64.as_2 (local.get $given)) (i32.const 32))))
                (call $support::env::printf_6 (i64.const 0x00000000000001ac) (call $system::core::u64.as_7 (call $system::core::u64.>> (call $system::core::i64.as_2 (local.get $expected)) (i32.const 32))))
                (call $support::env::printf_6 (i64.const 0x00000000000001d5) (call $system::core::i64.&_2 (local.get $given) (call $system::core::i32.as_3 (i32.const 4294967295))))
                (call $support::env::printf_6 (i64.const 0x00000000000001f8) (call $system::core::i64.&_2 (local.get $expected) (call $system::core::i32.as_3 (i32.const 4294967295))))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_4 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u32.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_6 (i64.const 0x0000000000000221) (local.get $given))
                (call $support::env::printf_6 (i64.const 0x000000000000023c) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_5 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i32.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_4 (i64.const 0x000000000000025d) (local.get $given))
                (call $support::env::printf_4 (i64.const 0x0000000000000278) (local.get $expected))
              )
          )
          (else)
        )
