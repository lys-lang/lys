(module
  ...
  (data 0 (i32.const 572) "\08\00\00\00t\00r\00u\00e\00\00")
  (data 0 (i32.const 585) "\0a\00\00\00f\00a\00l\00s\00e\00\00")
  (data 0 (i32.const 600) "\02\00\00\000\00\00")
  (data 0 (i32.const 607) "\02\00\00\000\00\00")
  ...
  (func $system::string::String.stringify (param $value i32) (result i64)
    (block $B1 (result i64)
      (if $IF2 (result i64) (local.get $value)
          (then
            (block $B3 (result i64)
                (i64.const 0x000000000000023c)
              )
          )
          (else
            (block $B4 (result i64)
                (i64.const 0x0000000000000249)
              )
          )
        )
    )
  ...
  (data 0 (i32.const 361) "\16\00\00\00 \00 \00g\00i\00v\00e\00n\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 388) "\1c\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 421) "\16\00\00\00 \00 \00g\00i\00v\00e\00n\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 448) "\1c\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 481) "\16\00\00\00 \00 \00g\00i\00v\00e\00n\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 508) "\1c\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 541) "\1a\00\00\00a\00s\00s\00e\00r\00t\00(\00f\00a\00l\00s\00e\00)\00\00")
  ...
  (func $support::test::mustEqual (param $given f64) (param $expected f64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::f64.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_13 (i64.const 0x0000000000000079) (local.get $given))
                (call $support::env::printf_13 (i64.const 0x0000000000000094) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_1 (param $given f32) (param $expected f32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::f32.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_11 (i64.const 0x00000000000000b5) (local.get $given))
                (call $support::env::printf_11 (i64.const 0x00000000000000d0) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_4 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u32.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_9 (i64.const 0x00000000000000f1) (local.get $given))
                (call $support::env::printf_9 (i64.const 0x000000000000010c) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_5 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i32.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_7 (i64.const 0x000000000000012d) (local.get $given))
                (call $support::env::printf_7 (i64.const 0x0000000000000148) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_6 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u16.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_17 (i64.const 0x0000000000000169) (local.get $given))
                (call $support::env::printf_17 (i64.const 0x0000000000000184) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_7 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i16.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_15 (i64.const 0x00000000000001a5) (local.get $given))
                (call $support::env::printf_15 (i64.const 0x00000000000001c0) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_8 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u8.!=_2 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_19 (i64.const 0x00000000000001e1) (local.get $given))
                (call $support::env::printf_19 (i64.const 0x00000000000001fc) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::assert (param $condition i32)
    (call $support::test::assert_2 (local.get $condition) (i64.const 0x000000000000021d))
  )
  ...
  (func $test/fixtures/execution/isPatternMatchingVariable.lys::A.as (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  ...
  (func $test/fixtures/execution/isPatternMatchingVariable.lys::A.A$discriminant (result i64)
    ...
    (block $B1 (result i64)
      ...
      (call $system::core::i64.<< (call $system::core::u32.as (local.get $test/fixtures/execution/isPatternMatchingVariable.lys::discriminant)) (i32.const 32))
    )
  )
  ...
  (func $test/fixtures/execution/isPatternMatchingVariable.lys::B.as (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  ...
  (func $test/fixtures/execution/isPatternMatchingVariable.lys::B.B$discriminant (result i64)
    ...
    (block $B1 (result i64)
      ...
      (call $system::core::i64.<< (call $system::core::u32.as (local.get $test/fixtures/execution/isPatternMatchingVariable.lys::discriminant_3)) (i32.const 32))
    )
  )
  ...
  (func $test/fixtures/execution/isPatternMatchingVariable.lys::C.as (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  ...
  (func $test/fixtures/execution/isPatternMatchingVariable.lys::C.C$discriminant (result i64)
    ...
    (block $B1 (result i64)
      ...
      (call $system::core::i64.<< (call $system::core::u32.as (local.get $test/fixtures/execution/isPatternMatchingVariable.lys::discriminant_6)) (i32.const 32))
    )
  )
  ...
  (func $test/fixtures/execution/isPatternMatchingVariable.lys::Red.as (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  ...
  (func $test/fixtures/execution/isPatternMatchingVariable.lys::Red.Red$discriminant (result i64)
    ...
    (block $B1 (result i64)
      ...
      (call $system::core::i64.<< (call $system::core::u32.as (local.get $test/fixtures/execution/isPatternMatchingVariable.lys::discriminant_9)) (i32.const 32))
    )
  )
  ...
  (func $test/fixtures/execution/isPatternMatchingVariable.lys::Green.as (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  ...
  (func $test/fixtures/execution/isPatternMatchingVariable.lys::Green.Green$discriminant (result i64)
    ...
    (block $B1 (result i64)
      ...
      (call $system::core::i64.<< (call $system::core::u32.as (local.get $test/fixtures/execution/isPatternMatchingVariable.lys::discriminant_12)) (i32.const 32))
    )
  )
  ...
  (func $test/fixtures/execution/isPatternMatchingVariable.lys::Blue.as (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  ...
  (func $test/fixtures/execution/isPatternMatchingVariable.lys::Blue.Blue$discriminant (result i64)
    ...
    (block $B1 (result i64)
      ...
      (call $system::core::i64.<< (call $system::core::u32.as (local.get $test/fixtures/execution/isPatternMatchingVariable.lys::discriminant_15)) (i32.const 32))
    )
  )
  ...
  (func $test/fixtures/execution/isPatternMatchingVariable.lys::Custom.as (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  ...
  (func $test/fixtures/execution/isPatternMatchingVariable.lys::Custom.Custom$discriminant (result i64)
    ...
    (block $B1 (result i64)
      ...
      (call $system::core::u64.<< (call $system::core::u32.as_1 (local.get $test/fixtures/execution/isPatternMatchingVariable.lys::discriminant_18)) (i32.const 32))
    )
  )
  (func $test/fixtures/execution/isPatternMatchingVariable.lys::Custom.apply (param $a i32) (result i64)
    ...
    (block $B1 (result i64)
      (local.set $test/fixtures/execution/isPatternMatchingVariable.lys::$ref (call $test/fixtures/execution/isPatternMatchingVariable.lys::Custom.fromPointer (call $system::memory::calloc (call $system::core::i32.as_3 (i32.const 1)) (i32.const 4))))
      (call $test/fixtures/execution/isPatternMatchingVariable.lys::Custom.property$0_1 (local.get $test/fixtures/execution/isPatternMatchingVariable.lys::$ref) (local.get $a))
  ...
  (func $test/fixtures/execution/isPatternMatchingVariable.lys::J.J$discriminant (result i64)
    ...
    (block $B1 (result i64)
      ...
      (call $system::core::i64.<< (call $system::core::u32.as (local.get $test/fixtures/execution/isPatternMatchingVariable.lys::discriminant_21)) (i32.const 32))
    )
  )
  ...
  (func $test/fixtures/execution/isPatternMatchingVariable.lys::J.as (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  ...
  (func $%%START%%
    ...
    (global.set $test/fixtures/execution/isPatternMatchingVariable.lys::value1 (call $test/fixtures/execution/isPatternMatchingVariable.lys::A.apply))
    (global.set $test/fixtures/execution/isPatternMatchingVariable.lys::value2 (call $test/fixtures/execution/isPatternMatchingVariable.lys::A.apply))
    (global.set $test/fixtures/execution/isPatternMatchingVariable.lys::value3 (call $test/fixtures/execution/isPatternMatchingVariable.lys::A.apply))
  )
  (start $%%START%%)
)
