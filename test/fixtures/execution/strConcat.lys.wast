(module
  ...
  (func $support::test::mustEqual_1 (param $given f64) (param $expected f64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::f64::f64.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_11 (i64.const 0x000000030000045e) (local.get $given))
                (call $support::env::printf_11 (i64.const 0x0000000300000479) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_2 (param $given f32) (param $expected f32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::f32::f32.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_10 (i64.const 0x000000030000049a) (local.get $given))
                (call $support::env::printf_10 (i64.const 0x00000003000004b5) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_3 (param $given i64) (param $expected i64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u64::u64.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_9 (i64.const 0x00000003000004d6) (call $system::core::u64::u64.as_8 (call $system::core::u64::u64.>>_1 (local.get $given) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x00000003000004f9) (call $system::core::u64::u64.as_8 (call $system::core::u64::u64.>>_1 (local.get $expected) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x0000000300000522) (call $system::core::u64::u64.&_3 (local.get $given) (i32.const 0xFFFFFFFF)))
                (call $support::env::printf_9 (i64.const 0x0000000300000545) (call $system::core::u64::u64.&_3 (local.get $expected) (i32.const 0xFFFFFFFF)))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_4 (param $given i64) (param $expected i64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i64::i64.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_9 (i64.const 0x000000030000056e) (call $system::core::u64::u64.as_8 (call $system::core::u64::u64.>>_1 (call $system::core::i64::i64.as_3 (local.get $given)) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x0000000300000591) (call $system::core::u64::u64.as_8 (call $system::core::u64::u64.>>_1 (call $system::core::i64::i64.as_3 (local.get $expected)) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x00000003000005ba) (call $system::core::i64::i64.&_3 (local.get $given) (i32.const 0xFFFFFFFF)))
                (call $support::env::printf_9 (i64.const 0x00000003000005dd) (call $system::core::i64::i64.&_3 (local.get $expected) (i32.const 0xFFFFFFFF)))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_5 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u32::u32.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_9 (i64.const 0x0000000300000606) (local.get $given))
                (call $support::env::printf_9 (i64.const 0x0000000300000621) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_6 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i32::i32.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_8 (i64.const 0x0000000300000642) (local.get $given))
                (call $support::env::printf_8 (i64.const 0x000000030000065d) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::assert_1 (param $condition i32)
    (call $support::test::assert_2 (local.get $condition) (i64.const 0x000000030000067e))
  )
  ...
  (func $system::core::string::string.stringify_1 (param $value i32) (result i64)
    (block $B1 (result i64)
      (if $IF2 (result i64) (local.get $value)
          (then
            (block $B3 (result i64)
                (i64.const 0x0000000300000434)
              )
          )
          (else
            (block $B4 (result i64)
                (i64.const 0x0000000300000441)
              )
          )
        )
    )
  ...
  (func $test::fixtures::execution::strConcat::main_1
    ...
    (block $B1
      ...
      (block $B2
          (local.set $test::fixtures::execution::strConcat::a (i64.const 0x0000000300000043))
          (local.set $test::fixtures::execution::strConcat::b (i64.const 0x000000030000004e))
          (local.set $test::fixtures::execution::strConcat::c (call $system::core::string::string.concat_1 (local.get $test::fixtures::execution::strConcat::a) (local.get $test::fixtures::execution::strConcat::b)))
          (call $support::test::mustEqual_5 (call $system::core::string::string.property_length_1 (local.get $test::fixtures::execution::strConcat::a)) (call $system::core::i32::i32.as_4 (i32.const 3)) (i64.const 0x000000030000005b))
          (call $support::test::mustEqual_5 (call $system::core::string::string.property_length_1 (local.get $test::fixtures::execution::strConcat::b)) (call $system::core::i32::i32.as_4 (i32.const 4)) (i64.const 0x000000030000007a))
          (call $support::test::mustEqual_5 (call $system::core::string::string.property_length_1 (local.get $test::fixtures::execution::strConcat::c)) (call $system::core::i32::i32.as_4 (i32.const 7)) (i64.const 0x0000000300000099))
          (call $support::test::mustEqual_8 (local.get $test::fixtures::execution::strConcat::c) (i64.const 0x00000003000000b8) (i64.const 0x00000003000000cb))
          (local.set $test::fixtures::execution::strConcat::D (call $system::core::string::string.concat_1 (local.get $test::fixtures::execution::strConcat::c) (local.get $test::fixtures::execution::strConcat::c)))
          (call $support::test::mustEqual_8 (local.get $test::fixtures::execution::strConcat::c) (i64.const 0x00000003000000f4) (i64.const 0x0000000300000107))
          (call $support::test::mustEqual_5 (call $system::core::string::string.property_length_1 (local.get $test::fixtures::execution::strConcat::D)) (call $system::core::i32::i32.as_4 (i32.const 14)) (i64.const 0x0000000300000130))
          (call $support::test::mustEqual_8 (local.get $test::fixtures::execution::strConcat::D) (i64.const 0x0000000300000151) (local.get $test::fixtures::execution::strConcat::D))
        )
      (call $support::test::END_1)
      (call $support::test::START_2 (i64.const 0x0000000300000172))
      (block $B3
          (local.set $test::fixtures::execution::strConcat::str (i64.const 0x00000003000001a3))
          (call $support::test::mustEqual_5 (call $system::core::string::string.property_length_1 (local.get $test::fixtures::execution::strConcat::str)) (call $system::core::i32::i32.as_4 (i32.const 6)) (i64.const 0x00000003000001b4))
          (call $support::test::mustEqual_1 (call $system::core::u16::u16.as_6 (call $system::core::string::string.___1 (local.get $test::fixtures::execution::strConcat::str) (call $system::core::i32::i32.as_4 (i32.const 0)))) (call $system::core::u16::u16.as_6 (call $system::core::i32::i32.as_9 (i32.const 97))) (i64.const 0x00000003000001d7))
          (call $support::test::mustEqual_1 (call $system::core::u16::u16.as_6 (call $system::core::string::string.___1 (local.get $test::fixtures::execution::strConcat::str) (call $system::core::i32::i32.as_4 (i32.const 1)))) (call $system::core::u16::u16.as_6 (call $system::core::i32::i32.as_9 (i32.const 115))) (i64.const 0x00000003000001ee))
          (call $support::test::mustEqual_1 (call $system::core::u16::u16.as_6 (call $system::core::string::string.___1 (local.get $test::fixtures::execution::strConcat::str) (call $system::core::i32::i32.as_4 (i32.const 2)))) (call $system::core::u16::u16.as_6 (call $system::core::i32::i32.as_9 (i32.const 100))) (i64.const 0x0000000300000205))
          (call $support::test::mustEqual_1 (call $system::core::u16::u16.as_6 (call $system::core::string::string.___1 (local.get $test::fixtures::execution::strConcat::str) (call $system::core::i32::i32.as_4 (i32.const 3)))) (call $system::core::u16::u16.as_6 (call $system::core::i32::i32.as_9 (i32.const 10094))) (i64.const 0x000000030000021c))
          (call $support::test::mustEqual_1 (call $system::core::u16::u16.as_6 (call $system::core::string::string.___1 (local.get $test::fixtures::execution::strConcat::str) (call $system::core::i32::i32.as_4 (i32.const 4)))) (call $system::core::u16::u16.as_6 (call $system::core::i32::i32.as_9 (i32.const 55349))) (i64.const 0x0000000300000233))
          (call $support::test::mustEqual_1 (call $system::core::u16::u16.as_6 (call $system::core::string::string.___1 (local.get $test::fixtures::execution::strConcat::str) (call $system::core::i32::i32.as_4 (i32.const 5)))) (call $system::core::u16::u16.as_6 (call $system::core::i32::i32.as_9 (i32.const 56337))) (i64.const 0x000000030000024a))
        )
      (call $support::test::END_1)
      (call $support::test::START_2 (i64.const 0x0000000300000261))
      (block $B4
          (local.set $test::fixtures::execution::strConcat::x (call $system::core::string::string.++_1 (i64.const 0x000000030000028e) (i64.const 0x0000000300000297)))
          (call $support::test::mustEqual_5 (call $system::core::string::string.property_length_1 (local.get $test::fixtures::execution::strConcat::x)) (call $system::core::i32::i32.as_4 (i32.const 4)) (i64.const 0x00000003000002a0))
        )
      (call $support::test::END_1)
      (call $support::test::START_2 (i64.const 0x00000003000002d3))
      (block $B5
          (local.set $test::fixtures::execution::strConcat::x_1 (call $system::core::string::string.++_1 (i64.const 0x000000030000030c) (i64.const 0x0000000300000315)))
          (call $support::test::mustEqual_5 (call $system::core::string::string.property_length_1 (local.get $test::fixtures::execution::strConcat::x_1)) (call $system::core::i32::i32.as_4 (i32.const 5)) (i64.const 0x0000000300000320))
          (call $support::test::mustEqual_5 (call $system::core::u16::u16.as_2 (call $system::core::string::string.___1 (local.get $test::fixtures::execution::strConcat::x_1) (call $system::core::i32::i32.as_4 (i32.const 0)))) (i32.const 0x0061) (i64.const 0x0000000300000353))
          (call $support::test::mustEqual_5 (call $system::core::u16::u16.as_2 (call $system::core::string::string.___1 (local.get $test::fixtures::execution::strConcat::x_1) (call $system::core::i32::i32.as_4 (i32.const 1)))) (i32.const 0x0062) (i64.const 0x000000030000037c))
          (call $support::test::mustEqual_5 (call $system::core::u16::u16.as_2 (call $system::core::string::string.___1 (local.get $test::fixtures::execution::strConcat::x_1) (call $system::core::i32::i32.as_4 (i32.const 2)))) (i32.const 0x00B5) (i64.const 0x00000003000003a5))
          (call $support::test::mustEqual_5 (call $system::core::u16::u16.as_2 (call $system::core::string::string.___1 (local.get $test::fixtures::execution::strConcat::x_1) (call $system::core::i32::i32.as_4 (i32.const 3)))) (i32.const 0x269C) (i64.const 0x00000003000003ce))
          (call $support::test::mustEqual_5 (call $system::core::u16::u16.as_2 (call $system::core::string::string.___1 (local.get $test::fixtures::execution::strConcat::x_1) (call $system::core::i32::i32.as_4 (i32.const 4)))) (i32.const 0xFE0E) (i64.const 0x0000000300000401))
        )
      (call $support::test::END_1)
    )
  )
