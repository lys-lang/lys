(module
  ...
  (data 0 (i32.const 38) "4\00\00\00t\00r\00y\00i\00n\00g\00 \00t\00o\00 \00a\00l\00l\00o\00c\00a\00t\00e\00 \000\00 \00b\00y\00t\00e\00s\00\00")
      ...
      (if $IF2 (result i32) (call $system::core::i32.> (get_local $size) (i32.const 0))
          ...
          (else
            (block $B12 (result i32)
                (call $support::env::printf_8 (i64.const 0x0000000000000026))
  ...
  (data 0 (i32.const 16) "\06\00\00\00a\00s\00d\00\00")
  (data 0 (i32.const 27) "\06\00\00\00d\00s\00a\00\00")
  (export "main" (func $test/fixtures/execution/strConcat.lys::main))
  (func $test/fixtures/execution/strConcat.lys::concat (param $lhs i64) (param $rhs i64) (result i64)
    (local $$ret i64)
    (block $B1 (result i64)
      (set_local $$ret (call $system::memory::allocBytes (call $system::core::u32.+ (call $system::core::bytes.property_length (get_local $lhs)) (call $system::core::bytes.property_length (get_local $rhs)))))
      (call $system::memory::memcpy (call $system::core::bytes.property_ptr (get_local $$ret)) (call $system::core::bytes.property_ptr (get_local $lhs)) (call $system::core::bytes.property_length (get_local $lhs)))
      (call $system::memory::memcpy (call $system::core::i32.+ (call $system::core::bytes.property_ptr (get_local $$ret)) (call $system::core::u32.as_4 (call $system::core::bytes.property_length (get_local $lhs)))) (call $system::core::bytes.property_ptr (get_local $rhs)) (call $system::core::bytes.property_length (get_local $rhs)))
      (get_local $$ret)
    )
  )
  (func $test/fixtures/execution/strConcat.lys::main (result i32)
    (call $system::core::bytes.property_length (call $test/fixtures/execution/strConcat.lys::concat (i64.const 0x0000000000000010) (i64.const 0x000000000000001b)))
  )
  (func $%%START%%
