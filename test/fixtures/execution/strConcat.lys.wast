(module
  ...
  (data 0 (i32.const 1250) "\16\00\00\00 \00 \00g\00i\00v\00e\00n\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 1277) "\1c\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 1310) "\16\00\00\00 \00 \00g\00i\00v\00e\00n\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 1337) "\1c\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 1370) "\16\00\00\00 \00 \00g\00i\00v\00e\00n\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 1397) "\1c\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 1430) "\16\00\00\00 \00 \00g\00i\00v\00e\00n\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 1457) "\1c\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 1490) "\16\00\00\00 \00 \00g\00i\00v\00e\00n\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 1517) "\1c\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 1550) "\1a\00\00\00a\00s\00s\00e\00r\00t\00(\00f\00a\00l\00s\00e\00)\00\00")
  ...
  (func $support::test::mustEqual (param $given f64) (param $expected f64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::f64.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_13 (i64.const 0x000000000000046a) (local.get $given))
                (call $support::env::printf_13 (i64.const 0x0000000000000485) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_1 (param $given f32) (param $expected f32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::f32.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_11 (i64.const 0x00000000000004a6) (local.get $given))
                (call $support::env::printf_11 (i64.const 0x00000000000004c1) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_4 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u32.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_9 (i64.const 0x00000000000004e2) (local.get $given))
                (call $support::env::printf_9 (i64.const 0x00000000000004fd) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_5 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i32.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_7 (i64.const 0x000000000000051e) (local.get $given))
                (call $support::env::printf_7 (i64.const 0x0000000000000539) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_6 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u16.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_17 (i64.const 0x000000000000055a) (local.get $given))
                (call $support::env::printf_17 (i64.const 0x0000000000000575) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_7 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i16.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_15 (i64.const 0x0000000000000596) (local.get $given))
                (call $support::env::printf_15 (i64.const 0x00000000000005b1) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_8 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u8.!=_2 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_19 (i64.const 0x00000000000005d2) (local.get $given))
                (call $support::env::printf_19 (i64.const 0x00000000000005ed) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::assert (param $condition i32)
    (call $support::test::assert_2 (local.get $condition) (i64.const 0x000000000000060e))
  )
  ...
  (export "main" (func $test/fixtures/execution/strConcat.lys::main))
  (func $test/fixtures/execution/strConcat.lys::main
    ...
    (block $B1
      ...
      (block $B2
          ...
          (local.set $test/fixtures/execution/strConcat.lys::c (call $system::string::concatBytes_1 (local.get $test/fixtures/execution/strConcat.lys::a) (local.get $test/fixtures/execution/strConcat.lys::b)))
          (call $support::test::mustEqual_4 (call $system::core::bytes.property_length (local.get $test/fixtures/execution/strConcat.lys::a)) (call $system::core::i32.as_3 (i32.const 6)) (i64.const 0x000000000000005b))
          (call $support::test::mustEqual_4 (call $system::core::bytes.property_length (local.get $test/fixtures/execution/strConcat.lys::b)) (call $system::core::i32.as_3 (i32.const 8)) (i64.const 0x000000000000007a))
          (call $support::test::mustEqual_4 (call $system::core::bytes.property_length (local.get $test/fixtures/execution/strConcat.lys::c)) (call $system::core::i32.as_3 (i32.const 14)) (i64.const 0x0000000000000099))
          (call $support::test::mustEqual_10 (local.get $test/fixtures/execution/strConcat.lys::c) (i64.const 0x00000000000000ba) (i64.const 0x00000000000000cd))
          (local.set $test/fixtures/execution/strConcat.lys::D (call $system::string::concatBytes_1 (local.get $test/fixtures/execution/strConcat.lys::c) (local.get $test/fixtures/execution/strConcat.lys::c)))
          (call $support::test::mustEqual_10 (local.get $test/fixtures/execution/strConcat.lys::c) (i64.const 0x00000000000000f6) (i64.const 0x0000000000000109))
          (call $support::test::mustEqual_4 (call $system::core::bytes.property_length (local.get $test/fixtures/execution/strConcat.lys::D)) (call $system::core::i32.as_3 (i32.const 28)) (i64.const 0x0000000000000132))
          (call $support::test::mustEqual_10 (local.get $test/fixtures/execution/strConcat.lys::D) (i64.const 0x0000000000000153) (local.get $test/fixtures/execution/strConcat.lys::D))
        )
      (call $support::test::END)
      (call $support::test::START_1 (i64.const 0x0000000000000174))
      (block $B3
          (local.set $test/fixtures/execution/strConcat.lys::str (call $system::string::String.apply (i64.const 0x00000000000001a5)))
          (call $support::test::mustEqual_4 (call $system::string::String.property_length (local.get $test/fixtures/execution/strConcat.lys::str)) (call $system::core::i32.as_3 (i32.const 6)) (i64.const 0x00000000000001b6))
          (call $support::test::mustEqual_6 (call $system::string::String.charAt (local.get $test/fixtures/execution/strConcat.lys::str) (call $system::core::i32.as_3 (i32.const 0))) (call $system::core::i32.as_8 (i32.const 97)) (i64.const 0x00000000000001d9))
          (call $support::test::mustEqual_6 (call $system::string::String.charAt (local.get $test/fixtures/execution/strConcat.lys::str) (call $system::core::i32.as_3 (i32.const 1))) (call $system::core::i32.as_8 (i32.const 115)) (i64.const 0x00000000000001f0))
          (call $support::test::mustEqual_6 (call $system::string::String.charAt (local.get $test/fixtures/execution/strConcat.lys::str) (call $system::core::i32.as_3 (i32.const 2))) (call $system::core::i32.as_8 (i32.const 100)) (i64.const 0x0000000000000207))
          (call $support::test::mustEqual_6 (call $system::string::String.charAt (local.get $test/fixtures/execution/strConcat.lys::str) (call $system::core::i32.as_3 (i32.const 3))) (call $system::core::i32.as_8 (i32.const 10094)) (i64.const 0x000000000000021e))
          (call $support::test::mustEqual_6 (call $system::string::String.charAt (local.get $test/fixtures/execution/strConcat.lys::str) (call $system::core::i32.as_3 (i32.const 4))) (call $system::core::i32.as_8 (i32.const 55349)) (i64.const 0x0000000000000235))
          (call $support::test::mustEqual_6 (call $system::string::String.charAt (local.get $test/fixtures/execution/strConcat.lys::str) (call $system::core::i32.as_3 (i32.const 5))) (call $system::core::i32.as_8 (i32.const 56337)) (i64.const 0x000000000000024c))
        )
      (call $support::test::END)
      (call $support::test::START_1 (i64.const 0x0000000000000263))
      (block $B4
          (local.set $test/fixtures/execution/strConcat.lys::x (call $system::string::String.+ (call $system::string::String.apply (i64.const 0x0000000000000290)) (call $system::string::String.apply (i64.const 0x0000000000000299))))
          (call $support::test::mustEqual_5 (call $system::core::u32.as_4 (call $system::string::String.property_length (local.get $test/fixtures/execution/strConcat.lys::x))) (i32.const 4) (i64.const 0x00000000000002a2))
          (call $support::test::mustEqual_5 (call $system::core::u32.as_4 (call $system::core::bytes.property_length (call $system::string::String.property_data (local.get $test/fixtures/execution/strConcat.lys::x)))) (i32.const 8) (i64.const 0x00000000000002d5))
        )
      (call $support::test::END)
      (call $support::test::START_1 (i64.const 0x0000000000000312))
      (block $B5
          (local.set $test/fixtures/execution/strConcat.lys::x_3 (call $system::string::String.+ (call $system::string::String.apply (i64.const 0x000000000000034b)) (call $system::string::String.apply (i64.const 0x0000000000000354))))
          (call $support::test::mustEqual_5 (call $system::core::u16.as (call $system::string::String.charAt (local.get $test/fixtures/execution/strConcat.lys::x_3) (call $system::core::i32.as_3 (i32.const 0)))) (i32.const 97) (i64.const 0x000000000000035f))
          (call $support::test::mustEqual_5 (call $system::core::u16.as (call $system::string::String.charAt (local.get $test/fixtures/execution/strConcat.lys::x_3) (call $system::core::i32.as_3 (i32.const 1)))) (i32.const 98) (i64.const 0x0000000000000388))
          (call $support::test::mustEqual_5 (call $system::core::u16.as (call $system::string::String.charAt (local.get $test/fixtures/execution/strConcat.lys::x_3) (call $system::core::i32.as_3 (i32.const 2)))) (i32.const 181) (i64.const 0x00000000000003b1))
          (call $support::test::mustEqual_5 (call $system::core::u16.as (call $system::string::String.charAt (local.get $test/fixtures/execution/strConcat.lys::x_3) (call $system::core::i32.as_3 (i32.const 3)))) (i32.const 9884) (i64.const 0x00000000000003da))
          (call $support::test::mustEqual_5 (call $system::core::u16.as (call $system::string::String.charAt (local.get $test/fixtures/execution/strConcat.lys::x_3) (call $system::core::i32.as_3 (i32.const 4)))) (i32.const 65038) (i64.const 0x000000000000040d))
        )
      (call $support::test::END)
    )
  )
