(module
  ...
  (data 0 (i32.const 418) "\1a\00\00\00a\00s\00s\00e\00r\00t\00(\00f\00a\00l\00s\00e\00)\00\00")
  ...
  (func $support::test::assert_11 (param $condition i32)
    (call $support::test::assert_13 (local.get $condition) (i64.const 0x00000000000001a2))
  )
  ...
  (data 0 (i32.const 376) "\08\00\00\00t\00r\00u\00e\00\00")
  (data 0 (i32.const 389) "\0a\00\00\00f\00a\00l\00s\00e\00\00")
  (data 0 (i32.const 404) "\02\00\00\000\00\00")
  (data 0 (i32.const 411) "\02\00\00\000\00\00")
  ...
  (func $system::string::String.stringify (param $value i32) (result i64)
    (block $B1 (result i64)
      (if $IF2 (result i64) (local.get $value)
          (then
            (block $B3 (result i64)
                (i64.const 0x0000000000000178)
              )
          )
          (else
            (block $B4 (result i64)
                (i64.const 0x0000000000000185)
              )
          )
        )
    )
  ...
  (data 0 (i32.const 16) "2\00\00\00T\00e\00s\00t\00 \00s\00t\00r\00i\00n\00g\00 \00c\00o\00n\00c\00a\00t\00e\00n\00a\00t\00i\00o\00n\00\00")
  (data 0 (i32.const 71) "\06\00\00\00a\00b\00c\00\00")
  (data 0 (i32.const 82) "\08\00\00\001\002\003\004\00\00")
  (data 0 (i32.const 95) "\1a\00\00\00a\00.\00l\00e\00n\00g\00t\00h\00 \00=\00=\00 \006\00\00")
  (data 0 (i32.const 126) "\1a\00\00\00a\00.\00l\00e\00n\00g\00t\00h\00 \00=\00=\00 \006\00\00")
  (data 0 (i32.const 157) "\1c\00\00\00c\00.\00l\00e\00n\00g\00t\00h\00 \00=\00=\00 \001\002\00\00")
  (data 0 (i32.const 190) "\0e\00\00\00a\00b\00c\001\002\003\004\00\00")
  (data 0 (i32.const 209) "$\00\00\00c\00 \00=\00=\00 \00'\00a\00b\00c\001\002\003\004\00'\00 \00(\001\00)\00\00")
  (data 0 (i32.const 250) "\0e\00\00\00a\00b\00c\001\002\003\004\00\00")
  (data 0 (i32.const 269) "$\00\00\00c\00 \00=\00=\00 \00'\00a\00b\00c\001\002\003\004\00'\00 \00(\002\00)\00\00")
  (data 0 (i32.const 310) "\1c\00\00\00d\00.\00l\00e\00n\00g\00t\00h\00 \00=\00=\00 \002\008\00\00")
  (data 0 (i32.const 343) "\1c\00\00\00a\00b\00c\001\002\003\004\00a\00b\00c\001\002\003\004\00\00")
  ...
  (func $test/fixtures/execution/strConcat.lys::main
    ...
    (block $B1
      ...
      (local.set $a (i64.const 0x0000000000000047))
      (local.set $b (i64.const 0x0000000000000052))
      (local.set $c (call $system::string::concatBytes_1 (local.get $a) (local.get $b)))
      (call $support::test::verify_1 (call $system::core::u32.== (call $system::core::bytes.property_length (local.get $a)) (call $system::core::i32.as_3 (i32.const 6))) (i64.const 0x000000000000005f))
      (call $support::test::verify_1 (call $system::core::u32.== (call $system::core::bytes.property_length (local.get $b)) (call $system::core::i32.as_3 (i32.const 8))) (i64.const 0x000000000000007e))
      (call $support::test::verify_1 (call $system::core::u32.== (call $system::core::bytes.property_length (local.get $c)) (call $system::core::i32.as_3 (i32.const 14))) (i64.const 0x000000000000009d))
      (call $support::test::verify_1 (call $system::core::bytes.== (local.get $c) (i64.const 0x00000000000000be)) (i64.const 0x00000000000000d1))
      (local.set $D (call $system::string::concatBytes_1 (local.get $c) (local.get $c)))
      (call $support::test::verify_1 (call $system::core::bytes.== (local.get $c) (i64.const 0x00000000000000fa)) (i64.const 0x000000000000010d))
      (call $support::test::verify_1 (call $system::core::u32.== (call $system::core::bytes.property_length (local.get $D)) (call $system::core::i32.as_3 (i32.const 28))) (i64.const 0x0000000000000136))
      (call $support::test::verify_1 (call $system::core::bytes.== (local.get $D) (i64.const 0x0000000000000157)) (local.get $D))
