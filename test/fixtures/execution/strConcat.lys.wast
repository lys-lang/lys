  ...
  (func $support::test::mustEqual_2 (param $given i64) (param $expected i64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u64.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_9 (i64.const 0x00000000000004e2) (call $system::core::u64.as_7 (call $system::core::u64.>> (local.get $given) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x0000000000000505) (call $system::core::u64.as_7 (call $system::core::u64.>> (local.get $expected) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x000000000000052e) (call $system::core::u64.&_2 (local.get $given) (call $system::core::i32.as_3 (i32.const 0xFFFFFFFF))))
                (call $support::env::printf_9 (i64.const 0x0000000000000551) (call $system::core::u64.&_2 (local.get $expected) (call $system::core::i32.as_3 (i32.const 0xFFFFFFFF))))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_3 (param $given i64) (param $expected i64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i64.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_9 (i64.const 0x000000000000057a) (call $system::core::u64.as_7 (call $system::core::u64.>> (call $system::core::i64.as_2 (local.get $given)) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x000000000000059d) (call $system::core::u64.as_7 (call $system::core::u64.>> (call $system::core::i64.as_2 (local.get $expected)) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x00000000000005c6) (call $system::core::i64.&_2 (local.get $given) (call $system::core::i32.as_3 (i32.const 0xFFFFFFFF))))
                (call $support::env::printf_9 (i64.const 0x00000000000005e9) (call $system::core::i64.&_2 (local.get $expected) (call $system::core::i32.as_3 (i32.const 0xFFFFFFFF))))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_5 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i32.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_7 (i64.const 0x000000000000064e) (local.get $given))
                (call $support::env::printf_7 (i64.const 0x0000000000000669) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $test/fixtures/execution/strConcat.lys::main
    ...
    (block $B1
      ...
      (block $B2
          ...
          (call $support::test::mustEqual_7 (local.get $test/fixtures/execution/strConcat.lys::c) (i64.const 0x00000000000000ba) (i64.const 0x00000000000000cd))
          ...
          (call $support::test::mustEqual_7 (local.get $test/fixtures/execution/strConcat.lys::c) (i64.const 0x00000000000000f6) (i64.const 0x0000000000000109))
          ...
          (call $support::test::mustEqual_7 (local.get $test/fixtures/execution/strConcat.lys::D) (i64.const 0x0000000000000153) (local.get $test/fixtures/execution/strConcat.lys::D))
        )
      ...
      (block $B3
          ...
          (call $support::test::mustEqual (call $system::core::u16.as_5 (call $system::string::String.charAt (local.get $test/fixtures/execution/strConcat.lys::str) (call $system::core::i32.as_3 (i32.const 0)))) (call $system::core::u16.as_5 (call $system::core::i32.as_8 (i32.const 97))) (i64.const 0x00000000000001d9))
          (call $support::test::mustEqual (call $system::core::u16.as_5 (call $system::string::String.charAt (local.get $test/fixtures/execution/strConcat.lys::str) (call $system::core::i32.as_3 (i32.const 1)))) (call $system::core::u16.as_5 (call $system::core::i32.as_8 (i32.const 115))) (i64.const 0x00000000000001f0))
          (call $support::test::mustEqual (call $system::core::u16.as_5 (call $system::string::String.charAt (local.get $test/fixtures/execution/strConcat.lys::str) (call $system::core::i32.as_3 (i32.const 2)))) (call $system::core::u16.as_5 (call $system::core::i32.as_8 (i32.const 100))) (i64.const 0x0000000000000207))
          (call $support::test::mustEqual (call $system::core::u16.as_5 (call $system::string::String.charAt (local.get $test/fixtures/execution/strConcat.lys::str) (call $system::core::i32.as_3 (i32.const 3)))) (call $system::core::u16.as_5 (call $system::core::i32.as_8 (i32.const 10094))) (i64.const 0x000000000000021e))
          (call $support::test::mustEqual (call $system::core::u16.as_5 (call $system::string::String.charAt (local.get $test/fixtures/execution/strConcat.lys::str) (call $system::core::i32.as_3 (i32.const 4)))) (call $system::core::u16.as_5 (call $system::core::i32.as_8 (i32.const 55349))) (i64.const 0x0000000000000235))
          (call $support::test::mustEqual (call $system::core::u16.as_5 (call $system::string::String.charAt (local.get $test/fixtures/execution/strConcat.lys::str) (call $system::core::i32.as_3 (i32.const 5)))) (call $system::core::u16.as_5 (call $system::core::i32.as_8 (i32.const 56337))) (i64.const 0x000000000000024c))
        )
      (call $support::test::END)
      ...
      (block $B5
          ...
          (call $support::test::mustEqual_5 (call $system::core::u16.as (call $system::string::String.charAt (local.get $test/fixtures/execution/strConcat.lys::x_3) (call $system::core::i32.as_3 (i32.const 0)))) (i32.const 0x0061) (i64.const 0x000000000000035f))
          (call $support::test::mustEqual_5 (call $system::core::u16.as (call $system::string::String.charAt (local.get $test/fixtures/execution/strConcat.lys::x_3) (call $system::core::i32.as_3 (i32.const 1)))) (i32.const 0x0062) (i64.const 0x0000000000000388))
          (call $support::test::mustEqual_5 (call $system::core::u16.as (call $system::string::String.charAt (local.get $test/fixtures/execution/strConcat.lys::x_3) (call $system::core::i32.as_3 (i32.const 2)))) (i32.const 0x00B5) (i64.const 0x00000000000003b1))
          (call $support::test::mustEqual_5 (call $system::core::u16.as (call $system::string::String.charAt (local.get $test/fixtures/execution/strConcat.lys::x_3) (call $system::core::i32.as_3 (i32.const 3)))) (i32.const 0x269C) (i64.const 0x00000000000003da))
          (call $support::test::mustEqual_5 (call $system::core::u16.as (call $system::string::String.charAt (local.get $test/fixtures/execution/strConcat.lys::x_3) (call $system::core::i32.as_3 (i32.const 4)))) (i32.const 0xFE0E) (i64.const 0x000000000000040d))
        )
      (call $support::test::END)
    )
  )
