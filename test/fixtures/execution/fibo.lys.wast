(module
  ...
  (data 0 (i32.const 300) "\08\00\00\00t\00r\00u\00e\00\00")
  (data 0 (i32.const 313) "\0a\00\00\00f\00a\00l\00s\00e\00\00")
  (data 0 (i32.const 328) "\02\00\00\000\00\00")
  ...
  (func $system::string::String.stringify (param $value i32) (result i64)
    (block $B1 (result i64)
      (if $IF2 (result i64) (local.get $value)
          (then
            (block $B3 (result i64)
                (i64.const 0x000000000000012c)
              )
          )
          (else
            (block $B4 (result i64)
                (i64.const 0x0000000000000139)
              )
          )
        )
    )
  ...
  (data 0 (i32.const 269) "\1a\00\00\00a\00s\00s\00e\00r\00t\00(\00f\00a\00l\00s\00e\00)\00\00")
  ...
  (func $support::test::assert (param $condition i32)
    (call $support::test::assert_2 (local.get $condition) (i64.const 0x000000000000010d))
  )
  ...
  (export "main" (func $test/fixtures/execution/fibo.lys::main))
  (func $test/fixtures/execution/fibo.lys::fibo (param $n i32) (param $x1 i32) (param $x2 i32) (result i32)
    (block $B1 (result i32)
      (if $IF2 (result i32) (call $system::core::i32.> (local.get $n) (i32.const 0))
          (then
            (block $B3 (result i32)
                (call $test/fixtures/execution/fibo.lys::fibo (call $system::core::i32.- (local.get $n) (i32.const 1)) (local.get $x2) (call $system::core::i32.+ (local.get $x1) (local.get $x2)))
              )
          )
          (else
            (block $B4 (result i32)
  ...
  (func $test/fixtures/execution/fibo.lys::fiboPatternMatching (param $n i32) (param $a i32) (param $b i32) (result i32)
    (local $var$3 i32)
    (block $B1 (result i32)
      ...
      (block $B1_0
          (block $B1_1
              ...
              (call $test/fixtures/execution/fibo.lys::fibo (call $system::core::i32.- (local.get $n) (i32.const 1)) (local.get $b) (call $system::core::i32.+ (local.get $a) (local.get $b)))
              (br $B1)
            )
          (local.get $b)
          (br $B1)
  ...
  (func $test/fixtures/execution/fibo.lys::fib (param $n i32) (result i32)
    (call $test/fixtures/execution/fibo.lys::fibo (local.get $n) (i32.const 0) (i32.const 1))
  )
  (func $test/fixtures/execution/fibo.lys::fibPatternMatching (param $n i32) (result i32)
    (call $test/fixtures/execution/fibo.lys::fiboPatternMatching (local.get $n) (i32.const 0) (i32.const 1))
  )
  (func $test/fixtures/execution/fibo.lys::factorial (param $n i32) (result i32)
    (if $IF1 (result i32) (call $system::core::i32.>= (local.get $n) (i32.const 1))
      (then
        (call $system::core::i32.* (local.get $n) (call $test/fixtures/execution/fibo.lys::factorial (call $system::core::i32.- (local.get $n) (i32.const 1))))
      )
      (else
        (i32.const 1)
      )
  ...
  (func $test/fixtures/execution/fibo.lys::main
    (block $B1
      (call $support::test::START_1 (i64.const 0x0000000000000010))
      (call $support::test::mustEqual_5 (call $test/fixtures/execution/fibo.lys::fib (i32.const 46)) (i32.const 1836311903) (i64.const 0x0000000000000027))
      (call $support::test::mustEqual_5 (call $test/fixtures/execution/fibo.lys::fibPatternMatching (i32.const 46)) (i32.const 1836311903) (i64.const 0x0000000000000060))
      (call $support::test::END)
      (call $support::test::START_1 (i64.const 0x00000000000000b7))
      (call $support::test::mustEqual_5 (call $test/fixtures/execution/fibo.lys::factorial (i32.const 10)) (i32.const 3628800) (i64.const 0x00000000000000ce))
      (call $support::test::END)
    )
  )
  (func $%%START%%
