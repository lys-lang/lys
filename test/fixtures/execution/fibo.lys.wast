  ...
  (func $support::test::mustEqual (param $given f64) (param $expected f64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::f64.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_10 (i64.const 0x000000000000010d) (local.get $given))
                (call $support::env::printf_10 (i64.const 0x0000000000000128) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_1 (param $given f32) (param $expected f32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::f32.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_8 (i64.const 0x0000000000000149) (local.get $given))
                (call $support::env::printf_8 (i64.const 0x0000000000000164) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_2 (param $given i64) (param $expected i64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u64.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_6 (i64.const 0x0000000000000185) (call $system::core::u64.as_7 (call $system::core::u64.>> (local.get $given) (i32.const 32))))
                (call $support::env::printf_6 (i64.const 0x00000000000001a8) (call $system::core::u64.as_7 (call $system::core::u64.>> (local.get $expected) (i32.const 32))))
                (call $support::env::printf_6 (i64.const 0x00000000000001d1) (call $system::core::u64.&_2 (local.get $given) (call $system::core::i32.as_3 (i32.const 4294967295))))
                (call $support::env::printf_6 (i64.const 0x00000000000001f4) (call $system::core::u64.&_2 (local.get $expected) (call $system::core::i32.as_3 (i32.const 4294967295))))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_3 (param $given i64) (param $expected i64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i64.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_6 (i64.const 0x000000000000021d) (call $system::core::u64.as_7 (call $system::core::u64.>> (call $system::core::i64.as_2 (local.get $given)) (i32.const 32))))
                (call $support::env::printf_6 (i64.const 0x0000000000000240) (call $system::core::u64.as_7 (call $system::core::u64.>> (call $system::core::i64.as_2 (local.get $expected)) (i32.const 32))))
                (call $support::env::printf_6 (i64.const 0x0000000000000269) (call $system::core::i64.&_2 (local.get $given) (call $system::core::i32.as_3 (i32.const 4294967295))))
                (call $support::env::printf_6 (i64.const 0x000000000000028c) (call $system::core::i64.&_2 (local.get $expected) (call $system::core::i32.as_3 (i32.const 4294967295))))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_4 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u32.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_6 (i64.const 0x00000000000002b5) (local.get $given))
                (call $support::env::printf_6 (i64.const 0x00000000000002d0) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_5 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i32.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_4 (i64.const 0x00000000000002f1) (local.get $given))
                (call $support::env::printf_4 (i64.const 0x000000000000030c) (local.get $expected))
              )
          )
          (else)
        )
