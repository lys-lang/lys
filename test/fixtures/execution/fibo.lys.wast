(module
  ...
  (func $support::test::mustEqual_1 (param $given f64) (param $expected f64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::f64::f64.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_11 (i64.const 0x0000000300000137) (local.get $given))
                (call $support::env::printf_11 (i64.const 0x0000000300000152) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_2 (param $given f32) (param $expected f32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::f32::f32.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_10 (i64.const 0x0000000300000173) (local.get $given))
                (call $support::env::printf_10 (i64.const 0x000000030000018e) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_3 (param $given i64) (param $expected i64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u64::u64.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_9 (i64.const 0x00000003000001af) (call $system::core::u64::u64.as_8 (call $system::core::u64::u64.>>_1 (local.get $given) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x00000003000001d2) (call $system::core::u64::u64.as_8 (call $system::core::u64::u64.>>_1 (local.get $expected) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x00000003000001fb) (call $system::core::u64::u64.&_3 (local.get $given) (i32.const 0xFFFFFFFF)))
                (call $support::env::printf_9 (i64.const 0x000000030000021e) (call $system::core::u64::u64.&_3 (local.get $expected) (i32.const 0xFFFFFFFF)))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_4 (param $given i64) (param $expected i64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i64::i64.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_9 (i64.const 0x0000000300000247) (call $system::core::u64::u64.as_8 (call $system::core::u64::u64.>>_1 (call $system::core::i64::i64.as_3 (local.get $given)) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x000000030000026a) (call $system::core::u64::u64.as_8 (call $system::core::u64::u64.>>_1 (call $system::core::i64::i64.as_3 (local.get $expected)) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x0000000300000293) (call $system::core::i64::i64.&_3 (local.get $given) (i32.const 0xFFFFFFFF)))
                (call $support::env::printf_9 (i64.const 0x00000003000002b6) (call $system::core::i64::i64.&_3 (local.get $expected) (i32.const 0xFFFFFFFF)))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_5 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u32::u32.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_9 (i64.const 0x00000003000002df) (local.get $given))
                (call $support::env::printf_9 (i64.const 0x00000003000002fa) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_6 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i32::i32.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_8 (i64.const 0x000000030000031b) (local.get $given))
                (call $support::env::printf_8 (i64.const 0x0000000300000336) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::assert_1 (param $condition i32)
    (call $support::test::assert_2 (local.get $condition) (i64.const 0x0000000300000357))
  )
  ...
  (data 0 (i32.const 269) "\08\00\00\00t\00r\00u\00e\00\00")
  (data 0 (i32.const 282) "\0a\00\00\00f\00a\00l\00s\00e\00\00")
  (data 0 (i32.const 297) "\02\00\00\000\00\00")
  (data 0 (i32.const 304) "\02\00\00\000\00\00")
  ...
  (func $system::core::string::string.stringify_1 (param $value i32) (result i64)
    (block $B1 (result i64)
      (if $IF2 (result i64) (local.get $value)
          (then
            (block $B3 (result i64)
                (i64.const 0x000000030000010d)
              )
          )
          (else
            (block $B4 (result i64)
                (i64.const 0x000000030000011a)
              )
          )
        )
    )
  ...
  (func $test::fixtures::execution::fibo::fibo_1 (param $n i32) (param $x1 i32) (param $x2 i32) (result i32)
    (block $B1 (result i32)
      (if $IF2 (result i32) (call $system::core::i32::i32.>_1 (local.get $n) (i32.const 0))
          (then
            (block $B3 (result i32)
                (call $test::fixtures::execution::fibo::fibo_1 (call $system::core::i32::i32.-_1 (local.get $n) (i32.const 1)) (local.get $x2) (call $system::core::i32::i32.+_1 (local.get $x1) (local.get $x2)))
              )
          )
          (else
            (block $B4 (result i32)
  ...
  (func $test::fixtures::execution::fibo::fiboPatternMatching_1 (param $n i32) (param $a i32) (param $b i32) (result i32)
    ...
    (block $B1 (result i32)
      ...
      (block $B1_0
          (block $B1_1
              (block $B1_2
                  (br_if $B1_0 (call $system::core::i32::i32.==_1 (local.get $var$3) (i32.const 0)))
                  (br_if $B1_1 (call $system::core::i32::i32.==_1 (local.get $var$3) (i32.const 1)))
                )
              (call $test::fixtures::execution::fibo::fibo_1 (call $system::core::i32::i32.-_1 (local.get $n) (i32.const 1)) (local.get $b) (call $system::core::i32::i32.+_1 (local.get $a) (local.get $b)))
              (br $B1)
            )
          (local.get $b)
          (br $B1)
  ...
  (func $test::fixtures::execution::fibo::factorial_1 (param $n i32) (result i32)
    (if $IF1 (result i32) (call $system::core::i32::i32.>=_1 (local.get $n) (i32.const 1))
      (then
        (call $system::core::i32::i32.*_1 (local.get $n) (call $test::fixtures::execution::fibo::factorial_1 (call $system::core::i32::i32.-_1 (local.get $n) (i32.const 1))))
      )
      (else
        (i32.const 1)
      )
  ...
  (func $test::fixtures::execution::fibo::main_1
    (block $B1
      ...
      (call $support::test::mustEqual_6 (call $test::fixtures::execution::fibo::fib_1 (i32.const 46)) (i32.const 1836311903) (i64.const 0x0000000300000027))
      (call $support::test::mustEqual_6 (call $test::fixtures::execution::fibo::fibPatternMatching_1 (i32.const 46)) (i32.const 1836311903) (i64.const 0x0000000300000060))
      (call $support::test::END_1)
      (call $support::test::START_2 (i64.const 0x00000003000000b7))
      (call $support::test::mustEqual_6 (call $test::fixtures::execution::fibo::factorial_1 (i32.const 10)) (i32.const 3628800) (i64.const 0x00000003000000ce))
      (call $support::test::END_1)
    )
  )
  (func $%%START%%
