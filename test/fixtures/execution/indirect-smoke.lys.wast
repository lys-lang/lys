(module
  ...
  (func $support::test::mustEqual_1 (param $given f64) (param $expected f64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::f64::f64.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_11 (i64.const 0x00000004000000f5) (local.get $given))
                (call $support::env::printf_11 (i64.const 0x0000000400000110) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_2 (param $given f32) (param $expected f32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::f32::f32.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_10 (i64.const 0x0000000400000131) (local.get $given))
                (call $support::env::printf_10 (i64.const 0x000000040000014c) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_3 (param $given i64) (param $expected i64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u64::u64.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_9 (i64.const 0x000000040000016d) (call $system::core::u64::u64.as_8 (call $system::core::u64::u64.>>_1 (local.get $given) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x0000000400000190) (call $system::core::u64::u64.as_8 (call $system::core::u64::u64.>>_1 (local.get $expected) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x00000004000001b9) (call $system::core::u64::u64.&_3 (local.get $given) (i32.const 0xFFFFFFFF)))
                (call $support::env::printf_9 (i64.const 0x00000004000001dc) (call $system::core::u64::u64.&_3 (local.get $expected) (i32.const 0xFFFFFFFF)))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_4 (param $given i64) (param $expected i64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i64::i64.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_9 (i64.const 0x0000000400000205) (call $system::core::u64::u64.as_8 (call $system::core::u64::u64.>>_1 (call $system::core::i64::i64.as_3 (local.get $given)) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x0000000400000228) (call $system::core::u64::u64.as_8 (call $system::core::u64::u64.>>_1 (call $system::core::i64::i64.as_3 (local.get $expected)) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x0000000400000251) (call $system::core::i64::i64.&_3 (local.get $given) (i32.const 0xFFFFFFFF)))
                (call $support::env::printf_9 (i64.const 0x0000000400000274) (call $system::core::i64::i64.&_3 (local.get $expected) (i32.const 0xFFFFFFFF)))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_5 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u32::u32.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_9 (i64.const 0x000000040000029d) (local.get $given))
                (call $support::env::printf_9 (i64.const 0x00000004000002b8) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_6 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i32::i32.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_8 (i64.const 0x00000004000002d9) (local.get $given))
                (call $support::env::printf_8 (i64.const 0x00000004000002f4) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::assert_1 (param $condition i32)
    (call $support::test::assert_2 (local.get $condition) (i64.const 0x0000000400000315))
  )
  ...
  (func $system::core::string::string.stringify_1 (param $value i32) (result i64)
    (block $B1 (result i64)
      (if $IF2 (result i64) (local.get $value)
          (then
            (block $B3 (result i64)
                (i64.const 0x00000004000000cb)
              )
          )
          (else
            (block $B4 (result i64)
                (i64.const 0x00000004000000d8)
              )
          )
        )
    )
  ...
  (func $test::fixtures::execution::indirect-smoke::x_2 (param $which i32) (result i32)
    (call_indirect (result i32) (local.get $which))
  )
  (func $test::fixtures::execution::indirect-smoke::x_3 (param $which i32) (param $z i32) (result i32)
    (call_indirect (param i32) (result i32) (local.get $which) (local.get $z))
  )
  ...
  (func $test::fixtures::execution::indirect-smoke::main_1
    (block $B1
      ...
      (call $support::test::mustEqual_6 (call $test::fixtures::execution::indirect-smoke::test_1 (i32.const 1)) (i32.const 1) (i64.const 0x000000040000005d))
      (call $support::test::mustEqual_6 (call $test::fixtures::execution::indirect-smoke::test_1 (i32.const 0)) (i32.const 2) (i64.const 0x0000000400000064))
      (call $support::test::END_1)
      (call $support::test::START_2 (i64.const 0x000000040000006b))
      (call $support::test::mustEqual_6 (call $test::fixtures::execution::indirect-smoke::test_2 (i32.const 1) (i32.const 1)) (i32.const 2) (i64.const 0x00000004000000b8))
      (call $support::test::mustEqual_6 (call $test::fixtures::execution::indirect-smoke::test_2 (i32.const 0) (i32.const 1)) (i32.const 3) (i64.const 0x00000004000000bf))
      (call $support::test::END_1)
    )
  )
  (func $%%START%%
