(module
  ...
  (data 0 (i32.const 762) "\08\00\00\00t\00r\00u\00e\00\00")
  (data 0 (i32.const 775) "\0a\00\00\00f\00a\00l\00s\00e\00\00")
  (data 0 (i32.const 790) "\02\00\00\000\00\00")
  (data 0 (i32.const 797) "\02\00\00\000\00\00")
  ...
  (func $system::string::String.stringify (param $value i32) (result i64)
    (block $B1 (result i64)
      (if $IF2 (result i64) (local.get $value)
          (then
            (block $B3 (result i64)
                (i64.const 0x00000000000002fa)
              )
          )
          (else
            (block $B4 (result i64)
                (i64.const 0x0000000000000307)
              )
          )
        )
    )
  ...
  (data 0 (i32.const 431) "\16\00\00\00 \00 \00g\00i\00v\00e\00n\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 458) "\1c\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 491) "\16\00\00\00 \00 \00g\00i\00v\00e\00n\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 518) "\1c\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00:\00 \00%\00d\00\00")
  ...
  (data 0 (i32.const 611) "\16\00\00\00 \00 \00g\00i\00v\00e\00n\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 638) "\1c\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 671) "\16\00\00\00 \00 \00g\00i\00v\00e\00n\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 698) "\1c\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 731) "\1a\00\00\00a\00s\00s\00e\00r\00t\00(\00f\00a\00l\00s\00e\00)\00\00")
  ...
  (func $support::test::mustEqual (param $given f64) (param $expected f64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::f64.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_13 (i64.const 0x0000000000000137) (local.get $given))
                (call $support::env::printf_13 (i64.const 0x0000000000000152) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_1 (param $given f32) (param $expected f32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::f32.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_11 (i64.const 0x0000000000000173) (local.get $given))
                (call $support::env::printf_11 (i64.const 0x000000000000018e) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_4 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u32.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_9 (i64.const 0x00000000000001af) (local.get $given))
                (call $support::env::printf_9 (i64.const 0x00000000000001ca) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_5 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i32.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_7 (i64.const 0x00000000000001eb) (local.get $given))
                (call $support::env::printf_7 (i64.const 0x0000000000000206) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_6 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u16.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_17 (i64.const 0x0000000000000227) (local.get $given))
                (call $support::env::printf_17 (i64.const 0x0000000000000242) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_7 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i16.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_15 (i64.const 0x0000000000000263) (local.get $given))
                (call $support::env::printf_15 (i64.const 0x000000000000027e) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_8 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u8.!=_2 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_19 (i64.const 0x000000000000029f) (local.get $given))
                (call $support::env::printf_19 (i64.const 0x00000000000002ba) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::assert (param $condition i32)
    (call $support::test::assert_2 (local.get $condition) (i64.const 0x00000000000002db))
  )
  ...
  (func $test/fixtures/execution/patternMatchingDeconstruct.lys::Red.as (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  ...
  (func $test/fixtures/execution/patternMatchingDeconstruct.lys::Red.Red$discriminant (result i64)
    ...
    (block $B1 (result i64)
      ...
      (call $system::core::i64.<< (call $system::core::u32.as (local.get $test/fixtures/execution/patternMatchingDeconstruct.lys::discriminant)) (i32.const 32))
    )
  )
  ...
  (func $test/fixtures/execution/patternMatchingDeconstruct.lys::Green.as (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  ...
  (func $test/fixtures/execution/patternMatchingDeconstruct.lys::Green.Green$discriminant (result i64)
    ...
    (block $B1 (result i64)
      ...
      (call $system::core::i64.<< (call $system::core::u32.as (local.get $test/fixtures/execution/patternMatchingDeconstruct.lys::discriminant_3)) (i32.const 32))
    )
  )
  ...
  (func $test/fixtures/execution/patternMatchingDeconstruct.lys::Blue.as (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  ...
  (func $test/fixtures/execution/patternMatchingDeconstruct.lys::Blue.Blue$discriminant (result i64)
    ...
    (block $B1 (result i64)
      ...
      (call $system::core::i64.<< (call $system::core::u32.as (local.get $test/fixtures/execution/patternMatchingDeconstruct.lys::discriminant_6)) (i32.const 32))
    )
  )
  ...
  (func $test/fixtures/execution/patternMatchingDeconstruct.lys::Custom.as (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  ...
  (func $test/fixtures/execution/patternMatchingDeconstruct.lys::Custom.Custom$discriminant (result i64)
    ...
    (block $B1 (result i64)
      ...
      (call $system::core::u64.<< (call $system::core::u32.as_1 (local.get $test/fixtures/execution/patternMatchingDeconstruct.lys::discriminant_9)) (i32.const 32))
    )
  )
  (func $test/fixtures/execution/patternMatchingDeconstruct.lys::Custom.apply (param $r i32) (param $g i32) (param $b i32) (result i64)
    ...
    (block $B1 (result i64)
      (local.set $test/fixtures/execution/patternMatchingDeconstruct.lys::$ref (call $test/fixtures/execution/patternMatchingDeconstruct.lys::Custom.fromPointer (call $system::memory::calloc (call $system::core::i32.as_3 (i32.const 1)) (i32.const 12))))
      (call $test/fixtures/execution/patternMatchingDeconstruct.lys::Custom.property$0_1 (local.get $test/fixtures/execution/patternMatchingDeconstruct.lys::$ref) (local.get $r))
      (call $test/fixtures/execution/patternMatchingDeconstruct.lys::Custom.property$1_1 (local.get $test/fixtures/execution/patternMatchingDeconstruct.lys::$ref) (local.get $g))
      (call $test/fixtures/execution/patternMatchingDeconstruct.lys::Custom.property$2_1 (local.get $test/fixtures/execution/patternMatchingDeconstruct.lys::$ref) (local.get $b))
    ...
    (block $B1 (result i32)
      (block $B3 (result i32)
          ...
          (block $B3_0
              ...
              (block $B2 (result i32)
                  (local.set $test/fixtures/execution/patternMatchingDeconstruct.lys::r_2 (call $test/fixtures/execution/patternMatchingDeconstruct.lys::Custom.property_r (local.get $var$4)))
                  (local.set $test/fixtures/execution/patternMatchingDeconstruct.lys::g_2 (call $test/fixtures/execution/patternMatchingDeconstruct.lys::Custom.property_g (local.get $var$4)))
                  (local.set $test/fixtures/execution/patternMatchingDeconstruct.lys::b_2 (call $test/fixtures/execution/patternMatchingDeconstruct.lys::Custom.property_b (local.get $var$4)))
                  (call $system::core::boolean.&& (call $system::core::boolean.&& (call $system::core::i32.== (local.get $test/fixtures/execution/patternMatchingDeconstruct.lys::r_2) (i32.const 255)) (call $system::core::i32.== (local.get $test/fixtures/execution/patternMatchingDeconstruct.lys::g_2) (i32.const 0))) (call $system::core::i32.== (local.get $test/fixtures/execution/patternMatchingDeconstruct.lys::b_2) (i32.const 0)))
                )
              (br $B3)
            )
          (i32.const 1)
