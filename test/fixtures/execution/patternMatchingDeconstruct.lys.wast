(module
  ...
  (func $support::test::mustEqual_2 (param $given i64) (param $expected i64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u64.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_9 (i64.const 0x00000000000001af) (call $system::core::u64.as_7 (call $system::core::u64.>> (local.get $given) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x00000000000001d2) (call $system::core::u64.as_7 (call $system::core::u64.>> (local.get $expected) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x00000000000001fb) (call $system::core::u64.&_2 (local.get $given) (call $system::core::i32.as_3 (i32.const 0xFFFFFFFF))))
                (call $support::env::printf_9 (i64.const 0x000000000000021e) (call $system::core::u64.&_2 (local.get $expected) (call $system::core::i32.as_3 (i32.const 0xFFFFFFFF))))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_3 (param $given i64) (param $expected i64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i64.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_9 (i64.const 0x0000000000000247) (call $system::core::u64.as_7 (call $system::core::u64.>> (call $system::core::i64.as_2 (local.get $given)) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x000000000000026a) (call $system::core::u64.as_7 (call $system::core::u64.>> (call $system::core::i64.as_2 (local.get $expected)) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x0000000000000293) (call $system::core::i64.&_2 (local.get $given) (call $system::core::i32.as_3 (i32.const 0xFFFFFFFF))))
                (call $support::env::printf_9 (i64.const 0x00000000000002b6) (call $system::core::i64.&_2 (local.get $expected) (call $system::core::i32.as_3 (i32.const 0xFFFFFFFF))))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_5 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i32.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_7 (i64.const 0x000000000000031b) (local.get $given))
                (call $support::env::printf_7 (i64.const 0x0000000000000336) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $test/fixtures/execution/patternMatchingDeconstruct.lys::main
    (block $B1
      ...
      (call $support::test::mustEqual_6 (call $test/fixtures/execution/patternMatchingDeconstruct.lys::isRed (call $test/fixtures/execution/patternMatchingDeconstruct.lys::Red.apply)) (i32.const 1) (i64.const 0x0000000000000057))
      (call $support::test::mustEqual_6 (call $test/fixtures/execution/patternMatchingDeconstruct.lys::isRed (call $test/fixtures/execution/patternMatchingDeconstruct.lys::Green.apply)) (i32.const 0) (i64.const 0x0000000000000070))
      (call $support::test::mustEqual_6 (call $test/fixtures/execution/patternMatchingDeconstruct.lys::isRed (call $test/fixtures/execution/patternMatchingDeconstruct.lys::Blue.apply)) (i32.const 0) (i64.const 0x000000000000008d))
      (call $support::test::mustEqual_6 (call $test/fixtures/execution/patternMatchingDeconstruct.lys::isRed (call $test/fixtures/execution/patternMatchingDeconstruct.lys::Custom.apply (i32.const 255) (i32.const 0) (i32.const 0))) (i32.const 1) (i64.const 0x00000000000000a8))
      (call $support::test::mustEqual_6 (call $test/fixtures/execution/patternMatchingDeconstruct.lys::isRed (call $test/fixtures/execution/patternMatchingDeconstruct.lys::Custom.apply (i32.const 0) (i32.const 1) (i32.const 3))) (i32.const 0) (i64.const 0x00000000000000d9))
      (call $support::test::mustEqual_6 (call $test/fixtures/execution/patternMatchingDeconstruct.lys::isRed (call $test/fixtures/execution/patternMatchingDeconstruct.lys::Custom.apply (i32.const 255) (i32.const 1) (i32.const 3))) (i32.const 0) (i64.const 0x0000000000000106))
