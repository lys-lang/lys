(module
  ...
  (func $test::fixtures::execution::patternMatchingDeconstruct::Custom.as_3 (param $self i64) (result i32)
    (call $system::core::native::addressFromRef_1 (get_local $self))
  )
  (func $test::fixtures::execution::patternMatchingDeconstruct::Custom.as_4 (param $lhs i64) (result i64)
    (local.get $lhs)
  )
