(module
  ...
  (data 0 (i32.const 518) "\08\00\00\00t\00r\00u\00e\00\00")
  (data 0 (i32.const 531) "\0a\00\00\00f\00a\00l\00s\00e\00\00")
  (data 0 (i32.const 546) "\02\00\00\000\00\00")
  (data 0 (i32.const 553) "\02\00\00\000\00\00")
  ...
  (func $system::string::String.stringify (param $value i32) (result i64)
    (block $B1 (result i64)
      (if $IF2 (result i64) (local.get $value)
          (then
            (block $B3 (result i64)
                (i64.const 0x0000000000000206)
              )
          )
          (else
            (block $B4 (result i64)
                (i64.const 0x0000000000000213)
              )
          )
        )
    )
  ...
  (data 0 (i32.const 187) "\16\00\00\00 \00 \00g\00i\00v\00e\00n\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 214) "\1c\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 247) "\16\00\00\00 \00 \00g\00i\00v\00e\00n\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 274) "\1c\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 307) "\16\00\00\00 \00 \00g\00i\00v\00e\00n\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 334) "\1c\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 367) "\16\00\00\00 \00 \00g\00i\00v\00e\00n\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 394) "\1c\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 427) "\16\00\00\00 \00 \00g\00i\00v\00e\00n\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 454) "\1c\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 487) "\1a\00\00\00a\00s\00s\00e\00r\00t\00(\00f\00a\00l\00s\00e\00)\00\00")
  ...
  (func $support::test::mustEqual_4 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u32.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_9 (i64.const 0x00000000000000bb) (local.get $given))
                (call $support::env::printf_9 (i64.const 0x00000000000000d6) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_5 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i32.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_7 (i64.const 0x00000000000000f7) (local.get $given))
                (call $support::env::printf_7 (i64.const 0x0000000000000112) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_6 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u16.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_17 (i64.const 0x0000000000000133) (local.get $given))
                (call $support::env::printf_17 (i64.const 0x000000000000014e) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_7 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i16.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_15 (i64.const 0x000000000000016f) (local.get $given))
                (call $support::env::printf_15 (i64.const 0x000000000000018a) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_8 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u8.!=_2 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_19 (i64.const 0x00000000000001ab) (local.get $given))
                (call $support::env::printf_19 (i64.const 0x00000000000001c6) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::assert (param $condition i32)
    (call $support::test::assert_2 (local.get $condition) (i64.const 0x00000000000001e7))
  )
