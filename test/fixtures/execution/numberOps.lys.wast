(module
  ...
  (data 0 (i32.const 353) "4\00\00\00t\00r\00y\00i\00n\00g\00 \00t\00o\00 \00a\00l\00l\00o\00c\00a\00t\00e\00 \000\00 \00b\00y\00t\00e\00s\00\00")
      ...
      (if $IF2 (result i32) (call $system::core::i32.> (get_local $size) (i32.const 0))
          ...
          (else
            (block $B12 (result i32)
                (call $support::env::printf_8 (i64.const 0x0000000000000161))
  ...
  (func $system::string::String.stringify (param $value i32) (result i64)
    (block $B1 (result i64)
      (if $IF2 (result i64) (get_local $value)
          (then
            (block $B3 (result i64)
                (i64.const 0x0000000000000137)
              )
          )
          (else
            (block $B4 (result i64)
                (i64.const 0x0000000000000144)
              )
          )
        )
    )
  ...
  (data 0 (i32.const 280) "\1a\00\00\00a\00s\00s\00e\00r\00t\00(\00f\00a\00l\00s\00e\00)\00\00")
  ...
  (func $support::test::assert_11 (param $condition i32)
    (call $support::test::assert_13 (get_local $condition) (i64.const 0x0000000000000118))
  )
  ...
  (export "main" (func $test/fixtures/execution/numberOps.lys::main))
  (func $test/fixtures/execution/numberOps.lys::maxI64 (result i64)
    (i64.const 0xFFFFFFFFFFFF)
  )
  (func $test/fixtures/execution/numberOps.lys::maxI16inI64 (result i64)
    (i64.const 0xFFFF)
  )
  (func $test/fixtures/execution/numberOps.lys::i32_one (result i32)
    (i32.const 1)
  )
  (func $test/fixtures/execution/numberOps.lys::u32_one (result i32)
    (i32.const 1)
  )
  (func $test/fixtures/execution/numberOps.lys::i32const_u32 (param $x i32) (result i32)
    (get_local $x)
  )
  (func $test/fixtures/execution/numberOps.lys::i32const_i32 (param $x i32) (result i32)
    (get_local $x)
  )
  (func $test/fixtures/execution/numberOps.lys::main
    (block $B1
      (call $support::test::START_1 (i64.const 0x0000000000000010))
      (call $support::test::verify_1 (call $system::core::i32.== (i32.const 0) (call $system::core::i32.- (i32.const 1) (i32.const 1))) (i64.const 0x000000000000003d))
      (call $support::test::verify_1 (call $system::core::i32.== (i32.const 0) (call $system::core::i32./ (i32.const 0) (i32.const 10))) (i64.const 0x0000000000000044))
      (call $support::test::verify_1 (call $system::core::i32.== (i32.const 1) (call $system::core::i32./ (i32.const 10) (i32.const 10))) (i64.const 0x0000000000000055))
      (call $support::test::verify_1 (call $system::core::i32.== (i32.const 0) (call $system::core::i32./ (i32.const 10) (i32.const 100))) (i64.const 0x0000000000000068))
      (call $support::test::verify_1 (call $system::core::i16.== (call $system::core::i32.as_8 (call $system::core::i64.as_4 (call $test/fixtures/execution/numberOps.lys::maxI16inI64))) (call $system::core::i32.as_8 (i32.const 65535))) (i64.const 0x000000000000007d))
      (call $support::test::verify_1 (call $system::core::i32.== (call $system::core::i16.as (call $system::core::i32.as_8 (i32.const 65535))) (i32.const 4294967295)) (i64.const 0x0000000000000084))
      (call $support::test::verify_1 (call $system::core::i32.== (call $system::core::i16.as (call $system::core::i32.as_8 (i32.const 32768))) (i32.const -32768)) (i64.const 0x00000000000000b1))
      (call $support::test::verify_1 (call $system::core::u32.== (call $system::core::i32.as_3 (i32.const 1)) (call $test/fixtures/execution/numberOps.lys::u32_one)) (i64.const 0x00000000000000de))
      (call $support::test::verify_1 (call $system::core::i32.== (call $test/fixtures/execution/numberOps.lys::i32const_i32 (i32.const 44)) (call $system::core::u32.as_4 (call $test/fixtures/execution/numberOps.lys::i32const_u32 (i32.const 44)))) (i64.const 0x00000000000000e5))
      (call $support::test::verify_1 (call $system::core::u32.== (call $test/fixtures/execution/numberOps.lys::i32const_u32 (i32.const 44)) (call $system::core::i32.as_3 (call $test/fixtures/execution/numberOps.lys::i32const_i32 (i32.const 44)))) (i64.const 0x00000000000000ec))
      (call $support::test::verify_1 (call $system::core::i32.== (call $system::core::i32./ (i32.const 44) (i32.const 10)) (i32.const 4)) (i64.const 0x00000000000000f3))
      (call $support::test::verify_1 (call $system::core::u64.== (call $system::core::u64./ (call $system::core::i32.as_4 (i32.const 44)) (call $system::core::i32.as_4 (i32.const 10))) (call $system::core::i32.as_4 (i32.const 4))) (i64.const 0x00000000000000fa))
      (call $support::test::verify_1 (call $system::core::i32.== (i32.const -1) (i32.const 4294967295)) (i64.const 0x0000000000000101))
      (call $support::test::verify_1 (call $system::core::u32.== (call $system::core::i32.as_3 (i32.const -1)) (call $system::core::i32.as_3 (i32.const 4294967295))) (i64.const 0x0000000000000108))
      (call $support::test::verify_1 (call $system::core::u32.== (call $system::core::i32.as_3 (call $system::core::i32.-_1 (i32.const -1))) (call $system::core::i32.as_3 (i32.const 1))) (i64.const 0x000000000000010f))
