(module
  ...
  (func $support::test::mustEqual (param $given f64) (param $expected f64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::f64.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_10 (i64.const 0x0000000000000118) (local.get $given))
                (call $support::env::printf_10 (i64.const 0x0000000000000133) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_1 (param $given f32) (param $expected f32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::f32.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_8 (i64.const 0x0000000000000154) (local.get $given))
                (call $support::env::printf_8 (i64.const 0x000000000000016f) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_2 (param $given i64) (param $expected i64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u64.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_6 (i64.const 0x0000000000000190) (call $system::core::u64.as_7 (call $system::core::u64.>> (local.get $given) (i32.const 32))))
                (call $support::env::printf_6 (i64.const 0x00000000000001b3) (call $system::core::u64.as_7 (call $system::core::u64.>> (local.get $expected) (i32.const 32))))
                (call $support::env::printf_6 (i64.const 0x00000000000001dc) (call $system::core::u64.&_2 (local.get $given) (call $system::core::i32.as_3 (i32.const 4294967295))))
                (call $support::env::printf_6 (i64.const 0x00000000000001ff) (call $system::core::u64.&_2 (local.get $expected) (call $system::core::i32.as_3 (i32.const 4294967295))))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_3 (param $given i64) (param $expected i64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i64.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_6 (i64.const 0x0000000000000228) (call $system::core::u64.as_7 (call $system::core::u64.>> (call $system::core::i64.as_2 (local.get $given)) (i32.const 32))))
                (call $support::env::printf_6 (i64.const 0x000000000000024b) (call $system::core::u64.as_7 (call $system::core::u64.>> (call $system::core::i64.as_2 (local.get $expected)) (i32.const 32))))
                (call $support::env::printf_6 (i64.const 0x0000000000000274) (call $system::core::i64.&_2 (local.get $given) (call $system::core::i32.as_3 (i32.const 4294967295))))
                (call $support::env::printf_6 (i64.const 0x0000000000000297) (call $system::core::i64.&_2 (local.get $expected) (call $system::core::i32.as_3 (i32.const 4294967295))))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_4 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u32.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_6 (i64.const 0x00000000000002c0) (local.get $given))
                (call $support::env::printf_6 (i64.const 0x00000000000002db) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_5 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i32.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_4 (i64.const 0x00000000000002fc) (local.get $given))
                (call $support::env::printf_4 (i64.const 0x0000000000000317) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $test/fixtures/execution/numberOps.lys::main
    (block $B1
      ...
      (call $support::test::verify_9 (call $system::core::i16.== (call $system::core::i32.as_9 (call $system::core::i64.as_3 (call $test/fixtures/execution/numberOps.lys::maxI16inI64))) (call $system::core::i32.as_9 (i32.const 65535))) (i64.const 0x000000000000007d))
      (call $support::test::verify_9 (call $system::core::i32.== (call $system::core::i16.as (call $system::core::i32.as_9 (i32.const 65535))) (i32.const 4294967295)) (i64.const 0x0000000000000084))
      (call $support::test::verify_9 (call $system::core::i32.== (call $system::core::i16.as (call $system::core::i32.as_9 (i32.const 32768))) (call $system::core::i32.-_1 (i32.const 32768))) (i64.const 0x00000000000000b1))
      ...
      (call $support::test::verify_9 (call $system::core::i32.== (call $system::core::i32.-_1 (i32.const 1)) (i32.const 4294967295)) (i64.const 0x0000000000000101))
      (call $support::test::verify_9 (call $system::core::u32.== (call $system::core::i32.as_3 (call $system::core::i32.-_1 (i32.const 1))) (call $system::core::i32.as_3 (i32.const 4294967295))) (i64.const 0x0000000000000108))
