(module
  ...
  (data $mem_410 (i32.const 410) "\16\00\00\00 \00 \00g\00i\00v\00e\00n\00:\00 \00%\00d\00\00")
  (data $mem_437 (i32.const 437) "\1c\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00:\00 \00%\00d\00\00")
  (data $mem_470 (i32.const 470) "\16\00\00\00 \00 \00g\00i\00v\00e\00n\00:\00 \00%\00d\00\00")
  (data $mem_497 (i32.const 497) "\1c\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00:\00 \00%\00d\00\00")
  (data $mem_530 (i32.const 530) "\1e\00\00\00 \00 \00g\00i\00v\00e\00n\00 \00L\00S\00B\00:\00 \00%\00X\00\00")
  (data $mem_565 (i32.const 565) "$\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00 \00L\00S\00B\00:\00 \00%\00X\00\00")
  (data $mem_606 (i32.const 606) "\1e\00\00\00 \00 \00g\00i\00v\00e\00n\00 \00M\00S\00B\00:\00 \00%\00X\00\00")
  (data $mem_641 (i32.const 641) "$\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00 \00M\00S\00B\00:\00 \00%\00X\00\00")
  (data $mem_682 (i32.const 682) "\1e\00\00\00 \00 \00g\00i\00v\00e\00n\00 \00L\00S\00B\00:\00 \00%\00X\00\00")
  (data $mem_717 (i32.const 717) "$\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00 \00L\00S\00B\00:\00 \00%\00X\00\00")
  (data $mem_758 (i32.const 758) "\1e\00\00\00 \00 \00g\00i\00v\00e\00n\00 \00M\00S\00B\00:\00 \00%\00X\00\00")
  (data $mem_793 (i32.const 793) "$\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00 \00M\00S\00B\00:\00 \00%\00X\00\00")
  (data $mem_834 (i32.const 834) "\16\00\00\00 \00 \00g\00i\00v\00e\00n\00:\00 \00%\00X\00\00")
  (data $mem_861 (i32.const 861) "\1c\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00:\00 \00%\00X\00\00")
  (data $mem_894 (i32.const 894) "\16\00\00\00 \00 \00g\00i\00v\00e\00n\00:\00 \00%\00d\00\00")
  (data $mem_921 (i32.const 921) "\1c\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00:\00 \00%\00d\00\00")
  (data $mem_954 (i32.const 954) "\1a\00\00\00a\00s\00s\00e\00r\00t\00(\00f\00a\00l\00s\00e\00)\00\00")
  ...
  (func $support::test::mustEqual_1 (param $given f64) (param $expected f64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::f64::f64.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_11 (i64.const 0x000000030000019a) (local.get $given))
                (call $support::env::printf_11 (i64.const 0x00000003000001b5) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_2 (param $given f32) (param $expected f32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::f32::f32.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_10 (i64.const 0x00000003000001d6) (local.get $given))
                (call $support::env::printf_10 (i64.const 0x00000003000001f1) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_3 (param $given i64) (param $expected i64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u64::u64.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_9 (i64.const 0x0000000300000212) (call $system::core::u64::u64.as_8 (call $system::core::u64::u64.>>_1 (local.get $given) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x0000000300000235) (call $system::core::u64::u64.as_8 (call $system::core::u64::u64.>>_1 (local.get $expected) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x000000030000025e) (call $system::core::u64::u64.&_3 (local.get $given) (i32.const 0xFFFFFFFF)))
                (call $support::env::printf_9 (i64.const 0x0000000300000281) (call $system::core::u64::u64.&_3 (local.get $expected) (i32.const 0xFFFFFFFF)))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_4 (param $given i64) (param $expected i64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i64::i64.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_9 (i64.const 0x00000003000002aa) (call $system::core::u64::u64.as_8 (call $system::core::u64::u64.>>_1 (call $system::core::i64::i64.as_3 (local.get $given)) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x00000003000002cd) (call $system::core::u64::u64.as_8 (call $system::core::u64::u64.>>_1 (call $system::core::i64::i64.as_3 (local.get $expected)) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x00000003000002f6) (call $system::core::i64::i64.&_3 (local.get $given) (i32.const 0xFFFFFFFF)))
                (call $support::env::printf_9 (i64.const 0x0000000300000319) (call $system::core::i64::i64.&_3 (local.get $expected) (i32.const 0xFFFFFFFF)))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_5 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u32::u32.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_9 (i64.const 0x0000000300000342) (local.get $given))
                (call $support::env::printf_9 (i64.const 0x000000030000035d) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_6 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i32::i32.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_8 (i64.const 0x000000030000037e) (local.get $given))
                (call $support::env::printf_8 (i64.const 0x0000000300000399) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::assert_1 (param $condition i32)
    (call $support::test::assert_2 (local.get $condition) (i64.const 0x00000003000003ba))
  )
  ...
  (data $mem_363 (i32.const 363) "\00\00\00\00\00")
  (data $mem_368 (i32.const 368) "\08\00\00\00t\00r\00u\00e\00\00")
  (data $mem_381 (i32.const 381) "\0a\00\00\00f\00a\00l\00s\00e\00\00")
  (data $mem_396 (i32.const 396) "\02\00\00\000\00\00")
  (data $mem_403 (i32.const 403) "\02\00\00\000\00\00")
  ...
  (func $system::core::string::string.stringify_1 (param $value i32) (result i64)
    (block $B1 (result i64)
      (if $IF2 (result i64) (local.get $value)
          (then
            (block $B3 (result i64)
                (i64.const 0x0000000300000170)
              )
          )
          (else
            (block $B4 (result i64)
                (i64.const 0x000000030000017d)
              )
          )
        )
    )
  ...
  (data $mem_16 (i32.const 16) "(\00\00\00N\00u\00m\00b\00e\00r\00 \00s\00a\00n\00i\00t\00y\00 \00c\00h\00e\00c\00k\00s\00\00")
  (data $mem_61 (i32.const 61) "\02\00\00\001\00\00")
  (data $mem_68 (i32.const 68) "\0c\00\00\000\00 \00/\00 \001\000\00\00")
  (data $mem_85 (i32.const 85) "\0e\00\00\001\000\00 \00/\00 \001\000\00\00")
  (data $mem_104 (i32.const 104) "\10\00\00\001\000\00 \00/\00 \001\000\000\00\00")
  (data $mem_125 (i32.const 125) "\02\00\00\002\00\00")
  (data $mem_132 (i32.const 132) "(\00\00\000\00x\00F\00F\00F\00F\00 \00a\00s\00 \00i\001\006\00 \00a\00s\00 \00i\003\002\00\00")
  (data $mem_177 (i32.const 177) "(\00\00\000\00x\00F\00F\00F\00F\00 \00a\00s\00 \00i\001\006\00 \00a\00s\00 \00i\003\002\00\00")
  (data $mem_222 (i32.const 222) "(\00\00\000\00x\008\000\000\000\00 \00a\00s\00 \00i\001\006\00 \00a\00s\00 \00i\003\002\00\00")
  (data $mem_267 (i32.const 267) "\02\00\00\003\00\00")
  (data $mem_274 (i32.const 274) "\02\00\00\004\00\00")
  (data $mem_281 (i32.const 281) "\02\00\00\005\00\00")
  (data $mem_288 (i32.const 288) "\02\00\00\006\00\00")
  (data $mem_295 (i32.const 295) "\02\00\00\007\00\00")
  (data $mem_302 (i32.const 302) "\02\00\00\008\00\00")
  (data $mem_309 (i32.const 309) "\02\00\00\009\00\00")
  (data $mem_316 (i32.const 316) "\04\00\00\001\000\00\00")
  (data $mem_325 (i32.const 325) "\0e\00\00\00s\00q\00r\00t\00(\001\00)\00\00")
  (data $mem_344 (i32.const 344) "\0e\00\00\00s\00q\00r\00t\00(\004\00)\00\00")
