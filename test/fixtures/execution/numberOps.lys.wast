(module
  ...
  (func $support::test::assert (param $condition i32)
    (call $support::test::assert_2 (local.get $condition) (i64.const 0x0000000000000118))
  )
  ...
  (func $test/fixtures/execution/numberOps.lys::main
    (block $B1
      ...
      (call $support::test::verify_12 (call $system::core::i32.== (i32.const 0) (call $system::core::i32.- (i32.const 1) (i32.const 1))) (i64.const 0x000000000000003d))
      (call $support::test::verify_12 (call $system::core::i32.== (i32.const 0) (call $system::core::i32./ (i32.const 0) (i32.const 10))) (i64.const 0x0000000000000044))
      (call $support::test::verify_12 (call $system::core::i32.== (i32.const 1) (call $system::core::i32./ (i32.const 10) (i32.const 10))) (i64.const 0x0000000000000055))
      (call $support::test::verify_12 (call $system::core::i32.== (i32.const 0) (call $system::core::i32./ (i32.const 10) (i32.const 100))) (i64.const 0x0000000000000068))
      (call $support::test::verify_12 (call $system::core::i16.== (call $system::core::i32.as_9 (call $system::core::i64.as_4 (call $test/fixtures/execution/numberOps.lys::maxI16inI64))) (call $system::core::i32.as_9 (i32.const 65535))) (i64.const 0x000000000000007d))
      (call $support::test::verify_12 (call $system::core::i32.== (call $system::core::i16.as (call $system::core::i32.as_9 (i32.const 65535))) (i32.const 4294967295)) (i64.const 0x0000000000000084))
      (call $support::test::verify_12 (call $system::core::i32.== (call $system::core::i16.as (call $system::core::i32.as_9 (i32.const 32768))) (i32.const -32768)) (i64.const 0x00000000000000b1))
      (call $support::test::verify_12 (call $system::core::u32.== (call $system::core::i32.as_3 (i32.const 1)) (call $test/fixtures/execution/numberOps.lys::u32_one)) (i64.const 0x00000000000000de))
      (call $support::test::verify_12 (call $system::core::i32.== (call $test/fixtures/execution/numberOps.lys::i32const_i32 (i32.const 44)) (call $system::core::u32.as_4 (call $test/fixtures/execution/numberOps.lys::i32const_u32 (i32.const 44)))) (i64.const 0x00000000000000e5))
      (call $support::test::verify_12 (call $system::core::u32.== (call $test/fixtures/execution/numberOps.lys::i32const_u32 (i32.const 44)) (call $system::core::i32.as_3 (call $test/fixtures/execution/numberOps.lys::i32const_i32 (i32.const 44)))) (i64.const 0x00000000000000ec))
      (call $support::test::verify_12 (call $system::core::i32.== (call $system::core::i32./ (i32.const 44) (i32.const 10)) (i32.const 4)) (i64.const 0x00000000000000f3))
      (call $support::test::verify_12 (call $system::core::u64.== (call $system::core::u64./ (call $system::core::i32.as_4 (i32.const 44)) (call $system::core::i32.as_4 (i32.const 10))) (call $system::core::i32.as_4 (i32.const 4))) (i64.const 0x00000000000000fa))
      (call $support::test::verify_12 (call $system::core::i32.== (i32.const -1) (i32.const 4294967295)) (i64.const 0x0000000000000101))
      (call $support::test::verify_12 (call $system::core::u32.== (call $system::core::i32.as_3 (i32.const -1)) (call $system::core::i32.as_3 (i32.const 4294967295))) (i64.const 0x0000000000000108))
      (call $support::test::verify_12 (call $system::core::u32.== (call $system::core::i32.as_3 (call $system::core::i32.-_1 (i32.const -1))) (call $system::core::i32.as_3 (i32.const 1))) (i64.const 0x000000000000010f))
