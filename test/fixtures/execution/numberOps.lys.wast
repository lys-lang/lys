(module
  ...
  (func $support::test::mustEqual (param $given f64) (param $expected f64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::f64.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_13 (i64.const 0x000000000000013e) (local.get $given))
                (call $support::env::printf_13 (i64.const 0x0000000000000159) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_1 (param $given f32) (param $expected f32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::f32.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_11 (i64.const 0x000000000000017a) (local.get $given))
                (call $support::env::printf_11 (i64.const 0x0000000000000195) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_2 (param $given i64) (param $expected i64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u64.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_9 (i64.const 0x00000000000001b6) (call $system::core::u64.as_7 (call $system::core::u64.>> (local.get $given) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x00000000000001d9) (call $system::core::u64.as_7 (call $system::core::u64.>> (local.get $expected) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x0000000000000202) (call $system::core::u64.&_2 (local.get $given) (call $system::core::i32.as_3 (i32.const 0xFFFFFFFF))))
                (call $support::env::printf_9 (i64.const 0x0000000000000225) (call $system::core::u64.&_2 (local.get $expected) (call $system::core::i32.as_3 (i32.const 0xFFFFFFFF))))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_3 (param $given i64) (param $expected i64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i64.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_9 (i64.const 0x000000000000024e) (call $system::core::u64.as_7 (call $system::core::u64.>> (call $system::core::i64.as_2 (local.get $given)) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x0000000000000271) (call $system::core::u64.as_7 (call $system::core::u64.>> (call $system::core::i64.as_2 (local.get $expected)) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x000000000000029a) (call $system::core::i64.&_2 (local.get $given) (call $system::core::i32.as_3 (i32.const 0xFFFFFFFF))))
                (call $support::env::printf_9 (i64.const 0x00000000000002bd) (call $system::core::i64.&_2 (local.get $expected) (call $system::core::i32.as_3 (i32.const 0xFFFFFFFF))))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_5 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i32.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_7 (i64.const 0x0000000000000322) (local.get $given))
                (call $support::env::printf_7 (i64.const 0x000000000000033d) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $test/fixtures/execution/numberOps.lys::main
    (block $B1
      ...
      (call $support::test::verify_9 (call $system::core::i32.== (i32.const 0) (call $system::core::i32.- (i32.const 1) (i32.const 1))) (i64.const 0x000000000000003d))
      (call $support::test::verify_9 (call $system::core::i32.== (i32.const 0) (call $system::core::i32./ (i32.const 0) (i32.const 10))) (i64.const 0x0000000000000044))
      (call $support::test::verify_9 (call $system::core::i32.== (i32.const 1) (call $system::core::i32./ (i32.const 10) (i32.const 10))) (i64.const 0x0000000000000055))
      (call $support::test::verify_9 (call $system::core::i32.== (i32.const 0) (call $system::core::i32./ (i32.const 10) (i32.const 100))) (i64.const 0x0000000000000068))
      (call $support::test::verify_9 (call $system::core::i16.== (call $system::core::i32.as_9 (call $system::core::i64.as_3 (call $test/fixtures/execution/numberOps.lys::maxI16inI64))) (call $system::core::i32.as_9 (i32.const 0xFFFF))) (i64.const 0x000000000000007d))
      (call $support::test::verify_9 (call $system::core::i32.== (call $system::core::i16.as (call $system::core::i32.as_9 (i32.const 0xFFFF))) (i32.const 0xFFFFFFFF)) (i64.const 0x0000000000000084))
      (call $support::test::verify_9 (call $system::core::i32.== (call $system::core::i16.as (call $system::core::i32.as_9 (i32.const 0x8000))) (call $system::core::i32.-_1 (i32.const 32768))) (i64.const 0x00000000000000b1))
      (call $support::test::verify_9 (call $system::core::u32.== (call $system::core::i32.as_3 (i32.const 1)) (call $test/fixtures/execution/numberOps.lys::u32_one)) (i64.const 0x00000000000000de))
      (call $support::test::verify_9 (call $system::core::i32.== (call $test/fixtures/execution/numberOps.lys::i32const_i32 (i32.const 44)) (call $system::core::u32.as_4 (call $test/fixtures/execution/numberOps.lys::i32const_u32 (i32.const 44)))) (i64.const 0x00000000000000e5))
      (call $support::test::verify_9 (call $system::core::u32.== (call $test/fixtures/execution/numberOps.lys::i32const_u32 (i32.const 44)) (call $system::core::i32.as_3 (call $test/fixtures/execution/numberOps.lys::i32const_i32 (i32.const 44)))) (i64.const 0x00000000000000ec))
      (call $support::test::verify_9 (call $system::core::i32.== (call $system::core::i32./ (i32.const 44) (i32.const 10)) (i32.const 4)) (i64.const 0x00000000000000f3))
      (call $support::test::verify_9 (call $system::core::u64.== (call $system::core::u64./ (call $system::core::i32.as_4 (i32.const 44)) (call $system::core::i32.as_4 (i32.const 10))) (call $system::core::i32.as_4 (i32.const 4))) (i64.const 0x00000000000000fa))
      (call $support::test::verify_9 (call $system::core::i32.== (call $system::core::i32.-_1 (i32.const 1)) (i32.const 0xFFFFFFFF)) (i64.const 0x0000000000000101))
      (call $support::test::verify_9 (call $system::core::u32.== (call $system::core::i32.as_3 (call $system::core::i32.-_1 (i32.const 1))) (call $system::core::i32.as_3 (i32.const 0xFFFFFFFF))) (i64.const 0x0000000000000108))
      (call $support::test::verify_9 (call $system::core::u32.== (call $system::core::i32.as_3 (call $system::core::i32.-_1 (call $system::core::i32.-_1 (i32.const 1)))) (call $system::core::i32.as_3 (i32.const 1))) (i64.const 0x000000000000010f))
      (call $support::test::verify_9 (call $system::core::f32.== (call $system::core::sqrt (call $system::core::i32.as_1 (i32.const 1))) (call $system::core::i32.as_1 (i32.const 1))) (i64.const 0x0000000000000118))
      (call $support::test::verify_9 (call $system::core::f32.== (call $system::core::sqrt (call $system::core::i32.as_1 (i32.const 4))) (call $system::core::i32.as_1 (i32.const 2))) (i64.const 0x000000000000012b))
