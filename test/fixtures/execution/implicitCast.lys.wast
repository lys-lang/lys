(module
  ...
  (data $mem_214 (i32.const 214) "\16\00\00\00 \00 \00g\00i\00v\00e\00n\00:\00 \00%\00d\00\00")
  (data $mem_241 (i32.const 241) "\1c\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00:\00 \00%\00d\00\00")
  (data $mem_274 (i32.const 274) "\16\00\00\00 \00 \00g\00i\00v\00e\00n\00:\00 \00%\00d\00\00")
  (data $mem_301 (i32.const 301) "\1c\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00:\00 \00%\00d\00\00")
  (data $mem_334 (i32.const 334) "\1e\00\00\00 \00 \00g\00i\00v\00e\00n\00 \00L\00S\00B\00:\00 \00%\00X\00\00")
  (data $mem_369 (i32.const 369) "$\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00 \00L\00S\00B\00:\00 \00%\00X\00\00")
  (data $mem_410 (i32.const 410) "\1e\00\00\00 \00 \00g\00i\00v\00e\00n\00 \00M\00S\00B\00:\00 \00%\00X\00\00")
  (data $mem_445 (i32.const 445) "$\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00 \00M\00S\00B\00:\00 \00%\00X\00\00")
  (data $mem_486 (i32.const 486) "\1e\00\00\00 \00 \00g\00i\00v\00e\00n\00 \00L\00S\00B\00:\00 \00%\00X\00\00")
  (data $mem_521 (i32.const 521) "$\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00 \00L\00S\00B\00:\00 \00%\00X\00\00")
  (data $mem_562 (i32.const 562) "\1e\00\00\00 \00 \00g\00i\00v\00e\00n\00 \00M\00S\00B\00:\00 \00%\00X\00\00")
  (data $mem_597 (i32.const 597) "$\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00 \00M\00S\00B\00:\00 \00%\00X\00\00")
  (data $mem_638 (i32.const 638) "\16\00\00\00 \00 \00g\00i\00v\00e\00n\00:\00 \00%\00X\00\00")
  (data $mem_665 (i32.const 665) "\1c\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00:\00 \00%\00X\00\00")
  (data $mem_698 (i32.const 698) "\16\00\00\00 \00 \00g\00i\00v\00e\00n\00:\00 \00%\00d\00\00")
  (data $mem_725 (i32.const 725) "\1c\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00:\00 \00%\00d\00\00")
  (data $mem_758 (i32.const 758) "\1a\00\00\00a\00s\00s\00e\00r\00t\00(\00f\00a\00l\00s\00e\00)\00\00")
  ...
  (func $support::test::mustEqual_1 (param $given f64) (param $expected f64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::f64::f64.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_11 (i64.const 0x00000003000000d6) (local.get $given))
                (call $support::env::printf_11 (i64.const 0x00000003000000f1) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_2 (param $given f32) (param $expected f32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::f32::f32.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_10 (i64.const 0x0000000300000112) (local.get $given))
                (call $support::env::printf_10 (i64.const 0x000000030000012d) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_3 (param $given i64) (param $expected i64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u64::u64.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_9 (i64.const 0x000000030000014e) (call $system::core::u64::u64.as_8 (call $system::core::u64::u64.>>_1 (local.get $given) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x0000000300000171) (call $system::core::u64::u64.as_8 (call $system::core::u64::u64.>>_1 (local.get $expected) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x000000030000019a) (call $system::core::u64::u64.&_3 (local.get $given) (i32.const 0xFFFFFFFF)))
                (call $support::env::printf_9 (i64.const 0x00000003000001bd) (call $system::core::u64::u64.&_3 (local.get $expected) (i32.const 0xFFFFFFFF)))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_4 (param $given i64) (param $expected i64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i64::i64.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_9 (i64.const 0x00000003000001e6) (call $system::core::u64::u64.as_8 (call $system::core::u64::u64.>>_1 (call $system::core::i64::i64.as_3 (local.get $given)) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x0000000300000209) (call $system::core::u64::u64.as_8 (call $system::core::u64::u64.>>_1 (call $system::core::i64::i64.as_3 (local.get $expected)) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x0000000300000232) (call $system::core::i64::i64.&_3 (local.get $given) (i32.const 0xFFFFFFFF)))
                (call $support::env::printf_9 (i64.const 0x0000000300000255) (call $system::core::i64::i64.&_3 (local.get $expected) (i32.const 0xFFFFFFFF)))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_5 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u32::u32.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_9 (i64.const 0x000000030000027e) (local.get $given))
                (call $support::env::printf_9 (i64.const 0x0000000300000299) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_6 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i32::i32.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_8 (i64.const 0x00000003000002ba) (local.get $given))
                (call $support::env::printf_8 (i64.const 0x00000003000002d5) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::assert_1 (param $condition i32)
    (call $support::test::assert_2 (local.get $condition) (i64.const 0x00000003000002f6))
  )
  ...
  (data $mem_167 (i32.const 167) "\00\00\00\00\00")
  (data $mem_172 (i32.const 172) "\08\00\00\00t\00r\00u\00e\00\00")
  (data $mem_185 (i32.const 185) "\0a\00\00\00f\00a\00l\00s\00e\00\00")
  (data $mem_200 (i32.const 200) "\02\00\00\000\00\00")
  (data $mem_207 (i32.const 207) "\02\00\00\000\00\00")
  ...
  (func $system::core::string::string.stringify_1 (param $value i32) (result i64)
    (block $B1 (result i64)
      (if $IF2 (result i64) (local.get $value)
          (then
            (block $B3 (result i64)
                (i64.const 0x00000003000000ac)
              )
          )
          (else
            (block $B4 (result i64)
                (i64.const 0x00000003000000b9)
              )
          )
        )
    )
  ...
  (data $mem_16 (i32.const 16) ".\00\00\00I\00m\00p\00l\00i\00c\00i\00t\00 \00n\00u\00m\00b\00e\00r\00 \00c\00a\00s\00t\00i\00n\00g\00\00")
  (data $mem_67 (i32.const 67) "$\00\00\00e\00q\00(\001\000\00_\00u\001\006\00,\00 \001\000\00_\00i\003\002\00)\00\00")
  (data $mem_108 (i32.const 108) "\0e\00\00\00m\00a\00t\00c\00h\00 \000\00\00")
  (data $mem_127 (i32.const 127) "\0e\00\00\00m\00a\00t\00c\00h\00 \001\00\00")
  (data $mem_146 (i32.const 146) "\10\00\00\000\00.\000\00 \00=\00=\00 \000\00\00")
