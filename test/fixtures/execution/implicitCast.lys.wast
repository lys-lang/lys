(module
  ...
  (data 0 (i32.const 664) "\08\00\00\00t\00r\00u\00e\00\00")
  (data 0 (i32.const 677) "\0a\00\00\00f\00a\00l\00s\00e\00\00")
  (data 0 (i32.const 692) "\02\00\00\000\00\00")
  (data 0 (i32.const 699) "\02\00\00\000\00\00")
  ...
  (data 0 (i32.const 213) "\16\00\00\00 \00 \00g\00i\00v\00e\00n\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 240) "\1c\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 273) "\16\00\00\00 \00 \00g\00i\00v\00e\00n\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 300) "\1c\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 333) "\16\00\00\00 \00 \00g\00i\00v\00e\00n\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 360) "\1c\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 393) "\16\00\00\00 \00 \00g\00i\00v\00e\00n\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 420) "\1c\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 453) "\16\00\00\00 \00 \00g\00i\00v\00e\00n\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 480) "\1c\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 513) "\16\00\00\00 \00 \00g\00i\00v\00e\00n\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 540) "\1c\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 573) "\16\00\00\00 \00 \00g\00i\00v\00e\00n\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 600) "\1c\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 633) "\1a\00\00\00a\00s\00s\00e\00r\00t\00(\00f\00a\00l\00s\00e\00)\00\00")
  ...
  (func $support::test::mustEqual (param $given f64) (param $expected f64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::f64.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_13 (i64.const 0x00000000000000d5) (local.get $given))
                (call $support::env::printf_13 (i64.const 0x00000000000000f0) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_1 (param $given f32) (param $expected f32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::f32.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_11 (i64.const 0x0000000000000111) (local.get $given))
                (call $support::env::printf_11 (i64.const 0x000000000000012c) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_4 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u32.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_9 (i64.const 0x000000000000014d) (local.get $given))
                (call $support::env::printf_9 (i64.const 0x0000000000000168) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_5 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i32.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_7 (i64.const 0x0000000000000189) (local.get $given))
                (call $support::env::printf_7 (i64.const 0x00000000000001a4) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_6 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u16.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_17 (i64.const 0x00000000000001c5) (local.get $given))
                (call $support::env::printf_17 (i64.const 0x00000000000001e0) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_7 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i16.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_15 (i64.const 0x0000000000000201) (local.get $given))
                (call $support::env::printf_15 (i64.const 0x000000000000021c) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_8 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u8.!=_2 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_19 (i64.const 0x000000000000023d) (local.get $given))
                (call $support::env::printf_19 (i64.const 0x0000000000000258) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::assert (param $condition i32)
    (call $support::test::assert_2 (local.get $condition) (i64.const 0x0000000000000279))
  )
  ...
  (data 0 (i32.const 146) "\12\00\00\00m\00a\00t\00c\00h\00 \001\00.\001\00\00")
  (data 0 (i32.const 169) "\12\00\00\00m\00a\00t\00c\00h\00 \001\00.\001\00\00")
  (data 0 (i32.const 192) "\10\00\00\000\00.\000\00 \00=\00=\00 \000\00\00")
  (global $test/fixtures/execution/implicitCast.lys::x (mut i32) (i32.const 0))
  (export "main" (func $test/fixtures/execution/implicitCast.lys::main))
  (func $test/fixtures/execution/implicitCast.lys::testMatchWithDifferentTypes (param $input i32) (result i32)
    (local $var$1 i32)
    (block $B1 (result i32)
      (block $B2 (result i32)
  ...
  (func $test/fixtures/execution/implicitCast.lys::main
    (block $B1
      (call $support::test::START_1 (i64.const 0x0000000000000010))
      (call $support::test::mustEqual_5 (call $system::core::u16.as (global.get $test/fixtures/execution/implicitCast.lys::x)) (i32.const 10) (i64.const 0x0000000000000043))
      (call $support::test::verify_12 (call $system::core::boolean.== (call $test/fixtures/execution/implicitCast.lys::testMatchWithDifferentTypes (i32.const 0)) (i32.const 0)) (i64.const 0x000000000000006c))
      (call $support::test::verify_12 (call $system::core::boolean.== (call $test/fixtures/execution/implicitCast.lys::testMatchWithDifferentTypes (i32.const 1)) (i32.const 1)) (i64.const 0x000000000000007f))
      (call $support::test::verify_12 (call $system::core::boolean.== (call $test/fixtures/execution/implicitCast.lys::testMatchWithDifferentTypes (call $system::core::f32.as_3 (f32.const 1))) (i32.const 1)) (i64.const 0x0000000000000092))
      (call $support::test::verify_12 (call $system::core::boolean.== (call $test/fixtures/execution/implicitCast.lys::testMatchWithDifferentTypes (call $system::core::f32.as_3 (f32.const 1))) (i32.const 1)) (i64.const 0x00000000000000a9))
      (call $support::test::verify_12 (call $system::core::f32.== (f32.const 0) (call $system::core::i32.as_1 (i32.const 0))) (i64.const 0x00000000000000c0))
  ...
  (func $%%START%%
    ...
    (global.set $test/fixtures/execution/implicitCast.lys::x (call $system::core::i32.as_8 (i32.const 10)))
  )
  (start $%%START%%)
)
