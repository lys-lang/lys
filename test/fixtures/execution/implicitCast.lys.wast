(module
  ...
  (data 0 (i32.const 209) "\16\00\00\00 \00 \00g\00i\00v\00e\00n\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 236) "\1c\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00:\00 \00%\00d\00\00")
  ...
  (data 0 (i32.const 329) "\1e\00\00\00 \00 \00g\00i\00v\00e\00n\00 \00L\00S\00B\00:\00 \00%\00X\00\00")
  (data 0 (i32.const 364) "$\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00 \00L\00S\00B\00:\00 \00%\00X\00\00")
  (data 0 (i32.const 405) "\1e\00\00\00 \00 \00g\00i\00v\00e\00n\00 \00M\00S\00B\00:\00 \00%\00X\00\00")
  (data 0 (i32.const 440) "$\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00 \00M\00S\00B\00:\00 \00%\00X\00\00")
  (data 0 (i32.const 481) "\1e\00\00\00 \00 \00g\00i\00v\00e\00n\00 \00L\00S\00B\00:\00 \00%\00X\00\00")
  (data 0 (i32.const 516) "$\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00 \00L\00S\00B\00:\00 \00%\00X\00\00")
  (data 0 (i32.const 557) "\1e\00\00\00 \00 \00g\00i\00v\00e\00n\00 \00M\00S\00B\00:\00 \00%\00X\00\00")
  (data 0 (i32.const 592) "$\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00 \00M\00S\00B\00:\00 \00%\00X\00\00")
  (data 0 (i32.const 633) "\16\00\00\00 \00 \00g\00i\00v\00e\00n\00:\00 \00%\00X\00\00")
  (data 0 (i32.const 660) "\1c\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00:\00 \00%\00X\00\00")
  (data 0 (i32.const 693) "\16\00\00\00 \00 \00g\00i\00v\00e\00n\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 720) "\1c\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 753) "\1a\00\00\00a\00s\00s\00e\00r\00t\00(\00f\00a\00l\00s\00e\00)\00\00")
  ...
  (func $support::test::mustEqual_1 (param $given f64) (param $expected f64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::f64::f64.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_11 (i64.const 0x00000003000000d1) (local.get $given))
                (call $support::env::printf_11 (i64.const 0x00000003000000ec) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_2 (param $given f32) (param $expected f32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::f32::f32.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_10 (i64.const 0x000000030000010d) (local.get $given))
                (call $support::env::printf_10 (i64.const 0x0000000300000128) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_3 (param $given i64) (param $expected i64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u64::u64.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_9 (i64.const 0x0000000300000149) (call $system::core::u64::u64.as_8 (call $system::core::u64::u64.>>_1 (local.get $given) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x000000030000016c) (call $system::core::u64::u64.as_8 (call $system::core::u64::u64.>>_1 (local.get $expected) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x0000000300000195) (call $system::core::u64::u64.&_3 (local.get $given) (i32.const 0xFFFFFFFF)))
                (call $support::env::printf_9 (i64.const 0x00000003000001b8) (call $system::core::u64::u64.&_3 (local.get $expected) (i32.const 0xFFFFFFFF)))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_4 (param $given i64) (param $expected i64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i64::i64.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_9 (i64.const 0x00000003000001e1) (call $system::core::u64::u64.as_8 (call $system::core::u64::u64.>>_1 (call $system::core::i64::i64.as_3 (local.get $given)) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x0000000300000204) (call $system::core::u64::u64.as_8 (call $system::core::u64::u64.>>_1 (call $system::core::i64::i64.as_3 (local.get $expected)) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x000000030000022d) (call $system::core::i64::i64.&_3 (local.get $given) (i32.const 0xFFFFFFFF)))
                (call $support::env::printf_9 (i64.const 0x0000000300000250) (call $system::core::i64::i64.&_3 (local.get $expected) (i32.const 0xFFFFFFFF)))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_5 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u32::u32.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_9 (i64.const 0x0000000300000279) (local.get $given))
                (call $support::env::printf_9 (i64.const 0x0000000300000294) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_6 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i32::i32.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_8 (i64.const 0x00000003000002b5) (local.get $given))
                (call $support::env::printf_8 (i64.const 0x00000003000002d0) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::assert_1 (param $condition i32)
    (call $support::test::assert_2 (local.get $condition) (i64.const 0x00000003000002f1))
  )
  ...
  (data 0 (i32.const 167) "\08\00\00\00t\00r\00u\00e\00\00")
  (data 0 (i32.const 180) "\0a\00\00\00f\00a\00l\00s\00e\00\00")
  (data 0 (i32.const 195) "\02\00\00\000\00\00")
  (data 0 (i32.const 202) "\02\00\00\000\00\00")
  ...
  (func $test::fixtures::execution::implicitCast::testMatchWithDifferentTypes_1 (param $input i32) (result i32)
    ...
    (block $B1 (result i32)
      (block $B2 (result i32)
          ...
          (block $B2_0
              (block $B2_1
                  (br_if $B2_0 (call $system::core::i32::i32.==_1 (local.get $var$1) (i32.const 1)))
                )
              (i32.const 0)
              (br $B2)
            )
  ...
  (func $test::fixtures::execution::implicitCast::main_1
    ...
    (block $B1
      ...
      (local.set $test::fixtures::execution::implicitCast::aByte (call $system::core::i32::i32.as_8 (i32.const 10)))
      (local.set $test::fixtures::execution::implicitCast::a (call $system::core::u8::u8.as_2 (local.get $test::fixtures::execution::implicitCast::aByte)))
      (call $support::test::mustEqual_6 (call $system::core::u16::u16.as_1 (local.get $test::fixtures::execution::implicitCast::a)) (i32.const 10) (i64.const 0x0000000300000043))
      (local.set $test::fixtures::execution::implicitCast::x (call $system::core::i32::i32.as_10 (i32.const 0)))
      (call $support::test::verify_2 (call $system::core::boolean::boolean.==_1 (call $test::fixtures::execution::implicitCast::testMatchWithDifferentTypes_1 (call $system::core::i16::i16.as_1 (local.get $test::fixtures::execution::implicitCast::x))) (i32.const 0)) (i64.const 0x000000030000006c))
      (local.set $test::fixtures::execution::implicitCast::y (call $system::core::i32::i32.as_8 (i32.const 1)))
      (call $support::test::verify_2 (call $system::core::boolean::boolean.==_1 (call $test::fixtures::execution::implicitCast::testMatchWithDifferentTypes_1 (call $system::core::u8::u8.as_3 (local.get $test::fixtures::execution::implicitCast::y))) (i32.const 1)) (i64.const 0x000000030000007f))
      (call $support::test::verify_2 (call $system::core::f32::f32.==_1 (f32.const 0) (call $system::core::i32::i32.as_2 (i32.const 0))) (i64.const 0x0000000300000092))
