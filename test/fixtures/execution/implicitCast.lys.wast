(module
  ...
  (func $support::test::mustEqual (param $given f64) (param $expected f64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::f64.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_13 (i64.const 0x00000000000000a7) (local.get $given))
                (call $support::env::printf_13 (i64.const 0x00000000000000c2) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_1 (param $given f32) (param $expected f32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::f32.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_11 (i64.const 0x00000000000000e3) (local.get $given))
                (call $support::env::printf_11 (i64.const 0x00000000000000fe) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_2 (param $given i64) (param $expected i64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u64.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_9 (i64.const 0x000000000000011f) (call $system::core::u64.as_7 (call $system::core::u64.>> (local.get $given) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x0000000000000142) (call $system::core::u64.as_7 (call $system::core::u64.>> (local.get $expected) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x000000000000016b) (call $system::core::u64.&_2 (local.get $given) (call $system::core::i32.as_3 (i32.const 0xFFFFFFFF))))
                (call $support::env::printf_9 (i64.const 0x000000000000018e) (call $system::core::u64.&_2 (local.get $expected) (call $system::core::i32.as_3 (i32.const 0xFFFFFFFF))))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_3 (param $given i64) (param $expected i64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i64.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_9 (i64.const 0x00000000000001b7) (call $system::core::u64.as_7 (call $system::core::u64.>> (call $system::core::i64.as_2 (local.get $given)) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x00000000000001da) (call $system::core::u64.as_7 (call $system::core::u64.>> (call $system::core::i64.as_2 (local.get $expected)) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x0000000000000203) (call $system::core::i64.&_2 (local.get $given) (call $system::core::i32.as_3 (i32.const 0xFFFFFFFF))))
                (call $support::env::printf_9 (i64.const 0x0000000000000226) (call $system::core::i64.&_2 (local.get $expected) (call $system::core::i32.as_3 (i32.const 0xFFFFFFFF))))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_5 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i32.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_7 (i64.const 0x000000000000028b) (local.get $given))
                (call $support::env::printf_7 (i64.const 0x00000000000002a6) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $test/fixtures/execution/implicitCast.lys::main
    ...
    (block $B1
      ...
      (local.set $test/fixtures/execution/implicitCast.lys::aByte (call $system::core::i32.as_7 (i32.const 10)))
      (local.set $test/fixtures/execution/implicitCast.lys::a (call $system::core::u8.as_1 (local.get $test/fixtures/execution/implicitCast.lys::aByte)))
      (call $support::test::mustEqual_5 (call $system::core::u16.as (local.get $test/fixtures/execution/implicitCast.lys::a)) (i32.const 10) (i64.const 0x0000000000000043))
      (local.set $test/fixtures/execution/implicitCast.lys::x (call $system::core::i32.as_9 (i32.const 0)))
      (call $support::test::verify_9 (call $system::core::boolean.== (call $test/fixtures/execution/implicitCast.lys::testMatchWithDifferentTypes (call $system::core::i16.as (local.get $test/fixtures/execution/implicitCast.lys::x))) (i32.const 0)) (i64.const 0x000000000000006c))
      (local.set $test/fixtures/execution/implicitCast.lys::y (call $system::core::i32.as_7 (i32.const 1)))
      (call $support::test::verify_9 (call $system::core::boolean.== (call $test/fixtures/execution/implicitCast.lys::testMatchWithDifferentTypes (call $system::core::u8.as_2 (local.get $test/fixtures/execution/implicitCast.lys::y))) (i32.const 1)) (i64.const 0x000000000000007f))
      (call $support::test::verify_9 (call $system::core::f32.== (f32.const 0) (call $system::core::i32.as_1 (i32.const 0))) (i64.const 0x0000000000000092))
