(module
  ...
  (func $support::test::mustEqual (param $given f64) (param $expected f64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::f64.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_13 (i64.const 0x0000000000000656) (local.get $given))
                (call $support::env::printf_13 (i64.const 0x0000000000000671) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_1 (param $given f32) (param $expected f32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::f32.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_11 (i64.const 0x0000000000000692) (local.get $given))
                (call $support::env::printf_11 (i64.const 0x00000000000006ad) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_2 (param $given i64) (param $expected i64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u64.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_9 (i64.const 0x00000000000006ce) (call $system::core::u64.as_7 (call $system::core::u64.>> (local.get $given) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x00000000000006f1) (call $system::core::u64.as_7 (call $system::core::u64.>> (local.get $expected) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x000000000000071a) (call $system::core::u64.&_2 (local.get $given) (call $system::core::i32.as_3 (i32.const 0xFFFFFFFF))))
                (call $support::env::printf_9 (i64.const 0x000000000000073d) (call $system::core::u64.&_2 (local.get $expected) (call $system::core::i32.as_3 (i32.const 0xFFFFFFFF))))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_3 (param $given i64) (param $expected i64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i64.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_9 (i64.const 0x0000000000000766) (call $system::core::u64.as_7 (call $system::core::u64.>> (call $system::core::i64.as_2 (local.get $given)) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x0000000000000789) (call $system::core::u64.as_7 (call $system::core::u64.>> (call $system::core::i64.as_2 (local.get $expected)) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x00000000000007b2) (call $system::core::i64.&_2 (local.get $given) (call $system::core::i32.as_3 (i32.const 0xFFFFFFFF))))
                (call $support::env::printf_9 (i64.const 0x00000000000007d5) (call $system::core::i64.&_2 (local.get $expected) (call $system::core::i32.as_3 (i32.const 0xFFFFFFFF))))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_5 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i32.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_7 (i64.const 0x000000000000083a) (local.get $given))
                (call $support::env::printf_7 (i64.const 0x0000000000000855) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $test/fixtures/execution/setStructValues.lys::Custom2.Custom2$discriminant (result i64)
    ...
    (block $B1 (result i64)
      ...
      (call $system::core::u64.<< (call $system::core::u32.as_1 (local.get $test/fixtures/execution/setStructValues.lys::discriminant_12)) (i32.const 32))
    )
  )
  (func $test/fixtures/execution/setStructValues.lys::Custom2.apply (param $r i32) (param $g i32) (result i64)
    (local $test/fixtures/execution/setStructValues.lys::$ref_7 i64)
    (block $B1 (result i64)
      (local.set $test/fixtures/execution/setStructValues.lys::$ref_7 (call $test/fixtures/execution/setStructValues.lys::Custom2.fromPointer (call $system::memory::calloc (call $system::core::i32.as_3 (i32.const 1)) (i32.const 8))))
      (call $test/fixtures/execution/setStructValues.lys::Custom2.property$0_1 (local.get $test/fixtures/execution/setStructValues.lys::$ref_7) (local.get $r))
      (call $test/fixtures/execution/setStructValues.lys::Custom2.property$1_1 (local.get $test/fixtures/execution/setStructValues.lys::$ref_7) (local.get $g))
      (local.get $test/fixtures/execution/setStructValues.lys::$ref_7)
    )
  )
  (func $test/fixtures/execution/setStructValues.lys::Custom2.fromPointer (param $ptr i32) (result i64)
    (i64.or (call $test/fixtures/execution/setStructValues.lys::Custom2.Custom2$discriminant) (i64.extend_u/i32 (local.get $ptr)))
  )
  (func $test/fixtures/execution/setStructValues.lys::Custom2.== (param $a i64) (param $b i64) (result i32)
    (i64.eq (local.get $a) (local.get $b))
  )
  (func $test/fixtures/execution/setStructValues.lys::Custom2.!= (param $a i64) (param $b i64) (result i32)
    (i64.ne (local.get $a) (local.get $b))
  )
  (func $test/fixtures/execution/setStructValues.lys::Custom2.property_r (param $self i64) (result i32)
    (call $test/fixtures/execution/setStructValues.lys::Custom2.property$0 (local.get $self))
  )
  (func $test/fixtures/execution/setStructValues.lys::Custom2.property_r_1 (param $self i64) (param $value i32)
    (call $test/fixtures/execution/setStructValues.lys::Custom2.property$0_1 (local.get $self) (local.get $value))
  )
  (func $test/fixtures/execution/setStructValues.lys::Custom2.property$0 (param $self i64) (result i32)
    (call $system::core::i32.load_1 (local.get $self) (i32.const 0))
  )
  (func $test/fixtures/execution/setStructValues.lys::Custom2.property$0_1 (param $self i64) (param $value i32)
    (call $system::core::i32.store_1 (local.get $self) (local.get $value) (i32.const 0))
  )
  (func $test/fixtures/execution/setStructValues.lys::Custom2.property_g (param $self i64) (result i32)
    (call $test/fixtures/execution/setStructValues.lys::Custom2.property$1 (local.get $self))
  )
  (func $test/fixtures/execution/setStructValues.lys::Custom2.property_g_1 (param $self i64) (param $value i32)
    (call $test/fixtures/execution/setStructValues.lys::Custom2.property$1_1 (local.get $self) (local.get $value))
  )
  (func $test/fixtures/execution/setStructValues.lys::Custom2.property$1 (param $self i64) (result i32)
    (call $system::core::i32.load_1 (local.get $self) (i32.const 4))
  )
  (func $test/fixtures/execution/setStructValues.lys::Custom2.property$1_1 (param $self i64) (param $value i32)
    (call $system::core::i32.store_1 (local.get $self) (local.get $value) (i32.const 4))
  )
  (func $test/fixtures/execution/setStructValues.lys::Custom2.is (param $a i64) (result i32)
    (i64.eq (i64.and (i64.const 0xffffffff00000000) (local.get $a)) (call $test/fixtures/execution/setStructValues.lys::Custom2.Custom2$discriminant))
  )
  (func $test/fixtures/execution/setStructValues.lys::Custom2.store (param $lhs i64) (param $rhs i64) (param $offset i32)
    (i64.store (i32.add (local.get $offset) (call $system::core::addressFromRef (local.get $lhs))) (local.get $rhs))
  )
  (func $test/fixtures/execution/setStructValues.lys::Custom2.load (param $lhs i64) (param $offset i32) (result i64)
    (i64.load (i32.add (local.get $offset) (call $system::core::addressFromRef (local.get $lhs))))
  )
  (func $test/fixtures/execution/setStructValues.lys::Custom2.as (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  (func $test/fixtures/execution/setStructValues.lys::testLoad
    (block $B1
      (call $support::test::START_1 (i64.const 0x0000000000000010))
      (call $support::test::mustEqual_5 (call $system::core::i32.load (global.get $test/fixtures/execution/setStructValues.lys::x)) (i32.const 0) (i64.const 0x0000000000000025))
      (call $support::test::mustEqual_5 (call $system::core::i32.load (global.get $test/fixtures/execution/setStructValues.lys::y)) (i32.const 0) (i64.const 0x000000000000004a))
      (call $support::test::END)
    )
  )
  (func $test/fixtures/execution/setStructValues.lys::testStore
    (block $B1
      (call $support::test::START_1 (i64.const 0x000000000000006f))
      (call $system::core::i32.store (global.get $test/fixtures/execution/setStructValues.lys::x) (i32.const 3))
      (call $system::core::i32.store (global.get $test/fixtures/execution/setStructValues.lys::y) (i32.const 2882400001))
      (call $system::core::i32.store_1 (global.get $test/fixtures/execution/setStructValues.lys::y) (i32.const 5) (call $system::core::i32.as_3 (i32.const 5)))
      (call $support::test::END)
    )
  )
  (func $test/fixtures/execution/setStructValues.lys::testNumbers
    (local $test/fixtures/execution/setStructValues.lys::VAR i64)
    (local $test/fixtures/execution/setStructValues.lys::VAR2 i64)
    (block $B1
      (call $support::test::START_1 (i64.const 0x0000000000000086))
      (call $support::test::mustEqual_5 (i32.const 0xFFFFFFFF) (call $system::core::i32.-_1 (i32.const 1)) (i64.const 0x00000000000000a1))
      (call $support::test::mustEqual_4 (call $system::core::i32.as_3 (i32.const 0xFFFFFFFF)) (call $system::core::i32.as_3 (call $system::core::i32.-_1 (i32.const 1))) (i64.const 0x00000000000000c6))
      (call $test/fixtures/execution/setStructValues.lys::testLoad)
      (call $test/fixtures/execution/setStructValues.lys::testStore)
      (call $support::env::printf_7 (i64.const 0x0000000000000107) (call $system::core::i32.load (global.get $test/fixtures/execution/setStructValues.lys::x)))
      (call $support::env::printf_7 (i64.const 0x0000000000000128) (call $system::core::i32.load (global.get $test/fixtures/execution/setStructValues.lys::y)))
      (call $support::test::mustEqual_3 (call $system::core::i32.as (i32.const 0xABCDEF01)) (call $system::core::i32.as (i32.const 0xABCDEF01)) (i64.const 0x0000000000000149))
      (call $support::test::mustEqual_5 (call $system::core::i32.load (global.get $test/fixtures/execution/setStructValues.lys::x)) (i32.const 3) (i64.const 0x000000000000019a))
      (call $support::test::mustEqual_5 (call $system::core::i32.load (global.get $test/fixtures/execution/setStructValues.lys::y)) (i32.const 0xABCDEF01) (i64.const 0x00000000000001bf))
      (call $support::test::mustEqual_5 (call $system::core::i32.load (global.get $test/fixtures/execution/setStructValues.lys::y)) (i32.const 0xABCDEF01) (i64.const 0x0000000000000204))
      (block $B2
          (local.set $test/fixtures/execution/setStructValues.lys::VAR (call $system::core::i32.as (call $system::core::i32.load (global.get $test/fixtures/execution/setStructValues.lys::y))))
          (local.set $test/fixtures/execution/setStructValues.lys::VAR2 (call $system::core::i32.as (i32.const 0xABCDEF01)))
          (call $support::test::mustEqual_3 (local.get $test/fixtures/execution/setStructValues.lys::VAR) (local.get $test/fixtures/execution/setStructValues.lys::VAR2) (i64.const 0x0000000000000249))
        )
      (call $support::test::mustEqual_3 (call $system::core::i32.as (call $system::core::i32.load (global.get $test/fixtures/execution/setStructValues.lys::y))) (call $system::core::i32.as (i32.const 0xABCDEF01)) (i64.const 0x0000000000000264))
      (call $support::test::mustEqual_2 (call $system::core::i32.as_4 (call $system::core::i32.load (global.get $test/fixtures/execution/setStructValues.lys::y))) (call $system::core::i32.as_4 (i32.const 0xABCDEF01)) (i64.const 0x00000000000002b7))
      (call $support::test::mustEqual_5 (call $system::core::u8.as_2 (call $system::core::u8.load (global.get $test/fixtures/execution/setStructValues.lys::y))) (i32.const 0x01) (i64.const 0x000000000000030a))
      (call $support::test::mustEqual_5 (call $system::core::u8.as_2 (call $system::core::u8.load_1 (global.get $test/fixtures/execution/setStructValues.lys::y) (call $system::core::i32.as_3 (i32.const 5)))) (i32.const 5) (i64.const 0x0000000000000341))
      (call $support::test::END)
    )
  )
  (func $test/fixtures/execution/setStructValues.lys::main
    ...
    (local $var$4 i64)
    (block $B1
      (call $support::test::START_1 (i64.const 0x0000000000000386))
      ...
      (block $B2
          (call $support::test::START_1 (i64.const 0x00000000000003b3))
          (call $support::test::verify_9 (call $test/fixtures/execution/setStructValues.lys::CatBag.is (local.get $test/fixtures/execution/setStructValues.lys::a_3)) (i64.const 0x00000000000003ec))
          (call $support::test::verify_9 (call $test/fixtures/execution/setStructValues.lys::Color.is (call $test/fixtures/execution/setStructValues.lys::CatBag.property_f (local.get $test/fixtures/execution/setStructValues.lys::a_3))) (i64.const 0x0000000000000407))
          (call $support::test::verify_9 (call $test/fixtures/execution/setStructValues.lys::Color.is (call $test/fixtures/execution/setStructValues.lys::CatBag.property_g (local.get $test/fixtures/execution/setStructValues.lys::a_3))) (i64.const 0x0000000000000424))
          (call $support::test::verify_9 (call $test/fixtures/execution/setStructValues.lys::Red.is (call $test/fixtures/execution/setStructValues.lys::CatBag.property_f (local.get $test/fixtures/execution/setStructValues.lys::a_3))) (i64.const 0x0000000000000441))
          (call $support::test::verify_9 (call $test/fixtures/execution/setStructValues.lys::None.is (call $test/fixtures/execution/setStructValues.lys::CatBag.property_g (local.get $test/fixtures/execution/setStructValues.lys::a_3))) (i64.const 0x000000000000045a))
          (call $support::test::END)
        )
      (block $B3
          (call $support::test::START_1 (i64.const 0x0000000000000473))
          (local.set $test/fixtures/execution/setStructValues.lys::y_12 (call $test/fixtures/execution/setStructValues.lys::Custom.apply (i32.const 0xAABBCCDD)))
          (call $support::test::verify_9 (call $system::core::i32.== (call $test/fixtures/execution/setStructValues.lys::Custom.property_hex (local.get $test/fixtures/execution/setStructValues.lys::y_12)) (i32.const 0xAABBCCDD)) (i64.const 0x0000000000000486))
          (call $test/fixtures/execution/setStructValues.lys::CatBag.property_f_1 (local.get $test/fixtures/execution/setStructValues.lys::a_3) (local.get $test/fixtures/execution/setStructValues.lys::y_12))
          (call $support::test::verify_9 (call $test/fixtures/execution/setStructValues.lys::Custom.== (local.get $test/fixtures/execution/setStructValues.lys::y_12) (local.get $test/fixtures/execution/setStructValues.lys::y_12)) (i64.const 0x00000000000004b1))
          ...
          (call $support::test::verify_9 (call $test/fixtures/execution/setStructValues.lys::Color.== (local.get $test/fixtures/execution/setStructValues.lys::tmp) (local.get $test/fixtures/execution/setStructValues.lys::y_12)) (i64.const 0x00000000000004c2))
          (call $support::test::verify_9 (call $test/fixtures/execution/setStructValues.lys::Color.== (call $test/fixtures/execution/setStructValues.lys::CatBag.property_f (local.get $test/fixtures/execution/setStructValues.lys::a_3)) (local.get $test/fixtures/execution/setStructValues.lys::y_12)) (i64.const 0x00000000000004d7))
          (call $support::test::verify_9 (call $test/fixtures/execution/setStructValues.lys::Color.== (call $test/fixtures/execution/setStructValues.lys::CatBag.property_f (local.get $test/fixtures/execution/setStructValues.lys::a_3)) (local.get $test/fixtures/execution/setStructValues.lys::tmp)) (i64.const 0x00000000000004ec))
          ...
          (call $support::test::verify_9 (call $test/fixtures/execution/setStructValues.lys::Red.is (call $test/fixtures/execution/setStructValues.lys::CatBag.property_g (local.get $test/fixtures/execution/setStructValues.lys::a_3))) (i64.const 0x0000000000000505))
          (call $support::test::END)
        )
      (block $B4
          (call $support::test::START_1 (i64.const 0x000000000000051e))
          (call $support::test::verify_9 (call $test/fixtures/execution/setStructValues.lys::Custom.is (call $test/fixtures/execution/setStructValues.lys::CatBag.property_f (local.get $test/fixtures/execution/setStructValues.lys::a_3))) (i64.const 0x0000000000000543))
          (call $support::test::verify_9 (call $test/fixtures/execution/setStructValues.lys::Red.is (call $test/fixtures/execution/setStructValues.lys::CatBag.property_g (local.get $test/fixtures/execution/setStructValues.lys::a_3))) (i64.const 0x0000000000000562))
          (call $support::test::verify_9 (call $test/fixtures/execution/setStructValues.lys::Color.is (call $test/fixtures/execution/setStructValues.lys::CatBag.property_f (local.get $test/fixtures/execution/setStructValues.lys::a_3))) (i64.const 0x000000000000057b))
          (call $support::test::verify_9 (call $test/fixtures/execution/setStructValues.lys::Color.is (call $test/fixtures/execution/setStructValues.lys::CatBag.property_g (local.get $test/fixtures/execution/setStructValues.lys::a_3))) (i64.const 0x0000000000000598))
          (block $B6
              ...
              (block $B6_0
                  ...
                  (call $support::test::verify_9 (i32.const 0) (i64.const 0x0000000000000607))
                  (br $B6)
                )
              (block $B5
                  ...
                  (call $support::test::verify_9 (call $system::core::i32.== (call $test/fixtures/execution/setStructValues.lys::Custom.property_hex (local.get $var$4)) (i32.const 0xAABBCCDD)) (i64.const 0x00000000000005b5))
                  (call $support::test::verify_9 (call $system::core::i32.== (local.get $test/fixtures/execution/setStructValues.lys::hex_3) (i32.const 0xAABBCCDD)) (i64.const 0x00000000000005e0))
                )
              (br $B6)
            )
          (call $support::test::END)
        )
      (call $test/fixtures/execution/setStructValues.lys::testNumbers)
      (call $support::test::END)
    )
  )
  (func $%%START%%
    ...
    (global.set $test/fixtures/execution/setStructValues.lys::x (call $test/fixtures/execution/setStructValues.lys::Custom2.apply (i32.const 0) (i32.const 0)))
    (global.set $test/fixtures/execution/setStructValues.lys::y (call $test/fixtures/execution/setStructValues.lys::Custom2.apply (i32.const 0) (i32.const 0)))
  )
  (start $%%START%%)
)
