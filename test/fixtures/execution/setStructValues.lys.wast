(module
  ...
  (func $support::test::mustEqual (param $given f64) (param $expected f64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::f64.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_10 (i64.const 0x0000000000000656) (local.get $given))
                (call $support::env::printf_10 (i64.const 0x0000000000000671) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_1 (param $given f32) (param $expected f32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::f32.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_8 (i64.const 0x0000000000000692) (local.get $given))
                (call $support::env::printf_8 (i64.const 0x00000000000006ad) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_2 (param $given i64) (param $expected i64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u64.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_6 (i64.const 0x00000000000006ce) (call $system::core::u64.as_7 (call $system::core::u64.>> (local.get $given) (i32.const 32))))
                (call $support::env::printf_6 (i64.const 0x00000000000006f1) (call $system::core::u64.as_7 (call $system::core::u64.>> (local.get $expected) (i32.const 32))))
                (call $support::env::printf_6 (i64.const 0x000000000000071a) (call $system::core::u64.&_2 (local.get $given) (call $system::core::i32.as_3 (i32.const 4294967295))))
                (call $support::env::printf_6 (i64.const 0x000000000000073d) (call $system::core::u64.&_2 (local.get $expected) (call $system::core::i32.as_3 (i32.const 4294967295))))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_3 (param $given i64) (param $expected i64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i64.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_6 (i64.const 0x0000000000000766) (call $system::core::u64.as_7 (call $system::core::u64.>> (call $system::core::i64.as_2 (local.get $given)) (i32.const 32))))
                (call $support::env::printf_6 (i64.const 0x0000000000000789) (call $system::core::u64.as_7 (call $system::core::u64.>> (call $system::core::i64.as_2 (local.get $expected)) (i32.const 32))))
                (call $support::env::printf_6 (i64.const 0x00000000000007b2) (call $system::core::i64.&_2 (local.get $given) (call $system::core::i32.as_3 (i32.const 4294967295))))
                (call $support::env::printf_6 (i64.const 0x00000000000007d5) (call $system::core::i64.&_2 (local.get $expected) (call $system::core::i32.as_3 (i32.const 4294967295))))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_4 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u32.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_6 (i64.const 0x00000000000007fe) (local.get $given))
                (call $support::env::printf_6 (i64.const 0x0000000000000819) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_5 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i32.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_4 (i64.const 0x000000000000083a) (local.get $given))
                (call $support::env::printf_4 (i64.const 0x0000000000000855) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $test/fixtures/execution/setStructValues.lys::testNumbers
    ...
    (block $B1
      ...
      (call $support::test::mustEqual_5 (i32.const 4294967295) (call $system::core::i32.-_1 (i32.const 1)) (i64.const 0x00000000000000a1))
      (call $support::test::mustEqual_4 (call $system::core::i32.as_3 (i32.const 4294967295)) (call $system::core::i32.as_3 (call $system::core::i32.-_1 (i32.const 1))) (i64.const 0x00000000000000c6))
      (call $test/fixtures/execution/setStructValues.lys::testLoad)
      (call $test/fixtures/execution/setStructValues.lys::testStore)
      (call $support::env::printf_4 (i64.const 0x0000000000000107) (call $system::core::i32.load (global.get $test/fixtures/execution/setStructValues.lys::x)))
      (call $support::env::printf_4 (i64.const 0x0000000000000128) (call $system::core::i32.load (global.get $test/fixtures/execution/setStructValues.lys::y)))
      (call $support::test::mustEqual_3 (call $system::core::i32.as (i32.const 2882400001)) (call $system::core::i32.as (i32.const 2882400001)) (i64.const 0x0000000000000149))
      ...
      (call $support::test::mustEqual_5 (call $system::core::i32.load (global.get $test/fixtures/execution/setStructValues.lys::y)) (i32.const 2882400001) (i64.const 0x00000000000001bf))
      (call $support::test::mustEqual_5 (call $system::core::i32.load (global.get $test/fixtures/execution/setStructValues.lys::y)) (i32.const 2882400001) (i64.const 0x0000000000000204))
      (block $B2
          ...
          (local.set $test/fixtures/execution/setStructValues.lys::VAR2 (call $system::core::i32.as (i32.const 2882400001)))
      ...
      (call $support::test::mustEqual_3 (call $system::core::i32.as (call $system::core::i32.load (global.get $test/fixtures/execution/setStructValues.lys::y))) (call $system::core::i32.as (i32.const 2882400001)) (i64.const 0x0000000000000264))
      (call $support::test::mustEqual_2 (call $system::core::i32.as_4 (call $system::core::i32.load (global.get $test/fixtures/execution/setStructValues.lys::y))) (call $system::core::i32.as_4 (i32.const 2882400001)) (i64.const 0x00000000000002b7))
      (call $support::test::mustEqual_5 (call $system::core::u8.as_2 (call $system::core::u8.load (global.get $test/fixtures/execution/setStructValues.lys::y))) (i32.const 1) (i64.const 0x000000000000030a))
  ...
  (func $test/fixtures/execution/setStructValues.lys::main
    ...
    (block $B1
      ...
      (block $B3
          ...
          (local.set $test/fixtures/execution/setStructValues.lys::y_12 (call $test/fixtures/execution/setStructValues.lys::Custom.apply (i32.const 2864434397)))
          (call $support::test::verify_9 (call $system::core::i32.== (call $test/fixtures/execution/setStructValues.lys::Custom.property_hex (local.get $test/fixtures/execution/setStructValues.lys::y_12)) (i32.const 2864434397)) (i64.const 0x0000000000000486))
      ...
      (block $B4
          ...
          (block $B6
              ...
              (block $B5
                  ...
                  (call $support::test::verify_9 (call $system::core::i32.== (call $test/fixtures/execution/setStructValues.lys::Custom.property_hex (local.get $var$4)) (i32.const 2864434397)) (i64.const 0x00000000000005b5))
                  (call $support::test::verify_9 (call $system::core::i32.== (local.get $test/fixtures/execution/setStructValues.lys::hex_3) (i32.const 2864434397)) (i64.const 0x00000000000005e0))
                )
              (br $B6)
            )
          (call $support::test::END)
