(module
  ...
  (data 0 (i32.const 767) "\08\00\00\00t\00r\00u\00e\00\00")
  (data 0 (i32.const 780) "\0a\00\00\00f\00a\00l\00s\00e\00\00")
  (data 0 (i32.const 795) "\02\00\00\000\00\00")
  ...
  (func $system::string::String.stringify (param $value i32) (result i64)
    (block $B1 (result i64)
      (if $IF2 (result i64) (local.get $value)
          (then
            (block $B3 (result i64)
                (i64.const 0x00000000000002ff)
              )
          )
          (else
            (block $B4 (result i64)
                (i64.const 0x000000000000030c)
              )
          )
        )
    )
  ...
  (func $support::test::assert (param $condition i32)
    (call $support::test::assert_2 (local.get $condition) (i64.const 0x00000000000002e0))
  )
  ...
  (func $test/fixtures/execution/setStructValues.lys::Custom.apply (param $hex i32) (result i64)
    (local $$ref i64)
    (block $B1 (result i64)
      (local.set $$ref (call $test/fixtures/execution/setStructValues.lys::Custom.fromPointer (call $system::memory::calloc (call $system::core::i32.as_3 (i32.const 1)) (i32.const 4))))
      (call $test/fixtures/execution/setStructValues.lys::Custom.property$0_1 (local.get $$ref) (local.get $hex))
      (local.get $$ref)
    )
  )
  ...
  (func $test/fixtures/execution/setStructValues.lys::CatBag.apply (param $f i64) (param $g i64) (result i64)
    (local $$ref i64)
    (block $B1 (result i64)
      (local.set $$ref (call $test/fixtures/execution/setStructValues.lys::CatBag.fromPointer (call $system::memory::calloc (call $system::core::i32.as_3 (i32.const 1)) (i32.const 16))))
      (call $test/fixtures/execution/setStructValues.lys::CatBag.property$0_1 (local.get $$ref) (local.get $f))
      (call $test/fixtures/execution/setStructValues.lys::CatBag.property$1_1 (local.get $$ref) (local.get $g))
      (local.get $$ref)
    )
  )
  ...
  (func $test/fixtures/execution/setStructValues.lys::main
    ...
    (block $B1
      ...
      (local.set $a (call $test/fixtures/execution/setStructValues.lys::CatBag.apply (call $test/fixtures/execution/setStructValues.lys::Red.apply) (call $test/fixtures/execution/setStructValues.lys::None.apply)))
      (call $support::test::printMemory_1 (call $system::core::addressFromRef (local.get $a)) (i32.const 16))
      (block $B2
          (call $support::test::START_1 (i64.const 0x000000000000003d))
          (call $support::test::verify_12 (call $test/fixtures/execution/setStructValues.lys::CatBag.is (local.get $a)) (i64.const 0x0000000000000076))
          (call $support::test::verify_12 (call $test/fixtures/execution/setStructValues.lys::Color.is (call $test/fixtures/execution/setStructValues.lys::CatBag.property_f (local.get $a))) (i64.const 0x0000000000000091))
          (call $support::test::verify_12 (call $test/fixtures/execution/setStructValues.lys::Color.is (call $test/fixtures/execution/setStructValues.lys::CatBag.property_g (local.get $a))) (i64.const 0x00000000000000ae))
          (call $support::test::verify_12 (call $test/fixtures/execution/setStructValues.lys::Red.is (call $test/fixtures/execution/setStructValues.lys::CatBag.property_f (local.get $a))) (i64.const 0x00000000000000cb))
          (call $support::test::verify_12 (call $test/fixtures/execution/setStructValues.lys::None.is (call $test/fixtures/execution/setStructValues.lys::CatBag.property_g (local.get $a))) (i64.const 0x00000000000000e4))
          (call $support::test::END)
        )
      (block $B3
          (call $support::test::START_1 (i64.const 0x00000000000000fd))
          (local.set $y (call $test/fixtures/execution/setStructValues.lys::Custom.apply (i32.const 2864434397)))
          (call $support::test::verify_12 (call $system::core::i32.== (call $test/fixtures/execution/setStructValues.lys::Custom.property_hex (local.get $y)) (i32.const 2864434397)) (i64.const 0x0000000000000110))
          (call $test/fixtures/execution/setStructValues.lys::CatBag.property_f_1 (local.get $a) (local.get $y))
          (call $support::test::verify_12 (call $test/fixtures/execution/setStructValues.lys::Custom.== (local.get $y) (local.get $y)) (i64.const 0x000000000000013b))
          (local.set $tmp (call $test/fixtures/execution/setStructValues.lys::CatBag.property_f (local.get $a)))
          (call $support::test::verify_12 (call $test/fixtures/execution/setStructValues.lys::Color.== (local.get $tmp) (local.get $y)) (i64.const 0x000000000000014c))
          (call $support::test::verify_12 (call $test/fixtures/execution/setStructValues.lys::Color.== (call $test/fixtures/execution/setStructValues.lys::CatBag.property_f (local.get $a)) (local.get $y)) (i64.const 0x0000000000000161))
          (call $support::test::verify_12 (call $test/fixtures/execution/setStructValues.lys::Color.== (call $test/fixtures/execution/setStructValues.lys::CatBag.property_f (local.get $a)) (local.get $tmp)) (i64.const 0x0000000000000176))
          (call $test/fixtures/execution/setStructValues.lys::CatBag.property_g_1 (local.get $a) (call $test/fixtures/execution/setStructValues.lys::Red.apply))
          (call $support::test::verify_12 (call $test/fixtures/execution/setStructValues.lys::Red.is (call $test/fixtures/execution/setStructValues.lys::CatBag.property_g (local.get $a))) (i64.const 0x000000000000018f))
          (call $support::test::END)
        )
      (block $B4
          (call $support::test::START_1 (i64.const 0x00000000000001a8))
          (call $support::test::verify_12 (call $test/fixtures/execution/setStructValues.lys::Custom.is (call $test/fixtures/execution/setStructValues.lys::CatBag.property_f (local.get $a))) (i64.const 0x00000000000001cd))
          (call $support::test::verify_12 (call $test/fixtures/execution/setStructValues.lys::Red.is (call $test/fixtures/execution/setStructValues.lys::CatBag.property_g (local.get $a))) (i64.const 0x00000000000001ec))
          (call $support::test::verify_12 (call $test/fixtures/execution/setStructValues.lys::Color.is (call $test/fixtures/execution/setStructValues.lys::CatBag.property_f (local.get $a))) (i64.const 0x0000000000000205))
          (call $support::test::verify_12 (call $test/fixtures/execution/setStructValues.lys::Color.is (call $test/fixtures/execution/setStructValues.lys::CatBag.property_g (local.get $a))) (i64.const 0x0000000000000222))
          (block $B6
              (local.set $var$4 (call $test/fixtures/execution/setStructValues.lys::CatBag.property_f (local.get $a)))
              (block $B6_0
                  (block $B6_1
              ...
              (block $B5
                  (local.set $hex (call $test/fixtures/execution/setStructValues.lys::Custom.property_hex (local.get $var$4)))
                  ...
                  (call $support::test::verify_12 (call $system::core::i32.== (local.get $hex) (i32.const 2864434397)) (i64.const 0x000000000000026a))
                )
              (br $B6)
            )
          (call $support::test::END)
