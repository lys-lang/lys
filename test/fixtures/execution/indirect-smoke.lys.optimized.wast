(module
 ...
 (export "main" (func $5))
 (start $6)
 (func $0 (; 4 ;) (type $4) (param $0 i64) (param $1 i32)
  (call $fimport$3
   (i32.wrap_i64
    (local.get $0)
   )
 ...
 (func $1 (; 5 ;) (type $0) (result i32)
  (global.get $global$6)
 )
 (func $2 (; 6 ;) (type $6) (param $0 i32) (param $1 i32) (param $2 i64)
  (call $fimport$1
   (i32.eq
    (local.get $0)
    (local.get $1)
