(module
 ...
 (type $11 (func (param f64 f64 i64)))
 ...
 (func $1 (; 7 ;) (type $4) (param $0 i64) (param $1 i32)
  (call $fimport$4
   (i32.wrap_i64
    (local.get $0)
   )
 ...
 (func $2 (; 8 ;) (type $5) (param $0 i64) (param $1 f64)
  (call $fimport$5
   (i32.wrap_i64
    (local.get $0)
   )
 ...
 (func $3 (; 9 ;) (type $7) (result i32)
  (global.get $global$6)
 )
 (func $4 (; 10 ;) (type $8) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
 ...
 (func $5 (; 11 ;) (type $9) (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  (local $3 i32)
  (local $4 i64)
  (local $5 i64)
  (local.set $4
 ...
 (func $6 (; 12 ;) (type $17) (param $0 i32) (param $1 i32)
  (local.set $1
   (i32.add
    (local.get $0)
    (local.get $1)
 ...
 (func $7 (; 13 ;) (type $11) (param $0 f64) (param $1 f64) (param $2 i64)
  (call $13
   (f64.eq
    (local.get $0)
    (local.get $1)
  ...
  (if
   ...
   (block
    (call $2
     (i64.const 64424510558)
     (local.get $0)
    )
    (call $2
     (i64.const 64424510585)
     (local.get $1)
    )
   )
  )
 )
 (func $8 (; 14 ;) (type $13) (param $0 i32) (param $1 i32) (param $2 i64)
  (call $13
   (i32.eq
    (local.get $0)
    (local.get $1)
  ...
  (if
   ...
   (block
    (call $1
     (i64.const 64424510982)
     (local.get $0)
    )
    (call $1
     (i64.const 64424511009)
     (local.get $1)
    )
   )
  )
 )
 (func $9 (; 15 ;) (type $13) (param $0 i32) (param $1 i32) (param $2 i64)
  (call $13
   (i32.eq
    (local.get $0)
    (local.get $1)
  ...
  (if
   ...
   (block
    (call $0
     (i64.const 64424511042)
     (local.get $0)
    )
    (call $0
     (i64.const 64424511069)
     (local.get $1)
    )
   )
  )
 )
 (func $10 (; 16 ;) (type $12) (param $0 i64) (param $1 i64) (param $2 i64)
  (call $13
   (call $17
    (local.get $0)
    (local.get $1)
 ...
 (func $13 (; 19 ;) (type $14) (param $0 i32) (param $1 i64)
  (call $fimport$1
   (local.get $0)
   (i32.wrap_i64
    (local.get $1)
 ...
 (func $14 (; 20 ;) (type $15) (param $0 i64) (param $1 i64) (result i64)
  (call $16
   (local.get $0)
   (local.get $1)
  )
 )
 (func $15 (; 21 ;) (type $16) (param $0 i64) (param $1 i32) (result i32)
  (if
   (i32.gt_u
    (local.get $1)
    (i32.div_u
 ...
 (func $16 (; 22 ;) (type $15) (param $0 i64) (param $1 i64) (result i64)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $17 (; 23 ;) (type $10) (param $0 i64) (param $1 i64) (result i32)
  (local $2 i32)
  (local $3 i32)
  (if (result i32)
   (i32.eq
 ...
 (func $18 (; 24 ;) (type $2)
  ...
  (local.set $0
   (call $16
    (i64.const 64424509507)
    (i64.const 64424509518)
   )
  )
  (call $8
   (i32.div_u
  ...
  (call $8
   ...
   (i32.const 7)
   (i64.const 64424509593)
  )
  (call $10
   (local.get $0)
   (i64.const 64424509624)
   (i64.const 64424509643)
  )
  (local.set $1
   (call $16
    (local.get $0)
  ...
  (call $10
   (local.get $0)
   (i64.const 64424509684)
   (i64.const 64424509703)
  )
  (call $8
   (i32.div_u
    (i32.load
   ...
   (i32.const 14)
   (i64.const 64424509744)
  )
  (call $10
   (local.get $1)
   (i64.const 64424509777)
   (local.get $1)
  )
  (call $fimport$2)
  (call $12
   (i64.const 64424509810)
  )
  (call $8
   (i32.div_u
    (i32.load
   ...
   (i32.const 6)
   (i64.const 64424509876)
  )
  (call $7
   (f64.convert_i32_u
    (call $15
     (i64.const 64424509859)
     (i32.const 0)
    )
   )
   (f64.const 97)
   (i64.const 64424509911)
  )
  (call $7
   (f64.convert_i32_u
    (call $15
  ...
  (call $7
   ...
   (f64.const 56337)
   (i64.const 64424510026)
  )
  (call $fimport$2)
  (call $12
   (i64.const 64424510049)
  )
  (call $8
   (i32.div_u
    (i32.load
     (i32.wrap_i64
      (call $14
       (i64.const 64424510094)
       (i64.const 64424510103)
      )
     )
    )
    (i32.const 2)
   ...
   (i32.const 4)
   (i64.const 64424510112)
  )
  (call $fimport$2)
  (call $12
   (i64.const 64424510163)
  )
  (call $8
   (i32.div_u
    (i32.load
     (i32.wrap_i64
      (local.tee $0
       (call $14
        (i64.const 64424510220)
        (i64.const 64424510229)
       )
      )
     )
    )
