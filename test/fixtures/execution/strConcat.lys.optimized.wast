(module
 ...
 (func $5 (; 10 ;) (type $9) (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  (local $3 i32)
  (local $4 i64)
  (local $5 i64)
  (local.set $4
 ...
 (func $6 (; 11 ;) (type $1) (param $0 i32) (param $1 i32)
  (local.set $1
   (i32.add
    (local.get $0)
    (local.get $1)
 ...
 (func $11 (; 16 ;) (type $17) (param $0 i64)
  (call $fimport$0
   (i32.wrap_i64
    (local.get $0)
   )
 ...
 (func $13 (; 18 ;) (type $6) (param $0 i64) (param $1 i64) (result i64)
  (call $15
   (local.get $0)
   (local.get $1)
  )
 )
 (func $14 (; 19 ;) (type $16) (param $0 i64) (param $1 i32) (result i32)
  (if
   (i32.gt_u
    (local.get $1)
    (i32.div_u
 ...
 (func $15 (; 20 ;) (type $6) (param $0 i64) (param $1 i64) (result i64)
  (local $2 i32)
  (local $3 i32)
  (local $4 i64)
  (drop
 ...
 (func $16 (; 21 ;) (type $10) (param $0 i64) (param $1 i64) (result i32)
  (local $2 i32)
  (local $3 i32)
  (if (result i32)
   (i32.eq
 ...
 (func $17 (; 22 ;) (type $11) (param $0 i32) (result i64)
  (local $1 i32)
  (local $2 i32)
  (call $6
   (local.tee $1
