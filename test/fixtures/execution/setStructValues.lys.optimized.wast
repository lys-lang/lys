(module
 ...
 (func $4 (; 9 ;) (param $0 i64) (param $1 i32)
  (call $fimport$4
   (i32.wrap_i64
    (local.get $0)
   )
 ...
 (func $6 (; 11 ;) (param $0 i64) (param $1 i64) (param $2 i64)
  (call $11
   (i64.eq
    (local.get $0)
    (local.get $1)
 ...
 (func $7 (; 12 ;) (param $0 i32) (param $1 i32) (param $2 i64)
  (call $11
   (i32.eq
    (local.get $0)
    (local.get $1)
 ...
 (func $11 (; 16 ;) (param $0 i32) (param $1 i64)
  (call $fimport$2
   (local.get $0)
   (i32.wrap_i64
    (local.get $1)
 ...
 (func $12 (; 17 ;) (param $0 i64) (result i32)
  (if (result i32)
   (i32.eq
    (i32.wrap_i64
     (i64.shr_u
