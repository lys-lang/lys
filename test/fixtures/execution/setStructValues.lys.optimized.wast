(module
 ...
 (import "env" "segfault" (func $fimport$5))
 (memory $0 1)
 (data (i32.const 824) "\08\00\00\00t\00r\00u\00e")
 (data (i32.const 837) "\n\00\00\00f\00a\00l\00s\00e")
 (data (i32.const 852) "\02\00\00\000")
 (data (i32.const 859) "\02\00\00\000")
 (data (i32.const 767) "4\00\00\00t\00r\00y\00i\00n\00g\00 \00t\00o\00 \00a\00l\00l\00o\00c\00a\00t\00e\00 \000\00 \00b\00y\00t\00e\00s")
 (data (i32.const 736) "\1a\00\00\00a\00s\00s\00e\00r\00t\00(\00f\00a\00l\00s\00e\00)")
 ...
 (func $1 (; 7 ;) (type $9) (param $0 i32) (result i32)
  (local $1 i32)
  (call $3
   (local.tee $0
    (call $2
 ...
 (func $3 (; 9 ;) (type $10) (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local.set $2
   (local.get $0)
  )
 ...
 (func $6 (; 12 ;) (type $8) (param $0 i32) (param $1 i64)
  (call $fimport$2
   (local.get $0)
   (i32.wrap_i64
    (local.get $1)
 ...
 (func $7 (; 13 ;) (type $3) (param $0 i64) (result i32)
  (if (result i32)
   (i64.eq
    (i64.and
     (local.get $0)
 ...
 (func $8 (; 14 ;) (type $4) (param $0 i64) (param $1 i64) (result i64)
  (local $2 i64)
  (i64.store
   (i32.wrap_i64
    (local.tee $2
