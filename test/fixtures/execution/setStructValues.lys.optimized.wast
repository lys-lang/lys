(module
 ...
 (func $6 (; 12 ;) (type $14) (param $0 i64) (param $1 i64)
  ...
  (if
   ...
   (block
    ...
    (call $5
     (i64.const 107374184218)
     (i32.wrap_i64
      (local.get $0)
     )
    )
    (call $5
     (i64.const 107374184253)
     (i32.wrap_i64
      (local.get $1)
     )
    )
 ...
 (func $7 (; 13 ;) (type $11) (param $0 i64) (param $1 i64) (param $2 i64)
  ...
  (if
   ...
   (block
    ...
    (call $5
     (i64.const 107374184370)
     (i32.wrap_i64
      (local.get $0)
     )
    )
    (call $5
     (i64.const 107374184405)
     (i32.wrap_i64
      (local.get $1)
     )
    )
 ...
 (func $8 (; 14 ;) (type $15) (param $0 i32) (param $1 i32)
  ...
  (if
   ...
   (block
    (call $5
     (i64.const 107374184446)
     (local.get $0)
    )
    (call $5
     (i64.const 107374184473)
     (local.get $1)
    )
   )
  )
 ...
 (func $9 (; 15 ;) (type $12) (param $0 i32) (param $1 i32) (param $2 i64)
  ...
  (if
   ...
   (block
    (call $4
     (i64.const 107374184506)
     (local.get $0)
    )
    (call $4
     (i64.const 107374184533)
     (local.get $1)
    )
   )
  )
 ...
 (func $17 (; 23 ;) (type $2)
  (call $11
   (i64.const 107374182534)
  )
  (call $9
   (i32.const -1)
   (i32.const -1)
   (i64.const 107374182561)
  )
  (call $8
   (i32.const -1)
   (i32.const -1)
  ...
  (call $9
   ...
   (i32.const 0)
   (i64.const 107374182474)
  )
  (call $fimport$3)
  (call $16)
  (call $4
   (i64.const 107374182663)
   (i32.load
    (i32.wrap_i64
     (global.get $global$8)
    )
 ...
 (func $18 (; 24 ;) (type $2)
  ...
  (call $12
   ...
   (i64.const 107374183514)
  )
  (call $fimport$3)
  (call $11
   (i64.const 107374183539)
  )
  (i32.store
   (i32.wrap_i64
    (local.tee $2
  ...
  (call $12
   ...
   (i64.const 107374183685)
  )
  (call $fimport$3)
  (call $11
   (i64.const 107374183710)
  )
  (call $12
   (i64.eq
    (i64.and
    ...
    (i32.eq
     (block (result i32)
      ...
      (call $12
       ...
       (i64.const 107374183861)
      )
      (local.get $4)
     )
     (i32.const -1430532899)
    )
    (i64.const 107374183904)
   )
  )
  (call $fimport$3)
  (call $17)
