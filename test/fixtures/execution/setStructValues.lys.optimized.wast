(module
 ...
 (func $1 (; 6 ;) (type $3) (param $0 i32) (param $1 i32) (result i32)
  (call $3
   (local.tee $1
    (call $2
     (local.tee $0
 ...
 (func $4 (; 9 ;) (type $8) (param $0 i64) (param $1 i32)
  (call $fimport$4
   (i32.wrap_i64
    (local.get $0)
   )
 ...
 (func $7 (; 12 ;) (type $11) (param $0 i64) (param $1 i64) (param $2 i64)
  (call $12
   (i64.eq
    (local.get $0)
    (local.get $1)
 ...
 (func $8 (; 13 ;) (type $12) (param $0 i32) (param $1 i32) (param $2 i64)
  (call $12
   (i32.eq
    (local.get $0)
    (local.get $1)
 ...
 (func $9 (; 14 ;) (type $12) (param $0 i32) (param $1 i32) (param $2 i64)
  (call $12
   (i32.eq
    (local.get $0)
    (local.get $1)
 ...
 (func $12 (; 17 ;) (type $13) (param $0 i32) (param $1 i64)
  (call $fimport$2
   (local.get $0)
   (i32.wrap_i64
    (local.get $1)
 ...
 (func $13 (; 18 ;) (type $10) (param $0 i64) (result i32)
  (if (result i32)
   (i32.eq
    (i32.wrap_i64
     (i64.shr_u
 ...
 (func $14 (; 19 ;) (type $4) (param $0 i64) (param $1 i64) (result i64)
  (local $2 i64)
  (i64.store
   (i32.wrap_i64
    (local.tee $2
