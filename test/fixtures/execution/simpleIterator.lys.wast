(module
  ...
  (data 0 (i32.const 116) "\16\00\00\00 \00 \00g\00i\00v\00e\00n\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 143) "\1c\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 176) "\16\00\00\00 \00 \00g\00i\00v\00e\00n\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 203) "\1c\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 236) "\1e\00\00\00 \00 \00g\00i\00v\00e\00n\00 \00L\00S\00B\00:\00 \00%\00X\00\00")
  (data 0 (i32.const 271) "$\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00 \00L\00S\00B\00:\00 \00%\00X\00\00")
  (data 0 (i32.const 312) "\1e\00\00\00 \00 \00g\00i\00v\00e\00n\00 \00M\00S\00B\00:\00 \00%\00X\00\00")
  (data 0 (i32.const 347) "$\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00 \00M\00S\00B\00:\00 \00%\00X\00\00")
  (data 0 (i32.const 388) "\1e\00\00\00 \00 \00g\00i\00v\00e\00n\00 \00L\00S\00B\00:\00 \00%\00X\00\00")
  (data 0 (i32.const 423) "$\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00 \00L\00S\00B\00:\00 \00%\00X\00\00")
  (data 0 (i32.const 464) "\1e\00\00\00 \00 \00g\00i\00v\00e\00n\00 \00M\00S\00B\00:\00 \00%\00X\00\00")
  (data 0 (i32.const 499) "$\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00 \00M\00S\00B\00:\00 \00%\00X\00\00")
  (data 0 (i32.const 540) "\16\00\00\00 \00 \00g\00i\00v\00e\00n\00:\00 \00%\00X\00\00")
  (data 0 (i32.const 567) "\1c\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00:\00 \00%\00X\00\00")
  (data 0 (i32.const 600) "\16\00\00\00 \00 \00g\00i\00v\00e\00n\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 627) "\1c\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 660) "\1a\00\00\00a\00s\00s\00e\00r\00t\00(\00f\00a\00l\00s\00e\00)\00\00")
  ...
  (func $support::test::mustEqual_1 (param $given f64) (param $expected f64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::f64::f64.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_11 (i64.const 0x0000000300000074) (local.get $given))
                (call $support::env::printf_11 (i64.const 0x000000030000008f) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_2 (param $given f32) (param $expected f32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::f32::f32.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_10 (i64.const 0x00000003000000b0) (local.get $given))
                (call $support::env::printf_10 (i64.const 0x00000003000000cb) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_3 (param $given i64) (param $expected i64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u64::u64.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_9 (i64.const 0x00000003000000ec) (call $system::core::u64::u64.as_8 (call $system::core::u64::u64.>>_1 (local.get $given) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x000000030000010f) (call $system::core::u64::u64.as_8 (call $system::core::u64::u64.>>_1 (local.get $expected) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x0000000300000138) (call $system::core::u64::u64.&_3 (local.get $given) (i32.const 0xFFFFFFFF)))
                (call $support::env::printf_9 (i64.const 0x000000030000015b) (call $system::core::u64::u64.&_3 (local.get $expected) (i32.const 0xFFFFFFFF)))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_4 (param $given i64) (param $expected i64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i64::i64.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_9 (i64.const 0x0000000300000184) (call $system::core::u64::u64.as_8 (call $system::core::u64::u64.>>_1 (call $system::core::i64::i64.as_3 (local.get $given)) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x00000003000001a7) (call $system::core::u64::u64.as_8 (call $system::core::u64::u64.>>_1 (call $system::core::i64::i64.as_3 (local.get $expected)) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x00000003000001d0) (call $system::core::i64::i64.&_3 (local.get $given) (i32.const 0xFFFFFFFF)))
                (call $support::env::printf_9 (i64.const 0x00000003000001f3) (call $system::core::i64::i64.&_3 (local.get $expected) (i32.const 0xFFFFFFFF)))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_5 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u32::u32.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_9 (i64.const 0x000000030000021c) (local.get $given))
                (call $support::env::printf_9 (i64.const 0x0000000300000237) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_6 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i32::i32.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_8 (i64.const 0x0000000300000258) (local.get $given))
                (call $support::env::printf_8 (i64.const 0x0000000300000273) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::assert_1 (param $condition i32)
    (call $support::test::assert_2 (local.get $condition) (i64.const 0x0000000300000294))
  )
  ...
  (data 0 (i32.const 74) "\08\00\00\00t\00r\00u\00e\00\00")
  (data 0 (i32.const 87) "\0a\00\00\00f\00a\00l\00s\00e\00\00")
  (data 0 (i32.const 102) "\02\00\00\000\00\00")
  (data 0 (i32.const 109) "\02\00\00\000\00\00")
  ...
  (func $system::core::string::string.stringify_1 (param $value i32) (result i64)
    (block $B1 (result i64)
      (if $IF2 (result i64) (local.get $value)
          (then
            (block $B3 (result i64)
                (i64.const 0x000000030000004a)
              )
          )
          (else
            (block $B4 (result i64)
                (i64.const 0x0000000300000057)
              )
          )
        )
    )
  ...
  (func $test::fixtures::execution::simpleIterator::Iterator.Iterator$discriminant_1 (result i64)
    ...
    (block $B1 (result i64)
      ...
      (call $system::core::u64::u64.<<_1 (call $system::core::u32::u32.as_2 (local.get $test::fixtures::execution::simpleIterator::discriminant)) (i32.const 32))
    )
  )
  (func $test::fixtures::execution::simpleIterator::Iterator.apply_1 (param $current i32) (param $target i32) (result i64)
    ...
    (block $B1 (result i64)
      (local.set $test::fixtures::execution::simpleIterator::$ref (call $test::fixtures::execution::simpleIterator::Iterator.fromPointer_1 (call $system::core::memory::calloc_1 (call $system::core::i32::i32.as_4 (i32.const 1)) (i32.const 8))))
  ...
  (func $test::fixtures::execution::simpleIterator::Iterator.as_1 (param $self i64) (result i32)
    (call $system::core::native::addressFromRef_1 (get_local $self))
  )
  (func $test::fixtures::execution::simpleIterator::Iterator.as_2 (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  ...
  (func $test::fixtures::execution::simpleIterator::Iterator.next_1 (param $iter i64) (result i64)
    ...
    (block $B1 (result i64)
      (if $IF2 (result i64) (call $system::core::i32::i32.<=_1 (call $test::fixtures::execution::simpleIterator::Iterator.property_current_1 (local.get $iter)) (call $test::fixtures::execution::simpleIterator::Iterator.property_target_1 (local.get $iter)))
          (then
            (block $B3 (result i64)
                ...
                (call $test::fixtures::execution::simpleIterator::Iterator.property_current_2 (local.get $iter) (call $system::core::i32::i32.+_1 (call $test::fixtures::execution::simpleIterator::Iterator.property_current_1 (local.get $iter)) (i32.const 1)))
  ...
  (func $test::fixtures::execution::simpleIterator::Maybe.is_1 (param $a i64) (result i32)
    (block $B1 (result i32)
      (call $system::core::boolean::boolean.||_1 (call $test::fixtures::execution::simpleIterator::None.is_1 (local.get $a)) (call $test::fixtures::execution::simpleIterator::Some.is_1 (local.get $a)))
    )
  )
  ...
  (func $test::fixtures::execution::simpleIterator::None.None$discriminant_1 (result i64)
    ...
    (block $B1 (result i64)
      (local.set $test::fixtures::execution::simpleIterator::discriminant_1 (i32.const 2))
      (call $system::core::i64::i64.<<_1 (call $system::core::u32::u32.as_1 (local.get $test::fixtures::execution::simpleIterator::discriminant_1)) (i32.const 32))
    )
  )
  ...
  (func $test::fixtures::execution::simpleIterator::Some.as_2 (param $self i64) (result i32)
    (call $system::core::native::addressFromRef_1 (get_local $self))
  )
  (func $test::fixtures::execution::simpleIterator::Some.as_3 (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  (func $test::fixtures::execution::simpleIterator::Some.Some$discriminant_1 (result i64)
    ...
    (block $B1 (result i64)
      (local.set $test::fixtures::execution::simpleIterator::discriminant_2 (i32.const 3))
      (call $system::core::u64::u64.<<_1 (call $system::core::u32::u32.as_2 (local.get $test::fixtures::execution::simpleIterator::discriminant_2)) (i32.const 32))
    )
  )
  (func $test::fixtures::execution::simpleIterator::Some.apply_1 (param $value i32) (result i64)
    ...
    (block $B1 (result i64)
      (local.set $test::fixtures::execution::simpleIterator::$ref_1 (call $test::fixtures::execution::simpleIterator::Some.fromPointer_1 (call $system::core::memory::calloc_1 (call $system::core::i32::i32.as_4 (i32.const 1)) (i32.const 4))))
              ...
              (block $B3
                  (block $B5
                      ...
                      (block $B4
                          ...
                          (local.set $test::fixtures::execution::simpleIterator::ret (call $system::core::i32::i32.+_1 (local.get $test::fixtures::execution::simpleIterator::ret) (local.get $test::fixtures::execution::simpleIterator::value_7)))
                          (br $Loop2)
                        )
                      (br $B5)
                    )
  ...
  (func $test::fixtures::execution::simpleIterator::main_1
    (block $B1
      ...
      (call $support::test::mustEqual_6 (call $test::fixtures::execution::simpleIterator::test_1 (i32.const 1) (i32.const 10)) (i32.const 55) (i64.const 0x000000030000002f))
