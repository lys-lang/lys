(module
  ...
  (data 0 (i32.const 525) "\08\00\00\00t\00r\00u\00e\00\00")
  (data 0 (i32.const 538) "\0a\00\00\00f\00a\00l\00s\00e\00\00")
  (data 0 (i32.const 553) "\02\00\00\000\00\00")
  (data 0 (i32.const 560) "\02\00\00\000\00\00")
  ...
  (func $system::string::String.stringify (param $value i32) (result i64)
    (block $B1 (result i64)
      (if $IF2 (result i64) (local.get $value)
          (then
            (block $B3 (result i64)
                (i64.const 0x000000000000020d)
              )
          )
          (else
            (block $B4 (result i64)
                (i64.const 0x000000000000021a)
              )
          )
        )
    )
  ...
  (data 0 (i32.const 254) "\16\00\00\00 \00 \00g\00i\00v\00e\00n\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 281) "\1c\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 314) "\16\00\00\00 \00 \00g\00i\00v\00e\00n\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 341) "\1c\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 374) "\16\00\00\00 \00 \00g\00i\00v\00e\00n\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 401) "\1c\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 434) "\16\00\00\00 \00 \00g\00i\00v\00e\00n\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 461) "\1c\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 494) "\1a\00\00\00a\00s\00s\00e\00r\00t\00(\00f\00a\00l\00s\00e\00)\00\00")
  ...
  (func $support::test::mustEqual (param $given f64) (param $expected f64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::f64.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_13 (i64.const 0x000000000000004a) (local.get $given))
                (call $support::env::printf_13 (i64.const 0x0000000000000065) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_1 (param $given f32) (param $expected f32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::f32.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_11 (i64.const 0x0000000000000086) (local.get $given))
                (call $support::env::printf_11 (i64.const 0x00000000000000a1) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_4 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u32.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_9 (i64.const 0x00000000000000c2) (local.get $given))
                (call $support::env::printf_9 (i64.const 0x00000000000000dd) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_5 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i32.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_7 (i64.const 0x00000000000000fe) (local.get $given))
                (call $support::env::printf_7 (i64.const 0x0000000000000119) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_6 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u16.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_17 (i64.const 0x000000000000013a) (local.get $given))
                (call $support::env::printf_17 (i64.const 0x0000000000000155) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_7 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i16.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_15 (i64.const 0x0000000000000176) (local.get $given))
                (call $support::env::printf_15 (i64.const 0x0000000000000191) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_8 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u8.!=_2 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_19 (i64.const 0x00000000000001b2) (local.get $given))
                (call $support::env::printf_19 (i64.const 0x00000000000001cd) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::assert (param $condition i32)
    (call $support::test::assert_2 (local.get $condition) (i64.const 0x00000000000001ee))
  )
  ...
  (func $test/fixtures/execution/simpleIterator.lys::Iterator.Iterator$discriminant (result i64)
    ...
    (block $B1 (result i64)
      ...
      (call $system::core::u64.<< (call $system::core::u32.as_1 (local.get $test/fixtures/execution/simpleIterator.lys::discriminant)) (i32.const 32))
    )
  )
  (func $test/fixtures/execution/simpleIterator.lys::Iterator.apply (param $current i32) (param $target i32) (result i64)
    ...
    (block $B1 (result i64)
      (local.set $test/fixtures/execution/simpleIterator.lys::$ref (call $test/fixtures/execution/simpleIterator.lys::Iterator.fromPointer (call $system::memory::calloc (call $system::core::i32.as_3 (i32.const 1)) (i32.const 8))))
      (call $test/fixtures/execution/simpleIterator.lys::Iterator.property$0_1 (local.get $test/fixtures/execution/simpleIterator.lys::$ref) (local.get $current))
      (call $test/fixtures/execution/simpleIterator.lys::Iterator.property$1_1 (local.get $test/fixtures/execution/simpleIterator.lys::$ref) (local.get $target))
  ...
  (func $test/fixtures/execution/simpleIterator.lys::Iterator.as (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  (func $test/fixtures/execution/simpleIterator.lys::Iterator.next (param $iter i64) (result i64)
    ...
    (block $B1 (result i64)
      (if $IF2 (result i64) (call $system::core::i32.<= (call $test/fixtures/execution/simpleIterator.lys::Iterator.property_current (local.get $iter)) (call $test/fixtures/execution/simpleIterator.lys::Iterator.property_target (local.get $iter)))
          (then
            (block $B3 (result i64)
                (local.set $test/fixtures/execution/simpleIterator.lys::r (call $test/fixtures/execution/simpleIterator.lys::Some.apply (call $test/fixtures/execution/simpleIterator.lys::Iterator.property_current (local.get $iter))))
  ...
  (func $test/fixtures/execution/simpleIterator.lys::None.as (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  ...
  (func $test/fixtures/execution/simpleIterator.lys::None.None$discriminant (result i64)
    ...
    (block $B1 (result i64)
      ...
      (call $system::core::i64.<< (call $system::core::u32.as (local.get $test/fixtures/execution/simpleIterator.lys::discriminant_3)) (i32.const 32))
    )
  )
  ...
  (func $test/fixtures/execution/simpleIterator.lys::Some.as (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  ...
  (func $test/fixtures/execution/simpleIterator.lys::Some.Some$discriminant (result i64)
    ...
    (block $B1 (result i64)
      ...
      (call $system::core::u64.<< (call $system::core::u32.as_1 (local.get $test/fixtures/execution/simpleIterator.lys::discriminant_6)) (i32.const 32))
    )
  )
  (func $test/fixtures/execution/simpleIterator.lys::Some.apply (param $value i32) (result i64)
    ...
    (block $B1 (result i64)
      (local.set $test/fixtures/execution/simpleIterator.lys::$ref_4 (call $test/fixtures/execution/simpleIterator.lys::Some.fromPointer (call $system::memory::calloc (call $system::core::i32.as_3 (i32.const 1)) (i32.const 4))))
      (call $test/fixtures/execution/simpleIterator.lys::Some.property$0_1 (local.get $test/fixtures/execution/simpleIterator.lys::$ref_4) (local.get $value))
  ...
  (func $test/fixtures/execution/simpleIterator.lys::test_1 (param $from i32) (param $to i32) (result i32)
    ...
    (block $B1 (result i32)
      ...
      (local.set $test/fixtures/execution/simpleIterator.lys::$iter$ (call $test/fixtures/execution/simpleIterator.lys::Iterator.apply (local.get $from) (local.get $to)))
      (block $Break2
          (loop $Loop2
              (block $B3
                  (block $B5
                      (local.set $var$5 (call $test/fixtures/execution/simpleIterator.lys::Iterator.next (local.get $test/fixtures/execution/simpleIterator.lys::$iter$)))
                      (block $B5_0
                          (block $B5_1
                      ...
                      (block $B4
                          (local.set $test/fixtures/execution/simpleIterator.lys::value_8 (call $test/fixtures/execution/simpleIterator.lys::Some.property_value (local.get $var$5)))
                          (local.set $test/fixtures/execution/simpleIterator.lys::ret (call $system::core::i32.+ (local.get $test/fixtures/execution/simpleIterator.lys::ret) (local.get $test/fixtures/execution/simpleIterator.lys::value_8)))
                          (br $Loop2)
                        )
                      (br $B5)
                    )
