(module
  ...
  (data 0 (i32.const 105) "\08\00\00\00t\00r\00u\00e\00\00")
  (data 0 (i32.const 118) "\0a\00\00\00f\00a\00l\00s\00e\00\00")
  (data 0 (i32.const 133) "\02\00\00\000\00\00")
  (data 0 (i32.const 140) "\02\00\00\000\00\00")
  ...
  (func $system::string::String.stringify (param $value i32) (result i64)
    (block $B1 (result i64)
      (if $IF2 (result i64) (local.get $value)
          (then
            (block $B3 (result i64)
                (i64.const 0x0000000000000069)
              )
          )
          (else
            (block $B4 (result i64)
                (i64.const 0x0000000000000076)
              )
          )
        )
    )
  ...
  (data 0 (i32.const 74) "\1a\00\00\00a\00s\00s\00e\00r\00t\00(\00f\00a\00l\00s\00e\00)\00\00")
  ...
  (func $support::test::assert (param $condition i32)
    (call $support::test::assert_2 (local.get $condition) (i64.const 0x000000000000004a))
  )
  ...
  (export "main" (func $test/fixtures/execution/simpleIterator.lys::main))
  (func $test/fixtures/execution/simpleIterator.lys::Iterator.Iterator$discriminant (result i64)
    (local $discriminant i32)
    (block $B1 (result i64)
      (local.set $discriminant (i32.const 1))
      (call $system::core::u64.<< (call $system::core::u32.as_1 (local.get $discriminant)) (i32.const 32))
    )
  )
  (func $test/fixtures/execution/simpleIterator.lys::Iterator.apply (param $current i32) (param $target i32) (result i64)
    (local $$ref i64)
    (block $B1 (result i64)
      (local.set $$ref (call $test/fixtures/execution/simpleIterator.lys::Iterator.fromPointer (call $system::memory::calloc (call $system::core::i32.as_3 (i32.const 1)) (i32.const 8))))
      (call $test/fixtures/execution/simpleIterator.lys::Iterator.property$0_1 (local.get $$ref) (local.get $current))
      (call $test/fixtures/execution/simpleIterator.lys::Iterator.property$1_1 (local.get $$ref) (local.get $target))
      (local.get $$ref)
    )
  )
  (func $test/fixtures/execution/simpleIterator.lys::Iterator.fromPointer (param $ptr i32) (result i64)
    (i64.or (call $test/fixtures/execution/simpleIterator.lys::Iterator.Iterator$discriminant) (i64.extend_u/i32 (local.get $ptr)))
  )
  (func $test/fixtures/execution/simpleIterator.lys::Iterator.== (param $a i64) (param $b i64) (result i32)
    (i64.eq (local.get $a) (local.get $b))
  )
  (func $test/fixtures/execution/simpleIterator.lys::Iterator.!= (param $a i64) (param $b i64) (result i32)
    (i64.ne (local.get $a) (local.get $b))
  )
  (func $test/fixtures/execution/simpleIterator.lys::Iterator.property_current (param $self i64) (result i32)
    (call $test/fixtures/execution/simpleIterator.lys::Iterator.property$0 (local.get $self))
  )
  (func $test/fixtures/execution/simpleIterator.lys::Iterator.property_current_1 (param $self i64) (param $value i32)
    (call $test/fixtures/execution/simpleIterator.lys::Iterator.property$0_1 (local.get $self) (local.get $value))
  )
  (func $test/fixtures/execution/simpleIterator.lys::Iterator.property$0 (param $self i64) (result i32)
    (call $system::core::i32.load_1 (local.get $self) (i32.const 0))
  )
  (func $test/fixtures/execution/simpleIterator.lys::Iterator.property$0_1 (param $self i64) (param $value i32)
    (call $system::core::i32.store_1 (local.get $self) (local.get $value) (i32.const 0))
  )
  (func $test/fixtures/execution/simpleIterator.lys::Iterator.property_target (param $self i64) (result i32)
    (call $test/fixtures/execution/simpleIterator.lys::Iterator.property$1 (local.get $self))
  )
  (func $test/fixtures/execution/simpleIterator.lys::Iterator.property_target_1 (param $self i64) (param $value i32)
    (call $test/fixtures/execution/simpleIterator.lys::Iterator.property$1_1 (local.get $self) (local.get $value))
  )
  (func $test/fixtures/execution/simpleIterator.lys::Iterator.property$1 (param $self i64) (result i32)
    (call $system::core::i32.load_1 (local.get $self) (i32.const 4))
  )
  (func $test/fixtures/execution/simpleIterator.lys::Iterator.property$1_1 (param $self i64) (param $value i32)
    (call $system::core::i32.store_1 (local.get $self) (local.get $value) (i32.const 4))
  )
  (func $test/fixtures/execution/simpleIterator.lys::Iterator.is (param $a i64) (result i32)
    (i64.eq (i64.and (i64.const 0xffffffff00000000) (local.get $a)) (call $test/fixtures/execution/simpleIterator.lys::Iterator.Iterator$discriminant))
  )
  (func $test/fixtures/execution/simpleIterator.lys::Iterator.store (param $lhs i64) (param $rhs i64) (param $offset i32)
    (i64.store (i32.add (local.get $offset) (call $system::core::addressFromRef (local.get $lhs))) (local.get $rhs))
  )
  (func $test/fixtures/execution/simpleIterator.lys::Iterator.load (param $lhs i64) (param $offset i32) (result i64)
    (i64.load (i32.add (local.get $offset) (call $system::core::addressFromRef (local.get $lhs))))
  )
  (func $test/fixtures/execution/simpleIterator.lys::Maybe.is (param $a i64) (result i32)
    (block $B1 (result i32)
      (call $system::core::boolean.|| (call $test/fixtures/execution/simpleIterator.lys::None.is (local.get $a)) (call $test/fixtures/execution/simpleIterator.lys::Some.is (local.get $a)))
    )
  )
  (func $test/fixtures/execution/simpleIterator.lys::Maybe.== (param $lhs i64) (param $rhs i64) (result i32)
    (call $system::core::ref.== (local.get $lhs) (local.get $rhs))
  )
  (func $test/fixtures/execution/simpleIterator.lys::Maybe.!= (param $lhs i64) (param $rhs i64) (result i32)
    (call $system::core::ref.!= (local.get $lhs) (local.get $rhs))
  )
  (func $test/fixtures/execution/simpleIterator.lys::Maybe.store (param $lhs i64) (param $rhs i64) (param $offset i32)
    (i64.store (i32.add (local.get $offset) (call $system::core::addressFromRef (local.get $lhs))) (local.get $rhs))
  )
  (func $test/fixtures/execution/simpleIterator.lys::Maybe.load (param $lhs i64) (param $offset i32) (result i64)
    (i64.load (i32.add (local.get $offset) (call $system::core::addressFromRef (local.get $lhs))))
  )
  (func $test/fixtures/execution/simpleIterator.lys::Maybe.as (param $a i64) (result i64)
    (local.get $a)
  )
  (func $test/fixtures/execution/simpleIterator.lys::None.as (param $a i64) (result i64)
    (local.get $a)
  )
  (func $test/fixtures/execution/simpleIterator.lys::Some.as (param $a i64) (result i64)
    (local.get $a)
  )
  (func $test/fixtures/execution/simpleIterator.lys::None.None$discriminant (result i64)
    (local $discriminant i32)
    (block $B1 (result i64)
  ...
  (func $test/fixtures/execution/simpleIterator.lys::None.apply (result i64)
    (call $test/fixtures/execution/simpleIterator.lys::None.None$discriminant)
  )
  (func $test/fixtures/execution/simpleIterator.lys::None.is (param $a i64) (result i32)
    (i64.eq (i64.and (i64.const 0xffffffff00000000) (local.get $a)) (call $test/fixtures/execution/simpleIterator.lys::None.None$discriminant))
  )
  (func $test/fixtures/execution/simpleIterator.lys::None.== (param $a i64) (param $b i64) (result i32)
    (i64.eq (local.get $a) (local.get $b))
  )
  (func $test/fixtures/execution/simpleIterator.lys::None.!= (param $a i64) (param $b i64) (result i32)
    (i64.ne (local.get $a) (local.get $b))
  )
  (func $test/fixtures/execution/simpleIterator.lys::None.store (param $lhs i64) (param $rhs i64) (param $offset i32)
    (i64.store (i32.add (local.get $offset) (call $system::core::addressFromRef (local.get $lhs))) (local.get $rhs))
  )
  (func $test/fixtures/execution/simpleIterator.lys::None.load (param $lhs i64) (param $offset i32) (result i64)
    (i64.load (i32.add (local.get $offset) (call $system::core::addressFromRef (local.get $lhs))))
  )
  (func $test/fixtures/execution/simpleIterator.lys::Some.Some$discriminant (result i64)
    (local $discriminant i32)
    (block $B1 (result i64)
  ...
  (func $test/fixtures/execution/simpleIterator.lys::Some.apply (param $value i32) (result i64)
    (local $$ref i64)
    (block $B1 (result i64)
      (local.set $$ref (call $test/fixtures/execution/simpleIterator.lys::Some.fromPointer (call $system::memory::calloc (call $system::core::i32.as_3 (i32.const 1)) (i32.const 4))))
      (call $test/fixtures/execution/simpleIterator.lys::Some.property$0_1 (local.get $$ref) (local.get $value))
      (local.get $$ref)
    )
  )
  (func $test/fixtures/execution/simpleIterator.lys::Some.fromPointer (param $ptr i32) (result i64)
    (i64.or (call $test/fixtures/execution/simpleIterator.lys::Some.Some$discriminant) (i64.extend_u/i32 (local.get $ptr)))
  )
  (func $test/fixtures/execution/simpleIterator.lys::Some.== (param $a i64) (param $b i64) (result i32)
    (i64.eq (local.get $a) (local.get $b))
  )
  (func $test/fixtures/execution/simpleIterator.lys::Some.!= (param $a i64) (param $b i64) (result i32)
    (i64.ne (local.get $a) (local.get $b))
  )
  (func $test/fixtures/execution/simpleIterator.lys::Some.property_value (param $self i64) (result i32)
    (call $test/fixtures/execution/simpleIterator.lys::Some.property$0 (local.get $self))
  )
  (func $test/fixtures/execution/simpleIterator.lys::Some.property_value_1 (param $self i64) (param $value i32)
    (call $test/fixtures/execution/simpleIterator.lys::Some.property$0_1 (local.get $self) (local.get $value))
  )
  (func $test/fixtures/execution/simpleIterator.lys::Some.property$0 (param $self i64) (result i32)
    (call $system::core::i32.load_1 (local.get $self) (i32.const 0))
  )
  (func $test/fixtures/execution/simpleIterator.lys::Some.property$0_1 (param $self i64) (param $value i32)
    (call $system::core::i32.store_1 (local.get $self) (local.get $value) (i32.const 0))
  )
  (func $test/fixtures/execution/simpleIterator.lys::Some.is (param $a i64) (result i32)
    (i64.eq (i64.and (i64.const 0xffffffff00000000) (local.get $a)) (call $test/fixtures/execution/simpleIterator.lys::Some.Some$discriminant))
  )
  (func $test/fixtures/execution/simpleIterator.lys::Some.store (param $lhs i64) (param $rhs i64) (param $offset i32)
    (i64.store (i32.add (local.get $offset) (call $system::core::addressFromRef (local.get $lhs))) (local.get $rhs))
  )
  (func $test/fixtures/execution/simpleIterator.lys::Some.load (param $lhs i64) (param $offset i32) (result i64)
    (i64.load (i32.add (local.get $offset) (call $system::core::addressFromRef (local.get $lhs))))
  )
  (func $test/fixtures/execution/simpleIterator.lys::Iterator.next (param $iter i64) (result i64)
    (local $r i64)
    (block $B1 (result i64)
      (if $IF2 (result i64) (call $system::core::i32.<= (call $test/fixtures/execution/simpleIterator.lys::Iterator.property_current (local.get $iter)) (call $test/fixtures/execution/simpleIterator.lys::Iterator.property_target (local.get $iter)))
          (then
            (block $B3 (result i64)
                (local.set $r (call $test/fixtures/execution/simpleIterator.lys::Some.apply (call $test/fixtures/execution/simpleIterator.lys::Iterator.property_current (local.get $iter))))
                (call $test/fixtures/execution/simpleIterator.lys::Iterator.property_current_1 (local.get $iter) (call $system::core::i32.+ (call $test/fixtures/execution/simpleIterator.lys::Iterator.property_current (local.get $iter)) (i32.const 1)))
                (local.get $r)
              )
          )
          (else
            (block $B4 (result i64)
                (call $test/fixtures/execution/simpleIterator.lys::None.apply)
              )
          )
        )
    )
  )
  (func $test/fixtures/execution/simpleIterator.lys::test_1 (param $from i32) (param $to i32) (result i32)
    (local $ret i32)
    (local $$iter$ i64)
    (local $value i32)
    (local $var$5 i64)
    (block $B1 (result i32)
      ...
      (local.set $$iter$ (call $test/fixtures/execution/simpleIterator.lys::Iterator.apply (local.get $from) (local.get $to)))
      (block $Break2
          (loop $Loop2
              (block $B3
                  (block $B5
                      (local.set $var$5 (call $test/fixtures/execution/simpleIterator.lys::Iterator.next (local.get $$iter$)))
                      (block $B5_0
                          (block $B5_1
                              (br_if $B5_0 (call $test/fixtures/execution/simpleIterator.lys::Some.is (local.get $var$5)))
                              (br_if $B5_1 (call $test/fixtures/execution/simpleIterator.lys::None.is (local.get $var$5)))
                            )
                          (br $Break2)
                          (br $B5)
                        )
                      (block $B4
                          (local.set $value (call $test/fixtures/execution/simpleIterator.lys::Some.property_value (local.get $var$5)))
                          (local.set $ret (call $system::core::i32.+ (local.get $ret) (local.get $value)))
                          (br $Loop2)
                        )
                      (br $B5)
                    )
  ...
  (func $test/fixtures/execution/simpleIterator.lys::main
    (block $B1
      (call $support::test::START_1 (i64.const 0x0000000000000010))
      (call $support::test::mustEqual_5 (call $test/fixtures/execution/simpleIterator.lys::test_1 (i32.const 1) (i32.const 10)) (i32.const 55) (i64.const 0x000000000000002f))
