(module
  ...
  (func $support::test::mustEqual (param $given f64) (param $expected f64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::f64.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_13 (i64.const 0x000000000000005c) (local.get $given))
                (call $support::env::printf_13 (i64.const 0x0000000000000077) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_1 (param $given f32) (param $expected f32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::f32.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_11 (i64.const 0x0000000000000098) (local.get $given))
                (call $support::env::printf_11 (i64.const 0x00000000000000b3) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_2 (param $given i64) (param $expected i64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u64.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_9 (i64.const 0x00000000000000d4) (call $system::core::u64.as_7 (call $system::core::u64.>> (local.get $given) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x00000000000000f7) (call $system::core::u64.as_7 (call $system::core::u64.>> (local.get $expected) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x0000000000000120) (call $system::core::u64.&_2 (local.get $given) (call $system::core::i32.as_3 (i32.const 0xFFFFFFFF))))
                (call $support::env::printf_9 (i64.const 0x0000000000000143) (call $system::core::u64.&_2 (local.get $expected) (call $system::core::i32.as_3 (i32.const 0xFFFFFFFF))))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_3 (param $given i64) (param $expected i64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i64.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_9 (i64.const 0x000000000000016c) (call $system::core::u64.as_7 (call $system::core::u64.>> (call $system::core::i64.as_2 (local.get $given)) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x000000000000018f) (call $system::core::u64.as_7 (call $system::core::u64.>> (call $system::core::i64.as_2 (local.get $expected)) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x00000000000001b8) (call $system::core::i64.&_2 (local.get $given) (call $system::core::i32.as_3 (i32.const 0xFFFFFFFF))))
                (call $support::env::printf_9 (i64.const 0x00000000000001db) (call $system::core::i64.&_2 (local.get $expected) (call $system::core::i32.as_3 (i32.const 0xFFFFFFFF))))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_5 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i32.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_7 (i64.const 0x0000000000000240) (local.get $given))
                (call $support::env::printf_7 (i64.const 0x000000000000025b) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (export "main" (func $test/fixtures/execution/traverseTree.lys::main))
  (func $test/fixtures/execution/traverseTree.lys::Tree.is (param $a i64) (result i32)
    (block $B1 (result i32)
      (call $system::core::boolean.|| (call $test/fixtures/execution/traverseTree.lys::Node.is (local.get $a)) (call $test/fixtures/execution/traverseTree.lys::Empty.is (local.get $a)))
    )
  )
  (func $test/fixtures/execution/traverseTree.lys::Tree.as (param $a i64) (result i64)
    (local.get $a)
  )
  (func $test/fixtures/execution/traverseTree.lys::Tree.== (param $lhs i64) (param $rhs i64) (result i32)
    (call $system::core::ref.== (local.get $lhs) (local.get $rhs))
  )
  (func $test/fixtures/execution/traverseTree.lys::Tree.!= (param $lhs i64) (param $rhs i64) (result i32)
    (call $system::core::ref.!= (local.get $lhs) (local.get $rhs))
  )
  (func $test/fixtures/execution/traverseTree.lys::Tree.store (param $lhs i64) (param $rhs i64) (param $offset i32)
    (i64.store (i32.add (local.get $offset) (call $system::core::addressFromRef (local.get $lhs))) (local.get $rhs))
  )
  (func $test/fixtures/execution/traverseTree.lys::Tree.load (param $lhs i64) (param $offset i32) (result i64)
    (i64.load (i32.add (local.get $offset) (call $system::core::addressFromRef (local.get $lhs))))
  )
  (func $test/fixtures/execution/traverseTree.lys::Node.as (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  (func $test/fixtures/execution/traverseTree.lys::Node.as_1 (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  (func $test/fixtures/execution/traverseTree.lys::Node.Node$discriminant (result i64)
    ...
    (block $B1 (result i64)
      ...
      (call $system::core::u64.<< (call $system::core::u32.as_1 (local.get $test/fixtures/execution/traverseTree.lys::discriminant)) (i32.const 32))
    )
  )
  (func $test/fixtures/execution/traverseTree.lys::Node.apply (param $value i32) (param $left i64) (param $right i64) (result i64)
    (local $test/fixtures/execution/traverseTree.lys::$ref i64)
    (block $B1 (result i64)
      (local.set $test/fixtures/execution/traverseTree.lys::$ref (call $test/fixtures/execution/traverseTree.lys::Node.fromPointer (call $system::memory::calloc (call $system::core::i32.as_3 (i32.const 1)) (i32.const 20))))
      (call $test/fixtures/execution/traverseTree.lys::Node.property$0_1 (local.get $test/fixtures/execution/traverseTree.lys::$ref) (local.get $value))
      (call $test/fixtures/execution/traverseTree.lys::Node.property$1_1 (local.get $test/fixtures/execution/traverseTree.lys::$ref) (local.get $left))
      (call $test/fixtures/execution/traverseTree.lys::Node.property$2_1 (local.get $test/fixtures/execution/traverseTree.lys::$ref) (local.get $right))
      (local.get $test/fixtures/execution/traverseTree.lys::$ref)
    )
  )
  (func $test/fixtures/execution/traverseTree.lys::Node.fromPointer (param $ptr i32) (result i64)
    (i64.or (call $test/fixtures/execution/traverseTree.lys::Node.Node$discriminant) (i64.extend_u/i32 (local.get $ptr)))
  )
  (func $test/fixtures/execution/traverseTree.lys::Node.== (param $a i64) (param $b i64) (result i32)
    (i64.eq (local.get $a) (local.get $b))
  )
  (func $test/fixtures/execution/traverseTree.lys::Node.!= (param $a i64) (param $b i64) (result i32)
    (i64.ne (local.get $a) (local.get $b))
  )
  (func $test/fixtures/execution/traverseTree.lys::Node.property_value (param $self i64) (result i32)
    (call $test/fixtures/execution/traverseTree.lys::Node.property$0 (local.get $self))
  )
  (func $test/fixtures/execution/traverseTree.lys::Node.property_value_1 (param $self i64) (param $value i32)
    (call $test/fixtures/execution/traverseTree.lys::Node.property$0_1 (local.get $self) (local.get $value))
  )
  (func $test/fixtures/execution/traverseTree.lys::Node.property$0 (param $self i64) (result i32)
    (call $system::core::i32.load_1 (local.get $self) (i32.const 0))
  )
  (func $test/fixtures/execution/traverseTree.lys::Node.property$0_1 (param $self i64) (param $value i32)
    (call $system::core::i32.store_1 (local.get $self) (local.get $value) (i32.const 0))
  )
  (func $test/fixtures/execution/traverseTree.lys::Node.property_left (param $self i64) (result i64)
    (call $test/fixtures/execution/traverseTree.lys::Node.property$1 (local.get $self))
  )
  (func $test/fixtures/execution/traverseTree.lys::Node.property_left_1 (param $self i64) (param $value i64)
    (call $test/fixtures/execution/traverseTree.lys::Node.property$1_1 (local.get $self) (local.get $value))
  )
  (func $test/fixtures/execution/traverseTree.lys::Node.property$1 (param $self i64) (result i64)
    (call $test/fixtures/execution/traverseTree.lys::Tree.load (local.get $self) (i32.const 4))
  )
  (func $test/fixtures/execution/traverseTree.lys::Node.property$1_1 (param $self i64) (param $value i64)
    (call $test/fixtures/execution/traverseTree.lys::Tree.store (local.get $self) (local.get $value) (i32.const 4))
  )
  (func $test/fixtures/execution/traverseTree.lys::Node.property_right (param $self i64) (result i64)
    (call $test/fixtures/execution/traverseTree.lys::Node.property$2 (local.get $self))
  )
  (func $test/fixtures/execution/traverseTree.lys::Node.property_right_1 (param $self i64) (param $value i64)
    (call $test/fixtures/execution/traverseTree.lys::Node.property$2_1 (local.get $self) (local.get $value))
  )
  (func $test/fixtures/execution/traverseTree.lys::Node.property$2 (param $self i64) (result i64)
    (call $test/fixtures/execution/traverseTree.lys::Tree.load (local.get $self) (i32.const 12))
  )
  (func $test/fixtures/execution/traverseTree.lys::Node.property$2_1 (param $self i64) (param $value i64)
    (call $test/fixtures/execution/traverseTree.lys::Tree.store (local.get $self) (local.get $value) (i32.const 12))
  )
  (func $test/fixtures/execution/traverseTree.lys::Node.is (param $a i64) (result i32)
    (i64.eq (i64.and (i64.const 0xffffffff00000000) (local.get $a)) (call $test/fixtures/execution/traverseTree.lys::Node.Node$discriminant))
  )
  (func $test/fixtures/execution/traverseTree.lys::Node.store (param $lhs i64) (param $rhs i64) (param $offset i32)
    (i64.store (i32.add (local.get $offset) (call $system::core::addressFromRef (local.get $lhs))) (local.get $rhs))
  )
  (func $test/fixtures/execution/traverseTree.lys::Node.load (param $lhs i64) (param $offset i32) (result i64)
    (i64.load (i32.add (local.get $offset) (call $system::core::addressFromRef (local.get $lhs))))
  )
  (func $test/fixtures/execution/traverseTree.lys::Empty.as (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  (func $test/fixtures/execution/traverseTree.lys::Empty.as_1 (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  (func $test/fixtures/execution/traverseTree.lys::Empty.Empty$discriminant (result i64)
    ...
    (block $B1 (result i64)
      ...
      (call $system::core::i64.<< (call $system::core::u32.as (local.get $test/fixtures/execution/traverseTree.lys::discriminant_3)) (i32.const 32))
    )
  )
  (func $test/fixtures/execution/traverseTree.lys::Empty.apply (result i64)
    (call $test/fixtures/execution/traverseTree.lys::Empty.Empty$discriminant)
  )
  (func $test/fixtures/execution/traverseTree.lys::Empty.is (param $a i64) (result i32)
    (i64.eq (i64.and (i64.const 0xffffffff00000000) (local.get $a)) (call $test/fixtures/execution/traverseTree.lys::Empty.Empty$discriminant))
  )
  (func $test/fixtures/execution/traverseTree.lys::Empty.== (param $a i64) (param $b i64) (result i32)
    (i64.eq (local.get $a) (local.get $b))
  )
  (func $test/fixtures/execution/traverseTree.lys::Empty.!= (param $a i64) (param $b i64) (result i32)
    (i64.ne (local.get $a) (local.get $b))
  )
  (func $test/fixtures/execution/traverseTree.lys::Empty.store (param $lhs i64) (param $rhs i64) (param $offset i32)
    (i64.store (i32.add (local.get $offset) (call $system::core::addressFromRef (local.get $lhs))) (local.get $rhs))
  )
  (func $test/fixtures/execution/traverseTree.lys::Empty.load (param $lhs i64) (param $offset i32) (result i64)
    (i64.load (i32.add (local.get $offset) (call $system::core::addressFromRef (local.get $lhs))))
  )
  (func $test/fixtures/execution/traverseTree.lys::sum (param $arg i64) (result i32)
    ...
    (block $B1 (result i32)
      (block $B3 (result i32)
          ...
          (block $B3_0
              (block $B3_1
                  (br_if $B3_0 (call $test/fixtures/execution/traverseTree.lys::Empty.is (local.get $var$4)))
                  (br_if $B3_1 (call $test/fixtures/execution/traverseTree.lys::Node.is (local.get $var$4)))
                )
              (block $B2 (result i32)
                  (local.set $test/fixtures/execution/traverseTree.lys::value_8 (call $test/fixtures/execution/traverseTree.lys::Node.property_value (local.get $var$4)))
                  (local.set $test/fixtures/execution/traverseTree.lys::left_2 (call $test/fixtures/execution/traverseTree.lys::Node.property_left (local.get $var$4)))
                  (local.set $test/fixtures/execution/traverseTree.lys::right_2 (call $test/fixtures/execution/traverseTree.lys::Node.property_right (local.get $var$4)))
                  (call $system::core::i32.+ (call $system::core::i32.+ (local.get $test/fixtures/execution/traverseTree.lys::value_8) (call $test/fixtures/execution/traverseTree.lys::sum (local.get $test/fixtures/execution/traverseTree.lys::left_2))) (call $test/fixtures/execution/traverseTree.lys::sum (local.get $test/fixtures/execution/traverseTree.lys::right_2)))
                )
              (br $B3)
            )
          (i32.const 0)
  ...
  (func $test/fixtures/execution/traverseTree.lys::main
    (local $test/fixtures/execution/traverseTree.lys::tree i64)
    (block $B1
      (call $support::test::START_1 (i64.const 0x0000000000000010))
      (local.set $test/fixtures/execution/traverseTree.lys::tree (call $test/fixtures/execution/traverseTree.lys::Node.apply (i32.const 42) (call $test/fixtures/execution/traverseTree.lys::Node.apply (i32.const 3) (call $test/fixtures/execution/traverseTree.lys::Empty.apply) (call $test/fixtures/execution/traverseTree.lys::Empty.apply)) (call $test/fixtures/execution/traverseTree.lys::Empty.apply)))
      (call $support::test::mustEqual_5 (call $test/fixtures/execution/traverseTree.lys::sum (local.get $test/fixtures/execution/traverseTree.lys::tree)) (i32.const 45) (i64.const 0x000000000000002f))
