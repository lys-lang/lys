(module
  ...
  (data 0 (i32.const 194) "\16\00\00\00 \00 \00g\00i\00v\00e\00n\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 221) "\1c\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 254) "\1e\00\00\00 \00 \00g\00i\00v\00e\00n\00 \00L\00S\00B\00:\00 \00%\00X\00\00")
  (data 0 (i32.const 289) "$\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00 \00L\00S\00B\00:\00 \00%\00X\00\00")
  (data 0 (i32.const 330) "\1e\00\00\00 \00 \00g\00i\00v\00e\00n\00 \00M\00S\00B\00:\00 \00%\00X\00\00")
  (data 0 (i32.const 365) "$\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00 \00M\00S\00B\00:\00 \00%\00X\00\00")
  (data 0 (i32.const 406) "\1e\00\00\00 \00 \00g\00i\00v\00e\00n\00 \00L\00S\00B\00:\00 \00%\00X\00\00")
  (data 0 (i32.const 441) "$\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00 \00L\00S\00B\00:\00 \00%\00X\00\00")
  (data 0 (i32.const 482) "\1e\00\00\00 \00 \00g\00i\00v\00e\00n\00 \00M\00S\00B\00:\00 \00%\00X\00\00")
  (data 0 (i32.const 517) "$\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00 \00M\00S\00B\00:\00 \00%\00X\00\00")
  (data 0 (i32.const 558) "\16\00\00\00 \00 \00g\00i\00v\00e\00n\00:\00 \00%\00X\00\00")
  (data 0 (i32.const 585) "\1c\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00:\00 \00%\00X\00\00")
  (data 0 (i32.const 618) "\16\00\00\00 \00 \00g\00i\00v\00e\00n\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 645) "\1c\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 678) "\1a\00\00\00a\00s\00s\00e\00r\00t\00(\00f\00a\00l\00s\00e\00)\00\00")
  ...
  (func $support::test::mustEqual_1 (param $given f64) (param $expected f64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::f64::f64.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_11 (i64.const 0x0000000300000086) (local.get $given))
                (call $support::env::printf_11 (i64.const 0x00000003000000a1) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_2 (param $given f32) (param $expected f32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::f32::f32.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_10 (i64.const 0x00000003000000c2) (local.get $given))
                (call $support::env::printf_10 (i64.const 0x00000003000000dd) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_3 (param $given i64) (param $expected i64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u64::u64.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_9 (i64.const 0x00000003000000fe) (call $system::core::u64::u64.as_8 (call $system::core::u64::u64.>>_1 (local.get $given) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x0000000300000121) (call $system::core::u64::u64.as_8 (call $system::core::u64::u64.>>_1 (local.get $expected) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x000000030000014a) (call $system::core::u64::u64.&_3 (local.get $given) (i32.const 0xFFFFFFFF)))
                (call $support::env::printf_9 (i64.const 0x000000030000016d) (call $system::core::u64::u64.&_3 (local.get $expected) (i32.const 0xFFFFFFFF)))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_4 (param $given i64) (param $expected i64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i64::i64.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_9 (i64.const 0x0000000300000196) (call $system::core::u64::u64.as_8 (call $system::core::u64::u64.>>_1 (call $system::core::i64::i64.as_3 (local.get $given)) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x00000003000001b9) (call $system::core::u64::u64.as_8 (call $system::core::u64::u64.>>_1 (call $system::core::i64::i64.as_3 (local.get $expected)) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x00000003000001e2) (call $system::core::i64::i64.&_3 (local.get $given) (i32.const 0xFFFFFFFF)))
                (call $support::env::printf_9 (i64.const 0x0000000300000205) (call $system::core::i64::i64.&_3 (local.get $expected) (i32.const 0xFFFFFFFF)))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_5 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u32::u32.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_9 (i64.const 0x000000030000022e) (local.get $given))
                (call $support::env::printf_9 (i64.const 0x0000000300000249) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_6 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i32::i32.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_8 (i64.const 0x000000030000026a) (local.get $given))
                (call $support::env::printf_8 (i64.const 0x0000000300000285) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::assert_1 (param $condition i32)
    (call $support::test::assert_2 (local.get $condition) (i64.const 0x00000003000002a6))
  )
  ...
  (data 0 (i32.const 92) "\08\00\00\00t\00r\00u\00e\00\00")
  (data 0 (i32.const 105) "\0a\00\00\00f\00a\00l\00s\00e\00\00")
  (data 0 (i32.const 120) "\02\00\00\000\00\00")
  (data 0 (i32.const 127) "\02\00\00\000\00\00")
  ...
  (func $test::fixtures::execution::traverseTree::Tree.is_1 (param $a i64) (result i32)
    (block $B1 (result i32)
      (call $system::core::boolean::boolean.||_1 (call $test::fixtures::execution::traverseTree::Node.is_1 (local.get $a)) (call $test::fixtures::execution::traverseTree::Empty.is_1 (local.get $a)))
    )
  )
  ...
  (func $test::fixtures::execution::traverseTree::Node.as_2 (param $self i64) (result i32)
    (call $system::core::native::addressFromRef_1 (get_local $self))
  )
  (func $test::fixtures::execution::traverseTree::Node.as_3 (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  (func $test::fixtures::execution::traverseTree::Node.Node$discriminant_1 (result i64)
    ...
    (block $B1 (result i64)
      (local.set $test::fixtures::execution::traverseTree::discriminant (i32.const 1))
      (call $system::core::u64::u64.<<_1 (call $system::core::u32::u32.as_2 (local.get $test::fixtures::execution::traverseTree::discriminant)) (i32.const 32))
    )
  )
  (func $test::fixtures::execution::traverseTree::Node.apply_1 (param $value i32) (param $left i64) (param $right i64) (result i64)
    ...
    (block $B1 (result i64)
      (local.set $test::fixtures::execution::traverseTree::$ref (call $test::fixtures::execution::traverseTree::Node.fromPointer_1 (call $system::core::memory::calloc_1 (call $system::core::i32::i32.as_4 (i32.const 1)) (i32.const 20))))
  ...
  (func $test::fixtures::execution::traverseTree::Empty.Empty$discriminant_1 (result i64)
    ...
    (block $B1 (result i64)
      (local.set $test::fixtures::execution::traverseTree::discriminant_1 (i32.const 2))
      (call $system::core::i64::i64.<<_1 (call $system::core::u32::u32.as_1 (local.get $test::fixtures::execution::traverseTree::discriminant_1)) (i32.const 32))
    )
  )
      ...
      (block $B3 (result i32)
          ...
          (block $B3_0
              ...
              (block $B2 (result i32)
                  ...
                  (call $system::core::i32::i32.+_1 (call $system::core::i32::i32.+_1 (local.get $test::fixtures::execution::traverseTree::value_7) (call $test::fixtures::execution::traverseTree::sum_1 (local.get $test::fixtures::execution::traverseTree::left_1))) (call $test::fixtures::execution::traverseTree::sum_1 (local.get $test::fixtures::execution::traverseTree::right_1)))
                )
              (br $B3)
            )
          (i32.const 0)
  ...
  (func $test::fixtures::execution::traverseTree::main_1
    ...
    (block $B1
      ...
      (call $support::test::mustEqual_6 (call $test::fixtures::execution::traverseTree::sum_1 (local.get $test::fixtures::execution::traverseTree::tree)) (i32.const 45) (i64.const 0x000000030000002f))
