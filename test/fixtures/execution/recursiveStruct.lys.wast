(module
  ...
  (data 0 (i32.const 230) "\08\00\00\00t\00r\00u\00e\00\00")
  (data 0 (i32.const 243) "\0a\00\00\00f\00a\00l\00s\00e\00\00")
  (data 0 (i32.const 258) "\02\00\00\000\00\00")
  (data 0 (i32.const 265) "\02\00\00\000\00\00")
  ...
  (func $system::string::String.stringify (param $value i32) (result i64)
    (block $B1 (result i64)
      (if $IF2 (result i64) (local.get $value)
          (then
            (block $B3 (result i64)
                (i64.const 0x00000000000000e6)
              )
          )
          (else
            (block $B4 (result i64)
                (i64.const 0x00000000000000f3)
              )
          )
        )
    )
  ...
  (data 0 (i32.const 199) "\1a\00\00\00a\00s\00s\00e\00r\00t\00(\00f\00a\00l\00s\00e\00)\00\00")
  ...
  (func $support::test::assert (param $condition i32)
    (call $support::test::assert_2 (local.get $condition) (i64.const 0x00000000000000c7))
  )
  ...
  (export "main" (func $test/fixtures/execution/recursiveStruct.lys::main))
  (func $test/fixtures/execution/recursiveStruct.lys::Tree.is (param $a i64) (result i32)
    (block $B1 (result i32)
      (call $system::core::boolean.|| (call $test/fixtures/execution/recursiveStruct.lys::Empty.is (local.get $a)) (call $test/fixtures/execution/recursiveStruct.lys::Node.is (local.get $a)))
    )
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Tree.== (param $lhs i64) (param $rhs i64) (result i32)
    (call $system::core::ref.== (local.get $lhs) (local.get $rhs))
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Tree.!= (param $lhs i64) (param $rhs i64) (result i32)
    (call $system::core::ref.!= (local.get $lhs) (local.get $rhs))
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Tree.store (param $lhs i64) (param $rhs i64) (param $offset i32)
    (i64.store (i32.add (local.get $offset) (call $system::core::addressFromRef (local.get $lhs))) (local.get $rhs))
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Tree.load (param $lhs i64) (param $offset i32) (result i64)
    (i64.load (i32.add (local.get $offset) (call $system::core::addressFromRef (local.get $lhs))))
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Tree.as (param $a i64) (result i64)
    (local.get $a)
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Empty.as (param $a i64) (result i64)
    (local.get $a)
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Node.as (param $a i64) (result i64)
    (local.get $a)
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Empty.Empty$discriminant (result i64)
    (local $discriminant i32)
    (block $B1 (result i64)
  ...
  (func $test/fixtures/execution/recursiveStruct.lys::Empty.apply (result i64)
    (call $test/fixtures/execution/recursiveStruct.lys::Empty.Empty$discriminant)
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Empty.is (param $a i64) (result i32)
    (i64.eq (i64.and (i64.const 0xffffffff00000000) (local.get $a)) (call $test/fixtures/execution/recursiveStruct.lys::Empty.Empty$discriminant))
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Empty.== (param $a i64) (param $b i64) (result i32)
    (i64.eq (local.get $a) (local.get $b))
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Empty.!= (param $a i64) (param $b i64) (result i32)
    (i64.ne (local.get $a) (local.get $b))
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Empty.store (param $lhs i64) (param $rhs i64) (param $offset i32)
    (i64.store (i32.add (local.get $offset) (call $system::core::addressFromRef (local.get $lhs))) (local.get $rhs))
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Empty.load (param $lhs i64) (param $offset i32) (result i64)
    (i64.load (i32.add (local.get $offset) (call $system::core::addressFromRef (local.get $lhs))))
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Node.Node$discriminant (result i64)
    (local $discriminant i32)
    (block $B1 (result i64)
  ...
  (func $test/fixtures/execution/recursiveStruct.lys::Node.apply (param $a i64) (result i64)
    (local $$ref i64)
    (block $B1 (result i64)
      (local.set $$ref (call $test/fixtures/execution/recursiveStruct.lys::Node.fromPointer (call $system::memory::calloc (call $system::core::i32.as_3 (i32.const 1)) (i32.const 8))))
      (call $test/fixtures/execution/recursiveStruct.lys::Node.property$0_1 (local.get $$ref) (local.get $a))
      (local.get $$ref)
    )
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Node.fromPointer (param $ptr i32) (result i64)
    (i64.or (call $test/fixtures/execution/recursiveStruct.lys::Node.Node$discriminant) (i64.extend_u/i32 (local.get $ptr)))
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Node.== (param $a i64) (param $b i64) (result i32)
    (i64.eq (local.get $a) (local.get $b))
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Node.!= (param $a i64) (param $b i64) (result i32)
    (i64.ne (local.get $a) (local.get $b))
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Node.property_a (param $self i64) (result i64)
    (call $test/fixtures/execution/recursiveStruct.lys::Node.property$0 (local.get $self))
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Node.property_a_1 (param $self i64) (param $value i64)
    (call $test/fixtures/execution/recursiveStruct.lys::Node.property$0_1 (local.get $self) (local.get $value))
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Node.property$0 (param $self i64) (result i64)
    (call $test/fixtures/execution/recursiveStruct.lys::Node.loadPropertyWithOffset$0 (local.get $self) (i32.const 0))
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Node.property$0_1 (param $self i64) (param $value i64)
    (call $test/fixtures/execution/recursiveStruct.lys::Node.storePropertyWithOffset$0 (local.get $self) (local.get $value) (i32.const 0))
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Node.loadPropertyWithOffset$0 (param $self i64) (param $offset i32) (result i64)
    (i64.load (i32.add (local.get $offset) (call $system::core::addressFromRef (local.get $self))))
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Node.storePropertyWithOffset$0 (param $self i64) (param $value i64) (param $offset i32)
    (i64.store (i32.add (local.get $offset) (call $system::core::addressFromRef (local.get $self))) (local.get $value))
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Node.is (param $a i64) (result i32)
    (i64.eq (i64.and (i64.const 0xffffffff00000000) (local.get $a)) (call $test/fixtures/execution/recursiveStruct.lys::Node.Node$discriminant))
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Node.store (param $lhs i64) (param $rhs i64) (param $offset i32)
    (i64.store (i32.add (local.get $offset) (call $system::core::addressFromRef (local.get $lhs))) (local.get $rhs))
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Node.load (param $lhs i64) (param $offset i32) (result i64)
    (i64.load (i32.add (local.get $offset) (call $system::core::addressFromRef (local.get $lhs))))
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Forest.is (param $a i64) (result i32)
    (block $B1 (result i32)
      (call $system::core::boolean.|| (call $test/fixtures/execution/recursiveStruct.lys::Nil.is (local.get $a)) (call $test/fixtures/execution/recursiveStruct.lys::Cons.is (local.get $a)))
    )
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Forest.== (param $lhs i64) (param $rhs i64) (result i32)
    (call $system::core::ref.== (local.get $lhs) (local.get $rhs))
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Forest.!= (param $lhs i64) (param $rhs i64) (result i32)
    (call $system::core::ref.!= (local.get $lhs) (local.get $rhs))
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Forest.store (param $lhs i64) (param $rhs i64) (param $offset i32)
    (i64.store (i32.add (local.get $offset) (call $system::core::addressFromRef (local.get $lhs))) (local.get $rhs))
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Forest.load (param $lhs i64) (param $offset i32) (result i64)
    (i64.load (i32.add (local.get $offset) (call $system::core::addressFromRef (local.get $lhs))))
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Forest.as (param $a i64) (result i64)
    (local.get $a)
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Nil.as (param $a i64) (result i64)
    (local.get $a)
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Cons.as (param $a i64) (result i64)
    (local.get $a)
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Nil.Nil$discriminant (result i64)
    (local $discriminant i32)
    (block $B1 (result i64)
  ...
  (func $test/fixtures/execution/recursiveStruct.lys::Nil.apply (result i64)
    (call $test/fixtures/execution/recursiveStruct.lys::Nil.Nil$discriminant)
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Nil.is (param $a i64) (result i32)
    (i64.eq (i64.and (i64.const 0xffffffff00000000) (local.get $a)) (call $test/fixtures/execution/recursiveStruct.lys::Nil.Nil$discriminant))
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Nil.== (param $a i64) (param $b i64) (result i32)
    (i64.eq (local.get $a) (local.get $b))
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Nil.!= (param $a i64) (param $b i64) (result i32)
    (i64.ne (local.get $a) (local.get $b))
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Nil.store (param $lhs i64) (param $rhs i64) (param $offset i32)
    (i64.store (i32.add (local.get $offset) (call $system::core::addressFromRef (local.get $lhs))) (local.get $rhs))
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Nil.load (param $lhs i64) (param $offset i32) (result i64)
    (i64.load (i32.add (local.get $offset) (call $system::core::addressFromRef (local.get $lhs))))
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Cons.Cons$discriminant (result i64)
    (local $discriminant i32)
    (block $B1 (result i64)
  ...
  (func $test/fixtures/execution/recursiveStruct.lys::Cons.apply (param $tree i64) (result i64)
    (local $$ref i64)
    (block $B1 (result i64)
      (local.set $$ref (call $test/fixtures/execution/recursiveStruct.lys::Cons.fromPointer (call $system::memory::calloc (call $system::core::i32.as_3 (i32.const 1)) (i32.const 8))))
      (call $test/fixtures/execution/recursiveStruct.lys::Cons.property$0_1 (local.get $$ref) (local.get $tree))
      (local.get $$ref)
    )
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Cons.fromPointer (param $ptr i32) (result i64)
    (i64.or (call $test/fixtures/execution/recursiveStruct.lys::Cons.Cons$discriminant) (i64.extend_u/i32 (local.get $ptr)))
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Cons.== (param $a i64) (param $b i64) (result i32)
    (i64.eq (local.get $a) (local.get $b))
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Cons.!= (param $a i64) (param $b i64) (result i32)
    (i64.ne (local.get $a) (local.get $b))
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Cons.property_tree (param $self i64) (result i64)
    (call $test/fixtures/execution/recursiveStruct.lys::Cons.property$0 (local.get $self))
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Cons.property_tree_1 (param $self i64) (param $value i64)
    (call $test/fixtures/execution/recursiveStruct.lys::Cons.property$0_1 (local.get $self) (local.get $value))
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Cons.property$0 (param $self i64) (result i64)
    (call $test/fixtures/execution/recursiveStruct.lys::Cons.loadPropertyWithOffset$0 (local.get $self) (i32.const 0))
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Cons.property$0_1 (param $self i64) (param $value i64)
    (call $test/fixtures/execution/recursiveStruct.lys::Cons.storePropertyWithOffset$0 (local.get $self) (local.get $value) (i32.const 0))
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Cons.loadPropertyWithOffset$0 (param $self i64) (param $offset i32) (result i64)
    (i64.load (i32.add (local.get $offset) (call $system::core::addressFromRef (local.get $self))))
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Cons.storePropertyWithOffset$0 (param $self i64) (param $value i64) (param $offset i32)
    (i64.store (i32.add (local.get $offset) (call $system::core::addressFromRef (local.get $self))) (local.get $value))
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Cons.is (param $a i64) (result i32)
    (i64.eq (i64.and (i64.const 0xffffffff00000000) (local.get $a)) (call $test/fixtures/execution/recursiveStruct.lys::Cons.Cons$discriminant))
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Cons.store (param $lhs i64) (param $rhs i64) (param $offset i32)
    (i64.store (i32.add (local.get $offset) (call $system::core::addressFromRef (local.get $lhs))) (local.get $rhs))
  )
  (func $test/fixtures/execution/recursiveStruct.lys::Cons.load (param $lhs i64) (param $offset i32) (result i64)
    (i64.load (i32.add (local.get $offset) (call $system::core::addressFromRef (local.get $lhs))))
  )
  (func $test/fixtures/execution/recursiveStruct.lys::main
    (local $a i64)
    (local $b i64)
    (local $c i64)
    (local $d i64)
    ...
    (block $B1
      ...
      (local.set $a (call $test/fixtures/execution/recursiveStruct.lys::Nil.apply))
      (local.set $b (call $test/fixtures/execution/recursiveStruct.lys::Cons.apply (call $test/fixtures/execution/recursiveStruct.lys::Empty.apply)))
      (local.set $c (call $test/fixtures/execution/recursiveStruct.lys::Cons.apply (call $test/fixtures/execution/recursiveStruct.lys::Nil.apply)))
      (local.set $d (call $test/fixtures/execution/recursiveStruct.lys::Cons.apply (call $test/fixtures/execution/recursiveStruct.lys::Node.apply (call $test/fixtures/execution/recursiveStruct.lys::Empty.apply))))
      (local.set $e (call $test/fixtures/execution/recursiveStruct.lys::Node.apply (call $test/fixtures/execution/recursiveStruct.lys::Nil.apply)))
      (call $support::test::verify_12 (call $test/fixtures/execution/recursiveStruct.lys::Nil.is (local.get $a)) (i64.const 0x000000000000003b))
      (call $support::test::verify_12 (call $test/fixtures/execution/recursiveStruct.lys::Forest.is (local.get $a)) (i64.const 0x0000000000000050))
      (call $support::test::verify_12 (call $test/fixtures/execution/recursiveStruct.lys::Forest.is (local.get $b)) (i64.const 0x0000000000000069))
      (call $support::test::verify_12 (call $test/fixtures/execution/recursiveStruct.lys::Cons.is (local.get $c)) (i64.const 0x0000000000000082))
      (call $support::test::verify_12 (call $test/fixtures/execution/recursiveStruct.lys::Node.is (local.get $e)) (i64.const 0x0000000000000099))
      (call $support::test::verify_12 (call $test/fixtures/execution/recursiveStruct.lys::Tree.is (local.get $e)) (i64.const 0x00000000000000b0))
