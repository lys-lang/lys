(module
  ...
  (func $support::test::mustEqual_2 (param $given i64) (param $expected i64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u64.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_9 (i64.const 0x000000000000013f) (call $system::core::u64.as_7 (call $system::core::u64.>> (local.get $given) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x0000000000000162) (call $system::core::u64.as_7 (call $system::core::u64.>> (local.get $expected) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x000000000000018b) (call $system::core::u64.&_2 (local.get $given) (call $system::core::i32.as_3 (i32.const 0xFFFFFFFF))))
                (call $support::env::printf_9 (i64.const 0x00000000000001ae) (call $system::core::u64.&_2 (local.get $expected) (call $system::core::i32.as_3 (i32.const 0xFFFFFFFF))))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_3 (param $given i64) (param $expected i64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i64.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_9 (i64.const 0x00000000000001d7) (call $system::core::u64.as_7 (call $system::core::u64.>> (call $system::core::i64.as_2 (local.get $given)) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x00000000000001fa) (call $system::core::u64.as_7 (call $system::core::u64.>> (call $system::core::i64.as_2 (local.get $expected)) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x0000000000000223) (call $system::core::i64.&_2 (local.get $given) (call $system::core::i32.as_3 (i32.const 0xFFFFFFFF))))
                (call $support::env::printf_9 (i64.const 0x0000000000000246) (call $system::core::i64.&_2 (local.get $expected) (call $system::core::i32.as_3 (i32.const 0xFFFFFFFF))))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_5 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i32.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_7 (i64.const 0x00000000000002ab) (local.get $given))
                (call $support::env::printf_7 (i64.const 0x00000000000002c6) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $test/fixtures/execution/recursiveStruct.lys::main
    ...
    (block $B1
      ...
      (call $support::test::verify_9 (call $test/fixtures/execution/recursiveStruct.lys::Nil.is (local.get $test/fixtures/execution/recursiveStruct.lys::a_6)) (i64.const 0x000000000000003b))
      (call $support::test::verify_9 (call $test/fixtures/execution/recursiveStruct.lys::Forest.is (local.get $test/fixtures/execution/recursiveStruct.lys::a_6)) (i64.const 0x0000000000000050))
      (call $support::test::verify_9 (call $test/fixtures/execution/recursiveStruct.lys::Forest.is (local.get $test/fixtures/execution/recursiveStruct.lys::b)) (i64.const 0x0000000000000069))
      (call $support::test::verify_9 (call $test/fixtures/execution/recursiveStruct.lys::Cons.is (local.get $test/fixtures/execution/recursiveStruct.lys::c)) (i64.const 0x0000000000000082))
      (call $support::test::verify_9 (call $test/fixtures/execution/recursiveStruct.lys::Node.is (local.get $test/fixtures/execution/recursiveStruct.lys::e)) (i64.const 0x0000000000000099))
      (call $support::test::verify_9 (call $test/fixtures/execution/recursiveStruct.lys::Tree.is (local.get $test/fixtures/execution/recursiveStruct.lys::e)) (i64.const 0x00000000000000b0))
