(module
  ...
  (func $test::fixtures::execution::structValuesExtended::Custom.as_3 (param $self i64) (result i32)
    (call $system::core::native::addressFromRef_1 (get_local $self))
  )
  (func $test::fixtures::execution::structValuesExtended::Custom.as_4 (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  ...
  (func $test::fixtures::execution::structValuesExtended::main_1
    ...
    (block $B1
      ...
      (call $support::test::verify_2 (call $system::core::i32::i32.==_1 (call $test::fixtures::execution::structValuesExtended::CatBag.a_1 (local.get $test::fixtures::execution::structValuesExtended::a_21)) (i32.const 1)) (i64.const 0x0000000300000048))
      (call $support::test::verify_2 (call $system::core::boolean::boolean.==_1 (call $test::fixtures::execution::structValuesExtended::CatBag.b_1 (local.get $test::fixtures::execution::structValuesExtended::a_21)) (i32.const 1)) (i64.const 0x000000030000004f))
      (call $support::test::verify_2 (call $system::core::f32::f32.==_1 (call $test::fixtures::execution::structValuesExtended::CatBag.c_1 (local.get $test::fixtures::execution::structValuesExtended::a_21)) (f32.const 3)) (i64.const 0x0000000300000056))
      (call $support::test::verify_2 (call $system::core::i64::i64.==_1 (call $test::fixtures::execution::structValuesExtended::CatBag.d_1 (local.get $test::fixtures::execution::structValuesExtended::a_21)) (call $system::core::u32::u32.as_1 (i32.const 0x8))) (i64.const 0x000000030000005d))
      (call $support::test::verify_2 (call $system::core::f64::f64.==_1 (call $test::fixtures::execution::structValuesExtended::CatBag.e_1 (local.get $test::fixtures::execution::structValuesExtended::a_21)) (call $system::core::f32::f32.as_1 (f32.const 0.4))) (i64.const 0x0000000300000064))
      (call $support::test::verify_2 (call $test::fixtures::execution::structValuesExtended::Red.is_1 (call $test::fixtures::execution::structValuesExtended::CatBag.f_1 (local.get $test::fixtures::execution::structValuesExtended::a_21))) (i64.const 0x000000030000006b))
      (call $support::test::verify_2 (call $test::fixtures::execution::structValuesExtended::Red.is_1 (call $test::fixtures::execution::structValuesExtended::CatBag.g_1 (local.get $test::fixtures::execution::structValuesExtended::a_21))) (i64.const 0x0000000300000072))
      (call $support::test::verify_2 (call $test::fixtures::execution::structValuesExtended::Color.is_1 (call $test::fixtures::execution::structValuesExtended::CatBag.f_1 (local.get $test::fixtures::execution::structValuesExtended::a_21))) (i64.const 0x0000000300000079))
      (call $support::test::verify_2 (call $test::fixtures::execution::structValuesExtended::Color.is_1 (call $test::fixtures::execution::structValuesExtended::CatBag.g_1 (local.get $test::fixtures::execution::structValuesExtended::a_21))) (i64.const 0x0000000300000080))
      (call $test::fixtures::execution::structValuesExtended::CatBag.a_2 (local.get $test::fixtures::execution::structValuesExtended::a_21) (i32.const 5))
      (call $test::fixtures::execution::structValuesExtended::CatBag.b_2 (local.get $test::fixtures::execution::structValuesExtended::a_21) (i32.const 0))
      (call $test::fixtures::execution::structValuesExtended::CatBag.c_2 (local.get $test::fixtures::execution::structValuesExtended::a_21) (call $system::core::f32::f32.-_2 (f32.const 999)))
      (call $test::fixtures::execution::structValuesExtended::CatBag.d_2 (local.get $test::fixtures::execution::structValuesExtended::a_21) (call $system::core::u32::u32.as_1 (i32.const 0xdeadbeef)))
      (call $test::fixtures::execution::structValuesExtended::CatBag.e_2 (local.get $test::fixtures::execution::structValuesExtended::a_21) (call $system::core::f32::f32.as_1 (f32.const 6.08e+23)))
      (call $support::test::printNumber_1 (call $test::fixtures::execution::structValuesExtended::CatBag.c_1 (local.get $test::fixtures::execution::structValuesExtended::a_21)))
      (call $test::fixtures::execution::structValuesExtended::CatBag.f_2 (local.get $test::fixtures::execution::structValuesExtended::a_21) (call $test::fixtures::execution::structValuesExtended::Custom.apply_1 (i32.const 333)))
      (call $support::test::printNumber_1 (call $test::fixtures::execution::structValuesExtended::CatBag.c_1 (local.get $test::fixtures::execution::structValuesExtended::a_21)))
      (call $test::fixtures::execution::structValuesExtended::CatBag.g_2 (local.get $test::fixtures::execution::structValuesExtended::a_21) (call $test::fixtures::execution::structValuesExtended::None.apply_1))
      (call $support::test::printNumber_4 (i32.const 0))
      (call $support::test::printNumber_4 (call $test::fixtures::execution::structValuesExtended::CatBag.a_1 (local.get $test::fixtures::execution::structValuesExtended::a_21)))
      (call $support::test::verify_2 (call $system::core::i32::i32.==_1 (call $test::fixtures::execution::structValuesExtended::CatBag.a_1 (local.get $test::fixtures::execution::structValuesExtended::a_21)) (i32.const 5)) (i64.const 0x0000000300000087))
      (call $support::test::printNumber_4 (if $IF2 (result i32) (call $test::fixtures::execution::structValuesExtended::CatBag.b_1 (local.get $test::fixtures::execution::structValuesExtended::a_21))
                (then
                  (i32.const 1)
                )
                (else
      ...
      (call $support::test::verify_2 (call $system::core::boolean::boolean.==_1 (call $test::fixtures::execution::structValuesExtended::CatBag.b_1 (local.get $test::fixtures::execution::structValuesExtended::a_21)) (i32.const 0)) (i64.const 0x000000030000008e))
      (call $support::test::printNumber_1 (call $test::fixtures::execution::structValuesExtended::CatBag.c_1 (local.get $test::fixtures::execution::structValuesExtended::a_21)))
      (call $support::test::verify_2 (call $system::core::f32::f32.==_1 (call $test::fixtures::execution::structValuesExtended::CatBag.c_1 (local.get $test::fixtures::execution::structValuesExtended::a_21)) (call $system::core::f32::f32.-_2 (f32.const 999))) (i64.const 0x0000000300000095))
      (call $support::test::verify_2 (call $system::core::i64::i64.==_1 (call $test::fixtures::execution::structValuesExtended::CatBag.d_1 (local.get $test::fixtures::execution::structValuesExtended::a_21)) (call $system::core::u32::u32.as_1 (i32.const 0xdeadbeef))) (i64.const 0x000000030000009c))
      (call $support::test::verify_2 (call $system::core::f64::f64.==_1 (call $test::fixtures::execution::structValuesExtended::CatBag.e_1 (local.get $test::fixtures::execution::structValuesExtended::a_21)) (call $system::core::f32::f32.as_1 (f32.const 6.08e+23))) (i64.const 0x00000003000000a3))
      (call $support::test::verify_2 (call $test::fixtures::execution::structValuesExtended::Custom.is_1 (call $test::fixtures::execution::structValuesExtended::CatBag.f_1 (local.get $test::fixtures::execution::structValuesExtended::a_21))) (i64.const 0x00000003000000aa))
      (call $support::test::verify_2 (call $test::fixtures::execution::structValuesExtended::None.is_1 (call $test::fixtures::execution::structValuesExtended::CatBag.g_1 (local.get $test::fixtures::execution::structValuesExtended::a_21))) (i64.const 0x00000003000000b1))
      (call $support::test::verify_2 (call $test::fixtures::execution::structValuesExtended::Color.is_1 (call $test::fixtures::execution::structValuesExtended::CatBag.f_1 (local.get $test::fixtures::execution::structValuesExtended::a_21))) (i64.const 0x00000003000000b8))
      (call $support::test::verify_2 (call $test::fixtures::execution::structValuesExtended::Color.is_1 (call $test::fixtures::execution::structValuesExtended::CatBag.g_1 (local.get $test::fixtures::execution::structValuesExtended::a_21))) (i64.const 0x00000003000000bf))
      (call $support::test::verify_2 (call $test::fixtures::execution::structValuesExtended::Custom.is_1 (call $test::fixtures::execution::structValuesExtended::CatBag.f_1 (local.get $test::fixtures::execution::structValuesExtended::a_21))) (i64.const 0x00000003000000c6))
      (block $B3
          (local.set $var$1 (call $test::fixtures::execution::structValuesExtended::CatBag.f_1 (local.get $test::fixtures::execution::structValuesExtended::a_21)))
          (block $B3_0
              (block $B3_1
