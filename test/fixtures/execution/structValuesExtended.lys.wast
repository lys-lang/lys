(module
  ...
  (func $support::test::mustEqual_2 (param $given i64) (param $expected i64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u64.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_9 (i64.const 0x0000000000000153) (call $system::core::u64.as_7 (call $system::core::u64.>> (local.get $given) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x0000000000000176) (call $system::core::u64.as_7 (call $system::core::u64.>> (local.get $expected) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x000000000000019f) (call $system::core::u64.&_2 (local.get $given) (call $system::core::i32.as_3 (i32.const 0xFFFFFFFF))))
                (call $support::env::printf_9 (i64.const 0x00000000000001c2) (call $system::core::u64.&_2 (local.get $expected) (call $system::core::i32.as_3 (i32.const 0xFFFFFFFF))))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_3 (param $given i64) (param $expected i64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i64.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_9 (i64.const 0x00000000000001eb) (call $system::core::u64.as_7 (call $system::core::u64.>> (call $system::core::i64.as_2 (local.get $given)) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x000000000000020e) (call $system::core::u64.as_7 (call $system::core::u64.>> (call $system::core::i64.as_2 (local.get $expected)) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x0000000000000237) (call $system::core::i64.&_2 (local.get $given) (call $system::core::i32.as_3 (i32.const 0xFFFFFFFF))))
                (call $support::env::printf_9 (i64.const 0x000000000000025a) (call $system::core::i64.&_2 (local.get $expected) (call $system::core::i32.as_3 (i32.const 0xFFFFFFFF))))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_5 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i32.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_7 (i64.const 0x00000000000002bf) (local.get $given))
                (call $support::env::printf_7 (i64.const 0x00000000000002da) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $test/fixtures/execution/structValuesExtended.lys::main
    ...
    (block $B1
      ...
      (local.set $test/fixtures/execution/structValuesExtended.lys::a_7 (call $test/fixtures/execution/structValuesExtended.lys::CatBag.apply (i32.const 1) (i32.const 1) (f32.const 3) (call $system::core::i32.as (i32.const 0x8)) (call $system::core::f32.as (f32.const 0.4)) (call $test/fixtures/execution/structValuesExtended.lys::Red.apply) (call $test/fixtures/execution/structValuesExtended.lys::Red.apply)))
      (call $support::test::verify_9 (call $test/fixtures/execution/structValuesExtended.lys::CatBag.is (local.get $test/fixtures/execution/structValuesExtended.lys::a_7)) (i64.const 0x0000000000000041))
      (call $support::test::verify_9 (call $system::core::i32.== (call $test/fixtures/execution/structValuesExtended.lys::CatBag.property_a (local.get $test/fixtures/execution/structValuesExtended.lys::a_7)) (i32.const 1)) (i64.const 0x0000000000000048))
      (call $support::test::verify_9 (call $system::core::boolean.== (call $test/fixtures/execution/structValuesExtended.lys::CatBag.property_b (local.get $test/fixtures/execution/structValuesExtended.lys::a_7)) (i32.const 1)) (i64.const 0x000000000000004f))
      (call $support::test::verify_9 (call $system::core::f32.== (call $test/fixtures/execution/structValuesExtended.lys::CatBag.property_c (local.get $test/fixtures/execution/structValuesExtended.lys::a_7)) (f32.const 3)) (i64.const 0x0000000000000056))
      (call $support::test::verify_9 (call $system::core::i64.==_1 (call $test/fixtures/execution/structValuesExtended.lys::CatBag.property_d (local.get $test/fixtures/execution/structValuesExtended.lys::a_7)) (i32.const 0x8)) (i64.const 0x000000000000005d))
      (call $support::test::verify_9 (call $system::core::f64.== (call $test/fixtures/execution/structValuesExtended.lys::CatBag.property_e (local.get $test/fixtures/execution/structValuesExtended.lys::a_7)) (call $system::core::f32.as (f32.const 0.4))) (i64.const 0x0000000000000064))
      (call $support::test::verify_9 (call $test/fixtures/execution/structValuesExtended.lys::Red.is (call $test/fixtures/execution/structValuesExtended.lys::CatBag.property_f (local.get $test/fixtures/execution/structValuesExtended.lys::a_7))) (i64.const 0x000000000000006b))
      (call $support::test::verify_9 (call $test/fixtures/execution/structValuesExtended.lys::Red.is (call $test/fixtures/execution/structValuesExtended.lys::CatBag.property_g (local.get $test/fixtures/execution/structValuesExtended.lys::a_7))) (i64.const 0x0000000000000072))
      (call $support::test::verify_9 (call $test/fixtures/execution/structValuesExtended.lys::Color.is (call $test/fixtures/execution/structValuesExtended.lys::CatBag.property_f (local.get $test/fixtures/execution/structValuesExtended.lys::a_7))) (i64.const 0x0000000000000079))
      (call $support::test::verify_9 (call $test/fixtures/execution/structValuesExtended.lys::Color.is (call $test/fixtures/execution/structValuesExtended.lys::CatBag.property_g (local.get $test/fixtures/execution/structValuesExtended.lys::a_7))) (i64.const 0x0000000000000080))
      ...
      (call $test/fixtures/execution/structValuesExtended.lys::CatBag.property_c_1 (local.get $test/fixtures/execution/structValuesExtended.lys::a_7) (call $system::core::f32.-_1 (f32.const 999)))
      (call $test/fixtures/execution/structValuesExtended.lys::CatBag.property_d_1 (local.get $test/fixtures/execution/structValuesExtended.lys::a_7) (call $system::core::i32.as (i32.const 0xdeadbeef)))
      ...
      (call $support::test::printNumber (call $test/fixtures/execution/structValuesExtended.lys::CatBag.property_c (local.get $test/fixtures/execution/structValuesExtended.lys::a_7)))
      ...
      (call $support::test::printNumber_3 (i32.const 0))
      (call $support::test::printNumber_3 (call $test/fixtures/execution/structValuesExtended.lys::CatBag.property_a (local.get $test/fixtures/execution/structValuesExtended.lys::a_7)))
      (call $support::test::verify_9 (call $system::core::i32.== (call $test/fixtures/execution/structValuesExtended.lys::CatBag.property_a (local.get $test/fixtures/execution/structValuesExtended.lys::a_7)) (i32.const 5)) (i64.const 0x0000000000000087))
      (call $support::test::printNumber_3 (if $IF2 (result i32) (call $test/fixtures/execution/structValuesExtended.lys::CatBag.property_b (local.get $test/fixtures/execution/structValuesExtended.lys::a_7))
                (then
                  (i32.const 1)
                )
                (else
      ...
      (call $support::test::verify_9 (call $system::core::boolean.== (call $test/fixtures/execution/structValuesExtended.lys::CatBag.property_b (local.get $test/fixtures/execution/structValuesExtended.lys::a_7)) (i32.const 0)) (i64.const 0x000000000000008e))
      (call $support::test::printNumber (call $test/fixtures/execution/structValuesExtended.lys::CatBag.property_c (local.get $test/fixtures/execution/structValuesExtended.lys::a_7)))
      (call $support::test::verify_9 (call $system::core::f32.== (call $test/fixtures/execution/structValuesExtended.lys::CatBag.property_c (local.get $test/fixtures/execution/structValuesExtended.lys::a_7)) (call $system::core::f32.-_1 (f32.const 999))) (i64.const 0x0000000000000095))
      (call $support::test::verify_9 (call $system::core::i64.== (call $test/fixtures/execution/structValuesExtended.lys::CatBag.property_d (local.get $test/fixtures/execution/structValuesExtended.lys::a_7)) (call $system::core::i32.as (i32.const 0xdeadbeef))) (i64.const 0x000000000000009c))
      (call $support::test::verify_9 (call $system::core::f64.== (call $test/fixtures/execution/structValuesExtended.lys::CatBag.property_e (local.get $test/fixtures/execution/structValuesExtended.lys::a_7)) (call $system::core::f32.as (f32.const 6.08e+23))) (i64.const 0x00000000000000a3))
      (call $support::test::verify_9 (call $test/fixtures/execution/structValuesExtended.lys::Custom.is (call $test/fixtures/execution/structValuesExtended.lys::CatBag.property_f (local.get $test/fixtures/execution/structValuesExtended.lys::a_7))) (i64.const 0x00000000000000aa))
      (call $support::test::verify_9 (call $test/fixtures/execution/structValuesExtended.lys::None.is (call $test/fixtures/execution/structValuesExtended.lys::CatBag.property_g (local.get $test/fixtures/execution/structValuesExtended.lys::a_7))) (i64.const 0x00000000000000b1))
      (call $support::test::verify_9 (call $test/fixtures/execution/structValuesExtended.lys::Color.is (call $test/fixtures/execution/structValuesExtended.lys::CatBag.property_f (local.get $test/fixtures/execution/structValuesExtended.lys::a_7))) (i64.const 0x00000000000000b8))
      (call $support::test::verify_9 (call $test/fixtures/execution/structValuesExtended.lys::Color.is (call $test/fixtures/execution/structValuesExtended.lys::CatBag.property_g (local.get $test/fixtures/execution/structValuesExtended.lys::a_7))) (i64.const 0x00000000000000bf))
      (call $support::test::verify_9 (call $test/fixtures/execution/structValuesExtended.lys::Custom.is (call $test/fixtures/execution/structValuesExtended.lys::CatBag.property_f (local.get $test/fixtures/execution/structValuesExtended.lys::a_7))) (i64.const 0x00000000000000c6))
      (block $B3
          ...
          (block $B3_0
              ...
              (call $support::test::verify_9 (i32.const 0) (i64.const 0x00000000000000d4))
              (br $B3)
            )
          (call $support::test::verify_9 (call $system::core::i32.== (call $test/fixtures/execution/structValuesExtended.lys::Custom.property_hex (local.get $var$1)) (i32.const 333)) (i64.const 0x00000000000000cd))
          (br $B3)
        )
