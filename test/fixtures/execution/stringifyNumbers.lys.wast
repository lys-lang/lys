(module
  ...
  (data 0 (i32.const 807) "\16\00\00\00 \00 \00g\00i\00v\00e\00n\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 834) "\1c\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 867) "\16\00\00\00 \00 \00g\00i\00v\00e\00n\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 894) "\1c\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 927) "\16\00\00\00 \00 \00g\00i\00v\00e\00n\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 954) "\1c\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 987) "\16\00\00\00 \00 \00g\00i\00v\00e\00n\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 1014) "\1c\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 1047) "\16\00\00\00 \00 \00g\00i\00v\00e\00n\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 1074) "\1c\00\00\00 \00 \00e\00x\00p\00e\00c\00t\00e\00d\00:\00 \00%\00d\00\00")
  (data 0 (i32.const 1107) "\1a\00\00\00a\00s\00s\00e\00r\00t\00(\00f\00a\00l\00s\00e\00)\00\00")
  ...
  (func $support::test::mustEqual (param $given f64) (param $expected f64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::f64.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_13 (i64.const 0x00000000000002af) (local.get $given))
                (call $support::env::printf_13 (i64.const 0x00000000000002ca) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_1 (param $given f32) (param $expected f32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::f32.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_11 (i64.const 0x00000000000002eb) (local.get $given))
                (call $support::env::printf_11 (i64.const 0x0000000000000306) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_4 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u32.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_9 (i64.const 0x0000000000000327) (local.get $given))
                (call $support::env::printf_9 (i64.const 0x0000000000000342) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_5 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i32.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_7 (i64.const 0x0000000000000363) (local.get $given))
                (call $support::env::printf_7 (i64.const 0x000000000000037e) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_6 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u16.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_17 (i64.const 0x000000000000039f) (local.get $given))
                (call $support::env::printf_17 (i64.const 0x00000000000003ba) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_7 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i16.!=_1 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_15 (i64.const 0x00000000000003db) (local.get $given))
                (call $support::env::printf_15 (i64.const 0x00000000000003f6) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_8 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u8.!=_2 (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_19 (i64.const 0x0000000000000417) (local.get $given))
                (call $support::env::printf_19 (i64.const 0x0000000000000432) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $support::test::assert (param $condition i32)
    (call $support::test::assert_2 (local.get $condition) (i64.const 0x0000000000000453))
  )
  ...
  (func $test/fixtures/execution/stringifyNumbers.lys::assertNumberLength (param $numberToSerialize i64) (param $expected i32)
    ...
    (block $B1
      ...
      (if $IF2 (call $system::core::boolean.! (local.get $test/fixtures/execution/stringifyNumbers.lys::result))
          (then
            (block $B3
                (call $support::env::printf_7 (i64.const 0x0000000000000010) (call $system::core::i64.as_4 (local.get $numberToSerialize)))
                (call $support::env::printf_7 (i64.const 0x0000000000000031) (call $system::core::u32.as_4 (local.get $test/fixtures/execution/stringifyNumbers.lys::size)))
                (call $support::env::printf_7 (i64.const 0x0000000000000052) (local.get $expected))
              )
          )
          (else)
        )
      (call $support::test::verify_12 (local.get $test/fixtures/execution/stringifyNumbers.lys::result) (i64.const 0x0000000000000073))
    )
  )
  (func $test/fixtures/execution/stringifyNumbers.lys::assertEquals_2 (param $given i64) (param $expected i64)
    ...
    (block $B1
      ...
      (if $IF2 (call $system::core::boolean.! (local.get $test/fixtures/execution/stringifyNumbers.lys::result_3))
          (then
            (block $B3
                (call $support::env::printf_21 (i64.const 0x00000000000000d7))
                (call $support::env::printf_21 (local.get $given))
                (call $support::env::printf_21 (i64.const 0x00000000000000e8))
                (call $support::env::printf_21 (local.get $expected))
              )
          )
          (else)
        )
      (call $support::test::verify_12 (local.get $test/fixtures/execution/stringifyNumbers.lys::result_3) (local.get $test/fixtures/execution/stringifyNumbers.lys::msg))
    )
  )
