(module
  ...
  (data 0 (i32.const 718) "4\00\00\00t\00r\00y\00i\00n\00g\00 \00t\00o\00 \00a\00l\00l\00o\00c\00a\00t\00e\00 \000\00 \00b\00y\00t\00e\00s\00\00")
      ...
      (if $IF2 (result i32) (call $system::core::i32.> (get_local $size) (i32.const 0))
          ...
          (else
            (block $B12 (result i32)
                (call $support::env::printf_8 (i64.const 0x00000000000002ce))
  ...
  (data 0 (i32.const 687) "\1a\00\00\00a\00s\00s\00e\00r\00t\00(\00f\00a\00l\00s\00e\00)\00\00")
  ...
  (func $support::test::assert_11 (param $condition i32)
    (call $support::test::assert_13 (get_local $condition) (i64.const 0x00000000000002af))
  )
  ...
  (func $test/fixtures/execution/stringifyNumbers.lys::assertNumber (param $numberToSerialize i64) (param $expected i64)
    (call $test/fixtures/execution/stringifyNumbers.lys::assertEquals_2 (call $system::string::String.stringify_7 (get_local $numberToSerialize)) (get_local $expected))
  )
  (func $test/fixtures/execution/stringifyNumbers.lys::assertNumber_1 (param $numberToSerialize i64) (param $expected i64)
    (call $test/fixtures/execution/stringifyNumbers.lys::assertEquals_2 (call $system::string::String.stringify_6 (get_local $numberToSerialize)) (get_local $expected))
  )
  (func $test/fixtures/execution/stringifyNumbers.lys::assertNumber_2 (param $numberToSerialize i32) (param $expected i64)
    (call $test/fixtures/execution/stringifyNumbers.lys::assertNumber_1 (call $system::core::i32.as (get_local $numberToSerialize)) (get_local $expected))
  )
  (func $test/fixtures/execution/stringifyNumbers.lys::assertNumber_4 (param $numberToSerialize i32) (param $expected i64)
    (call $test/fixtures/execution/stringifyNumbers.lys::assertNumber (call $system::core::u32.as_1 (get_local $numberToSerialize)) (get_local $expected))
  )
  (func $test/fixtures/execution/stringifyNumbers.lys::assertNumberLength (param $numberToSerialize i64) (param $expected i32)
    (local $size i32)
    (local $result i32)
    (block $B1
      (set_local $size (call $system::string::String.charLength (get_local $numberToSerialize)))
      (set_local $result (call $system::core::i32.== (call $system::core::u32.as_4 (get_local $size)) (get_local $expected)))
      (if $IF2 (call $system::core::boolean.! (get_local $result))
          (then
            (block $B3
                (call $support::env::printf_4 (i64.const 0x0000000000000010) (call $system::core::i64.as_4 (get_local $numberToSerialize)))
                (call $support::env::printf_4 (i64.const 0x0000000000000031) (call $system::core::u32.as_4 (get_local $size)))
                (call $support::env::printf_4 (i64.const 0x0000000000000052) (get_local $expected))
              )
          )
          (else)
        )
      (call $support::test::verify_1 (get_local $result) (i64.const 0x0000000000000073))
    )
  )
  (func $test/fixtures/execution/stringifyNumbers.lys::assertEquals_2 (param $given i64) (param $expected i64)
    ...
    (local $result i32)
    (block $B1
      (set_local $msg (call $system::string::concatBytes_1 (call $system::string::concatBytes_1 (call $system::string::concatBytes_1 (call $system::string::concatBytes_1 (i64.const 0x000000000000009c) (get_local $given)) (i64.const 0x00000000000000b1)) (get_local $expected)) (i64.const 0x00000000000000d0)))
      (set_local $result (call $system::core::bytes.== (get_local $given) (get_local $expected)))
      (if $IF2 (call $system::core::boolean.! (get_local $result))
          (then
            (block $B3
                (call $support::env::printf_8 (i64.const 0x00000000000000d7))
                (call $support::env::printf_8 (get_local $given))
                (call $support::env::printf_8 (i64.const 0x00000000000000e8))
                (call $support::env::printf_8 (get_local $expected))
              )
          )
          (else)
        )
      (call $support::test::verify_1 (get_local $result) (get_local $msg))
    )
  )
  (func $test/fixtures/execution/stringifyNumbers.lys::main
    (block $B1
      ...
      (block $B3
          ...
          (call $test/fixtures/execution/stringifyNumbers.lys::assertNumberLength (call $system::core::i32.as (i32.const -2)) (i32.const 2))
          (call $test/fixtures/execution/stringifyNumbers.lys::assertNumberLength (call $system::core::i32.as (i32.const -33)) (i32.const 3))
          (call $test/fixtures/execution/stringifyNumbers.lys::assertNumberLength (call $system::core::i32.as (i32.const -1)) (i32.const 2))
          ...
          (call $test/fixtures/execution/stringifyNumbers.lys::assertNumberLength (call $system::core::i32.as (i32.const -444444)) (i32.const 7))
          ...
          (call $test/fixtures/execution/stringifyNumbers.lys::assertNumberLength (call $system::core::f32.as_1 (f32.const -4000)) (i32.const 5))
          (call $support::test::END)
        )
      (block $B4
          ...
          (call $test/fixtures/execution/stringifyNumbers.lys::assertNumber_2 (i32.const -1) (i64.const 0x00000000000001f0))
          ...
          (call $test/fixtures/execution/stringifyNumbers.lys::assertNumber_2 (i32.const -444444) (i64.const 0x000000000000021f))
