(module
 ...
 (func $8 (param $0 i32) (param $1 i64)
  (call $fimport$1
   (local.get $0)
   (i32.wrap_i64
    (local.get $1)
 ...
 (func $10 (param $0 i64) (param $1 i64) (result i64)
  (call $12
   (local.get $0)
   (local.get $1)
  )
 )
 (func $11 (param $0 i64) (param $1 i32) (result i32)
  (if
   (i32.gt_u
    (local.get $1)
    (i32.shr_u
 ...
 (func $12 (param $0 i64) (param $1 i64) (result i64)
  (local $2 i32)
  (local $3 i32)
  (local $4 i64)
  (drop
 ...
 (func $13 (param $0 i64) (param $1 i64) (result i32)
  (local $2 i32)
  (local $3 i32)
  (if (result i32)
   (i32.eq
 ...
 (func $14 (param $0 i64) (result i32)
  (local $1 i32)
  (if (result i32)
   (i64.eqz
    (local.get $0)
 ...
 (func $15 (param $0 i64) (result i32)
  (local $1 i32)
  (if (result i32)
   (i64.eqz
    (local.get $0)
 ...
 (func $16 (param $0 i64) (param $1 i64) (param $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i64)
  (local $6 i64)
 ...
 (func $17 (param $0 i64) (result i64)
  (local $1 i32)
  (local $2 i64)
  (if (result i64)
   (i64.eqz
 ...
 (func $18 (param $0 i64) (result i64)
  (local $1 i32)
  (local $2 i64)
  (if (result i64)
   (i64.eqz
 ...
 (func $19 (param $0 i64) (param $1 i64)
  (call $23
   (call $18
    (local.get $0)
   )
 ...
 (func $20 (param $0 i32) (param $1 i64)
  (call $23
   (call $17
    (i64.extend_i32_s
     (local.get $0)
 ...
 (func $21 (param $0 i32) (param $1 i64)
  (call $19
   (i64.extend_i32_u
    (local.get $0)
   )
 ...
 (func $22 (param $0 i64) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (if
   (select
 ...
 (func $23 (param $0 i64) (param $1 i64)
  (local $2 i32)
  (local $3 i64)
  (local.set $3
   (call $10
