(module
 ...
 (func $2 (; 3 ;) (type $4) (result i32)
  (global.get $global$7)
 )
 (func $3 (; 4 ;) (type $6) (param $0 i32) (result i32)
  (local $1 i32)
  (call $5
   (local.tee $1
    (call $4
 ...
 (func $4 (; 5 ;) (type $6) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
 ...
 (func $5 (; 6 ;) (type $2) (param $0 i32) (param $1 i32)
  (local.set $1
   (i32.add
    (local.get $0)
    (local.get $1)
