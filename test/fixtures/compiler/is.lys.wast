(module
  ...
  (func $test/fixtures/compiler/is.lys::Enum.is (param $a i64) (result i32)
    (block $B1 (result i32)
      (call $system::core::boolean.|| (call $system::core::boolean.|| (call $test/fixtures/compiler/is.lys::A.is (local.get $a)) (call $test/fixtures/compiler/is.lys::B.is (local.get $a))) (call $test/fixtures/compiler/is.lys::C.is (local.get $a)))
    )
  )
  ...
  (func $test/fixtures/compiler/is.lys::A.as (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  ...
  (func $test/fixtures/compiler/is.lys::A.A$discriminant (result i64)
    ...
    (block $B1 (result i64)
      ...
      (call $system::core::i64.<< (call $system::core::u32.as (local.get $test/fixtures/compiler/is.lys::discriminant)) (i32.const 32))
    )
  )
  ...
  (func $test/fixtures/compiler/is.lys::A.is (param $a i64) (result i32)
    (i64.eq (i64.and (i64.const 0xffffffff00000000) (local.get $a)) (call $test/fixtures/compiler/is.lys::A.A$discriminant))
  )
  ...
  (func $test/fixtures/compiler/is.lys::B.as (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  ...
  (func $test/fixtures/compiler/is.lys::B.B$discriminant (result i64)
    ...
    (block $B1 (result i64)
      ...
      (call $system::core::i64.<< (call $system::core::u32.as (local.get $test/fixtures/compiler/is.lys::discriminant_3)) (i32.const 32))
    )
  )
  ...
  (func $test/fixtures/compiler/is.lys::B.is (param $a i64) (result i32)
    (i64.eq (i64.and (i64.const 0xffffffff00000000) (local.get $a)) (call $test/fixtures/compiler/is.lys::B.B$discriminant))
  )
  ...
  (func $test/fixtures/compiler/is.lys::C.as (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  ...
  (func $test/fixtures/compiler/is.lys::C.C$discriminant (result i64)
    ...
    (block $B1 (result i64)
      ...
      (call $system::core::i64.<< (call $system::core::u32.as (local.get $test/fixtures/compiler/is.lys::discriminant_6)) (i32.const 32))
    )
  )
  ...
  (func $test/fixtures/compiler/is.lys::C.is (param $a i64) (result i32)
    (i64.eq (i64.and (i64.const 0xffffffff00000000) (local.get $a)) (call $test/fixtures/compiler/is.lys::C.C$discriminant))
  )
  ...
  (func $test/fixtures/compiler/is.lys::test
    ...
    (block $B1
      (local.set $test/fixtures/compiler/is.lys::x1 (call $test/fixtures/compiler/is.lys::A.is (global.get $test/fixtures/compiler/is.lys::value1)))
      (local.set $test/fixtures/compiler/is.lys::y1 (call $test/fixtures/compiler/is.lys::Enum.is (global.get $test/fixtures/compiler/is.lys::value1)))
      (local.set $test/fixtures/compiler/is.lys::z1 (call $test/fixtures/compiler/is.lys::B.is (global.get $test/fixtures/compiler/is.lys::value1)))
      (local.set $test/fixtures/compiler/is.lys::x2 (call $test/fixtures/compiler/is.lys::A.is (global.get $test/fixtures/compiler/is.lys::value2)))
      (local.set $test/fixtures/compiler/is.lys::y2 (call $test/fixtures/compiler/is.lys::Enum.is (global.get $test/fixtures/compiler/is.lys::value2)))
      (local.set $test/fixtures/compiler/is.lys::z2 (call $test/fixtures/compiler/is.lys::B.is (global.get $test/fixtures/compiler/is.lys::value2)))
      (local.set $test/fixtures/compiler/is.lys::x3 (call $test/fixtures/compiler/is.lys::A.is (global.get $test/fixtures/compiler/is.lys::value3)))
      (local.set $test/fixtures/compiler/is.lys::y3 (call $test/fixtures/compiler/is.lys::Enum.is (global.get $test/fixtures/compiler/is.lys::value3)))
      (local.set $test/fixtures/compiler/is.lys::z3 (call $test/fixtures/compiler/is.lys::B.is (call $test/fixtures/compiler/is.lys::identity (global.get $test/fixtures/compiler/is.lys::value3))))
    )
  )
  (func $%%START%%
    (global.set $test/fixtures/compiler/is.lys::value1 (call $test/fixtures/compiler/is.lys::A.apply))
    (global.set $test/fixtures/compiler/is.lys::value2 (call $test/fixtures/compiler/is.lys::A.apply))
    (global.set $test/fixtures/compiler/is.lys::value3 (call $test/fixtures/compiler/is.lys::A.apply))
  )
  (start $%%START%%)
)
