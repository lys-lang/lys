(module
  ...
  (func $test/fixtures/compiler/is.lys::test
    ...
    (local $z3 i32)
    (block $B1
      (local.set $x1 (call $test/fixtures/compiler/is.lys::A.is (global.get $test/fixtures/compiler/is.lys::value1_4)))
      (local.set $y1 (call $test/fixtures/compiler/is.lys::Enum.is (global.get $test/fixtures/compiler/is.lys::value1_4)))
      (local.set $z1 (call $test/fixtures/compiler/is.lys::B.is (global.get $test/fixtures/compiler/is.lys::value1_4)))
      (local.set $x2 (call $test/fixtures/compiler/is.lys::A.is (global.get $test/fixtures/compiler/is.lys::value2_4)))
      (local.set $y2 (call $test/fixtures/compiler/is.lys::Enum.is (global.get $test/fixtures/compiler/is.lys::value2_4)))
      (local.set $z2 (call $test/fixtures/compiler/is.lys::B.is (global.get $test/fixtures/compiler/is.lys::value2_4)))
      (local.set $x3 (call $test/fixtures/compiler/is.lys::A.is (global.get $test/fixtures/compiler/is.lys::value3_4)))
      (local.set $y3 (call $test/fixtures/compiler/is.lys::Enum.is (global.get $test/fixtures/compiler/is.lys::value3_4)))
      (local.set $z3 (call $test/fixtures/compiler/is.lys::B.is (call $test/fixtures/compiler/is.lys::identity (global.get $test/fixtures/compiler/is.lys::value3_4))))
    )
  )
  (func $%%START%%
    (global.set $test/fixtures/compiler/is.lys::value1_4 (call $test/fixtures/compiler/is.lys::A.apply))
    (global.set $test/fixtures/compiler/is.lys::value2_4 (call $test/fixtures/compiler/is.lys::A.apply))
    (global.set $test/fixtures/compiler/is.lys::value3_4 (call $test/fixtures/compiler/is.lys::A.apply))
  )
  (start $%%START%%)
)
