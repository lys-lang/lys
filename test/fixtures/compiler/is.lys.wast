(module
  ...
  (func $test::fixtures::compiler::is::Enum.is_1 (param $a i64) (result i32)
    (block $B1 (result i32)
      (call $system::core::boolean::boolean.||_1 (call $system::core::boolean::boolean.||_1 (call $test::fixtures::compiler::is::A.is_1 (local.get $a)) (call $test::fixtures::compiler::is::B.is_1 (local.get $a))) (call $test::fixtures::compiler::is::C.is_1 (local.get $a)))
    )
  )
  ...
  (func $test::fixtures::compiler::is::A.A$discriminant_1 (result i64)
    ...
    (block $B1 (result i64)
      (local.set $test::fixtures::compiler::is::discriminant (i32.const 1))
      (call $system::core::i64::i64.<<_1 (call $system::core::u32::u32.as_1 (local.get $test::fixtures::compiler::is::discriminant)) (i32.const 32))
    )
  )
  ...
  (func $test::fixtures::compiler::is::B.B$discriminant_1 (result i64)
    ...
    (block $B1 (result i64)
      (local.set $test::fixtures::compiler::is::discriminant_1 (i32.const 2))
      (call $system::core::i64::i64.<<_1 (call $system::core::u32::u32.as_1 (local.get $test::fixtures::compiler::is::discriminant_1)) (i32.const 32))
    )
  )
  ...
  (func $test::fixtures::compiler::is::C.C$discriminant_1 (result i64)
    ...
    (block $B1 (result i64)
      (local.set $test::fixtures::compiler::is::discriminant_2 (i32.const 3))
      (call $system::core::i64::i64.<<_1 (call $system::core::u32::u32.as_1 (local.get $test::fixtures::compiler::is::discriminant_2)) (i32.const 32))
    )
  )
