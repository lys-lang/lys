(module
  ...
  (global $test/fixtures/compiler/is.lys::value1_4 (mut i64) (i64.const 0))
  (global $test/fixtures/compiler/is.lys::value2_4 (mut i64) (i64.const 0))
  (global $test/fixtures/compiler/is.lys::value3_4 (mut i64) (i64.const 0))
  (export "identity" (func $test/fixtures/compiler/is.lys::identity))
  (export "test" (func $test/fixtures/compiler/is.lys::test))
  (func $test/fixtures/compiler/is.lys::Enum.is (param $a i64) (result i32)
    (block $B1 (result i32)
      (call $system::core::boolean.|| (call $system::core::boolean.|| (call $test/fixtures/compiler/is.lys::A.is (get_local $a)) (call $test/fixtures/compiler/is.lys::B.is (get_local $a))) (call $test/fixtures/compiler/is.lys::C.is (get_local $a)))
    )
  )
  (func $test/fixtures/compiler/is.lys::Enum.== (param $lhs i64) (param $rhs i64) (result i32)
    (call $system::core::ref.== (get_local $lhs) (get_local $rhs))
  )
  (func $test/fixtures/compiler/is.lys::Enum.!= (param $lhs i64) (param $rhs i64) (result i32)
    (call $system::core::ref.!= (get_local $lhs) (get_local $rhs))
  )
  (func $test/fixtures/compiler/is.lys::Enum.store (param $lhs i64) (param $rhs i64) (param $offset i32)
    (i64.store (i32.add (get_local $offset) (call $system::core::addressFromRef (get_local $lhs))) (get_local $rhs))
  )
  (func $test/fixtures/compiler/is.lys::Enum.load (param $lhs i64) (param $offset i32) (result i64)
    (i64.load (i32.add (get_local $offset) (call $system::core::addressFromRef (get_local $lhs))))
  )
  (func $test/fixtures/compiler/is.lys::Enum.as (param $a i64) (result i64)
    (get_local $a)
  )
  (func $test/fixtures/compiler/is.lys::A.as (param $a i64) (result i64)
    (get_local $a)
  )
  (func $test/fixtures/compiler/is.lys::B.as (param $a i64) (result i64)
    (get_local $a)
  )
  (func $test/fixtures/compiler/is.lys::C.as (param $a i64) (result i64)
    (get_local $a)
  )
  (func $test/fixtures/compiler/is.lys::A.A$discriminant (result i64)
  ...
  (func $test/fixtures/compiler/is.lys::A.apply (result i64)
    (call $test/fixtures/compiler/is.lys::A.A$discriminant)
  )
  (func $test/fixtures/compiler/is.lys::A.is (param $a i64) (result i32)
    (i64.eq (i64.and (i64.const 0xffffffff00000000) (get_local $a)) (call $test/fixtures/compiler/is.lys::A.A$discriminant))
  )
  (func $test/fixtures/compiler/is.lys::A.== (param $a i64) (param $b i64) (result i32)
    (i64.eq (get_local $a) (get_local $b))
  )
  (func $test/fixtures/compiler/is.lys::A.!= (param $a i64) (param $b i64) (result i32)
    (i64.ne (get_local $a) (get_local $b))
  )
  (func $test/fixtures/compiler/is.lys::A.store (param $lhs i64) (param $rhs i64) (param $offset i32)
    (i64.store (i32.add (get_local $offset) (call $system::core::addressFromRef (get_local $lhs))) (get_local $rhs))
  )
  (func $test/fixtures/compiler/is.lys::A.load (param $lhs i64) (param $offset i32) (result i64)
    (i64.load (i32.add (get_local $offset) (call $system::core::addressFromRef (get_local $lhs))))
  )
  (func $test/fixtures/compiler/is.lys::B.B$discriminant (result i64)
    (local $discriminant i32)
    (block $B1 (result i64)
  ...
  (func $test/fixtures/compiler/is.lys::B.apply (result i64)
    (call $test/fixtures/compiler/is.lys::B.B$discriminant)
  )
  (func $test/fixtures/compiler/is.lys::B.is (param $a i64) (result i32)
    (i64.eq (i64.and (i64.const 0xffffffff00000000) (get_local $a)) (call $test/fixtures/compiler/is.lys::B.B$discriminant))
  )
  (func $test/fixtures/compiler/is.lys::B.== (param $a i64) (param $b i64) (result i32)
    (i64.eq (get_local $a) (get_local $b))
  )
  (func $test/fixtures/compiler/is.lys::B.!= (param $a i64) (param $b i64) (result i32)
    (i64.ne (get_local $a) (get_local $b))
  )
  (func $test/fixtures/compiler/is.lys::B.store (param $lhs i64) (param $rhs i64) (param $offset i32)
    (i64.store (i32.add (get_local $offset) (call $system::core::addressFromRef (get_local $lhs))) (get_local $rhs))
  )
  (func $test/fixtures/compiler/is.lys::B.load (param $lhs i64) (param $offset i32) (result i64)
    (i64.load (i32.add (get_local $offset) (call $system::core::addressFromRef (get_local $lhs))))
  )
  (func $test/fixtures/compiler/is.lys::C.C$discriminant (result i64)
    (local $discriminant i32)
    (block $B1 (result i64)
  ...
  (func $test/fixtures/compiler/is.lys::C.apply (result i64)
    (call $test/fixtures/compiler/is.lys::C.C$discriminant)
  )
  (func $test/fixtures/compiler/is.lys::C.is (param $a i64) (result i32)
    (i64.eq (i64.and (i64.const 0xffffffff00000000) (get_local $a)) (call $test/fixtures/compiler/is.lys::C.C$discriminant))
  )
  (func $test/fixtures/compiler/is.lys::C.== (param $a i64) (param $b i64) (result i32)
    (i64.eq (get_local $a) (get_local $b))
  )
  (func $test/fixtures/compiler/is.lys::C.!= (param $a i64) (param $b i64) (result i32)
    (i64.ne (get_local $a) (get_local $b))
  )
  (func $test/fixtures/compiler/is.lys::C.store (param $lhs i64) (param $rhs i64) (param $offset i32)
    (i64.store (i32.add (get_local $offset) (call $system::core::addressFromRef (get_local $lhs))) (get_local $rhs))
  )
  (func $test/fixtures/compiler/is.lys::C.load (param $lhs i64) (param $offset i32) (result i64)
    (i64.load (i32.add (get_local $offset) (call $system::core::addressFromRef (get_local $lhs))))
  )
  (func $test/fixtures/compiler/is.lys::identity (param $a i64) (result i64)
    (get_local $a)
  )
  (func $test/fixtures/compiler/is.lys::test
    (local $x1 i32)
    (local $y1 i32)
    (local $z1 i32)
    (local $x2 i32)
    ...
    (local $z3 i32)
    (block $B1
      (set_local $x1 (call $test/fixtures/compiler/is.lys::A.is (get_global $test/fixtures/compiler/is.lys::value1_4)))
      (set_local $y1 (call $test/fixtures/compiler/is.lys::Enum.is (get_global $test/fixtures/compiler/is.lys::value1_4)))
      (set_local $z1 (call $test/fixtures/compiler/is.lys::B.is (get_global $test/fixtures/compiler/is.lys::value1_4)))
      (set_local $x2 (call $test/fixtures/compiler/is.lys::A.is (get_global $test/fixtures/compiler/is.lys::value2_4)))
      (set_local $y2 (call $test/fixtures/compiler/is.lys::Enum.is (get_global $test/fixtures/compiler/is.lys::value2_4)))
      (set_local $z2 (call $test/fixtures/compiler/is.lys::B.is (get_global $test/fixtures/compiler/is.lys::value2_4)))
      (set_local $x3 (call $test/fixtures/compiler/is.lys::A.is (get_global $test/fixtures/compiler/is.lys::value3_4)))
      (set_local $y3 (call $test/fixtures/compiler/is.lys::Enum.is (get_global $test/fixtures/compiler/is.lys::value3_4)))
      (set_local $z3 (call $test/fixtures/compiler/is.lys::B.is (call $test/fixtures/compiler/is.lys::identity (get_global $test/fixtures/compiler/is.lys::value3_4))))
    )
  )
  (func $%%START%%
    (set_global $test/fixtures/compiler/is.lys::value1_4 (call $test/fixtures/compiler/is.lys::A.apply))
    (set_global $test/fixtures/compiler/is.lys::value2_4 (call $test/fixtures/compiler/is.lys::A.apply))
    (set_global $test/fixtures/compiler/is.lys::value3_4 (call $test/fixtures/compiler/is.lys::A.apply))
  )
  (start $%%START%%)
)
