(module
  ...
  (func $test::fixtures::compiler::is::Enum.is_1 (param $self i64) (result i32)
    (block $B1 (result i32)
      (call $system::core::boolean::boolean.||_1 (call $system::core::boolean::boolean.||_1 (call $test::fixtures::compiler::is::A.is_1 (local.get $self)) (call $test::fixtures::compiler::is::B.is_1 (local.get $self))) (call $test::fixtures::compiler::is::C.is_1 (local.get $self)))
    )
  )
  (func $test::fixtures::compiler::is::Enum.as_1 (param $self i64) (result i64)
    (local.get $self)
  )
  ...
  (func $test::fixtures::compiler::is::A.is_1 (param $a i64) (result i32)
    ...
    (block $B1 (result i32)
      ...
      (call $system::core::u32::u32.==_1 (call $system::core::native::ref.getDiscriminant_1 (local.get $a)) (local.get $test::fixtures::compiler::is::discriminant))
    )
  )
  (func $test::fixtures::compiler::is::A.as_3 (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  (func $test::fixtures::compiler::is::A.A$discriminant_1 (result i64)
    (local $test::fixtures::compiler::is::discriminant_1 i32)
    (block $B1 (result i64)
      (local.set $test::fixtures::compiler::is::discriminant_1 (i32.const 1))
  ...
  (func $test::fixtures::compiler::is::B.is_1 (param $a i64) (result i32)
    ...
    (block $B1 (result i32)
      (local.set $test::fixtures::compiler::is::discriminant_2 (i32.const 2))
      (call $system::core::u32::u32.==_1 (call $system::core::native::ref.getDiscriminant_1 (local.get $a)) (local.get $test::fixtures::compiler::is::discriminant_2))
    )
  )
  (func $test::fixtures::compiler::is::B.as_3 (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  (func $test::fixtures::compiler::is::B.B$discriminant_1 (result i64)
    (local $test::fixtures::compiler::is::discriminant_3 i32)
    (block $B1 (result i64)
      (local.set $test::fixtures::compiler::is::discriminant_3 (i32.const 2))
      (call $system::core::i64::i64.<<_1 (call $system::core::u32::u32.as_1 (local.get $test::fixtures::compiler::is::discriminant_3)) (i32.const 32))
    )
  )
  ...
  (func $test::fixtures::compiler::is::C.is_1 (param $a i64) (result i32)
    (local $test::fixtures::compiler::is::discriminant_4 i32)
    (block $B1 (result i32)
      (local.set $test::fixtures::compiler::is::discriminant_4 (i32.const 3))
      (call $system::core::u32::u32.==_1 (call $system::core::native::ref.getDiscriminant_1 (local.get $a)) (local.get $test::fixtures::compiler::is::discriminant_4))
    )
  )
  (func $test::fixtures::compiler::is::C.as_3 (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  (func $test::fixtures::compiler::is::C.C$discriminant_1 (result i64)
    (local $test::fixtures::compiler::is::discriminant_5 i32)
    (block $B1 (result i64)
      (local.set $test::fixtures::compiler::is::discriminant_5 (i32.const 3))
      (call $system::core::i64::i64.<<_1 (call $system::core::u32::u32.as_1 (local.get $test::fixtures::compiler::is::discriminant_5)) (i32.const 32))
    )
  )
