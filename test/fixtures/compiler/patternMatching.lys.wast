(module
  ...
  (export "test" (func $test/fixtures/compiler/patternMatching.lys::test))
  (export "test2" (func $test/fixtures/compiler/patternMatching.lys::test2))
  (export "test3" (func $test/fixtures/compiler/patternMatching.lys::test3))
  (export "test4" (func $test/fixtures/compiler/patternMatching.lys::test4))
  (func $test/fixtures/compiler/patternMatching.lys::Maybe.is (param $a i64) (result i32)
    (block $B1 (result i32)
      (call $system::core::boolean.|| (call $test/fixtures/compiler/patternMatching.lys::None.is (get_local $a)) (call $test/fixtures/compiler/patternMatching.lys::Some.is (get_local $a)))
    )
  )
  (func $test/fixtures/compiler/patternMatching.lys::Maybe.== (param $lhs i64) (param $rhs i64) (result i32)
    (call $system::core::ref.== (get_local $lhs) (get_local $rhs))
  )
  (func $test/fixtures/compiler/patternMatching.lys::Maybe.!= (param $lhs i64) (param $rhs i64) (result i32)
    (call $system::core::ref.!= (get_local $lhs) (get_local $rhs))
  )
  (func $test/fixtures/compiler/patternMatching.lys::Maybe.store (param $lhs i64) (param $rhs i64) (param $offset i32)
    (i64.store (i32.add (get_local $offset) (call $system::core::addressFromRef (get_local $lhs))) (get_local $rhs))
  )
  (func $test/fixtures/compiler/patternMatching.lys::Maybe.load (param $lhs i64) (param $offset i32) (result i64)
    (i64.load (i32.add (get_local $offset) (call $system::core::addressFromRef (get_local $lhs))))
  )
  (func $test/fixtures/compiler/patternMatching.lys::Maybe.as (param $a i64) (result i64)
    (get_local $a)
  )
  (func $test/fixtures/compiler/patternMatching.lys::None.as (param $a i64) (result i64)
    (get_local $a)
  )
  (func $test/fixtures/compiler/patternMatching.lys::Some.as (param $a i64) (result i64)
    (get_local $a)
  )
  (func $test/fixtures/compiler/patternMatching.lys::None.None$discriminant (result i64)
  ...
  (func $test/fixtures/compiler/patternMatching.lys::None.apply (result i64)
    (call $test/fixtures/compiler/patternMatching.lys::None.None$discriminant)
  )
  (func $test/fixtures/compiler/patternMatching.lys::None.is (param $a i64) (result i32)
    (i64.eq (i64.and (i64.const 0xffffffff00000000) (get_local $a)) (call $test/fixtures/compiler/patternMatching.lys::None.None$discriminant))
  )
  (func $test/fixtures/compiler/patternMatching.lys::None.== (param $a i64) (param $b i64) (result i32)
    (i64.eq (get_local $a) (get_local $b))
  )
  (func $test/fixtures/compiler/patternMatching.lys::None.!= (param $a i64) (param $b i64) (result i32)
    (i64.ne (get_local $a) (get_local $b))
  )
  (func $test/fixtures/compiler/patternMatching.lys::None.store (param $lhs i64) (param $rhs i64) (param $offset i32)
    (i64.store (i32.add (get_local $offset) (call $system::core::addressFromRef (get_local $lhs))) (get_local $rhs))
  )
  (func $test/fixtures/compiler/patternMatching.lys::None.load (param $lhs i64) (param $offset i32) (result i64)
    (i64.load (i32.add (get_local $offset) (call $system::core::addressFromRef (get_local $lhs))))
  )
  (func $test/fixtures/compiler/patternMatching.lys::Some.Some$discriminant (result i64)
    (local $discriminant i32)
    (block $B1 (result i64)
  ...
  (func $test/fixtures/compiler/patternMatching.lys::Some.apply (param $value i32) (result i64)
    (local $$ref i64)
    (block $B1 (result i64)
      (set_local $$ref (call $test/fixtures/compiler/patternMatching.lys::Some.fromPointer (call $system::memory::calloc (i32.const 1) (i32.const 4))))
      (call $test/fixtures/compiler/patternMatching.lys::Some.property$0_1 (get_local $$ref) (get_local $value))
      (get_local $$ref)
    )
  )
  (func $test/fixtures/compiler/patternMatching.lys::Some.fromPointer (param $ptr i32) (result i64)
    (i64.or (call $test/fixtures/compiler/patternMatching.lys::Some.Some$discriminant) (i64.extend_u/i32 (get_local $ptr)))
  )
  (func $test/fixtures/compiler/patternMatching.lys::Some.== (param $a i64) (param $b i64) (result i32)
    (i64.eq (get_local $a) (get_local $b))
  )
  (func $test/fixtures/compiler/patternMatching.lys::Some.!= (param $a i64) (param $b i64) (result i32)
    (i64.ne (get_local $a) (get_local $b))
  )
  (func $test/fixtures/compiler/patternMatching.lys::Some.property_value (param $self i64) (result i32)
    (call $test/fixtures/compiler/patternMatching.lys::Some.property$0 (get_local $self))
  )
  (func $test/fixtures/compiler/patternMatching.lys::Some.property_value_1 (param $self i64) (param $value i32)
    (call $test/fixtures/compiler/patternMatching.lys::Some.property$0_1 (get_local $self) (get_local $value))
  )
  (func $test/fixtures/compiler/patternMatching.lys::Some.property$0 (param $self i64) (result i32)
    (call $system::core::i32.load_1 (get_local $self) (i32.const 0))
  )
  (func $test/fixtures/compiler/patternMatching.lys::Some.property$0_1 (param $self i64) (param $value i32)
    (call $system::core::i32.store_1 (get_local $self) (get_local $value) (i32.const 0))
  )
  (func $test/fixtures/compiler/patternMatching.lys::Some.is (param $a i64) (result i32)
    (i64.eq (i64.and (i64.const 0xffffffff00000000) (get_local $a)) (call $test/fixtures/compiler/patternMatching.lys::Some.Some$discriminant))
  )
  (func $test/fixtures/compiler/patternMatching.lys::Some.store (param $lhs i64) (param $rhs i64) (param $offset i32)
    (i64.store (i32.add (get_local $offset) (call $system::core::addressFromRef (get_local $lhs))) (get_local $rhs))
  )
  (func $test/fixtures/compiler/patternMatching.lys::Some.load (param $lhs i64) (param $offset i32) (result i64)
    (i64.load (i32.add (get_local $offset) (call $system::core::addressFromRef (get_local $lhs))))
  )
  (func $test/fixtures/compiler/patternMatching.lys::test (param $a i32) (result i32)
    (local $var$1 i32)
    (block $B1 (result i32)
  ...
  (func $test/fixtures/compiler/patternMatching.lys::test2 (param $a i32) (result i32)
    (local $var$1 i32)
    (block $B1 (result i32)
      (set_local $var$1 (get_local $a))
      (block $B1_0
  ...
  (func $test/fixtures/compiler/patternMatching.lys::test3 (param $a i64) (result i32)
    (local $var$1 i64)
    (block $B1 (result i32)
      (set_local $var$1 (get_local $a))
      (block $B1_0
          (block $B1_1
              (br_if $B1_0 (call $test/fixtures/compiler/patternMatching.lys::Some.is (get_local $var$1)))
              (br_if $B1_1 (call $test/fixtures/compiler/patternMatching.lys::None.is (get_local $var$1)))
            )
          (i32.const 0)
          (br $B1)
        )
  ...
  (func $test/fixtures/compiler/patternMatching.lys::test4 (param $a i64) (result i64)
    (local $var$1 i64)
    (block $B1 (result i64)
      (set_local $var$1 (get_local $a))
      (block $B1_0
          ...
          (call $test/fixtures/compiler/patternMatching.lys::Some.apply (i32.const 0))
          (br $B1)
        )
      (get_local $var$1)
      (br $B1)
