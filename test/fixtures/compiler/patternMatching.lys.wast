(module
  ...
  (func $test::fixtures::compiler::patternMatching::Maybe.is_1 (param $self i64) (result i32)
    (block $B1 (result i32)
      (call $system::core::boolean::boolean.||_1 (call $test::fixtures::compiler::patternMatching::None.is_1 (local.get $self)) (call $test::fixtures::compiler::patternMatching::Some.is_1 (local.get $self)))
    )
  )
  (func $test::fixtures::compiler::patternMatching::Maybe.as_1 (param $self i64) (result i64)
    (local.get $self)
  )
  ...
  (func $test::fixtures::compiler::patternMatching::None.is_1 (param $a i64) (result i32)
    ...
    (block $B1 (result i32)
      ...
      (call $system::core::u32::u32.==_1 (call $system::core::native::ref.getDiscriminant_1 (local.get $a)) (local.get $test::fixtures::compiler::patternMatching::discriminant))
    )
  )
  (func $test::fixtures::compiler::patternMatching::None.as_3 (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  (func $test::fixtures::compiler::patternMatching::None.None$discriminant_1 (result i64)
    ...
    (block $B1 (result i64)
      (local.set $test::fixtures::compiler::patternMatching::discriminant_1 (i32.const 1))
      (call $system::core::i64::i64.<<_1 (call $system::core::u32::u32.as_1 (local.get $test::fixtures::compiler::patternMatching::discriminant_1)) (i32.const 32))
    )
  )
  ...
  (func $test::fixtures::compiler::patternMatching::Some.is_1 (param $a i64) (result i32)
    (local $test::fixtures::compiler::patternMatching::discriminant_2 i32)
    (block $B1 (result i32)
      (local.set $test::fixtures::compiler::patternMatching::discriminant_2 (i32.const 2))
      (call $system::core::u32::u32.==_1 (call $system::core::native::ref.getDiscriminant_1 (local.get $a)) (local.get $test::fixtures::compiler::patternMatching::discriminant_2))
    )
  )
  ...
  (func $test::fixtures::compiler::patternMatching::Some.Some$discriminant_1 (result i64)
    ...
    (block $B1 (result i64)
      (local.set $test::fixtures::compiler::patternMatching::discriminant_3 (i32.const 2))
      (call $system::core::u64::u64.<<_1 (call $system::core::u32::u32.as_2 (local.get $test::fixtures::compiler::patternMatching::discriminant_3)) (i32.const 32))
    )
  )
  ...
  (func $test::fixtures::compiler::patternMatching::Some.as_5 (param $self i64) (result i32)
    (call $system::core::native::addressFromRef_1 (local.get $self))
  )
  (func $test::fixtures::compiler::patternMatching::Some.fromPointer_1 (param $ptr i32) (result i64)
    (i64.or (call $test::fixtures::compiler::patternMatching::Some.Some$discriminant_1) (i64.extend_i32_u (local.get $ptr)))
  )
  ...
  (func $test::fixtures::compiler::patternMatching::Some.value_1 (param $self i64) (result i32)
    (call $test::fixtures::compiler::patternMatching::Some.property$0_1 (local.get $self))
  )
  (func $test::fixtures::compiler::patternMatching::Some.value_2 (param $self i64) (param $value i32)
