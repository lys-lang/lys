(module
  ...
  (func $test/fixtures/compiler/patternMatching.lys::Maybe.is (param $a i64) (result i32)
    (block $B1 (result i32)
      (call $system::core::boolean.|| (call $test/fixtures/compiler/patternMatching.lys::None.is (local.get $a)) (call $test/fixtures/compiler/patternMatching.lys::Some.is (local.get $a)))
    )
  )
  ...
  (func $test/fixtures/compiler/patternMatching.lys::None.is (param $a i64) (result i32)
    (i64.eq (i64.and (i64.const 0xffffffff00000000) (local.get $a)) (call $test/fixtures/compiler/patternMatching.lys::None.None$discriminant))
  )
  ...
  (func $test/fixtures/compiler/patternMatching.lys::Some.apply (param $value i32) (result i64)
    (local $$ref i64)
    (block $B1 (result i64)
      (local.set $$ref (call $test/fixtures/compiler/patternMatching.lys::Some.fromPointer (call $system::memory::calloc (call $system::core::i32.as_3 (i32.const 1)) (i32.const 4))))
      (call $test/fixtures/compiler/patternMatching.lys::Some.property$0_1 (local.get $$ref) (local.get $value))
      (local.get $$ref)
    )
  )
  (func $test/fixtures/compiler/patternMatching.lys::Some.fromPointer (param $ptr i32) (result i64)
    (i64.or (call $test/fixtures/compiler/patternMatching.lys::Some.Some$discriminant) (i64.extend_u/i32 (local.get $ptr)))
  )
  ...
  (func $test/fixtures/compiler/patternMatching.lys::Some.property_value (param $self i64) (result i32)
    (call $test/fixtures/compiler/patternMatching.lys::Some.property$0 (local.get $self))
  )
  (func $test/fixtures/compiler/patternMatching.lys::Some.property_value_1 (param $self i64) (param $value i32)
    (call $test/fixtures/compiler/patternMatching.lys::Some.property$0_1 (local.get $self) (local.get $value))
  )
  ...
  (func $test/fixtures/compiler/patternMatching.lys::Some.is (param $a i64) (result i32)
    (i64.eq (i64.and (i64.const 0xffffffff00000000) (local.get $a)) (call $test/fixtures/compiler/patternMatching.lys::Some.Some$discriminant))
  )
                          ...
                          (block $B1_5
                              (block $B1_6
                                  (block $B1_7
                                      (block $B1_8
                                          (block $B1_9
                                              (br_if $B1_0 (call $system::core::i32.== (i32.const 10) (local.get $var$1)))
                                              (br_if $B1_1 (call $system::core::i32.== (i32.const 20) (local.get $var$1)))
                                              (br_if $B1_2 (call $system::core::i32.== (i32.const 30) (local.get $var$1)))
                                              (br_if $B1_3 (call $system::core::i32.== (i32.const 40) (local.get $var$1)))
                                              (br_if $B1_4 (call $system::core::i32.== (i32.const 50) (local.get $var$1)))
                                              (br_if $B1_5 (call $system::core::i32.== (i32.const 60) (local.get $var$1)))
                                              (br_if $B1_6 (call $system::core::i32.== (i32.const 70) (local.get $var$1)))
                                              (br_if $B1_7 (call $system::core::i32.== (i32.const 80) (local.get $var$1)))
                                              (br_if $B1_8 (call $system::core::i32.== (i32.const 90) (local.get $var$1)))
                                            )
                                          (i32.const 0)
                                          (br $B1)
                                        )
  ...
  (func $test/fixtures/compiler/patternMatching.lys::test3 (param $a i64) (result i32)
    ...
    (block $B1 (result i32)
      ...
      (block $B1_0
          (block $B1_1
              (br_if $B1_0 (call $test/fixtures/compiler/patternMatching.lys::Some.is (local.get $var$1)))
              (br_if $B1_1 (call $test/fixtures/compiler/patternMatching.lys::None.is (local.get $var$1)))
            )
          (i32.const 0)
          (br $B1)
        )
