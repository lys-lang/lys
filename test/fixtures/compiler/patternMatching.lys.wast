(module
  ...
  (func $test/fixtures/compiler/patternMatching.lys::Some.discriminant (result i64)
    (i64.const 0x300000000)
  )
  (func $test/fixtures/compiler/patternMatching.lys::Some.sizeOf (result i32)
    (i32.const 8)
  )
  (func $test/fixtures/compiler/patternMatching.lys::Some.allocationSize (result i32)
    (call $system::core::ref.allocationSize)
  )
  (func $test/fixtures/compiler/patternMatching.lys::Some.apply (param $value i32) (result i64)
    (local $$ref i64)
    (block $B1 (result i64)
      (set_local $$ref (call $test/fixtures/compiler/patternMatching.lys::Some.fromPointer (call $system::memory::calloc (i32.const 1) (call $test/fixtures/compiler/patternMatching.lys::Some.sizeOf))))
      (call $test/fixtures/compiler/patternMatching.lys::Some.set$value (get_local $$ref) (get_local $value))
      (get_local $$ref)
    )
  )
  ...
  (func $test/fixtures/compiler/patternMatching.lys::Some.property_value_1 (param $target i64) (param $value i32)
    (call $test/fixtures/compiler/patternMatching.lys::Some.set$value (get_local $target) (get_local $value))
  )
  (func $test/fixtures/compiler/patternMatching.lys::Some.set$value (param $target i64) (param $value i32)
