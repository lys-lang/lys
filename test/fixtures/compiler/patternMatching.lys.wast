(module
  ...
  (func $test/fixtures/compiler/patternMatching.lys::None.as (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  ...
  (func $test/fixtures/compiler/patternMatching.lys::None.None$discriminant (result i64)
    ...
    (block $B1 (result i64)
      ...
      (call $system::core::i64.<< (call $system::core::u32.as (local.get $test/fixtures/compiler/patternMatching.lys::discriminant)) (i32.const 32))
    )
  )
  ...
  (func $test/fixtures/compiler/patternMatching.lys::Some.as (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  ...
  (func $test/fixtures/compiler/patternMatching.lys::Some.Some$discriminant (result i64)
    ...
    (block $B1 (result i64)
      ...
      (call $system::core::u64.<< (call $system::core::u32.as_1 (local.get $test/fixtures/compiler/patternMatching.lys::discriminant_3)) (i32.const 32))
    )
  )
  (func $test/fixtures/compiler/patternMatching.lys::Some.apply (param $value i32) (result i64)
    ...
    (block $B1 (result i64)
      (local.set $test/fixtures/compiler/patternMatching.lys::$ref (call $test/fixtures/compiler/patternMatching.lys::Some.fromPointer (call $system::memory::calloc (call $system::core::i32.as_3 (i32.const 1)) (i32.const 4))))
      (call $test/fixtures/compiler/patternMatching.lys::Some.property$0_1 (local.get $test/fixtures/compiler/patternMatching.lys::$ref) (local.get $value))
                          ...
                          (block $B1_5
                              (block $B1_6
                                  (block $B1_7
                                      (block $B1_8
                                          (block $B1_9
                                              (br_if $B1_0 (call $system::core::i32.== (local.get $var$1) (i32.const 10)))
                                              (br_if $B1_1 (call $system::core::i32.== (local.get $var$1) (i32.const 20)))
                                              (br_if $B1_2 (call $system::core::i32.== (local.get $var$1) (i32.const 30)))
                                              (br_if $B1_3 (call $system::core::i32.== (local.get $var$1) (i32.const 40)))
                                              (br_if $B1_4 (call $system::core::i32.== (local.get $var$1) (i32.const 50)))
                                              (br_if $B1_5 (call $system::core::i32.== (local.get $var$1) (i32.const 60)))
                                              (br_if $B1_6 (call $system::core::i32.== (local.get $var$1) (i32.const 70)))
                                              (br_if $B1_7 (call $system::core::i32.== (local.get $var$1) (i32.const 80)))
                                              (br_if $B1_8 (call $system::core::i32.== (local.get $var$1) (i32.const 90)))
                                            )
                                          (i32.const 0)
                                          (br $B1)
                                        )
