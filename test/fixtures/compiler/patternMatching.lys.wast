(module
  ...
  (func $test::fixtures::compiler::patternMatching::Maybe.is_1 (param $a i64) (result i32)
    (block $B1 (result i32)
      (call $system::core::boolean::boolean.||_1 (call $test::fixtures::compiler::patternMatching::None.is_1 (local.get $a)) (call $test::fixtures::compiler::patternMatching::Some.is_1 (local.get $a)))
    )
  )
  ...
  (func $test::fixtures::compiler::patternMatching::None.None$discriminant_1 (result i64)
    ...
    (block $B1 (result i64)
      (local.set $test::fixtures::compiler::patternMatching::discriminant (i32.const 1))
      (call $system::core::i64::i64.<<_1 (call $system::core::u32::u32.as_1 (local.get $test::fixtures::compiler::patternMatching::discriminant)) (i32.const 32))
    )
  )
  ...
  (func $test::fixtures::compiler::patternMatching::Some.as_2 (param $self i64) (result i32)
    (call $system::core::native::addressFromRef_1 (get_local $self))
  )
  (func $test::fixtures::compiler::patternMatching::Some.as_3 (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  (func $test::fixtures::compiler::patternMatching::Some.Some$discriminant_1 (result i64)
    ...
    (block $B1 (result i64)
      (local.set $test::fixtures::compiler::patternMatching::discriminant_1 (i32.const 2))
      (call $system::core::u64::u64.<<_1 (call $system::core::u32::u32.as_2 (local.get $test::fixtures::compiler::patternMatching::discriminant_1)) (i32.const 32))
    )
  )
  (func $test::fixtures::compiler::patternMatching::Some.apply_1 (param $value i32) (result i64)
    ...
    (block $B1 (result i64)
      (local.set $test::fixtures::compiler::patternMatching::$ref (call $test::fixtures::compiler::patternMatching::Some.fromPointer_1 (call $system::core::memory::calloc_1 (call $system::core::i32::i32.as_4 (i32.const 1)) (i32.const 4))))
  ...
  (func $test::fixtures::compiler::patternMatching::test_1 (param $a i32) (result i32)
    ...
    (block $B1 (result i32)
      ...
      (block $B1_0
          (block $B1_1
              (br_if $B1_0 (call $system::core::i32::i32.==_1 (local.get $var$1) (i32.const 1)))
            )
          (i32.const 0)
          (br $B1)
        )
                          ...
                          (block $B1_5
                              (block $B1_6
                                  (block $B1_7
                                      (block $B1_8
                                          (block $B1_9
                                              (br_if $B1_0 (call $system::core::i32::i32.==_1 (local.get $var$1) (i32.const 10)))
                                              (br_if $B1_1 (call $system::core::i32::i32.==_1 (local.get $var$1) (i32.const 20)))
                                              (br_if $B1_2 (call $system::core::i32::i32.==_1 (local.get $var$1) (i32.const 30)))
                                              (br_if $B1_3 (call $system::core::i32::i32.==_1 (local.get $var$1) (i32.const 40)))
                                              (br_if $B1_4 (call $system::core::i32::i32.==_1 (local.get $var$1) (i32.const 50)))
                                              (br_if $B1_5 (call $system::core::i32::i32.==_1 (local.get $var$1) (i32.const 60)))
                                              (br_if $B1_6 (call $system::core::i32::i32.==_1 (local.get $var$1) (i32.const 70)))
                                              (br_if $B1_7 (call $system::core::i32::i32.==_1 (local.get $var$1) (i32.const 80)))
                                              (br_if $B1_8 (call $system::core::i32::i32.==_1 (local.get $var$1) (i32.const 90)))
                                            )
                                          (i32.const 0)
                                          (br $B1)
                                        )
