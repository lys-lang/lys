(module
  ...
  (func $test/fixtures/compiler/fib2.ro::fibo (param $n i32) (param $x1 i32) (param $x2 i32) (result i32)
    (if $a_wild_if (result i32) (call $system::core::> (get_local $n) (i32.const 0))
      (then
        (call $test/fixtures/compiler/fib2.ro::fibo (call $system::core::- (get_local $n) (i32.const 1)) (get_local $x2) (call $system::core::+ (get_local $x1) (get_local $x2)))
      )
      (else
        (get_local $x1)
      )
  ...
  (func $test/fixtures/compiler/fib2.ro::fib (param $n i32) (result i32)
    (call $test/fixtures/compiler/fib2.ro::fibo (get_local $n) (i32.const 0) (i32.const 1))
  )
  (func $test/fixtures/compiler/fib2.ro::test (result i32)
    (call $test/fixtures/compiler/fib2.ro::fib (i32.const 46))
  )
)
