(module
  (memory 0 1)
  (export "keccak" (func $keccak))
  (func $memcpy (param $from i32) (param $to i32) (param $len i32)
    (local $end i32)
  ...
  (func $keccak_theta (param $context_offset i32)
    (local $C0 i64)
    (local $C1 i64)
    (local $C2 i64)
    (local $C3 i64)
  ...
  (func $keccak_rho (param $context_offset i32) (param $rotation_consts i32)
    (local $tmp i32)
    (local $i i32)
  ...
  (func $keccak_pi (param $context_offset i32)
    (local $A1 i64)
  ...
  (func $keccak_chi (param $context_offset i32)
    (local $A0 i64)
    (local $A1 i64)
    (local $i i32)
    (set_local $i (i32.const 0))
  ...
  (func $keccak_permute (param $context_offset i32)
  ...
  (func $keccak_block (param $input_offset i32) (param $input_length i32) (param $context_offset i32)
  ...
  (func $keccak_init (param $context_offset i32)
    (local $round_consts i32)
    (local $rotation_consts i32)
  ...
  (func $memset (param $ptr i32) (param $content i32) (param $len i32)
    (local $end i32)
  ...
  (func $keccak_reset (param $context_offset i32)
    (block $unknown_block_1
      (call $memset (get_local $context_offset) (i32.const 0) (i32.const 400))
    )
  )
  (func $keccak_update (param $context_offset i32) (param $input_offset i32) (param $input_length i32)
  ...
  (func $keccak (param $context_offset i32) (param $input_offset i32) (param $input_length i32) (param $output_offset i32) (result i32)
