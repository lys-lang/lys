  ...
  (func $test/fixtures/compiler/patternMatchinIs.ro::isA (param $x i64) (result i32)
    ...
    (block $B1 (result i32)
      (block $B2 (result i32)
          ...
          (block $B2_0
              (block $B2_1
                  (br_if $B2_0 (call $test/fixtures/compiler/patternMatchinIs.ro::A.is (get_local $var$1)))
                )
              (i32.const 0)
              (br $B2)
            )
  ...
  (func $test/fixtures/compiler/patternMatchinIs.ro::isB (param $x i64) (result i32)
    ...
    (block $B1 (result i32)
      (block $B2 (result i32)
          ...
          (block $B2_0
              (block $B2_1
                  (br_if $B2_0 (call $test/fixtures/compiler/patternMatchinIs.ro::B.is (get_local $var$1)))
                )
              (i32.const 0)
              (br $B2)
            )
  ...
  (func $test/fixtures/compiler/patternMatchinIs.ro::isEnum (param $x i64) (result i32)
    ...
    (block $B1 (result i32)
      (block $B2 (result i32)
          ...
          (block $B2_0
              (block $B2_1
                  (br_if $B2_0 (call $test/fixtures/compiler/patternMatchinIs.ro::Enum.is (get_local $var$1)))
                )
              (i32.const 0)
              (br $B2)
            )
  ...
  (func $test/fixtures/compiler/patternMatchinIs.ro::isRed (param $x i64) (result i32)
    ...
    (block $B1 (result i32)
      (block $B2 (result i32)
          ...
          (block $B2_0
              (block $B2_1
                  (br_if $B2_0 (call $test/fixtures/compiler/patternMatchinIs.ro::Red.is (get_local $var$1)))
                )
              (i32.const 0)
              (br $B2)
            )
  ...
  (func $test/fixtures/compiler/patternMatchinIs.ro::isColor (param $x i64) (result i32)
    ...
    (block $B1 (result i32)
      (block $B2 (result i32)
          ...
          (block $B2_0
              (block $B2_1
                  (br_if $B2_0 (call $test/fixtures/compiler/patternMatchinIs.ro::Color.is (get_local $var$1)))
                )
              (i32.const 0)
              (br $B2)
            )
  ...
  (func $test/fixtures/compiler/patternMatchinIs.ro::isCustom (param $x i64) (result i32)
    ...
    (block $B1 (result i32)
      (block $B2 (result i32)
          ...
          (block $B2_0
              (block $B2_1
                  (br_if $B2_0 (call $test/fixtures/compiler/patternMatchinIs.ro::Custom.is (get_local $var$1)))
                )
              (i32.const 0)
              (br $B2)
            )
