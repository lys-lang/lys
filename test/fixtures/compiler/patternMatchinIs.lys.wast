(module
  ...
  (func $test/fixtures/compiler/patternMatchinIs.lys::A.A$discriminant (result i64)
    ...
    (block $B1 (result i64)
      ...
      (call $system::core::i64.<< (call $system::core::u32.as (local.get $test/fixtures/compiler/patternMatchinIs.lys::discriminant)) (i32.const 32))
    )
  )
  ...
  (func $test/fixtures/compiler/patternMatchinIs.lys::B.B$discriminant (result i64)
    ...
    (block $B1 (result i64)
      ...
      (call $system::core::i64.<< (call $system::core::u32.as (local.get $test/fixtures/compiler/patternMatchinIs.lys::discriminant_3)) (i32.const 32))
    )
  )
  ...
  (func $test/fixtures/compiler/patternMatchinIs.lys::C.C$discriminant (result i64)
    ...
    (block $B1 (result i64)
      ...
      (call $system::core::i64.<< (call $system::core::u32.as (local.get $test/fixtures/compiler/patternMatchinIs.lys::discriminant_6)) (i32.const 32))
    )
  )
  ...
  (func $test/fixtures/compiler/patternMatchinIs.lys::Red.Red$discriminant (result i64)
    ...
    (block $B1 (result i64)
      ...
      (call $system::core::i64.<< (call $system::core::u32.as (local.get $test/fixtures/compiler/patternMatchinIs.lys::discriminant_9)) (i32.const 32))
    )
  )
  ...
  (func $test/fixtures/compiler/patternMatchinIs.lys::Green.Green$discriminant (result i64)
    ...
    (block $B1 (result i64)
      ...
      (call $system::core::i64.<< (call $system::core::u32.as (local.get $test/fixtures/compiler/patternMatchinIs.lys::discriminant_12)) (i32.const 32))
    )
  )
  ...
  (func $test/fixtures/compiler/patternMatchinIs.lys::Blue.Blue$discriminant (result i64)
    ...
    (block $B1 (result i64)
      ...
      (call $system::core::i64.<< (call $system::core::u32.as (local.get $test/fixtures/compiler/patternMatchinIs.lys::discriminant_15)) (i32.const 32))
    )
  )
  ...
  (func $test/fixtures/compiler/patternMatchinIs.lys::Custom.Custom$discriminant (result i64)
    ...
    (block $B1 (result i64)
      ...
      (call $system::core::u64.<< (call $system::core::u32.as_1 (local.get $test/fixtures/compiler/patternMatchinIs.lys::discriminant_18)) (i32.const 32))
    )
  )
  (func $test/fixtures/compiler/patternMatchinIs.lys::Custom.apply (param $a i32) (result i64)
    ...
    (block $B1 (result i64)
      (local.set $test/fixtures/compiler/patternMatchinIs.lys::$ref (call $test/fixtures/compiler/patternMatchinIs.lys::Custom.fromPointer (call $system::memory::calloc (call $system::core::i32.as_3 (i32.const 1)) (i32.const 4))))
      (call $test/fixtures/compiler/patternMatchinIs.lys::Custom.property$0_1 (local.get $test/fixtures/compiler/patternMatchinIs.lys::$ref) (local.get $a))
  ...
  (func $test/fixtures/compiler/patternMatchinIs.lys::testPassing
    (block $B1
      ...
      (call $support::test::assert (call $system::core::boolean.== (call $test/fixtures/compiler/patternMatchinIs.lys::isA (global.get $test/fixtures/compiler/patternMatchinIs.lys::value1)) (i32.const 1)))
      (call $support::test::assert (call $system::core::boolean.== (call $test/fixtures/compiler/patternMatchinIs.lys::isB (global.get $test/fixtures/compiler/patternMatchinIs.lys::value1)) (i32.const 0)))
      (call $support::test::assert (call $system::core::boolean.== (call $test/fixtures/compiler/patternMatchinIs.lys::isEnum (global.get $test/fixtures/compiler/patternMatchinIs.lys::value1)) (i32.const 1)))
      (call $support::test::assert (call $system::core::boolean.== (call $test/fixtures/compiler/patternMatchinIs.lys::isA (global.get $test/fixtures/compiler/patternMatchinIs.lys::value2)) (i32.const 1)))
      (call $support::test::assert (call $system::core::boolean.== (call $test/fixtures/compiler/patternMatchinIs.lys::isB (global.get $test/fixtures/compiler/patternMatchinIs.lys::value2)) (i32.const 0)))
      (call $support::test::assert (call $system::core::boolean.== (call $test/fixtures/compiler/patternMatchinIs.lys::isEnum (global.get $test/fixtures/compiler/patternMatchinIs.lys::value2)) (i32.const 1)))
      (call $support::test::assert (call $system::core::boolean.== (call $test/fixtures/compiler/patternMatchinIs.lys::isA (global.get $test/fixtures/compiler/patternMatchinIs.lys::value3)) (i32.const 1)))
      (call $support::test::assert (call $system::core::boolean.== (call $test/fixtures/compiler/patternMatchinIs.lys::isB (global.get $test/fixtures/compiler/patternMatchinIs.lys::value3)) (i32.const 0)))
      (call $support::test::assert (call $system::core::boolean.== (call $test/fixtures/compiler/patternMatchinIs.lys::isEnum (global.get $test/fixtures/compiler/patternMatchinIs.lys::value3)) (i32.const 1)))
      (call $support::test::assert (call $system::core::boolean.== (call $test/fixtures/compiler/patternMatchinIs.lys::isRed (global.get $test/fixtures/compiler/patternMatchinIs.lys::value3)) (i32.const 0)))
  ...
  (func $%%START%%
    ...
    (global.set $test/fixtures/compiler/patternMatchinIs.lys::value1 (call $test/fixtures/compiler/patternMatchinIs.lys::A.apply))
    (global.set $test/fixtures/compiler/patternMatchinIs.lys::value2 (call $test/fixtures/compiler/patternMatchinIs.lys::A.apply))
    (global.set $test/fixtures/compiler/patternMatchinIs.lys::value3 (call $test/fixtures/compiler/patternMatchinIs.lys::A.apply))
  )
  (start $%%START%%)
)
