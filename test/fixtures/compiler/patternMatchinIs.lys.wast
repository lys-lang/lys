(module
  ...
  (func $support::test::mustEqual_2 (param $given i64) (param $expected i64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::u64.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_9 (i64.const 0x0000000000000088) (call $system::core::u64.as_7 (call $system::core::u64.>> (local.get $given) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x00000000000000ab) (call $system::core::u64.as_7 (call $system::core::u64.>> (local.get $expected) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x00000000000000d4) (call $system::core::u64.&_2 (local.get $given) (call $system::core::i32.as_3 (i32.const 0xFFFFFFFF))))
                (call $support::env::printf_9 (i64.const 0x00000000000000f7) (call $system::core::u64.&_2 (local.get $expected) (call $system::core::i32.as_3 (i32.const 0xFFFFFFFF))))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_3 (param $given i64) (param $expected i64) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i64.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_9 (i64.const 0x0000000000000120) (call $system::core::u64.as_7 (call $system::core::u64.>> (call $system::core::i64.as_2 (local.get $given)) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x0000000000000143) (call $system::core::u64.as_7 (call $system::core::u64.>> (call $system::core::i64.as_2 (local.get $expected)) (i32.const 32))))
                (call $support::env::printf_9 (i64.const 0x000000000000016c) (call $system::core::i64.&_2 (local.get $given) (call $system::core::i32.as_3 (i32.const 0xFFFFFFFF))))
                (call $support::env::printf_9 (i64.const 0x000000000000018f) (call $system::core::i64.&_2 (local.get $expected) (call $system::core::i32.as_3 (i32.const 0xFFFFFFFF))))
              )
          )
          (else)
        )
  ...
  (func $support::test::mustEqual_5 (param $given i32) (param $expected i32) (param $message i64)
    (block $B1
      ...
      (if $IF2 (call $system::core::i32.!= (local.get $given) (local.get $expected))
          (then
            (block $B3
                (call $support::env::printf_7 (i64.const 0x00000000000001f4) (local.get $given))
                (call $support::env::printf_7 (i64.const 0x000000000000020f) (local.get $expected))
              )
          )
          (else)
        )
  ...
  (func $test/fixtures/compiler/patternMatchinIs.lys::A.as (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  ...
  (func $test/fixtures/compiler/patternMatchinIs.lys::B.as (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  ...
  (func $test/fixtures/compiler/patternMatchinIs.lys::C.as (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  ...
  (func $test/fixtures/compiler/patternMatchinIs.lys::Red.as (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  ...
  (func $test/fixtures/compiler/patternMatchinIs.lys::Green.as (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  ...
  (func $test/fixtures/compiler/patternMatchinIs.lys::Blue.as (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  ...
  (func $test/fixtures/compiler/patternMatchinIs.lys::Custom.as (param $lhs i64) (result i64)
    (local.get $lhs)
  )
