(module
  ...
  (func $test::fixtures::compiler::a::addFloat_1 (param $a f32) (param $b f32) (result f32)
    (call $system::core::f32::f32.+_1 (local.get $a) (local.get $b))
  )
  (func $test::fixtures::compiler::a::addInts_1 (param $a i32) (param $b i32) (result i32)
    (call $system::core::i32::i32.+_1 (local.get $a) (local.get $b))
  )
  (func $test::fixtures::compiler::a::x_1 (param $width f32) (param $height f32) (result f32)
    (call $system::core::f32::f32.*_1 (call $system::core::f32::f32.+_1 (local.get $width) (f32.const 1)) (local.get $height))
  )
  (func $%%START%%
