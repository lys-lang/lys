(module
  ...
  (func $test/fixtures/compiler/a.lys::addFloat (param $a f32) (param $b f32) (result f32)
    (call $system::core::f32.+ (get_local $a) (get_local $b))
  )
  (func $test/fixtures/compiler/a.lys::addInts (param $a i32) (param $b i32) (result i32)
    (call $system::core::i32.+ (get_local $a) (get_local $b))
  )
  (func $test/fixtures/compiler/a.lys::x (param $width f32) (param $height f32) (result f32)
    (call $system::core::f32.* (call $system::core::f32.+ (get_local $width) (f32.const 1)) (get_local $height))
  )
)
