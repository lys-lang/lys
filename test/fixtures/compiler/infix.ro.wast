(module
  ...
  (export "testInt" (func $test/fixtures/compiler/infix.ro::testInt))
  (export "testFloat" (func $test/fixtures/compiler/infix.ro::testFloat))
  (func $test/fixtures/compiler/infix.ro::sum (param $a f32) (param $b f32) (result f32)
    (call $system::core::f32.+ (get_local $a) (get_local $b))
  )
  (func $test/fixtures/compiler/infix.ro::sum_1 (param $a i32) (param $b i32) (result i32)
    (call $system::core::i32.+ (get_local $a) (get_local $b))
  )
  (func $test/fixtures/compiler/infix.ro::testInt (param $a i32) (param $b i32) (result i32)
    (call $test/fixtures/compiler/infix.ro::sum_1 (get_local $a) (get_local $b))
  )
  (func $test/fixtures/compiler/infix.ro::testFloat (param $a f32) (param $b f32) (result f32)
    (call $test/fixtures/compiler/infix.ro::sum (get_local $a) (get_local $b))
  )
)
