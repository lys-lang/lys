(module
  ...
  (export "main" (func $test/fixtures/compiler/mutability.ro::main))
  (export "main2" (func $test/fixtures/compiler/mutability.ro::main2))
  (func $test/fixtures/compiler/mutability.ro::main (result i32)
    (local $a i32)
  ...
  (func $test/fixtures/compiler/mutability.ro::main2 (param $x i32) (result i32)
    (local $a i32)
    (block $unknown_block_2 (result i32)
      (set_local $a (i32.const 1))
      (if $a_wild_if (call $system::core::==_12 (get_local $x) (i32.const 1))
          (then
