(module
  ...
  (func $test::fixtures::compiler::iterator-loco::Iterator.Iterator$discriminant_1 (result i64)
    ...
    (block $B1 (result i64)
      ...
      (call $system::core::u64::u64.<<_1 (call $system::core::u32::u32.as_2 (local.get $test::fixtures::compiler::iterator-loco::discriminant)) (i32.const 32))
    )
  )
  (func $test::fixtures::compiler::iterator-loco::Iterator.apply_1 (param $current i32) (param $target i32) (result i64)
    ...
    (block $B1 (result i64)
      (local.set $test::fixtures::compiler::iterator-loco::$ref (call $test::fixtures::compiler::iterator-loco::Iterator.fromPointer_1 (call $system::core::memory::calloc_1 (call $system::core::i32::i32.as_4 (i32.const 1)) (i32.const 8))))
  ...
  (func $test::fixtures::compiler::iterator-loco::Iterator.as_1 (param $self i64) (result i32)
    (call $system::core::native::addressFromRef_1 (get_local $self))
  )
  (func $test::fixtures::compiler::iterator-loco::Iterator.as_2 (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  ...
  (func $test::fixtures::compiler::iterator-loco::Iterator.next_1 (param $iter i64) (result i64)
    ...
    (block $B1 (result i64)
      (if $IF2 (result i64) (call $system::core::i32::i32.<=_1 (call $test::fixtures::compiler::iterator-loco::Iterator.property_current_1 (local.get $iter)) (call $test::fixtures::compiler::iterator-loco::Iterator.property_target_1 (local.get $iter)))
          (then
            (block $B3 (result i64)
                ...
                (call $test::fixtures::compiler::iterator-loco::Iterator.property_current_2 (local.get $iter) (call $system::core::i32::i32.+_1 (call $test::fixtures::compiler::iterator-loco::Iterator.property_current_1 (local.get $iter)) (i32.const 1)))
  ...
  (func $test::fixtures::compiler::iterator-loco::Maybe.is_1 (param $a i64) (result i32)
    (block $B1 (result i32)
      (call $system::core::boolean::boolean.||_1 (call $test::fixtures::compiler::iterator-loco::None.is_1 (local.get $a)) (call $test::fixtures::compiler::iterator-loco::Some.is_1 (local.get $a)))
    )
  )
  ...
  (func $test::fixtures::compiler::iterator-loco::None.None$discriminant_1 (result i64)
    ...
    (block $B1 (result i64)
      (local.set $test::fixtures::compiler::iterator-loco::discriminant_1 (i32.const 2))
      (call $system::core::i64::i64.<<_1 (call $system::core::u32::u32.as_1 (local.get $test::fixtures::compiler::iterator-loco::discriminant_1)) (i32.const 32))
    )
  )
  ...
  (func $test::fixtures::compiler::iterator-loco::Some.as_2 (param $self i64) (result i32)
    (call $system::core::native::addressFromRef_1 (get_local $self))
  )
  (func $test::fixtures::compiler::iterator-loco::Some.as_3 (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  (func $test::fixtures::compiler::iterator-loco::Some.Some$discriminant_1 (result i64)
    ...
    (block $B1 (result i64)
      (local.set $test::fixtures::compiler::iterator-loco::discriminant_2 (i32.const 3))
      (call $system::core::u64::u64.<<_1 (call $system::core::u32::u32.as_2 (local.get $test::fixtures::compiler::iterator-loco::discriminant_2)) (i32.const 32))
    )
  )
  (func $test::fixtures::compiler::iterator-loco::Some.apply_1 (param $value i32) (result i64)
    ...
    (block $B1 (result i64)
      (local.set $test::fixtures::compiler::iterator-loco::$ref_1 (call $test::fixtures::compiler::iterator-loco::Some.fromPointer_1 (call $system::core::memory::calloc_1 (call $system::core::i32::i32.as_4 (i32.const 1)) (i32.const 4))))
              ...
              (block $B3
                  (block $B5
                      ...
                      (block $B4
                          ...
                          (local.set $test::fixtures::compiler::iterator-loco::ret (call $system::core::i32::i32.+_1 (local.get $test::fixtures::compiler::iterator-loco::ret) (local.get $test::fixtures::compiler::iterator-loco::value_7)))
                          (br $Loop2)
                        )
                      (br $B5)
                    )
