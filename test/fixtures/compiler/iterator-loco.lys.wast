(module
  ...
  (func $test/fixtures/compiler/iterator-loco.lys::Iterator.== (param $a i64) (param $b i64) (result i32)
    (i64.eq (get_local $a) (get_local $b))
  )
  (func $test/fixtures/compiler/iterator-loco.lys::Iterator.!= (param $a i64) (param $b i64) (result i32)
    (i64.ne (get_local $a) (get_local $b))
  )
  (func $test/fixtures/compiler/iterator-loco.lys::Iterator.property_current (param $self i64) (result i32)
    (call $test/fixtures/compiler/iterator-loco.lys::Iterator.property$0 (get_local $self))
  )
  (func $test/fixtures/compiler/iterator-loco.lys::Iterator.property_current_1 (param $self i64) (param $value i32)
    (call $test/fixtures/compiler/iterator-loco.lys::Iterator.property$0_1 (get_local $self) (get_local $value))
  )
  (func $test/fixtures/compiler/iterator-loco.lys::Iterator.property$0 (param $self i64) (result i32)
    (call $system::core::i32.load_1 (get_local $self) (i32.const 0))
  )
  (func $test/fixtures/compiler/iterator-loco.lys::Iterator.property$0_1 (param $self i64) (param $value i32)
    (call $system::core::i32.store_1 (get_local $self) (get_local $value) (i32.const 0))
  )
  (func $test/fixtures/compiler/iterator-loco.lys::Iterator.property_target (param $self i64) (result i32)
    (call $test/fixtures/compiler/iterator-loco.lys::Iterator.property$1 (get_local $self))
  )
  (func $test/fixtures/compiler/iterator-loco.lys::Iterator.property_target_1 (param $self i64) (param $value i32)
    (call $test/fixtures/compiler/iterator-loco.lys::Iterator.property$1_1 (get_local $self) (get_local $value))
  )
  (func $test/fixtures/compiler/iterator-loco.lys::Iterator.property$1 (param $self i64) (result i32)
    (call $system::core::i32.load_1 (get_local $self) (i32.const 4))
  )
  (func $test/fixtures/compiler/iterator-loco.lys::Iterator.property$1_1 (param $self i64) (param $value i32)
  ...
  (func $test/fixtures/compiler/iterator-loco.lys::Some.apply (param $value i32) (result i64)
    (local $$ref i64)
    (block $B1 (result i64)
      (set_local $$ref (call $test/fixtures/compiler/iterator-loco.lys::Some.fromPointer (call $system::memory::calloc (i32.const 1) (i32.const 4))))
  ...
  (func $test/fixtures/compiler/iterator-loco.lys::Some.== (param $a i64) (param $b i64) (result i32)
    (i64.eq (get_local $a) (get_local $b))
  )
  (func $test/fixtures/compiler/iterator-loco.lys::Some.!= (param $a i64) (param $b i64) (result i32)
    (i64.ne (get_local $a) (get_local $b))
  )
  (func $test/fixtures/compiler/iterator-loco.lys::Some.property_value (param $self i64) (result i32)
    (call $test/fixtures/compiler/iterator-loco.lys::Some.property$0 (get_local $self))
  )
  (func $test/fixtures/compiler/iterator-loco.lys::Some.property_value_1 (param $self i64) (param $value i32)
    (call $test/fixtures/compiler/iterator-loco.lys::Some.property$0_1 (get_local $self) (get_local $value))
  )
  (func $test/fixtures/compiler/iterator-loco.lys::Some.property$0 (param $self i64) (result i32)
    (call $system::core::i32.load_1 (get_local $self) (i32.const 0))
  )
  (func $test/fixtures/compiler/iterator-loco.lys::Some.property$0_1 (param $self i64) (param $value i32)
    (call $system::core::i32.store_1 (get_local $self) (get_local $value) (i32.const 0))
  )
