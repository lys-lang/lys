(module
  ...
  (func $test::fixtures::compiler::iterator-loco::Iterator.is_1 (param $a i64) (result i32)
    ...
    (block $B1 (result i32)
      ...
      (call $system::core::u32::u32.==_1 (call $system::core::native::ref.getDiscriminant_1 (local.get $a)) (local.get $test::fixtures::compiler::iterator-loco::discriminant))
    )
  )
  ...
  (func $test::fixtures::compiler::iterator-loco::Iterator.Iterator$discriminant_1 (result i64)
    ...
    (block $B1 (result i64)
      (local.set $test::fixtures::compiler::iterator-loco::discriminant_1 (i32.const 1))
      (call $system::core::u64::u64.<<_1 (call $system::core::u32::u32.as_2 (local.get $test::fixtures::compiler::iterator-loco::discriminant_1)) (i32.const 32))
    )
  )
  ...
  (func $test::fixtures::compiler::iterator-loco::Iterator.as_3 (param $self i64) (result i32)
    (call $system::core::native::addressFromRef_1 (local.get $self))
  )
  (func $test::fixtures::compiler::iterator-loco::Iterator.fromPointer_1 (param $ptr i32) (result i64)
    (i64.or (call $test::fixtures::compiler::iterator-loco::Iterator.Iterator$discriminant_1) (i64.extend_i32_u (local.get $ptr)))
  )
  ...
  (func $test::fixtures::compiler::iterator-loco::Iterator.current_1 (param $self i64) (result i32)
    (call $test::fixtures::compiler::iterator-loco::Iterator.property$0_1 (local.get $self))
  )
  (func $test::fixtures::compiler::iterator-loco::Iterator.current_2 (param $self i64) (param $value i32)
  ...
  (func $test::fixtures::compiler::iterator-loco::Iterator.target_1 (param $self i64) (result i32)
    (call $test::fixtures::compiler::iterator-loco::Iterator.property$1_1 (local.get $self))
  )
  (func $test::fixtures::compiler::iterator-loco::Iterator.target_2 (param $self i64) (param $value i32)
  ...
  (func $test::fixtures::compiler::iterator-loco::Maybe.is_1 (param $self i64) (result i32)
    (block $B1 (result i32)
      (call $system::core::boolean::boolean.||_1 (call $test::fixtures::compiler::iterator-loco::None.is_1 (local.get $self)) (call $test::fixtures::compiler::iterator-loco::Some.is_1 (local.get $self)))
    )
  )
  (func $test::fixtures::compiler::iterator-loco::Maybe.as_1 (param $self i64) (result i64)
    (local.get $self)
  )
  ...
  (func $test::fixtures::compiler::iterator-loco::None.is_1 (param $a i64) (result i32)
    ...
    (block $B1 (result i32)
      (local.set $test::fixtures::compiler::iterator-loco::discriminant_2 (i32.const 2))
      (call $system::core::u32::u32.==_1 (call $system::core::native::ref.getDiscriminant_1 (local.get $a)) (local.get $test::fixtures::compiler::iterator-loco::discriminant_2))
    )
  )
  (func $test::fixtures::compiler::iterator-loco::None.as_3 (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  (func $test::fixtures::compiler::iterator-loco::None.None$discriminant_1 (result i64)
    ...
    (block $B1 (result i64)
      (local.set $test::fixtures::compiler::iterator-loco::discriminant_3 (i32.const 2))
      (call $system::core::i64::i64.<<_1 (call $system::core::u32::u32.as_1 (local.get $test::fixtures::compiler::iterator-loco::discriminant_3)) (i32.const 32))
    )
  )
  ...
  (func $test::fixtures::compiler::iterator-loco::Some.is_1 (param $a i64) (result i32)
    (local $test::fixtures::compiler::iterator-loco::discriminant_4 i32)
    (block $B1 (result i32)
      (local.set $test::fixtures::compiler::iterator-loco::discriminant_4 (i32.const 3))
      (call $system::core::u32::u32.==_1 (call $system::core::native::ref.getDiscriminant_1 (local.get $a)) (local.get $test::fixtures::compiler::iterator-loco::discriminant_4))
    )
  )
  ...
  (func $test::fixtures::compiler::iterator-loco::Some.Some$discriminant_1 (result i64)
    (local $test::fixtures::compiler::iterator-loco::discriminant_5 i32)
    (block $B1 (result i64)
      (local.set $test::fixtures::compiler::iterator-loco::discriminant_5 (i32.const 3))
      (call $system::core::u64::u64.<<_1 (call $system::core::u32::u32.as_2 (local.get $test::fixtures::compiler::iterator-loco::discriminant_5)) (i32.const 32))
    )
  )
  ...
  (func $test::fixtures::compiler::iterator-loco::Some.as_5 (param $self i64) (result i32)
    (call $system::core::native::addressFromRef_1 (local.get $self))
  )
  (func $test::fixtures::compiler::iterator-loco::Some.fromPointer_1 (param $ptr i32) (result i64)
    (i64.or (call $test::fixtures::compiler::iterator-loco::Some.Some$discriminant_1) (i64.extend_i32_u (local.get $ptr)))
  )
  ...
  (func $test::fixtures::compiler::iterator-loco::Some.value_1 (param $self i64) (result i32)
    (call $test::fixtures::compiler::iterator-loco::Some.property$0_1 (local.get $self))
  )
  (func $test::fixtures::compiler::iterator-loco::Some.value_2 (param $self i64) (param $value i32)
  ...
  (func $test::fixtures::compiler::iterator-loco::Iterator.next_1 (param $iter i64) (result i64)
    ...
    (block $B1 (result i64)
      (if $IF2 (result i64) (call $system::core::i32::i32.<=_1 (call $test::fixtures::compiler::iterator-loco::Iterator.current_1 (local.get $iter)) (call $test::fixtures::compiler::iterator-loco::Iterator.target_1 (local.get $iter)))
          (then
            (block $B3 (result i64)
                (local.set $test::fixtures::compiler::iterator-loco::r (call $test::fixtures::compiler::iterator-loco::Some.apply_1 (call $test::fixtures::compiler::iterator-loco::Iterator.current_1 (local.get $iter))))
                (call $test::fixtures::compiler::iterator-loco::Iterator.current_2 (local.get $iter) (call $system::core::i32::i32.+_1 (call $test::fixtures::compiler::iterator-loco::Iterator.current_1 (local.get $iter)) (i32.const 1)))
          ...
          (loop $Loop2
              (block $B3
                  (block $B5
                      ...
                      (block $B4
                          (local.set $test::fixtures::compiler::iterator-loco::value_7 (call $test::fixtures::compiler::iterator-loco::Some.value_1 (local.get $var$5)))
