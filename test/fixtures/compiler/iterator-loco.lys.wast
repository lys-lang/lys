(module
  ...
  (func $test/fixtures/compiler/iterator-loco.lys::Iterator.apply (param $current i32) (param $target i32) (result i64)
    (local $$ref i64)
    (block $B1 (result i64)
      (local.set $$ref (call $test/fixtures/compiler/iterator-loco.lys::Iterator.fromPointer (call $system::memory::calloc (call $system::core::i32.as_3 (i32.const 1)) (i32.const 8))))
      (call $test/fixtures/compiler/iterator-loco.lys::Iterator.property$0_1 (local.get $$ref) (local.get $current))
      (call $test/fixtures/compiler/iterator-loco.lys::Iterator.property$1_1 (local.get $$ref) (local.get $target))
      (local.get $$ref)
    )
  )
  ...
  (func $test/fixtures/compiler/iterator-loco.lys::Some.apply (param $value i32) (result i64)
    (local $$ref i64)
    (block $B1 (result i64)
      (local.set $$ref (call $test/fixtures/compiler/iterator-loco.lys::Some.fromPointer (call $system::memory::calloc (call $system::core::i32.as_3 (i32.const 1)) (i32.const 4))))
      (call $test/fixtures/compiler/iterator-loco.lys::Some.property$0_1 (local.get $$ref) (local.get $value))
      (local.get $$ref)
    )
  )
  ...
  (func $test/fixtures/compiler/iterator-loco.lys::Iterator.next (param $iter i64) (result i64)
    ...
    (block $B1 (result i64)
      (if $IF2 (result i64) (call $system::core::i32.<= (call $test/fixtures/compiler/iterator-loco.lys::Iterator.property_current (local.get $iter)) (call $test/fixtures/compiler/iterator-loco.lys::Iterator.property_target (local.get $iter)))
          (then
            (block $B3 (result i64)
                (local.set $r (call $test/fixtures/compiler/iterator-loco.lys::Some.apply (call $test/fixtures/compiler/iterator-loco.lys::Iterator.property_current (local.get $iter))))
  ...
  (func $test/fixtures/compiler/iterator-loco.lys::test (param $from i32) (param $to i32) (result i32)
    ...
    (block $B1 (result i32)
      ...
      (local.set $$iter$ (call $test/fixtures/compiler/iterator-loco.lys::Iterator.apply (local.get $from) (local.get $to)))
      (block $Break2
          (loop $Loop2
              (block $B3
                  (block $B5
                      (local.set $var$5 (call $test/fixtures/compiler/iterator-loco.lys::Iterator.next (local.get $$iter$)))
                      (block $B5_0
                          (block $B5_1
                      ...
                      (block $B4
                          (local.set $value (call $test/fixtures/compiler/iterator-loco.lys::Some.property_value (local.get $var$5)))
