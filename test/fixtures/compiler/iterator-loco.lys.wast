(module
  ...
  (func $test/fixtures/compiler/iterator-loco.lys::Iterator.discriminant (result i64)
    (i64.const 0x100000000)
  )
  (func $test/fixtures/compiler/iterator-loco.lys::Iterator.sizeOf (result i32)
    (call $system::core::i32.+ (i32.const 8) (i32.const 8))
  )
  (func $test/fixtures/compiler/iterator-loco.lys::Iterator.allocationSize (result i32)
  ...
  (func $test/fixtures/compiler/iterator-loco.lys::Iterator.apply (param $current i32) (param $target i32) (result i64)
    (local $$ref i64)
    (block $B1 (result i64)
      (set_local $$ref (call $test/fixtures/compiler/iterator-loco.lys::Iterator.fromPointer (call $system::memory::calloc (i32.const 1) (call $test/fixtures/compiler/iterator-loco.lys::Iterator.sizeOf))))
      (call $test/fixtures/compiler/iterator-loco.lys::Iterator.set$current (get_local $$ref) (get_local $current))
      (call $test/fixtures/compiler/iterator-loco.lys::Iterator.set$target (get_local $$ref) (get_local $target))
      (get_local $$ref)
    )
  )
  ...
  (func $test/fixtures/compiler/iterator-loco.lys::Iterator.property_current_1 (param $target i64) (param $value i32)
    (call $test/fixtures/compiler/iterator-loco.lys::Iterator.set$current (get_local $target) (get_local $value))
  )
  (func $test/fixtures/compiler/iterator-loco.lys::Iterator.set$current (param $target i64) (param $value i32)
  ...
  (func $test/fixtures/compiler/iterator-loco.lys::Iterator.property_target_1 (param $target i64) (param $value i32)
    (call $test/fixtures/compiler/iterator-loco.lys::Iterator.set$target (get_local $target) (get_local $value))
  )
  (func $test/fixtures/compiler/iterator-loco.lys::Iterator.set$target (param $target i64) (param $value i32)
  ...
  (func $test/fixtures/compiler/iterator-loco.lys::Some.discriminant (result i64)
    (i64.const 0x400000000)
  )
  (func $test/fixtures/compiler/iterator-loco.lys::Some.sizeOf (result i32)
    (i32.const 8)
  )
  (func $test/fixtures/compiler/iterator-loco.lys::Some.allocationSize (result i32)
    (call $system::core::ref.allocationSize)
  )
  (func $test/fixtures/compiler/iterator-loco.lys::Some.apply (param $value i32) (result i64)
    (local $$ref i64)
    (block $B1 (result i64)
      (set_local $$ref (call $test/fixtures/compiler/iterator-loco.lys::Some.fromPointer (call $system::memory::calloc (i32.const 1) (call $test/fixtures/compiler/iterator-loco.lys::Some.sizeOf))))
      (call $test/fixtures/compiler/iterator-loco.lys::Some.set$value (get_local $$ref) (get_local $value))
      (get_local $$ref)
    )
  )
  ...
  (func $test/fixtures/compiler/iterator-loco.lys::Some.property_value_1 (param $target i64) (param $value i32)
    (call $test/fixtures/compiler/iterator-loco.lys::Some.set$value (get_local $target) (get_local $value))
  )
  (func $test/fixtures/compiler/iterator-loco.lys::Some.set$value (param $target i64) (param $value i32)
    (call $system::core::i32.store_1 (get_local $target) (get_local $value) (i32.const 0))
  )
