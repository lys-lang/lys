(module
  ...
  (func $test/fixtures/compiler/iterator-loco.lys::Iterator.Iterator$discriminant (result i64)
    ...
    (block $B1 (result i64)
      ...
      (call $system::core::u64.<< (call $system::core::u32.as_1 (local.get $test/fixtures/compiler/iterator-loco.lys::discriminant)) (i32.const 32))
    )
  )
  (func $test/fixtures/compiler/iterator-loco.lys::Iterator.apply (param $current i32) (param $target i32) (result i64)
    ...
    (block $B1 (result i64)
      (local.set $test/fixtures/compiler/iterator-loco.lys::$ref (call $test/fixtures/compiler/iterator-loco.lys::Iterator.fromPointer (call $system::memory::calloc (call $system::core::i32.as_3 (i32.const 1)) (i32.const 8))))
      (call $test/fixtures/compiler/iterator-loco.lys::Iterator.property$0_1 (local.get $test/fixtures/compiler/iterator-loco.lys::$ref) (local.get $current))
      (call $test/fixtures/compiler/iterator-loco.lys::Iterator.property$1_1 (local.get $test/fixtures/compiler/iterator-loco.lys::$ref) (local.get $target))
  ...
  (func $test/fixtures/compiler/iterator-loco.lys::Iterator.fromPointer (param $ptr i32) (result i64)
    (i64.or (call $test/fixtures/compiler/iterator-loco.lys::Iterator.Iterator$discriminant) (i64.extend_u/i32 (local.get $ptr)))
  )
  ...
  (func $test/fixtures/compiler/iterator-loco.lys::Iterator.property_current (param $self i64) (result i32)
    (call $test/fixtures/compiler/iterator-loco.lys::Iterator.property$0 (local.get $self))
  )
  (func $test/fixtures/compiler/iterator-loco.lys::Iterator.property_current_1 (param $self i64) (param $value i32)
    (call $test/fixtures/compiler/iterator-loco.lys::Iterator.property$0_1 (local.get $self) (local.get $value))
  )
  ...
  (func $test/fixtures/compiler/iterator-loco.lys::Iterator.property_target (param $self i64) (result i32)
    (call $test/fixtures/compiler/iterator-loco.lys::Iterator.property$1 (local.get $self))
  )
  (func $test/fixtures/compiler/iterator-loco.lys::Iterator.property_target_1 (param $self i64) (param $value i32)
    (call $test/fixtures/compiler/iterator-loco.lys::Iterator.property$1_1 (local.get $self) (local.get $value))
  )
  ...
  (func $test/fixtures/compiler/iterator-loco.lys::Iterator.is (param $a i64) (result i32)
    (i64.eq (i64.and (i64.const 0xffffffff00000000) (local.get $a)) (call $test/fixtures/compiler/iterator-loco.lys::Iterator.Iterator$discriminant))
  )
  ...
  (func $test/fixtures/compiler/iterator-loco.lys::Iterator.as (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  (func $test/fixtures/compiler/iterator-loco.lys::Iterator.next (param $iter i64) (result i64)
    ...
    (block $B1 (result i64)
      (if $IF2 (result i64) (call $system::core::i32.<= (call $test/fixtures/compiler/iterator-loco.lys::Iterator.property_current (local.get $iter)) (call $test/fixtures/compiler/iterator-loco.lys::Iterator.property_target (local.get $iter)))
          (then
            (block $B3 (result i64)
                (local.set $test/fixtures/compiler/iterator-loco.lys::r (call $test/fixtures/compiler/iterator-loco.lys::Some.apply (call $test/fixtures/compiler/iterator-loco.lys::Iterator.property_current (local.get $iter))))
                (call $test/fixtures/compiler/iterator-loco.lys::Iterator.property_current_1 (local.get $iter) (call $system::core::i32.+ (call $test/fixtures/compiler/iterator-loco.lys::Iterator.property_current (local.get $iter)) (i32.const 1)))
  ...
  (func $test/fixtures/compiler/iterator-loco.lys::Maybe.is (param $a i64) (result i32)
    (block $B1 (result i32)
      (call $system::core::boolean.|| (call $test/fixtures/compiler/iterator-loco.lys::None.is (local.get $a)) (call $test/fixtures/compiler/iterator-loco.lys::Some.is (local.get $a)))
    )
  )
  ...
  (func $test/fixtures/compiler/iterator-loco.lys::None.as (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  ...
  (func $test/fixtures/compiler/iterator-loco.lys::None.None$discriminant (result i64)
    ...
    (block $B1 (result i64)
      ...
      (call $system::core::i64.<< (call $system::core::u32.as (local.get $test/fixtures/compiler/iterator-loco.lys::discriminant_3)) (i32.const 32))
    )
  )
  ...
  (func $test/fixtures/compiler/iterator-loco.lys::None.is (param $a i64) (result i32)
    (i64.eq (i64.and (i64.const 0xffffffff00000000) (local.get $a)) (call $test/fixtures/compiler/iterator-loco.lys::None.None$discriminant))
  )
  ...
  (func $test/fixtures/compiler/iterator-loco.lys::Some.as (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  ...
  (func $test/fixtures/compiler/iterator-loco.lys::Some.Some$discriminant (result i64)
    ...
    (block $B1 (result i64)
      ...
      (call $system::core::u64.<< (call $system::core::u32.as_1 (local.get $test/fixtures/compiler/iterator-loco.lys::discriminant_6)) (i32.const 32))
    )
  )
  (func $test/fixtures/compiler/iterator-loco.lys::Some.apply (param $value i32) (result i64)
    ...
    (block $B1 (result i64)
      (local.set $test/fixtures/compiler/iterator-loco.lys::$ref_4 (call $test/fixtures/compiler/iterator-loco.lys::Some.fromPointer (call $system::memory::calloc (call $system::core::i32.as_3 (i32.const 1)) (i32.const 4))))
      (call $test/fixtures/compiler/iterator-loco.lys::Some.property$0_1 (local.get $test/fixtures/compiler/iterator-loco.lys::$ref_4) (local.get $value))
  ...
  (func $test/fixtures/compiler/iterator-loco.lys::Some.fromPointer (param $ptr i32) (result i64)
    (i64.or (call $test/fixtures/compiler/iterator-loco.lys::Some.Some$discriminant) (i64.extend_u/i32 (local.get $ptr)))
  )
  ...
  (func $test/fixtures/compiler/iterator-loco.lys::Some.property_value (param $self i64) (result i32)
    (call $test/fixtures/compiler/iterator-loco.lys::Some.property$0 (local.get $self))
  )
  (func $test/fixtures/compiler/iterator-loco.lys::Some.property_value_1 (param $self i64) (param $value i32)
    (call $test/fixtures/compiler/iterator-loco.lys::Some.property$0_1 (local.get $self) (local.get $value))
  )
  ...
  (func $test/fixtures/compiler/iterator-loco.lys::Some.is (param $a i64) (result i32)
    (i64.eq (i64.and (i64.const 0xffffffff00000000) (local.get $a)) (call $test/fixtures/compiler/iterator-loco.lys::Some.Some$discriminant))
  )
  ...
  (func $test/fixtures/compiler/iterator-loco.lys::test (param $from i32) (param $to i32) (result i32)
    ...
    (block $B1 (result i32)
      ...
      (local.set $test/fixtures/compiler/iterator-loco.lys::$iter$ (call $test/fixtures/compiler/iterator-loco.lys::Iterator.apply (local.get $from) (local.get $to)))
      (block $Break2
          (loop $Loop2
              (block $B3
                  (block $B5
                      (local.set $var$5 (call $test/fixtures/compiler/iterator-loco.lys::Iterator.next (local.get $test/fixtures/compiler/iterator-loco.lys::$iter$)))
                      (block $B5_0
                          (block $B5_1
                              (br_if $B5_0 (call $test/fixtures/compiler/iterator-loco.lys::Some.is (local.get $var$5)))
                              (br_if $B5_1 (call $test/fixtures/compiler/iterator-loco.lys::None.is (local.get $var$5)))
                            )
                          (br $Break2)
                          (br $B5)
                        )
                      (block $B4
                          (local.set $test/fixtures/compiler/iterator-loco.lys::value_8 (call $test/fixtures/compiler/iterator-loco.lys::Some.property_value (local.get $var$5)))
                          (local.set $test/fixtures/compiler/iterator-loco.lys::ret (call $system::core::i32.+ (local.get $test/fixtures/compiler/iterator-loco.lys::ret) (local.get $test/fixtures/compiler/iterator-loco.lys::value_8)))
                          (br $Loop2)
                        )
                      (br $B5)
                    )
