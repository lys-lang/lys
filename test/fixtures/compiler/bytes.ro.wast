(module
  ...
  (data 0 (i32.const 16) "asdasd")
  (data 0 (i32.const 22) "utf Â«ããÂ»")
  ...
  (func $%%START%%
    (set_global $test/fixtures/compiler/bytes.ro::a_2 (i64.const 0x600000010))
    (set_global $test/fixtures/compiler/bytes.ro::b_1 (i64.const 0xe00000016))
  )
  (start $%%START%%)
)
