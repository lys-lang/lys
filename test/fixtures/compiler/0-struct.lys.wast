(module
  ...
  (func $test/fixtures/compiler/0-struct.lys::Custom.apply (param $r i32) (param $g i32) (param $b i32) (result i64)
    (local $$ref i64)
    (block $B1 (result i64)
      (set_local $$ref (call $test/fixtures/compiler/0-struct.lys::Custom.fromPointer (call $system::memory::calloc (i32.const 1) (i32.const 12))))
  ...
  (func $test/fixtures/compiler/0-struct.lys::Custom.property_r (param $self i64) (result i32)
    (call $test/fixtures/compiler/0-struct.lys::Custom.property$0 (get_local $self))
  )
  (func $test/fixtures/compiler/0-struct.lys::Custom.property_r_1 (param $self i64) (param $value i32)
    (call $test/fixtures/compiler/0-struct.lys::Custom.property$0_1 (get_local $self) (get_local $value))
  )
