(module
  ...
  (func $test::fixtures::compiler::0-struct::Color.is_1 (param $a i64) (result i32)
    (block $B1 (result i32)
      (call $system::core::boolean::boolean.||_1 (call $system::core::boolean::boolean.||_1 (call $system::core::boolean::boolean.||_1 (call $test::fixtures::compiler::0-struct::Red.is_1 (local.get $a)) (call $test::fixtures::compiler::0-struct::Green.is_1 (local.get $a))) (call $test::fixtures::compiler::0-struct::Blue.is_1 (local.get $a))) (call $test::fixtures::compiler::0-struct::Custom.is_1 (local.get $a)))
    )
  )
  ...
  (func $test::fixtures::compiler::0-struct::Red.Red$discriminant_1 (result i64)
    ...
    (block $B1 (result i64)
      (local.set $test::fixtures::compiler::0-struct::discriminant (i32.const 1))
      (call $system::core::i64::i64.<<_1 (call $system::core::u32::u32.as_1 (local.get $test::fixtures::compiler::0-struct::discriminant)) (i32.const 32))
    )
  )
  ...
  (func $test::fixtures::compiler::0-struct::Green.Green$discriminant_1 (result i64)
    ...
    (block $B1 (result i64)
      (local.set $test::fixtures::compiler::0-struct::discriminant_1 (i32.const 2))
      (call $system::core::i64::i64.<<_1 (call $system::core::u32::u32.as_1 (local.get $test::fixtures::compiler::0-struct::discriminant_1)) (i32.const 32))
    )
  )
  ...
  (func $test::fixtures::compiler::0-struct::Blue.Blue$discriminant_1 (result i64)
    ...
    (block $B1 (result i64)
      (local.set $test::fixtures::compiler::0-struct::discriminant_2 (i32.const 3))
      (call $system::core::i64::i64.<<_1 (call $system::core::u32::u32.as_1 (local.get $test::fixtures::compiler::0-struct::discriminant_2)) (i32.const 32))
    )
  )
  ...
  (func $test::fixtures::compiler::0-struct::Custom.as_2 (param $self i64) (result i32)
    (call $system::core::native::addressFromRef_1 (get_local $self))
  )
  (func $test::fixtures::compiler::0-struct::Custom.as_3 (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  (func $test::fixtures::compiler::0-struct::Custom.Custom$discriminant_1 (result i64)
    ...
    (block $B1 (result i64)
      (local.set $test::fixtures::compiler::0-struct::discriminant_3 (i32.const 4))
      (call $system::core::u64::u64.<<_1 (call $system::core::u32::u32.as_2 (local.get $test::fixtures::compiler::0-struct::discriminant_3)) (i32.const 32))
    )
  )
  (func $test::fixtures::compiler::0-struct::Custom.apply_1 (param $r i32) (param $g i32) (param $b i32) (result i64)
    ...
    (block $B1 (result i64)
      (local.set $test::fixtures::compiler::0-struct::$ref (call $test::fixtures::compiler::0-struct::Custom.fromPointer_1 (call $system::core::memory::calloc_1 (call $system::core::i32::i32.as_4 (i32.const 1)) (i32.const 12))))
  ...
  (func $test::fixtures::compiler::0-struct::testColors_1
    (block $B1
      (call $support::test::assert_1 (call $system::core::boolean::boolean.==_1 (call $test::fixtures::compiler::0-struct::isRed_1 (call $test::fixtures::compiler::0-struct::Red.apply_1)) (i32.const 1)))
      (call $support::test::assert_1 (call $system::core::boolean::boolean.==_1 (call $test::fixtures::compiler::0-struct::isRed_1 (call $test::fixtures::compiler::0-struct::Green.apply_1)) (i32.const 0)))
      (call $support::test::assert_1 (call $system::core::boolean::boolean.==_1 (call $test::fixtures::compiler::0-struct::isRed_1 (call $test::fixtures::compiler::0-struct::Blue.apply_1)) (i32.const 0)))
      (call $support::test::assert_1 (call $system::core::boolean::boolean.==_1 (call $test::fixtures::compiler::0-struct::isRed_1 (call $test::fixtures::compiler::0-struct::Custom.apply_1 (i32.const 5) (i32.const 5) (i32.const 5))) (i32.const 0)))
    )
  )
  (func $%%START%%
