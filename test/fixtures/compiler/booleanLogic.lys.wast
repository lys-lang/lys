(module
  ...
  (export "test" (func $test/fixtures/compiler/booleanLogic.lys::test))
  (func $test/fixtures/compiler/booleanLogic.lys::test (param $a i32) (param $b i32) (result i32)
    (call $system::core::boolean.&& (get_local $a) (get_local $b))
  )
)
