(module
  ...
  (func $test::fixtures::compiler::extern::main_1
    (block $B1
      (call $test::fixtures::compiler::extern::putchar_1 (call $system::core::i32::i32.as_4 (i32.const 0)))
      (call $test::fixtures::compiler::extern::printf_1 (call $system::core::i32::i32.as_4 (i32.const 0)) (i32.const 0))
    )
  )
  (func $%%START%%
