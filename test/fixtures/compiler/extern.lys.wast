(module
  (import "env" "printf" (func $test/fixtures/compiler/extern.lys::printf (param $str i32) (param $extra i32)))
  ...
  (export "main" (func $test/fixtures/compiler/extern.lys::main))
  (func $test/fixtures/compiler/extern.lys::main
    (block $B1
      (call $test/fixtures/compiler/extern.lys::putchar (call $system::core::i32.as_3 (i32.const 0)))
      (call $test/fixtures/compiler/extern.lys::printf (call $system::core::i32.as_3 (i32.const 0)) (i32.const 0))
    )
  )
)
