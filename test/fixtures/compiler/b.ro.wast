(module
  ...
  (func $test/fixtures/compiler/b.ro::innerFunction (result i32)
    (call $test/fixtures/compiler/b.ro::innerFunctionArgs (i32.const 3))
  )
  (func $test/fixtures/compiler/b.ro::over (result i32)
    (i32.const 1)
  )
  (func $test/fixtures/compiler/b.ro::over_1 (param $a i32) (result i32)
    (get_local $a)
  )
  (func $test/fixtures/compiler/b.ro::outerFunction (result i32)
    (call $system::core::i32.+ (call $test/fixtures/compiler/b.ro::innerFunction) (call $test/fixtures/compiler/b.ro::over))
  )
)
