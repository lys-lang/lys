(module
  ...
  (func $test/fixtures/compiler/patternMatchinIs.ro::Custom.apply (param $a i32) (result i64)
    ...
    (block $unknown_block_3 (result i64)
      (set_local $ref (call $test/fixtures/compiler/patternMatchinIs.ro::Custom.fromPointer (call $system::memory::malloc (call $test/fixtures/compiler/patternMatchinIs.ro::Custom.sizeOf))))
      (call $test/fixtures/compiler/patternMatchinIs.ro::Custom.property_a_1 (get_local $ref) (get_local $a))
      (get_local $ref)
    )
  )
