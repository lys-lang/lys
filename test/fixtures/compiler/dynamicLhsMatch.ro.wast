(module
  ...
  (func $test::test (param $a i32) (result i32)
    ...
    (block $B1 (result i32)
      ...
      (block $B1_0
          (block $B1_1
              (br_if $B1_0 (call $system::core::==_11 (i32.const 1) (get_local $var$1)))
            )
          (i32.const 1)
          (br $B1)
        )
  ...
  (func $test::test2 (param $a i32) (result i32)
    (if $a_wild_if (result i32) (call $system::core::==_11 (call $system::core::+ (get_local $a) (i32.const 1)) (i32.const 1))
      (then
        (i32.const 0)
      )
      (else
