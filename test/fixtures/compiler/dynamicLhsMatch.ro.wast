(module
  ...
  (export "test" (func $test/fixtures/compiler/dynamicLhsMatch.ro::test))
  (export "test2" (func $test/fixtures/compiler/dynamicLhsMatch.ro::test2))
  (func $test/fixtures/compiler/dynamicLhsMatch.ro::test (param $a i32) (result i32)
    (local $var$1 i32)
    (block $B1 (result i32)
      (set_local $var$1 (call $system::core::+ (get_local $a) (i32.const 1)))
      (block $B1_0
          (block $B1_1
              (br_if $B1_0 (call $system::core::==_12 (i32.const 1) (get_local $var$1)))
            )
          (i32.const 1)
          (br $B1)
        )
  ...
  (func $test/fixtures/compiler/dynamicLhsMatch.ro::test2 (param $a i32) (result i32)
    (if $a_wild_if (result i32) (call $system::core::==_12 (call $system::core::+ (get_local $a) (i32.const 1)) (i32.const 1))
      (then
        (i32.const 0)
      )
      (else
