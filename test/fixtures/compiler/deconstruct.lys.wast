(module
  ...
  (func $test/fixtures/compiler/deconstruct.lys::Color.is (param $a i64) (result i32)
    (block $B1 (result i32)
      (call $system::core::boolean.|| (call $system::core::boolean.|| (call $system::core::boolean.|| (call $test/fixtures/compiler/deconstruct.lys::Red.is (get_local $a)) (call $test/fixtures/compiler/deconstruct.lys::Green.is (get_local $a))) (call $test/fixtures/compiler/deconstruct.lys::Blue.is (get_local $a))) (call $test/fixtures/compiler/deconstruct.lys::Custom.is (get_local $a)))
    )
  )
  ...
  (func $test/fixtures/compiler/deconstruct.lys::Red.is (param $a i64) (result i32)
    (i64.eq (i64.and (i64.const 0xffffffff00000000) (get_local $a)) (call $test/fixtures/compiler/deconstruct.lys::Red.Red$discriminant))
  )
  ...
  (func $test/fixtures/compiler/deconstruct.lys::Green.is (param $a i64) (result i32)
    (i64.eq (i64.and (i64.const 0xffffffff00000000) (get_local $a)) (call $test/fixtures/compiler/deconstruct.lys::Green.Green$discriminant))
  )
  ...
  (func $test/fixtures/compiler/deconstruct.lys::Blue.is (param $a i64) (result i32)
    (i64.eq (i64.and (i64.const 0xffffffff00000000) (get_local $a)) (call $test/fixtures/compiler/deconstruct.lys::Blue.Blue$discriminant))
  )
  ...
  (func $test/fixtures/compiler/deconstruct.lys::Custom.apply (param $a i32) (result i64)
    (local $$ref i64)
    (block $B1 (result i64)
      (set_local $$ref (call $test/fixtures/compiler/deconstruct.lys::Custom.fromPointer (call $system::memory::calloc (i32.const 1) (i32.const 4))))
      (call $test/fixtures/compiler/deconstruct.lys::Custom.property$0_1 (get_local $$ref) (get_local $a))
      (get_local $$ref)
    )
  )
  (func $test/fixtures/compiler/deconstruct.lys::Custom.fromPointer (param $ptr i32) (result i64)
    (i64.or (call $test/fixtures/compiler/deconstruct.lys::Custom.Custom$discriminant) (i64.extend_u/i32 (get_local $ptr)))
  )
  ...
  (func $test/fixtures/compiler/deconstruct.lys::Custom.property_a (param $self i64) (result i32)
    (call $test/fixtures/compiler/deconstruct.lys::Custom.property$0 (get_local $self))
  )
  (func $test/fixtures/compiler/deconstruct.lys::Custom.property_a_1 (param $self i64) (param $value i32)
    (call $test/fixtures/compiler/deconstruct.lys::Custom.property$0_1 (get_local $self) (get_local $value))
  )
  ...
  (func $test/fixtures/compiler/deconstruct.lys::Custom.is (param $a i64) (result i32)
    (i64.eq (i64.and (i64.const 0xffffffff00000000) (get_local $a)) (call $test/fixtures/compiler/deconstruct.lys::Custom.Custom$discriminant))
  )
  ...
  (func $test/fixtures/compiler/deconstruct.lys::isRed (param $x i64) (result i32)
    ...
    (block $B1 (result i32)
      (block $B3 (result i32)
          (set_local $var$2 (get_local $x))
          (block $B3_0
              (block $B3_1
                  (block $B3_2
                      (br_if $B3_0 (call $test/fixtures/compiler/deconstruct.lys::Red.is (get_local $var$2)))
                      (br_if $B3_1 (call $test/fixtures/compiler/deconstruct.lys::Custom.is (get_local $var$2)))
                    )
                  (i32.const 0)
                  (br $B3)
                )
              (block $B2 (result i32)
                  (set_local $a (call $test/fixtures/compiler/deconstruct.lys::Custom.property_a (get_local $var$2)))
                  (call $system::core::i32.== (get_local $a) (i32.const 16711680))
                )
              (br $B3)
            )
          (i32.const 1)
