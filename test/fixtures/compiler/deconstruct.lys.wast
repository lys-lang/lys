(module
  ...
  (func $test::fixtures::compiler::deconstruct::Color.is_1 (param $a i64) (result i32)
    (block $B1 (result i32)
      (call $system::core::boolean::boolean.||_1 (call $system::core::boolean::boolean.||_1 (call $system::core::boolean::boolean.||_1 (call $test::fixtures::compiler::deconstruct::Red.is_1 (local.get $a)) (call $test::fixtures::compiler::deconstruct::Green.is_1 (local.get $a))) (call $test::fixtures::compiler::deconstruct::Blue.is_1 (local.get $a))) (call $test::fixtures::compiler::deconstruct::Custom.is_1 (local.get $a)))
    )
  )
  ...
  (func $test::fixtures::compiler::deconstruct::Red.Red$discriminant_1 (result i64)
    ...
    (block $B1 (result i64)
      (local.set $test::fixtures::compiler::deconstruct::discriminant (i32.const 1))
      (call $system::core::i64::i64.<<_1 (call $system::core::u32::u32.as_1 (local.get $test::fixtures::compiler::deconstruct::discriminant)) (i32.const 32))
    )
  )
  ...
  (func $test::fixtures::compiler::deconstruct::Green.Green$discriminant_1 (result i64)
    ...
    (block $B1 (result i64)
      (local.set $test::fixtures::compiler::deconstruct::discriminant_1 (i32.const 2))
      (call $system::core::i64::i64.<<_1 (call $system::core::u32::u32.as_1 (local.get $test::fixtures::compiler::deconstruct::discriminant_1)) (i32.const 32))
    )
  )
  ...
  (func $test::fixtures::compiler::deconstruct::Blue.Blue$discriminant_1 (result i64)
    ...
    (block $B1 (result i64)
      (local.set $test::fixtures::compiler::deconstruct::discriminant_2 (i32.const 3))
      (call $system::core::i64::i64.<<_1 (call $system::core::u32::u32.as_1 (local.get $test::fixtures::compiler::deconstruct::discriminant_2)) (i32.const 32))
    )
  )
  ...
  (func $test::fixtures::compiler::deconstruct::Custom.as_2 (param $self i64) (result i32)
    (call $system::core::native::addressFromRef_1 (get_local $self))
  )
  (func $test::fixtures::compiler::deconstruct::Custom.as_3 (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  (func $test::fixtures::compiler::deconstruct::Custom.Custom$discriminant_1 (result i64)
    ...
    (block $B1 (result i64)
      (local.set $test::fixtures::compiler::deconstruct::discriminant_3 (i32.const 4))
      (call $system::core::u64::u64.<<_1 (call $system::core::u32::u32.as_2 (local.get $test::fixtures::compiler::deconstruct::discriminant_3)) (i32.const 32))
    )
  )
  (func $test::fixtures::compiler::deconstruct::Custom.apply_1 (param $a i32) (result i64)
    ...
    (block $B1 (result i64)
      (local.set $test::fixtures::compiler::deconstruct::$ref (call $test::fixtures::compiler::deconstruct::Custom.fromPointer_1 (call $system::core::memory::calloc_1 (call $system::core::i32::i32.as_4 (i32.const 1)) (i32.const 4))))
      ...
      (block $B3 (result i32)
          ...
          (block $B3_0
              ...
              (block $B2 (result i32)
                  ...
                  (call $system::core::u32::u32.==_1 (local.get $test::fixtures::compiler::deconstruct::a_15) (i32.const 0xFF0000))
                )
              (br $B3)
            )
          (i32.const 1)
