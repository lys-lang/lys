(module
  ...
  (func $test/fixtures/compiler/deconstruct.lys::Custom.discriminant (result i64)
    (i64.const 0x500000000)
  )
  (func $test/fixtures/compiler/deconstruct.lys::Custom.sizeOf (result i32)
    (i32.const 8)
  )
  (func $test/fixtures/compiler/deconstruct.lys::Custom.allocationSize (result i32)
    (call $system::core::ref.allocationSize)
  )
  (func $test/fixtures/compiler/deconstruct.lys::Custom.apply (param $a i32) (result i64)
    (local $$ref i64)
    (block $B1 (result i64)
      (set_local $$ref (call $test/fixtures/compiler/deconstruct.lys::Custom.fromPointer (call $system::memory::calloc (i32.const 1) (call $test/fixtures/compiler/deconstruct.lys::Custom.sizeOf))))
      (call $test/fixtures/compiler/deconstruct.lys::Custom.set$a (get_local $$ref) (get_local $a))
      (get_local $$ref)
    )
  )
  ...
  (func $test/fixtures/compiler/deconstruct.lys::Custom.property_a_1 (param $target i64) (param $value i32)
    (call $test/fixtures/compiler/deconstruct.lys::Custom.set$a (get_local $target) (get_local $value))
  )
  (func $test/fixtures/compiler/deconstruct.lys::Custom.set$a (param $target i64) (param $value i32)
