(module
  ...
  (func $test/fixtures/compiler/deconstruct.lys::Custom.apply (param $a i32) (result i64)
    (local $$ref i64)
    (block $B1 (result i64)
      (set_local $$ref (call $test/fixtures/compiler/deconstruct.lys::Custom.fromPointer (call $system::memory::calloc (i32.const 1) (i32.const 8))))
  ...
  (func $test/fixtures/compiler/deconstruct.lys::Custom.property_a (param $target i64) (result i32)
    (call $test/fixtures/compiler/deconstruct.lys::Custom.property$0 (get_local $target))
  )
  (func $test/fixtures/compiler/deconstruct.lys::Custom.property_a_1 (param $target i64) (param $value i32)
    (call $test/fixtures/compiler/deconstruct.lys::Custom.property$0_1 (get_local $target) (get_local $value))
  )
  (func $test/fixtures/compiler/deconstruct.lys::Custom.property$0 (param $target i64) (result i32)
    (call $system::core::i32.load_1 (get_local $target) (i32.const 0))
  )
  (func $test/fixtures/compiler/deconstruct.lys::Custom.property$0_1 (param $target i64) (param $value i32)
