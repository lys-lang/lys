(module
  ...
  (func $test/fixtures/compiler/deconstruct.lys::Red.as (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  ...
  (func $test/fixtures/compiler/deconstruct.lys::Red.Red$discriminant (result i64)
    ...
    (block $B1 (result i64)
      ...
      (call $system::core::i64.<< (call $system::core::u32.as (local.get $test/fixtures/compiler/deconstruct.lys::discriminant)) (i32.const 32))
    )
  )
  ...
  (func $test/fixtures/compiler/deconstruct.lys::Green.as (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  ...
  (func $test/fixtures/compiler/deconstruct.lys::Green.Green$discriminant (result i64)
    ...
    (block $B1 (result i64)
      ...
      (call $system::core::i64.<< (call $system::core::u32.as (local.get $test/fixtures/compiler/deconstruct.lys::discriminant_3)) (i32.const 32))
    )
  )
  ...
  (func $test/fixtures/compiler/deconstruct.lys::Blue.as (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  ...
  (func $test/fixtures/compiler/deconstruct.lys::Blue.Blue$discriminant (result i64)
    ...
    (block $B1 (result i64)
      ...
      (call $system::core::i64.<< (call $system::core::u32.as (local.get $test/fixtures/compiler/deconstruct.lys::discriminant_6)) (i32.const 32))
    )
  )
  ...
  (func $test/fixtures/compiler/deconstruct.lys::Custom.as (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  ...
  (func $test/fixtures/compiler/deconstruct.lys::Custom.Custom$discriminant (result i64)
    ...
    (block $B1 (result i64)
      ...
      (call $system::core::u64.<< (call $system::core::u32.as_1 (local.get $test/fixtures/compiler/deconstruct.lys::discriminant_9)) (i32.const 32))
    )
  )
  (func $test/fixtures/compiler/deconstruct.lys::Custom.apply (param $a i32) (result i64)
    ...
    (block $B1 (result i64)
      (local.set $test/fixtures/compiler/deconstruct.lys::$ref (call $test/fixtures/compiler/deconstruct.lys::Custom.fromPointer (call $system::memory::calloc (call $system::core::i32.as_3 (i32.const 1)) (i32.const 4))))
      (call $test/fixtures/compiler/deconstruct.lys::Custom.property$0_1 (local.get $test/fixtures/compiler/deconstruct.lys::$ref) (local.get $a))
    ...
    (block $B1 (result i32)
      (block $B3 (result i32)
          ...
          (block $B3_0
              ...
              (block $B2 (result i32)
                  (local.set $test/fixtures/compiler/deconstruct.lys::a_6 (call $test/fixtures/compiler/deconstruct.lys::Custom.property_a (local.get $var$2)))
                  (call $system::core::i32.== (local.get $test/fixtures/compiler/deconstruct.lys::a_6) (i32.const 0xFF0000))
                )
              (br $B3)
            )
          (i32.const 1)
