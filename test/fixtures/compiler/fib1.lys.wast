    ...
    (block $B1 (result i32)
      ...
      (block $B1_0
          (block $B1_1
              ...
              (call $test::fixtures::compiler::fib1::fibo_1 (call $system::core::i32::i32.-_1 (local.get $n) (i32.const 1)) (local.get $b) (call $system::core::i32::i32.+_1 (local.get $a) (local.get $b)))
              (br $B1)
            )
          (local.get $b)
          (br $B1)
