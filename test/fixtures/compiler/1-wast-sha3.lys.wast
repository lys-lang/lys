(module
  ...
  (func $system::hash::keccak::keccak_reset_1 (param $context_offset i32)
    (block $B1
      (call $system::memory::memset_2 (local.get $context_offset) (call $system::core::i32.as_7 (i32.const 0)) (call $system::core::i32.as_3 (i32.const 400)))
    )
  )
  ...
  (func $system::hash::keccak::keccak_finish (param $context_offset i32) (param $output_offset i32)
    ...
    (call $system::memory::memset_2 (i32.add (get_local $residue_buffer) (get_local $tmp)) (i32.const 0) (i32.sub (i32.const 136) (get_local $tmp)))
  ...
  (func $system::hash::keccak::keccak (param $input i64) (result i64)
    ...
    (local $ret i64)
    (block $B1 (result i64)
      (local.set $context (call $system::memory::allocBytes (call $system::core::i32.as_3 (i32.const 616))))
      (local.set $ret (call $system::memory::allocBytes (call $system::core::i32.as_3 (i32.const 32))))
      (call $system::hash::keccak::keccak_init (call $system::core::bytes.property_ptr (local.get $context)))
      (call $system::hash::keccak::keccak_update (call $system::core::bytes.property_ptr (local.get $context)) (call $system::core::bytes.property_ptr (local.get $input)) (call $system::core::bytes.property_length (local.get $input)))
      (call $system::hash::keccak::keccak_finish (call $system::core::bytes.property_ptr (local.get $context)) (call $system::core::bytes.property_ptr (local.get $ret)))
      (local.get $ret)
    )
  )
  ...
  (func $test/fixtures/compiler/1-wast-sha3.lys::keccak (param $input i64) (result i64)
    (block $B1 (result i64)
      (call $system::hash::keccak::keccak (local.get $input))
    )
  )
  (func $%%START%%
