(module
  ...
  (func $system::hash::keccak::keccak (param $input i64) (result i64)
    ...
    (local $system::hash::keccak::ret i64)
    (block $B1 (result i64)
      (local.set $system::hash::keccak::context (call $system::memory::allocBytes (call $system::core::i32.as_3 (i32.const 616))))
      (local.set $system::hash::keccak::ret (call $system::memory::allocBytes (call $system::core::i32.as_3 (i32.const 32))))
      (call $system::hash::keccak::keccak_init (call $system::core::bytes.property_ptr (local.get $system::hash::keccak::context)))
      (call $system::hash::keccak::keccak_update (call $system::core::bytes.property_ptr (local.get $system::hash::keccak::context)) (call $system::core::bytes.property_ptr (local.get $input)) (call $system::core::bytes.property_length (local.get $input)))
      (call $system::hash::keccak::keccak_finish (call $system::core::bytes.property_ptr (local.get $system::hash::keccak::context)) (call $system::core::bytes.property_ptr (local.get $system::hash::keccak::ret)))
      (local.get $system::hash::keccak::ret)
    )
  )
