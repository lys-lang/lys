(module
  ...
  (global $test::x_4 (mut i32) (i32.const 0))
  (global $test::bc_2 (mut i32) (i32.const 0))
  (global $test::a_2 (mut i32) (i32.const 0))
  (func $test::main (result i32)
    (block $unknown_block_2 (result i32)
      (block $tee_global_3 (result i32)
          (set_global $test::x_4 (call $system::core::- (call $system::core::+ (get_global $test::x_4) (i32.const 1)) (get_global $test::a_2)))
          (get_global $test::x_4)
        )
    )
  )
  (func $%%START%%
    (set_global $test::x_4 (i32.const 2))
    (set_global $test::bc_2 (i32.const 1))
    (set_global $test::a_2 (block $unknown_block_1 (result i32)
            (call $system::core::- (get_global $test::bc_2) (get_global $test::x_4))
          ))
  )
  (start $%%START%%)
)
