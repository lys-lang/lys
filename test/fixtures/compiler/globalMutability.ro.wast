(module
  ...
  (func $system::core::bytes.property_ptr (param $str i64) (result i32)
    (block $unknown_block_39 (result i32)
  ...
  (func $test/fixtures/compiler/globalMutability.ro::main (result i32)
    (block $unknown_block_2 (result i32)
      (block $tee_global_3 (result i32)
          (set_global $test/fixtures/compiler/globalMutability.ro::x_4 (call $system::core::i32.- (call $system::core::i32.+ (get_global $test/fixtures/compiler/globalMutability.ro::x_4) (i32.const 1)) (get_global $test/fixtures/compiler/globalMutability.ro::a_2)))
  ...
  (func $%%START%%
    ...
    (set_global $test/fixtures/compiler/globalMutability.ro::a_2 (block $unknown_block_1 (result i32)
            (call $system::core::i32.- (get_global $test/fixtures/compiler/globalMutability.ro::bc_2) (get_global $test/fixtures/compiler/globalMutability.ro::x_4))
          ))
  )
  (start $%%START%%)
)
