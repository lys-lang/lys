(module
  ...
  (func $test::fixtures::compiler::if::gcd_1 (param $x i32) (param $y i32) (result i32)
    (if $IF1 (result i32) (call $system::core::i32::i32.>_1 (local.get $x) (local.get $y))
      (then
        (call $test::fixtures::compiler::if::gcd_1 (call $system::core::i32::i32.-_1 (local.get $x) (local.get $y)) (local.get $y))
      )
      (else
        (if $IF2 (result i32) (call $system::core::i32::i32.<_1 (local.get $x) (local.get $y))
            (then
              (call $test::fixtures::compiler::if::gcd_1 (local.get $x) (call $system::core::i32::i32.-_1 (local.get $y) (local.get $x)))
            )
            (else
              (local.get $x)
            )
  ...
  (func $test::fixtures::compiler::if::ifWithoutElse_1 (param $x i32) (result i32)
    ...
    (block $B1 (result i32)
      ...
      (if $IF2 (call $system::core::i32::i32.==_1 (local.get $x) (i32.const 1))
          (then
            (block $B3
