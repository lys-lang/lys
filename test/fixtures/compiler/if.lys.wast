(module
  ...
  (export "gcd" (func $test/fixtures/compiler/if.lys::gcd))
  (export "test" (func $test/fixtures/compiler/if.lys::test))
  (export "ifWithoutElse" (func $test/fixtures/compiler/if.lys::ifWithoutElse))
  (func $test/fixtures/compiler/if.lys::gcd (param $x i32) (param $y i32) (result i32)
    (if $IF1 (result i32) (call $system::core::i32.> (get_local $x) (get_local $y))
      (then
        (call $test/fixtures/compiler/if.lys::gcd (call $system::core::i32.- (get_local $x) (get_local $y)) (get_local $y))
      )
      (else
        (if $IF2 (result i32) (call $system::core::i32.< (get_local $x) (get_local $y))
            (then
              (call $test/fixtures/compiler/if.lys::gcd (get_local $x) (call $system::core::i32.- (get_local $y) (get_local $x)))
            )
            (else
              (get_local $x)
            )
  ...
  (func $test/fixtures/compiler/if.lys::test (result i32)
    (call $test/fixtures/compiler/if.lys::gcd (i32.const 119) (i32.const 7))
  )
  (func $test/fixtures/compiler/if.lys::ifWithoutElse (param $x i32) (result i32)
    (local $a i32)
    (block $B1 (result i32)
