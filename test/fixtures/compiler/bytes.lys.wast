(module
  ...
  (func $%%START%%
    ...
    (global.set $test::fixtures::compiler::bytes::a (i64.const 0x0000000300000010))
    (global.set $test::fixtures::compiler::bytes::b (i64.const 0x0000000300000021))
  )
  (start $%%START%%)
)
