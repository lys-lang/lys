(module
  ...
  (func $test/fixtures/compiler/bytes.lys::main (result i64)
    (global.get $test/fixtures/compiler/bytes.lys::a_2)
  )
  (func $%%START%%
    (global.set $test/fixtures/compiler/bytes.lys::a_2 (i64.const 0x0000000000000010))
    (global.set $test/fixtures/compiler/bytes.lys::b_1 (i64.const 0x0000000000000021))
  )
  (start $%%START%%)
)
