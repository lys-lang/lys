(module
  ...
  (global $test/fixtures/compiler/bytes.lys::a_2 (mut i64) (i64.const 0))
  (global $test/fixtures/compiler/bytes.lys::b_1 (mut i64) (i64.const 0))
  (export "main" (func $test/fixtures/compiler/bytes.lys::main))
  (func $test/fixtures/compiler/bytes.lys::main (result i64)
    (get_global $test/fixtures/compiler/bytes.lys::a_2)
  )
  (func $%%START%%
    (set_global $test/fixtures/compiler/bytes.lys::a_2 (i64.const 0x0000000000000010))
    (set_global $test/fixtures/compiler/bytes.lys::b_1 (i64.const 0x0000000000000021))
  )
  (start $%%START%%)
)
