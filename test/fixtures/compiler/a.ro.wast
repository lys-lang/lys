(module
  ...
  (func $system::core::bytes.property_ptr (param $str i64) (result i32)
    (block $unknown_block_26 (result i32)
  ...
  (export "test" (func $test/fixtures/compiler/a.ro::test))
  (export "test0" (func $test/fixtures/compiler/a.ro::test0))
  (export "testa" (func $test/fixtures/compiler/a.ro::testa))
  (export "floatingPoints" (func $test/fixtures/compiler/a.ro::floatingPoints))
  (export "addFloat" (func $test/fixtures/compiler/a.ro::addFloat))
  (export "addInts" (func $test/fixtures/compiler/a.ro::addInts))
  (export "x" (func $test/fixtures/compiler/a.ro::x))
  (func $test/fixtures/compiler/a.ro::test (result i32)
    (i32.const 1)
  )
  (func $test/fixtures/compiler/a.ro::test0 (result i32)
    (i32.const 1)
  )
  (func $test/fixtures/compiler/a.ro::testa (param $a i32) (result i32)
    (get_local $a)
  )
  (func $test/fixtures/compiler/a.ro::floatingPoints (param $a f32) (param $b f64) (result f32)
    (get_local $a)
  )
  (func $test/fixtures/compiler/a.ro::addFloat (param $a f32) (param $b f32) (result f32)
    (call $system::core::f32.+ (get_local $a) (get_local $b))
  )
  (func $test/fixtures/compiler/a.ro::addInts (param $a i32) (param $b i32) (result i32)
    (call $system::core::i32.+ (get_local $a) (get_local $b))
  )
  (func $test/fixtures/compiler/a.ro::x (param $width f32) (param $height f32) (result f32)
