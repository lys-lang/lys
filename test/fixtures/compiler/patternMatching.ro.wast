(module
  ...
  (func $test::is (param $a i64) (result i32)
    (block $unknown_block_1 (result i32)
      (call $system::core::|| (call $test::is_2 (get_local $a)) (call $test::is_4 (get_local $a)))
    )
  )
  ...
  (func $test::as_5 (param $a i64) (result i64)
    (get_local $a)
  )
  ...
  (func $test::apply_2 (param $value i32) (result i64)
  ...
  (func $test::get_value (param $target i64) (result i32)
    (local $offset i32)
    (set_local $offset (i32.const 0))
    (unreachable)
  )
  (func $test::set_value (param $target i64) (param $value i32)
    (local $offset i32)
    (set_local $offset (i32.const 0))
    (unreachable)
  )
  ...
  (func $test::test (param $a i32) (result i32)
    ...
    (block $B2 (result i32)
      ...
      (block $B2_0
          (block $B2_1
              (br_if $B2_0 (call $system::core::==_11 (i32.const 1) (get_local $var$1)))
            )
          (i32.const 0)
          (br $B2)
        )
                          ...
                          (block $B3_5
                              (block $B3_6
                                  (block $B3_7
                                      (block $B3_8
                                          (block $B3_9
                                              (br_if $B3_0 (call $system::core::==_11 (i32.const 10) (get_local $var$1)))
                                              (br_if $B3_1 (call $system::core::==_11 (i32.const 20) (get_local $var$1)))
                                              (br_if $B3_2 (call $system::core::==_11 (i32.const 30) (get_local $var$1)))
                                              (br_if $B3_3 (call $system::core::==_11 (i32.const 40) (get_local $var$1)))
                                              (br_if $B3_4 (call $system::core::==_11 (i32.const 50) (get_local $var$1)))
                                              (br_if $B3_5 (call $system::core::==_11 (i32.const 60) (get_local $var$1)))
                                              (br_if $B3_6 (call $system::core::==_11 (i32.const 70) (get_local $var$1)))
                                              (br_if $B3_7 (call $system::core::==_11 (i32.const 80) (get_local $var$1)))
                                              (br_if $B3_8 (call $system::core::==_11 (i32.const 90) (get_local $var$1)))
                                            )
                                          (i32.const 0)
                                          (br $B3)
                                        )
  ...
  (func $test::test3 (param $a i64) (result i32)
    ...
    (block $B4 (result i32)
      ...
      (block $B4_0
          (block $B4_1
              (br_if $B4_0 (call $test::is_4 (get_local $var$1)))
              (br_if $B4_1 (call $test::is_2 (get_local $var$1)))
            )
          (i32.const 0)
          (br $B4)
        )
  ...
  (func $test::test4 (param $a i64) (result i64)
    ...
    (block $B5 (result i64)
      ...
      (block $B5_0
          (block $B5_1
              (br_if $B5_0 (call $test::is_4 (get_local $var$1)))
              (br_if $B5_1 (call $test::is_2 (get_local $var$1)))
            )
          (call $test::apply_2 (i32.const 0))
          (br $B5)
        )
      (get_local $var$1)
      (br $B5)
