(module
  ...
  (export "main" (func $test/fixtures/compiler/mutability.lys::main))
  (export "main2" (func $test/fixtures/compiler/mutability.lys::main2))
  (func $test/fixtures/compiler/mutability.lys::main (result i32)
    (local $a i32)
    (block $B1 (result i32)
  ...
  (func $test/fixtures/compiler/mutability.lys::main2 (param $x i32) (result i32)
    (local $a i32)
    (block $B1 (result i32)
      (set_local $a (i32.const 1))
