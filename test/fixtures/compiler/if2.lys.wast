  ...
  (func $test::fixtures::compiler::if2::gcd_1 (param $x i32) (param $y i32) (result i32)
    (block $B1 (result i32)
      (if $IF2 (result i32) (call $system::core::i32::i32.>_1 (local.get $x) (local.get $y))
          (then
            (block $B3 (result i32)
                (call $test::fixtures::compiler::if2::gcd_1 (call $system::core::i32::i32.-_1 (local.get $x) (local.get $y)) (local.get $y))
              )
          )
          (else
            (if $IF4 (result i32) (call $system::core::i32::i32.<_1 (local.get $x) (local.get $y))
                (then
                  (block $B5 (result i32)
                      (call $test::fixtures::compiler::if2::gcd_1 (local.get $x) (call $system::core::i32::i32.-_1 (local.get $y) (local.get $x)))
                    )
                )
                (else
                  (block $B6 (result i32)
