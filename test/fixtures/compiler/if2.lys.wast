(module
  ...
  (export "gcd" (func $test/fixtures/compiler/if2.lys::gcd))
  (export "test" (func $test/fixtures/compiler/if2.lys::test))
  (func $test/fixtures/compiler/if2.lys::gcd (param $x i32) (param $y i32) (result i32)
    (block $B1 (result i32)
      (if $IF2 (result i32) (call $system::core::i32.> (get_local $x) (get_local $y))
          (then
            (block $B3 (result i32)
                (call $test/fixtures/compiler/if2.lys::gcd (call $system::core::i32.- (get_local $x) (get_local $y)) (get_local $y))
              )
          )
          (else
            (if $IF4 (result i32) (call $system::core::i32.< (get_local $x) (get_local $y))
                (then
                  (block $B5 (result i32)
                      (call $test/fixtures/compiler/if2.lys::gcd (get_local $x) (call $system::core::i32.- (get_local $y) (get_local $x)))
                    )
                )
                (else
                  (block $B6 (result i32)
  ...
  (func $test/fixtures/compiler/if2.lys::test (result i32)
    (block $B1 (result i32)
      (call $test/fixtures/compiler/if2.lys::gcd (i32.const 119) (i32.const 7))
    )
  )
)
