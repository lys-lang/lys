(module
  ...
  (export "testInt" (func $test/fixtures/compiler/infix.lys::testInt))
  (export "testFloat" (func $test/fixtures/compiler/infix.lys::testFloat))
  (func $test/fixtures/compiler/infix.lys::sum (param $a f32) (param $b f32) (result f32)
    (call $system::core::f32.+ (get_local $a) (get_local $b))
  )
  (func $test/fixtures/compiler/infix.lys::sum_1 (param $a i32) (param $b i32) (result i32)
    (call $system::core::i32.+ (get_local $a) (get_local $b))
  )
  (func $test/fixtures/compiler/infix.lys::testInt (param $a i32) (param $b i32) (result i32)
    (call $test/fixtures/compiler/infix.lys::sum_1 (get_local $a) (get_local $b))
  )
  (func $test/fixtures/compiler/infix.lys::testFloat (param $a f32) (param $b f32) (result f32)
    (call $test/fixtures/compiler/infix.lys::sum (get_local $a) (get_local $b))
  )
)
