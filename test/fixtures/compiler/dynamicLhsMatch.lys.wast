(module
  ...
  (func $test::fixtures::compiler::dynamicLhsMatch::test_1 (param $a i32) (result i32)
    (local $var$1 i32)
    (block $B1 (result i32)
      (local.set $var$1 (call $system::core::i32::i32.+_1 (local.get $a) (i32.const 1)))
      (block $B1_0
          (block $B1_1
  ...
  (func $test::fixtures::compiler::dynamicLhsMatch::test2_1 (param $a i32) (result i32)
    (if $IF1 (result i32) (call $system::core::i32::i32.==_1 (call $system::core::i32::i32.+_1 (local.get $a) (i32.const 1)) (i32.const 1))
      (then
        (i32.const 0)
      )
      (else
