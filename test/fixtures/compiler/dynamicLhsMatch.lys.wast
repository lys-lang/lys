(module
  ...
  (export "test" (func $test/fixtures/compiler/dynamicLhsMatch.lys::test))
  (export "test2" (func $test/fixtures/compiler/dynamicLhsMatch.lys::test2))
  (func $test/fixtures/compiler/dynamicLhsMatch.lys::test (param $a i32) (result i32)
    (local $var$1 i32)
    (block $B1 (result i32)
      (set_local $var$1 (call $system::core::i32.+ (get_local $a) (i32.const 1)))
      (block $B1_0
          (block $B1_1
  ...
  (func $test/fixtures/compiler/dynamicLhsMatch.lys::test2 (param $a i32) (result i32)
    (if $IF1 (result i32) (call $system::core::i32.== (call $system::core::i32.+ (get_local $a) (i32.const 1)) (i32.const 1))
      (then
        (i32.const 0)
      )
      (else
