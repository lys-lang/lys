(module
  ...
  (export "isRed" (func $test/fixtures/compiler/deconstruct.ro::isRed))
  (func $test/fixtures/compiler/deconstruct.ro::Color.is (param $a i64) (result i32)
    (block $B1 (result i32)
      (call $system::core::boolean.|| (call $system::core::boolean.|| (call $system::core::boolean.|| (call $test/fixtures/compiler/deconstruct.ro::Red.is (get_local $a)) (call $test/fixtures/compiler/deconstruct.ro::Green.is (get_local $a))) (call $test/fixtures/compiler/deconstruct.ro::Blue.is (get_local $a))) (call $test/fixtures/compiler/deconstruct.ro::Custom.is (get_local $a)))
    )
  )
  (func $test/fixtures/compiler/deconstruct.ro::Color.== (param $lhs i64) (param $rhs i64) (result i32)
    (call $system::core::ref.== (get_local $lhs) (get_local $rhs))
  )
  (func $test/fixtures/compiler/deconstruct.ro::Color.!= (param $lhs i64) (param $rhs i64) (result i32)
    (call $system::core::ref.!= (get_local $lhs) (get_local $rhs))
  )
  (func $test/fixtures/compiler/deconstruct.ro::Color.store (param $lhs i64) (param $rhs i64) (param $offset i32)
    (i64.store (i32.add (get_local $offset) (call $system::core::addressFromRef (get_local $lhs))) (get_local $rhs))
  )
  (func $test/fixtures/compiler/deconstruct.ro::Color.load (param $lhs i64) (param $offset i32) (result i64)
    (i64.load (i32.add (get_local $offset) (call $system::core::addressFromRef (get_local $lhs))))
  )
  (func $test/fixtures/compiler/deconstruct.ro::Red.as (param $a i64) (result i64)
    (get_local $a)
  )
  (func $test/fixtures/compiler/deconstruct.ro::Green.as (param $a i64) (result i64)
    (get_local $a)
  )
  (func $test/fixtures/compiler/deconstruct.ro::Blue.as (param $a i64) (result i64)
    (get_local $a)
  )
  (func $test/fixtures/compiler/deconstruct.ro::Custom.as (param $a i64) (result i64)
    (get_local $a)
  )
  (func $test/fixtures/compiler/deconstruct.ro::Color.as (param $a i64) (result i64)
    (get_local $a)
  )
  (func $test/fixtures/compiler/deconstruct.ro::Color.as_1 (param $a i64) (result i64)
    (get_local $a)
  )
  (func $test/fixtures/compiler/deconstruct.ro::Red.apply (result i64)
    (i64.const 0x200000000)
  )
  (func $test/fixtures/compiler/deconstruct.ro::Red.is (param $a i64) (result i32)
    (i64.eq (i64.and (i64.const 0xffffffff00000000) (get_local $a)) (i64.const 0x200000000))
  )
  (func $test/fixtures/compiler/deconstruct.ro::Red.== (param $a i64) (param $b i64) (result i32)
    (i64.eq (get_local $a) (get_local $b))
  )
  (func $test/fixtures/compiler/deconstruct.ro::Red.!= (param $a i64) (param $b i64) (result i32)
    (i64.ne (get_local $a) (get_local $b))
  )
  (func $test/fixtures/compiler/deconstruct.ro::Red.store (param $lhs i64) (param $rhs i64) (param $offset i32)
    (i64.store (i32.add (get_local $offset) (call $system::core::addressFromRef (get_local $lhs))) (get_local $rhs))
  )
  (func $test/fixtures/compiler/deconstruct.ro::Red.load (param $lhs i64) (param $offset i32) (result i64)
    (i64.load (i32.add (get_local $offset) (call $system::core::addressFromRef (get_local $lhs))))
  )
  (func $test/fixtures/compiler/deconstruct.ro::Green.apply (result i64)
    (i64.const 0x300000000)
  )
  (func $test/fixtures/compiler/deconstruct.ro::Green.is (param $a i64) (result i32)
    (i64.eq (i64.and (i64.const 0xffffffff00000000) (get_local $a)) (i64.const 0x300000000))
  )
  (func $test/fixtures/compiler/deconstruct.ro::Green.== (param $a i64) (param $b i64) (result i32)
    (i64.eq (get_local $a) (get_local $b))
  )
  (func $test/fixtures/compiler/deconstruct.ro::Green.!= (param $a i64) (param $b i64) (result i32)
    (i64.ne (get_local $a) (get_local $b))
  )
  (func $test/fixtures/compiler/deconstruct.ro::Green.store (param $lhs i64) (param $rhs i64) (param $offset i32)
    (i64.store (i32.add (get_local $offset) (call $system::core::addressFromRef (get_local $lhs))) (get_local $rhs))
  )
  (func $test/fixtures/compiler/deconstruct.ro::Green.load (param $lhs i64) (param $offset i32) (result i64)
    (i64.load (i32.add (get_local $offset) (call $system::core::addressFromRef (get_local $lhs))))
  )
  (func $test/fixtures/compiler/deconstruct.ro::Blue.apply (result i64)
    (i64.const 0x400000000)
  )
  (func $test/fixtures/compiler/deconstruct.ro::Blue.is (param $a i64) (result i32)
    (i64.eq (i64.and (i64.const 0xffffffff00000000) (get_local $a)) (i64.const 0x400000000))
  )
  (func $test/fixtures/compiler/deconstruct.ro::Blue.== (param $a i64) (param $b i64) (result i32)
    (i64.eq (get_local $a) (get_local $b))
  )
  (func $test/fixtures/compiler/deconstruct.ro::Blue.!= (param $a i64) (param $b i64) (result i32)
    (i64.ne (get_local $a) (get_local $b))
  )
  (func $test/fixtures/compiler/deconstruct.ro::Blue.store (param $lhs i64) (param $rhs i64) (param $offset i32)
    (i64.store (i32.add (get_local $offset) (call $system::core::addressFromRef (get_local $lhs))) (get_local $rhs))
  )
  (func $test/fixtures/compiler/deconstruct.ro::Blue.load (param $lhs i64) (param $offset i32) (result i64)
    (i64.load (i32.add (get_local $offset) (call $system::core::addressFromRef (get_local $lhs))))
  )
  (func $test/fixtures/compiler/deconstruct.ro::Custom.discriminant (result i64)
    (i64.const 0x500000000)
  )
  (func $test/fixtures/compiler/deconstruct.ro::Custom.sizeOf (result i32)
    (i32.const 8)
  )
  (func $test/fixtures/compiler/deconstruct.ro::Custom.allocationSize (result i32)
    (call $system::core::ref.allocationSize)
  )
  (func $test/fixtures/compiler/deconstruct.ro::Custom.apply (param $a i32) (result i64)
    (local $$ref i64)
    (block $B1 (result i64)
      (set_local $$ref (call $test/fixtures/compiler/deconstruct.ro::Custom.fromPointer (call $system::memory::calloc (i32.const 1) (call $test/fixtures/compiler/deconstruct.ro::Custom.sizeOf))))
      (call $test/fixtures/compiler/deconstruct.ro::Custom.set$a (get_local $$ref) (get_local $a))
      (get_local $$ref)
    )
  )
  (func $test/fixtures/compiler/deconstruct.ro::Custom.fromPointer (param $ptr i32) (result i64)
    (i64.or (i64.const 0x500000000) (i64.extend_u/i32 (get_local $ptr)))
  )
  (func $test/fixtures/compiler/deconstruct.ro::Custom.property_a (param $target i64) (result i32)
    (call $system::core::i32.load_1 (get_local $target) (i32.const 0))
  )
  (func $test/fixtures/compiler/deconstruct.ro::Custom.property_a_1 (param $target i64) (param $value i32)
    (call $test/fixtures/compiler/deconstruct.ro::Custom.set$a (get_local $target) (get_local $value))
  )
  (func $test/fixtures/compiler/deconstruct.ro::Custom.set$a (param $target i64) (param $value i32)
    (call $system::core::i32.store_1 (get_local $target) (get_local $value) (i32.const 0))
  )
  (func $test/fixtures/compiler/deconstruct.ro::Custom.is (param $a i64) (result i32)
    (i64.eq (i64.and (i64.const 0xffffffff00000000) (get_local $a)) (i64.const 0x500000000))
  )
  (func $test/fixtures/compiler/deconstruct.ro::Custom.store (param $lhs i64) (param $rhs i64) (param $offset i32)
    (i64.store (i32.add (get_local $offset) (call $system::core::addressFromRef (get_local $lhs))) (get_local $rhs))
  )
  (func $test/fixtures/compiler/deconstruct.ro::Custom.load (param $lhs i64) (param $offset i32) (result i64)
    (i64.load (i32.add (get_local $offset) (call $system::core::addressFromRef (get_local $lhs))))
  )
  (func $test/fixtures/compiler/deconstruct.ro::isRed (param $x i64) (result i32)
    (local $a i32)
    (local $var$2 i64)
    (block $B1 (result i32)
      (block $B3 (result i32)
          ...
          (block $B3_0
              (block $B3_1
                  (block $B3_2
                      (br_if $B3_0 (call $test/fixtures/compiler/deconstruct.ro::Red.is (get_local $var$2)))
                      (br_if $B3_1 (call $test/fixtures/compiler/deconstruct.ro::Custom.is (get_local $var$2)))
                    )
                  (i32.const 0)
                  (br $B3)
                )
              (block $B2 (result i32)
                  (set_local $a (call $test/fixtures/compiler/deconstruct.ro::Custom.property_a (get_local $var$2)))
