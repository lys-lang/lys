(module
  ...
  (func $system::core::bytes.property_ptr (param $str i64) (result i32)
    (block $unknown_block_32 (result i32)
  ...
  (export "outer" (func $test/fixtures/compiler/c.ro::outer))
  (func $test/fixtures/compiler/c.ro::x (param $x i32) (result i32)
    (get_local $x)
  )
  (func $test/fixtures/compiler/c.ro::x_3 (param $x f32) (result f32)
    (get_local $x)
  )
  (func $test/fixtures/compiler/c.ro::outer (result i32)
    (call $test/fixtures/compiler/c.ro::x (i32.const 1))
  )
)
