  ...
  (func $test::fixtures::compiler::loops::test1_1
    ...
    (block $B1
      ...
      (block $Break2
          (loop $Loop2
              (block $B3
                  (local.set $test::fixtures::compiler::loops::x (call $system::core::i32::i32.+_1 (local.get $test::fixtures::compiler::loops::x) (i32.const 1)))
                  (if $IF4 (call $system::core::i32::i32.>_1 (local.get $test::fixtures::compiler::loops::x) (i32.const 10))
                      (then
                        (br $Break2)
                      )
                      (else)
  ...
  (func $test::fixtures::compiler::loops::test2_1
    ...
    (block $B1
      ...
      (block $Break2
          (loop $Loop2
              (block $B3
                  (local.set $test::fixtures::compiler::loops::x_1 (call $system::core::i32::i32.+_1 (local.get $test::fixtures::compiler::loops::x_1) (i32.const 1)))
                  (br $Loop2)
                )
            )
        )
          ...
          (loop $Loop2
              (block $B3
                  (block $Break4
                      (loop $Loop4
                          (block $B5
                              (local.set $test::fixtures::compiler::loops::x_2 (call $system::core::i32::i32.+_1 (local.get $test::fixtures::compiler::loops::x_2) (i32.const 1)))
                              (if $IF6 (call $system::core::i32::i32.==_1 (local.get $test::fixtures::compiler::loops::x_2) (i32.const 10))
                                  (then
                                    (br $Break4)
                                  )
                                  (else)
                  ...
                  (if $IF7 (call $system::core::i32::i32.>_1 (local.get $test::fixtures::compiler::loops::x_2) (i32.const 100))
                      (then
                        (br $Break2)
                      )
                      (else)
