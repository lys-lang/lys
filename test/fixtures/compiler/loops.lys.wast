  ...
  (func $test/fixtures/compiler/loops.lys::test1
    ...
    (block $B1
      ...
      (block $Break2
          (loop $Loop2
              (block $B3
                  (set_local $x (call $system::core::i32.+ (get_local $x) (i32.const 1)))
                  (if $IF4 (call $system::core::i32.> (get_local $x) (i32.const 10))
                      (then
                        (br $Break2)
                      )
                      (else)
              ...
              (block $B3
                  (block $Break4
                      (loop $Loop4
                          (block $B5
                              (set_local $x (call $system::core::i32.+ (get_local $x) (i32.const 1)))
                              (if $IF6 (call $system::core::i32.== (get_local $x) (i32.const 10))
                                  (then
                                    (br $Break4)
                                  )
                                  (else)
                  ...
                  (if $IF7 (call $system::core::i32.> (get_local $x) (i32.const 100))
                      (then
                        (br $Break2)
                      )
                      (else)
