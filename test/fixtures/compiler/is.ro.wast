(module
  ...
  (global $value1 (mut i64) (i64.const 0))
  (global $value2 (mut i64) (i64.const 0))
  (global $value3 (mut i64) (i64.const 0))
  ...
  (func $test::test
    ...
    (block $unknown_block_1
      (set_local $x1 (call $test::is (get_global $value1)))
      (set_local $y1 (call $test::is_3 (get_global $value1)))
      (set_local $z1 (call $test::is_1 (get_global $value1)))
      (set_local $x2 (call $test::is (get_global $value2)))
      (set_local $y2 (call $test::is_3 (get_global $value2)))
      (set_local $z2 (call $test::is_1 (get_global $value2)))
      (set_local $x3 (call $test::is (get_global $value3)))
      (set_local $y3 (call $test::is_3 (get_global $value3)))
      (set_local $z3 (call $test::is_1 (get_global $value3)))
    )
  )
  ...
  (func $%%START%%
    (set_global $value1 (call $AType))
    (set_global $value2 (call $AType))
    (set_global $value3 (call $AType))
  )
  (start $%%START%%)
)
