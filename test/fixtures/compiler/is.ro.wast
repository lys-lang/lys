(module
  ...
  (global $test::value3_4 (mut i64) (i64.const 0))
  ...
  (func $test::test
    ...
    (block $unknown_block_2
      (set_local $x1 (call $test::is_2 (get_global $test::value1_4)))
      (set_local $y1 (call $test::is (get_global $test::value1_4)))
      (set_local $z1 (call $test::is_4 (get_global $test::value1_4)))
      (set_local $x2 (call $test::is_2 (get_global $test::value2_4)))
      (set_local $y2 (call $test::is (get_global $test::value2_4)))
      (set_local $z2 (call $test::is_4 (get_global $test::value2_4)))
      (set_local $x3 (call $test::is_2 (get_global $test::value3_4)))
      (set_local $y3 (call $test::is (get_global $test::value3_4)))
      (set_local $z3 (call $test::is_4 (call $test::identity (get_global $test::value3_4))))
    )
  )
  (func $%%START%%
    (set_global $test::value1_4 (call $test::apply))
    (set_global $test::value2_4 (call $test::apply))
    (set_global $test::value3_4 (call $test::apply))
  )
  (start $%%START%%)
)
