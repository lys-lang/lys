(module
  ...
  (func $system::core::bytes.property_ptr (param $str i64) (result i32)
    (block $unknown_block_41 (result i32)
  ...
  (func $test/fixtures/compiler/is.ro::Enum.== (param $lhs i64) (param $rhs i64) (result i32)
    (call $system::core::ref.== (get_local $lhs) (get_local $rhs))
  )
  (func $test/fixtures/compiler/is.ro::Enum.!= (param $lhs i64) (param $rhs i64) (result i32)
    (call $system::core::ref.!= (get_local $lhs) (get_local $rhs))
  )
  (func $test/fixtures/compiler/is.ro::Enum.store (param $lhs i64) (param $rhs i64) (param $offset i32)
    (i64.store (i32.add (get_local $offset) (call $system::core::addressFromRef (get_local $lhs))) (get_local $rhs))
  )
  (func $test/fixtures/compiler/is.ro::Enum.load (param $lhs i64) (param $offset i32) (result i64)
    (i64.load (i32.add (get_local $offset) (call $system::core::addressFromRef (get_local $lhs))))
  )
  (func $test/fixtures/compiler/is.ro::A.as (param $a i64) (result i64)
    (get_local $a)
  )
  (func $test/fixtures/compiler/is.ro::B.as (param $a i64) (result i64)
    (get_local $a)
  )
  (func $test/fixtures/compiler/is.ro::C.as (param $a i64) (result i64)
    (get_local $a)
  )
  (func $test/fixtures/compiler/is.ro::Enum.as (param $a i64) (result i64)
    (get_local $a)
  )
  (func $test/fixtures/compiler/is.ro::Enum.as_1 (param $a i64) (result i64)
    (get_local $a)
  )
  (func $test/fixtures/compiler/is.ro::A.apply (result i64)
    (i64.const 0x200000000)
  )
  (func $test/fixtures/compiler/is.ro::A.is (param $a i64) (result i32)
    (i64.eq (i64.and (i64.const 0xffffffff00000000) (get_local $a)) (i64.const 0x200000000))
  )
  (func $test/fixtures/compiler/is.ro::A.== (param $a i64) (param $b i64) (result i32)
    (i64.eq (get_local $a) (get_local $b))
  )
  (func $test/fixtures/compiler/is.ro::A.!= (param $a i64) (param $b i64) (result i32)
    (i64.ne (get_local $a) (get_local $b))
  )
  (func $test/fixtures/compiler/is.ro::A.store (param $lhs i64) (param $rhs i64) (param $offset i32)
    (i64.store (i32.add (get_local $offset) (call $system::core::addressFromRef (get_local $lhs))) (get_local $rhs))
  )
  (func $test/fixtures/compiler/is.ro::A.load (param $lhs i64) (param $offset i32) (result i64)
    (i64.load (i32.add (get_local $offset) (call $system::core::addressFromRef (get_local $lhs))))
  )
  (func $test/fixtures/compiler/is.ro::B.apply (result i64)
    (i64.const 0x300000000)
  )
  (func $test/fixtures/compiler/is.ro::B.is (param $a i64) (result i32)
    (i64.eq (i64.and (i64.const 0xffffffff00000000) (get_local $a)) (i64.const 0x300000000))
  )
  (func $test/fixtures/compiler/is.ro::B.== (param $a i64) (param $b i64) (result i32)
    (i64.eq (get_local $a) (get_local $b))
  )
  (func $test/fixtures/compiler/is.ro::B.!= (param $a i64) (param $b i64) (result i32)
    (i64.ne (get_local $a) (get_local $b))
  )
  (func $test/fixtures/compiler/is.ro::B.store (param $lhs i64) (param $rhs i64) (param $offset i32)
    (i64.store (i32.add (get_local $offset) (call $system::core::addressFromRef (get_local $lhs))) (get_local $rhs))
  )
  (func $test/fixtures/compiler/is.ro::B.load (param $lhs i64) (param $offset i32) (result i64)
    (i64.load (i32.add (get_local $offset) (call $system::core::addressFromRef (get_local $lhs))))
  )
  (func $test/fixtures/compiler/is.ro::C.apply (result i64)
    (i64.const 0x400000000)
  )
  (func $test/fixtures/compiler/is.ro::C.is (param $a i64) (result i32)
    (i64.eq (i64.and (i64.const 0xffffffff00000000) (get_local $a)) (i64.const 0x400000000))
  )
  (func $test/fixtures/compiler/is.ro::C.== (param $a i64) (param $b i64) (result i32)
    (i64.eq (get_local $a) (get_local $b))
  )
  (func $test/fixtures/compiler/is.ro::C.!= (param $a i64) (param $b i64) (result i32)
    (i64.ne (get_local $a) (get_local $b))
  )
  (func $test/fixtures/compiler/is.ro::C.store (param $lhs i64) (param $rhs i64) (param $offset i32)
    (i64.store (i32.add (get_local $offset) (call $system::core::addressFromRef (get_local $lhs))) (get_local $rhs))
  )
  (func $test/fixtures/compiler/is.ro::C.load (param $lhs i64) (param $offset i32) (result i64)
    (i64.load (i32.add (get_local $offset) (call $system::core::addressFromRef (get_local $lhs))))
  )
  ...
  (func $test/fixtures/compiler/is.ro::test
    ...
    (block $unknown_block_2
      ...
      (set_local $x2 (call $test/fixtures/compiler/is.ro::A.is (get_global $test/fixtures/compiler/is.ro::value2_4)))
      (set_local $y2 (call $test/fixtures/compiler/is.ro::Enum.is (get_global $test/fixtures/compiler/is.ro::value2_4)))
      (set_local $z2 (call $test/fixtures/compiler/is.ro::B.is (get_global $test/fixtures/compiler/is.ro::value2_4)))
      (set_local $x3 (call $test/fixtures/compiler/is.ro::A.is (get_global $test/fixtures/compiler/is.ro::value3_4)))
      (set_local $y3 (call $test/fixtures/compiler/is.ro::Enum.is (get_global $test/fixtures/compiler/is.ro::value3_4)))
      (set_local $z3 (call $test/fixtures/compiler/is.ro::B.is (call $test/fixtures/compiler/is.ro::identity (get_global $test/fixtures/compiler/is.ro::value3_4))))
    )
  )
  (func $%%START%%
    (set_global $test/fixtures/compiler/is.ro::value1_4 (call $test/fixtures/compiler/is.ro::A.apply))
    (set_global $test/fixtures/compiler/is.ro::value2_4 (call $test/fixtures/compiler/is.ro::A.apply))
    (set_global $test/fixtures/compiler/is.ro::value3_4 (call $test/fixtures/compiler/is.ro::A.apply))
  )
  (start $%%START%%)
)
