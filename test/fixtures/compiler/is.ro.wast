(module
  ...
  (func $test/fixtures/compiler/is.ro::== (param $a i64) (param $b i64) (result i32)
  ...
  (func $test/fixtures/compiler/is.ro::==_2 (param $a i64) (param $b i64) (result i32)
    (i64.eq (get_local $a) (get_local $b))
  )
  (func $test/fixtures/compiler/is.ro::!=_2 (param $a i64) (param $b i64) (result i32)
    (i64.ne (get_local $a) (get_local $b))
  ...
  (func $test/fixtures/compiler/is.ro::==_4 (param $a i64) (param $b i64) (result i32)
    (i64.eq (get_local $a) (get_local $b))
  )
  (func $test/fixtures/compiler/is.ro::!=_4 (param $a i64) (param $b i64) (result i32)
    (i64.ne (get_local $a) (get_local $b))
