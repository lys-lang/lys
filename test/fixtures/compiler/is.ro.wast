(module
  ...
  (func $test::test
    ...
    (block $unknown_block_1
      (set_local $x1 (call $test::is (get_global $test::value1)))
      (set_local $y1 (call $test::is_3 (get_global $test::value1)))
      (set_local $z1 (call $test::is_1 (get_global $test::value1)))
      (set_local $x2 (call $test::is (get_global $test::value2)))
      (set_local $y2 (call $test::is_3 (get_global $test::value2)))
