(module
  ...
  (func $test/fixtures/compiler/if2.ro::gcd (param $x i32) (param $y i32) (result i32)
    (block $unknown_block_1 (result i32)
      (if $a_wild_if (result i32) (call $system::core::> (get_local $x) (get_local $y))
          (then
            (block $unknown_block_2 (result i32)
                (call $test/fixtures/compiler/if2.ro::gcd (call $system::core::- (get_local $x) (get_local $y)) (get_local $y))
              )
          )
          (else
            (if $a_wild_if (result i32) (call $system::core::< (get_local $x) (get_local $y))
                (then
                  (block $unknown_block_3 (result i32)
                      (call $test/fixtures/compiler/if2.ro::gcd (get_local $x) (call $system::core::- (get_local $y) (get_local $x)))
                    )
                )
                (else
