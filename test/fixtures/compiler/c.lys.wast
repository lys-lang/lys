(module
  ...
  (export "outer" (func $test/fixtures/compiler/c.lys::outer))
  (func $test/fixtures/compiler/c.lys::x (param $x i32) (result i32)
    (get_local $x)
  )
  (func $test/fixtures/compiler/c.lys::x_3 (param $x f32) (result f32)
    (get_local $x)
  )
  (func $test/fixtures/compiler/c.lys::outer (result i32)
    (call $test/fixtures/compiler/c.lys::x (i32.const 1))
  )
)
