(module
  ...
  (export "fib" (func $test/fixtures/compiler/fib2.lys::fib))
  (export "test" (func $test/fixtures/compiler/fib2.lys::test))
  (func $test/fixtures/compiler/fib2.lys::fibo (param $n i32) (param $x1 i32) (param $x2 i32) (result i32)
    (if $IF1 (result i32) (call $system::core::i32.> (get_local $n) (i32.const 0))
      (then
        (call $test/fixtures/compiler/fib2.lys::fibo (call $system::core::i32.- (get_local $n) (i32.const 1)) (get_local $x2) (call $system::core::i32.+ (get_local $x1) (get_local $x2)))
      )
      (else
        (get_local $x1)
      )
  ...
  (func $test/fixtures/compiler/fib2.lys::fib (param $n i32) (result i32)
    (call $test/fixtures/compiler/fib2.lys::fibo (get_local $n) (i32.const 0) (i32.const 1))
  )
  (func $test/fixtures/compiler/fib2.lys::test (result i32)
    (call $test/fixtures/compiler/fib2.lys::fib (i32.const 46))
  )
)
