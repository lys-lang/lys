(module
  ...
  (func $test/fixtures/compiler/fib2.lys::fibo (param $n i32) (param $x1 i32) (param $x2 i32) (result i32)
    (if $IF1 (result i32) (call $system::core::i32.> (local.get $n) (i32.const 0))
      (then
        (call $test/fixtures/compiler/fib2.lys::fibo (call $system::core::i32.- (local.get $n) (i32.const 1)) (local.get $x2) (call $system::core::i32.+ (local.get $x1) (local.get $x2)))
      )
      (else
        (local.get $x1)
      )
  ...
  (func $test/fixtures/compiler/fib2.lys::fib (param $n i32) (result i32)
    (call $test/fixtures/compiler/fib2.lys::fibo (local.get $n) (i32.const 0) (i32.const 1))
  )
