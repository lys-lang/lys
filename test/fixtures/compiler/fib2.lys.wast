(module
  ...
  (func $test::fixtures::compiler::fib2::fibo_1 (param $n i32) (param $x1 i32) (param $x2 i32) (result i32)
    (if $IF1 (result i32) (call $system::core::i32::i32.>_1 (local.get $n) (i32.const 0))
      (then
        (call $test::fixtures::compiler::fib2::fibo_1 (call $system::core::i32::i32.-_1 (local.get $n) (i32.const 1)) (local.get $x2) (call $system::core::i32::i32.+_1 (local.get $x1) (local.get $x2)))
      )
      (else
        (local.get $x1)
      )
