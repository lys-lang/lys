(module
  ...
  (func $system::core::bytes.property_ptr (param $str i64) (result i32)
    (block $unknown_block_33 (result i32)
  ...
  (export "fib" (func $test/fixtures/compiler/fib1.ro::fib))
  (func $test/fixtures/compiler/fib1.ro::fibo (param $n i32) (param $a i32) (param $b i32) (result i32)
    (local $var$3 i32)
    (block $B1 (result i32)
      ...
      (block $B1_0
          (block $B1_1
              ...
              (call $test/fixtures/compiler/fib1.ro::fibo (call $system::core::i32.- (get_local $n) (i32.const 1)) (get_local $b) (call $system::core::i32.+ (get_local $a) (get_local $b)))
              (br $B1)
            )
          (get_local $b)
          (br $B1)
  ...
  (func $test/fixtures/compiler/fib1.ro::fib (param $n i32) (result i32)
    (call $test/fixtures/compiler/fib1.ro::fibo (get_local $n) (i32.const 0) (i32.const 1))
  )
)
