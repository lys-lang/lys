  ...
  (func $test/fixtures/compiler/fib1.ro::fibo (param $n i32) (param $a i32) (param $b i32) (result i32)
    ...
    (block $B1 (result i32)
      ...
      (block $B1_0
          (block $B1_1
              (block $B1_2
                  (br_if $B1_0 (call $system::core::==_12 (i32.const 0) (get_local $var$3)))
                  (br_if $B1_1 (call $system::core::==_12 (i32.const 1) (get_local $var$3)))
                )
              (call $test/fixtures/compiler/fib1.ro::fibo (call $system::core::- (get_local $n) (i32.const 1)) (get_local $b) (call $system::core::+ (get_local $a) (get_local $b)))
              (br $B1)
            )
          (get_local $b)
          (br $B1)
