(module
  ...
  (func $test::fixtures::compiler::getter::Color.Color$discriminant_1 (result i64)
    ...
    (block $B1 (result i64)
      ...
      (call $system::core::u64::u64.<<_1 (call $system::core::u32::u32.as_2 (local.get $test::fixtures::compiler::getter::discriminant)) (i32.const 32))
    )
  )
  (func $test::fixtures::compiler::getter::Color.apply_1 (param $r i32) (param $g i32) (param $b i32) (result i64)
    ...
    (block $B1 (result i64)
      (local.set $test::fixtures::compiler::getter::$ref (call $test::fixtures::compiler::getter::Color.fromPointer_1 (call $system::core::memory::calloc_1 (call $system::core::i32::i32.as_4 (i32.const 1)) (i32.const 12))))
  ...
  (func $test::fixtures::compiler::getter::Color.as_1 (param $self i64) (result i32)
    (call $system::core::native::addressFromRef_1 (get_local $self))
  )
  (func $test::fixtures::compiler::getter::Color.as_2 (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  ...
  (func $test::fixtures::compiler::getter::main_1 (param $color i64) (result i32)
    (call $system::core::u32::u32.|_1 (call $system::core::u32::u32.|_1 (call $system::core::u32::u32.*_1 (call $test::fixtures::compiler::getter::Color.property_r_1 (local.get $color)) (i32.const 0x10000)) (call $system::core::u32::u32.*_1 (call $test::fixtures::compiler::getter::Color.property_g_1 (local.get $color)) (i32.const 0x100))) (call $test::fixtures::compiler::getter::Color.property_b_1 (local.get $color)))
  )
  (func $%%START%%
