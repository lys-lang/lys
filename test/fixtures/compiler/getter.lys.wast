(module
  ...
  (func $test::fixtures::compiler::getter::Color.is_1 (param $a i64) (result i32)
    ...
    (block $B1 (result i32)
      ...
      (call $system::core::u32::u32.==_1 (call $system::core::native::ref.getDiscriminant_1 (local.get $a)) (local.get $test::fixtures::compiler::getter::discriminant))
    )
  )
  ...
  (func $test::fixtures::compiler::getter::Color.Color$discriminant_1 (result i64)
    (local $test::fixtures::compiler::getter::discriminant_1 i32)
    (block $B1 (result i64)
      (local.set $test::fixtures::compiler::getter::discriminant_1 (i32.const 1))
      (call $system::core::u64::u64.<<_1 (call $system::core::u32::u32.as_2 (local.get $test::fixtures::compiler::getter::discriminant_1)) (i32.const 32))
    )
  )
  ...
  (func $test::fixtures::compiler::getter::Color.as_3 (param $self i64) (result i32)
    (call $system::core::native::addressFromRef_1 (local.get $self))
  )
  (func $test::fixtures::compiler::getter::Color.fromPointer_1 (param $ptr i32) (result i64)
    (i64.or (call $test::fixtures::compiler::getter::Color.Color$discriminant_1) (i64.extend_i32_u (local.get $ptr)))
  )
  ...
  (func $test::fixtures::compiler::getter::Color.r_1 (param $self i64) (result i32)
    (call $test::fixtures::compiler::getter::Color.property$0_1 (local.get $self))
  )
  (func $test::fixtures::compiler::getter::Color.r_2 (param $self i64) (param $value i32)
  ...
  (func $test::fixtures::compiler::getter::Color.g_1 (param $self i64) (result i32)
    (call $test::fixtures::compiler::getter::Color.property$1_1 (local.get $self))
  )
  (func $test::fixtures::compiler::getter::Color.g_2 (param $self i64) (param $value i32)
  ...
  (func $test::fixtures::compiler::getter::Color.b_1 (param $self i64) (result i32)
    (call $test::fixtures::compiler::getter::Color.property$2_1 (local.get $self))
  )
  (func $test::fixtures::compiler::getter::Color.b_2 (param $self i64) (param $value i32)
  ...
  (func $test::fixtures::compiler::getter::main_1 (param $color i64) (result i32)
    (call $system::core::u32::u32.|_1 (call $system::core::u32::u32.|_1 (call $system::core::u32::u32.*_1 (call $test::fixtures::compiler::getter::Color.r_1 (local.get $color)) (i32.const 0x10000)) (call $system::core::u32::u32.*_1 (call $test::fixtures::compiler::getter::Color.g_1 (local.get $color)) (i32.const 0x100))) (call $test::fixtures::compiler::getter::Color.b_1 (local.get $color)))
  )
  (func $%%START%%
