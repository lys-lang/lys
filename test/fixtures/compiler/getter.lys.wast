(module
  ...
  (func $test/fixtures/compiler/getter.lys::Color.Color$discriminant (result i64)
    ...
    (block $B1 (result i64)
      ...
      (call $system::core::u64.<< (call $system::core::u32.as_1 (local.get $test/fixtures/compiler/getter.lys::discriminant)) (i32.const 32))
    )
  )
  (func $test/fixtures/compiler/getter.lys::Color.apply (param $r i32) (param $g i32) (param $b i32) (result i64)
    ...
    (block $B1 (result i64)
      (local.set $test/fixtures/compiler/getter.lys::$ref (call $test/fixtures/compiler/getter.lys::Color.fromPointer (call $system::memory::calloc (call $system::core::i32.as_3 (i32.const 1)) (i32.const 12))))
      (call $test/fixtures/compiler/getter.lys::Color.property$0_1 (local.get $test/fixtures/compiler/getter.lys::$ref) (local.get $r))
      (call $test/fixtures/compiler/getter.lys::Color.property$1_1 (local.get $test/fixtures/compiler/getter.lys::$ref) (local.get $g))
      (call $test/fixtures/compiler/getter.lys::Color.property$2_1 (local.get $test/fixtures/compiler/getter.lys::$ref) (local.get $b))
  ...
  (func $test/fixtures/compiler/getter.lys::Color.as (param $lhs i64) (result i64)
    (local.get $lhs)
  )
  (func $test/fixtures/compiler/getter.lys::main (param $color i64) (result i32)
    (call $system::core::i32.| (call $system::core::i32.| (call $system::core::i32.* (call $test/fixtures/compiler/getter.lys::Color.property_r (local.get $color)) (i32.const 0x10000)) (call $system::core::i32.* (call $test/fixtures/compiler/getter.lys::Color.property_g (local.get $color)) (i32.const 0x100))) (call $test/fixtures/compiler/getter.lys::Color.property_b (local.get $color)))
  )
  (func $%%START%%
