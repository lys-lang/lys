(module
  ...
  (func $test/fixtures/compiler/getter.lys::Color.apply (param $r i32) (param $g i32) (param $b i32) (result i64)
    (local $$ref i64)
    (block $B1 (result i64)
      (local.set $$ref (call $test/fixtures/compiler/getter.lys::Color.fromPointer (call $system::memory::calloc (call $system::core::i32.as_3 (i32.const 1)) (i32.const 12))))
      (call $test/fixtures/compiler/getter.lys::Color.property$0_1 (local.get $$ref) (local.get $r))
      (call $test/fixtures/compiler/getter.lys::Color.property$1_1 (local.get $$ref) (local.get $g))
      (call $test/fixtures/compiler/getter.lys::Color.property$2_1 (local.get $$ref) (local.get $b))
      (local.get $$ref)
    )
  )
  (func $test/fixtures/compiler/getter.lys::Color.fromPointer (param $ptr i32) (result i64)
    (i64.or (call $test/fixtures/compiler/getter.lys::Color.Color$discriminant) (i64.extend_u/i32 (local.get $ptr)))
  )
  ...
  (func $test/fixtures/compiler/getter.lys::Color.property_r (param $self i64) (result i32)
    (call $test/fixtures/compiler/getter.lys::Color.property$0 (local.get $self))
  )
  (func $test/fixtures/compiler/getter.lys::Color.property_r_1 (param $self i64) (param $value i32)
    (call $test/fixtures/compiler/getter.lys::Color.property$0_1 (local.get $self) (local.get $value))
  )
  ...
  (func $test/fixtures/compiler/getter.lys::Color.property_g (param $self i64) (result i32)
    (call $test/fixtures/compiler/getter.lys::Color.property$1 (local.get $self))
  )
  (func $test/fixtures/compiler/getter.lys::Color.property_g_1 (param $self i64) (param $value i32)
    (call $test/fixtures/compiler/getter.lys::Color.property$1_1 (local.get $self) (local.get $value))
  )
  ...
  (func $test/fixtures/compiler/getter.lys::Color.property_b (param $self i64) (result i32)
    (call $test/fixtures/compiler/getter.lys::Color.property$2 (local.get $self))
  )
  (func $test/fixtures/compiler/getter.lys::Color.property_b_1 (param $self i64) (param $value i32)
    (call $test/fixtures/compiler/getter.lys::Color.property$2_1 (local.get $self) (local.get $value))
  )
  ...
  (func $test/fixtures/compiler/getter.lys::Color.is (param $a i64) (result i32)
    (i64.eq (i64.and (i64.const 0xffffffff00000000) (local.get $a)) (call $test/fixtures/compiler/getter.lys::Color.Color$discriminant))
  )
  ...
  (func $test/fixtures/compiler/getter.lys::main (param $color i64) (result i32)
    (call $system::core::i32.| (call $system::core::i32.| (call $system::core::i32.* (call $test/fixtures/compiler/getter.lys::Color.property_r (local.get $color)) (i32.const 65536)) (call $system::core::i32.* (call $test/fixtures/compiler/getter.lys::Color.property_g (local.get $color)) (i32.const 256))) (call $test/fixtures/compiler/getter.lys::Color.property_b (local.get $color)))
  )
  (func $%%START%%
