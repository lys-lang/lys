(module
  ...
  (export "main" (func $test/fixtures/compiler/getter.lys::main))
  (func $test/fixtures/compiler/getter.lys::Color.Color$discriminant (result i64)
  ...
  (func $test/fixtures/compiler/getter.lys::Color.apply (param $r i32) (param $g i32) (param $b i32) (result i64)
    (local $$ref i64)
    (block $B1 (result i64)
      (set_local $$ref (call $test/fixtures/compiler/getter.lys::Color.fromPointer (call $system::memory::calloc (i32.const 1) (i32.const 12))))
      (call $test/fixtures/compiler/getter.lys::Color.property$0_1 (get_local $$ref) (get_local $r))
      (call $test/fixtures/compiler/getter.lys::Color.property$1_1 (get_local $$ref) (get_local $g))
      (call $test/fixtures/compiler/getter.lys::Color.property$2_1 (get_local $$ref) (get_local $b))
      (get_local $$ref)
    )
  )
  (func $test/fixtures/compiler/getter.lys::Color.fromPointer (param $ptr i32) (result i64)
    (i64.or (call $test/fixtures/compiler/getter.lys::Color.Color$discriminant) (i64.extend_u/i32 (get_local $ptr)))
  )
  (func $test/fixtures/compiler/getter.lys::Color.== (param $a i64) (param $b i64) (result i32)
    (i64.eq (get_local $a) (get_local $b))
  )
  (func $test/fixtures/compiler/getter.lys::Color.!= (param $a i64) (param $b i64) (result i32)
    (i64.ne (get_local $a) (get_local $b))
  )
  (func $test/fixtures/compiler/getter.lys::Color.property_r (param $self i64) (result i32)
    (call $test/fixtures/compiler/getter.lys::Color.property$0 (get_local $self))
  )
  (func $test/fixtures/compiler/getter.lys::Color.property_r_1 (param $self i64) (param $value i32)
    (call $test/fixtures/compiler/getter.lys::Color.property$0_1 (get_local $self) (get_local $value))
  )
  (func $test/fixtures/compiler/getter.lys::Color.property$0 (param $self i64) (result i32)
    (call $system::core::i32.load_1 (get_local $self) (i32.const 0))
  )
  (func $test/fixtures/compiler/getter.lys::Color.property$0_1 (param $self i64) (param $value i32)
    (call $system::core::i32.store_1 (get_local $self) (get_local $value) (i32.const 0))
  )
  (func $test/fixtures/compiler/getter.lys::Color.property_g (param $self i64) (result i32)
    (call $test/fixtures/compiler/getter.lys::Color.property$1 (get_local $self))
  )
  (func $test/fixtures/compiler/getter.lys::Color.property_g_1 (param $self i64) (param $value i32)
    (call $test/fixtures/compiler/getter.lys::Color.property$1_1 (get_local $self) (get_local $value))
  )
  (func $test/fixtures/compiler/getter.lys::Color.property$1 (param $self i64) (result i32)
    (call $system::core::i32.load_1 (get_local $self) (i32.const 4))
  )
  (func $test/fixtures/compiler/getter.lys::Color.property$1_1 (param $self i64) (param $value i32)
    (call $system::core::i32.store_1 (get_local $self) (get_local $value) (i32.const 4))
  )
  (func $test/fixtures/compiler/getter.lys::Color.property_b (param $self i64) (result i32)
    (call $test/fixtures/compiler/getter.lys::Color.property$2 (get_local $self))
  )
  (func $test/fixtures/compiler/getter.lys::Color.property_b_1 (param $self i64) (param $value i32)
    (call $test/fixtures/compiler/getter.lys::Color.property$2_1 (get_local $self) (get_local $value))
  )
  (func $test/fixtures/compiler/getter.lys::Color.property$2 (param $self i64) (result i32)
    (call $system::core::i32.load_1 (get_local $self) (i32.const 8))
  )
  (func $test/fixtures/compiler/getter.lys::Color.property$2_1 (param $self i64) (param $value i32)
    (call $system::core::i32.store_1 (get_local $self) (get_local $value) (i32.const 8))
  )
  (func $test/fixtures/compiler/getter.lys::Color.is (param $a i64) (result i32)
    (i64.eq (i64.and (i64.const 0xffffffff00000000) (get_local $a)) (call $test/fixtures/compiler/getter.lys::Color.Color$discriminant))
  )
  (func $test/fixtures/compiler/getter.lys::Color.store (param $lhs i64) (param $rhs i64) (param $offset i32)
    (i64.store (i32.add (get_local $offset) (call $system::core::addressFromRef (get_local $lhs))) (get_local $rhs))
  )
  (func $test/fixtures/compiler/getter.lys::Color.load (param $lhs i64) (param $offset i32) (result i64)
    (i64.load (i32.add (get_local $offset) (call $system::core::addressFromRef (get_local $lhs))))
  )
  (func $test/fixtures/compiler/getter.lys::main (param $color i64) (result i32)
    (call $system::core::i32.| (call $system::core::i32.| (call $system::core::i32.* (call $test/fixtures/compiler/getter.lys::Color.property_r (get_local $color)) (i32.const 65536)) (call $system::core::i32.* (call $test/fixtures/compiler/getter.lys::Color.property_g (get_local $color)) (i32.const 256))) (call $test/fixtures/compiler/getter.lys::Color.property_b (get_local $color)))
  )
  (func $%%START%%
