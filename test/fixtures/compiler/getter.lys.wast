(module
  ...
  (func $test/fixtures/compiler/getter.lys::Color.apply (param $r i32) (param $g i32) (param $b i32) (result i64)
    (local $$ref i64)
    (block $B1 (result i64)
      (set_local $$ref (call $test/fixtures/compiler/getter.lys::Color.fromPointer (call $system::memory::calloc (i32.const 1) (i32.const 8))))
  ...
  (func $test/fixtures/compiler/getter.lys::Color.property_r (param $target i64) (result i32)
    (call $test/fixtures/compiler/getter.lys::Color.property$0 (get_local $target))
  )
  (func $test/fixtures/compiler/getter.lys::Color.property_r_1 (param $target i64) (param $value i32)
    (call $test/fixtures/compiler/getter.lys::Color.property$0_1 (get_local $target) (get_local $value))
  )
  (func $test/fixtures/compiler/getter.lys::Color.property$0 (param $target i64) (result i32)
    (call $system::core::i32.load_1 (get_local $target) (i32.const 0))
  )
  (func $test/fixtures/compiler/getter.lys::Color.property$0_1 (param $target i64) (param $value i32)
    (call $system::core::i32.store_1 (get_local $target) (get_local $value) (i32.const 0))
  )
  (func $test/fixtures/compiler/getter.lys::Color.property_g (param $target i64) (result i32)
    (call $test/fixtures/compiler/getter.lys::Color.property$1 (get_local $target))
  )
  (func $test/fixtures/compiler/getter.lys::Color.property_g_1 (param $target i64) (param $value i32)
    (call $test/fixtures/compiler/getter.lys::Color.property$1_1 (get_local $target) (get_local $value))
  )
  (func $test/fixtures/compiler/getter.lys::Color.property$1 (param $target i64) (result i32)
    (call $system::core::i32.load_1 (get_local $target) (i32.const 4))
  )
  (func $test/fixtures/compiler/getter.lys::Color.property$1_1 (param $target i64) (param $value i32)
    (call $system::core::i32.store_1 (get_local $target) (get_local $value) (i32.const 4))
  )
  (func $test/fixtures/compiler/getter.lys::Color.property_b (param $target i64) (result i32)
    (call $test/fixtures/compiler/getter.lys::Color.property$2 (get_local $target))
  )
  (func $test/fixtures/compiler/getter.lys::Color.property_b_1 (param $target i64) (param $value i32)
    (call $test/fixtures/compiler/getter.lys::Color.property$2_1 (get_local $target) (get_local $value))
  )
  (func $test/fixtures/compiler/getter.lys::Color.property$2 (param $target i64) (result i32)
    (call $system::core::i32.load_1 (get_local $target) (i32.const 8))
  )
  (func $test/fixtures/compiler/getter.lys::Color.property$2_1 (param $target i64) (param $value i32)
