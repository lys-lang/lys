(module
  ...
  (func $test/fixtures/compiler/getter.lys::Color.discriminant (result i64)
    (i64.const 0x100000000)
  )
  (func $test/fixtures/compiler/getter.lys::Color.sizeOf (result i32)
    (call $system::core::i32.+ (call $system::core::i32.+ (i32.const 8) (i32.const 8)) (i32.const 8))
  )
  (func $test/fixtures/compiler/getter.lys::Color.allocationSize (result i32)
  ...
  (func $test/fixtures/compiler/getter.lys::Color.apply (param $r i32) (param $g i32) (param $b i32) (result i64)
    (local $$ref i64)
    (block $B1 (result i64)
      (set_local $$ref (call $test/fixtures/compiler/getter.lys::Color.fromPointer (call $system::memory::calloc (i32.const 1) (call $test/fixtures/compiler/getter.lys::Color.sizeOf))))
      (call $test/fixtures/compiler/getter.lys::Color.set$r (get_local $$ref) (get_local $r))
      (call $test/fixtures/compiler/getter.lys::Color.set$g (get_local $$ref) (get_local $g))
      (call $test/fixtures/compiler/getter.lys::Color.set$b (get_local $$ref) (get_local $b))
      (get_local $$ref)
    )
  )
  ...
  (func $test/fixtures/compiler/getter.lys::Color.property_r_1 (param $target i64) (param $value i32)
    (call $test/fixtures/compiler/getter.lys::Color.set$r (get_local $target) (get_local $value))
  )
  (func $test/fixtures/compiler/getter.lys::Color.set$r (param $target i64) (param $value i32)
  ...
  (func $test/fixtures/compiler/getter.lys::Color.property_g_1 (param $target i64) (param $value i32)
    (call $test/fixtures/compiler/getter.lys::Color.set$g (get_local $target) (get_local $value))
  )
  (func $test/fixtures/compiler/getter.lys::Color.set$g (param $target i64) (param $value i32)
  ...
  (func $test/fixtures/compiler/getter.lys::Color.property_b_1 (param $target i64) (param $value i32)
    (call $test/fixtures/compiler/getter.lys::Color.set$b (get_local $target) (get_local $value))
  )
  (func $test/fixtures/compiler/getter.lys::Color.set$b (param $target i64) (param $value i32)
