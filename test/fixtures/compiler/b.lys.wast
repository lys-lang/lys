(module
  ...
  (export "outerFunction" (func $test/fixtures/compiler/b.lys::outerFunction))
  (func $test/fixtures/compiler/b.lys::innerFunctionArgs (param $a i32) (result i32)
    (get_local $a)
  )
  (func $test/fixtures/compiler/b.lys::innerFunction (result i32)
    (call $test/fixtures/compiler/b.lys::innerFunctionArgs (i32.const 3))
  )
  (func $test/fixtures/compiler/b.lys::over (result i32)
    (i32.const 1)
  )
  (func $test/fixtures/compiler/b.lys::over_1 (param $a i32) (result i32)
    (get_local $a)
  )
  (func $test/fixtures/compiler/b.lys::outerFunction (result i32)
    (call $system::core::i32.+ (call $test/fixtures/compiler/b.lys::innerFunction) (call $test/fixtures/compiler/b.lys::over))
  )
)
