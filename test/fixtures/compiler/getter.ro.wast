(module
  ...
  (func $test/fixtures/compiler/getter.ro::discriminant (result i64)
    (i64.const 0x100000000)
  )
  (func $test/fixtures/compiler/getter.ro::sizeOf (result i32)
    (call $system::core::+ (call $system::core::+ (i32.const 8) (i32.const 8)) (i32.const 8))
  )
  (func $test/fixtures/compiler/getter.ro::allocationSize (result i32)
    (call $system::core::allocationSize_26)
  )
  (func $test/fixtures/compiler/getter.ro::apply (param $r i32) (param $g i32) (param $b i32) (result i64)
    (local $ref i64)
    (block $unknown_block_1 (result i64)
      (set_local $ref (call $test/fixtures/compiler/getter.ro::fromPointer_1 (call $system::memory::malloc (call $test/fixtures/compiler/getter.ro::sizeOf))))
      (call $test/fixtures/compiler/getter.ro::property_r_2 (get_local $ref) (get_local $r))
      (call $test/fixtures/compiler/getter.ro::property_g_2 (get_local $ref) (get_local $g))
      (call $test/fixtures/compiler/getter.ro::property_b_2 (get_local $ref) (get_local $b))
      (get_local $ref)
    )
  )
  (func $test/fixtures/compiler/getter.ro::fromPointer_1 (param $ptr i32) (result i64)
    (i64.or (i64.const 0x100000000) (i64.extend_u/i32 (get_local $ptr)))
  )
  (func $test/fixtures/compiler/getter.ro::property_r_1 (param $target i64) (result i32)
    (call $system::core::load_4 (get_local $target) (i32.const 0))
  )
  (func $test/fixtures/compiler/getter.ro::property_r_2 (param $target i64) (param $value i32)
    (call $system::core::store_8 (get_local $target) (get_local $value) (i32.const 0))
  )
  (func $test/fixtures/compiler/getter.ro::property_g_1 (param $target i64) (result i32)
    (call $system::core::load_4 (get_local $target) (i32.const 8))
  )
  (func $test/fixtures/compiler/getter.ro::property_g_2 (param $target i64) (param $value i32)
    (call $system::core::store_8 (get_local $target) (get_local $value) (i32.const 8))
  )
  (func $test/fixtures/compiler/getter.ro::property_b_1 (param $target i64) (result i32)
    (call $system::core::load_4 (get_local $target) (i32.const 16))
  )
  (func $test/fixtures/compiler/getter.ro::property_b_2 (param $target i64) (param $value i32)
    (call $system::core::store_8 (get_local $target) (get_local $value) (i32.const 16))
  )
  (func $test/fixtures/compiler/getter.ro::is (param $a i64) (result i32)
    (i64.eq (i64.and (i64.const 0xffffffff00000000) (get_local $a)) (i64.const 0x100000000))
  )
  (func $test/fixtures/compiler/getter.ro::store_3 (param $lhs i64) (param $rhs i64) (param $offset i32)
    (i64.store (i32.add (get_local $offset) (call $system::core::addressFromRef (get_local $lhs))) (get_local $rhs))
  )
  (func $test/fixtures/compiler/getter.ro::load_3 (param $lhs i64) (param $offset i32) (result i64)
    (i64.load (i32.add (get_local $offset) (call $system::core::addressFromRef (get_local $lhs))))
  )
  (func $test/fixtures/compiler/getter.ro::main (param $color i64) (result i32)
    (call $system::core::| (call $system::core::| (call $system::core::* (call $test/fixtures/compiler/getter.ro::property_r_1 (get_local $color)) (i32.const 65536)) (call $system::core::* (call $test/fixtures/compiler/getter.ro::property_g_1 (get_local $color)) (i32.const 256))) (call $test/fixtures/compiler/getter.ro::property_b_1 (get_local $color)))
  )
  (func $%%START%%
