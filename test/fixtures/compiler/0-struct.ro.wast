(module
  ...
  (func $test::is (param $a i64) (result i32)
    (block $unknown_block_1 (result i32)
      (call $system::core::|| (call $system::core::|| (call $system::core::|| (call $test::is_2 (get_local $a)) (call $test::is_4 (get_local $a))) (call $test::is_6 (get_local $a))) (call $test::is_8 (get_local $a)))
    )
  )
  ...
  (func $test::as_8 (param $a i64) (result i64)
    (get_local $a)
  )
  ...
  (func $test::apply_6 (param $r i32) (param $g i32) (param $b i32) (result i64)
  ...
  (func $test::get_r (param $target i64) (result i32)
    (local $offset i32)
    (set_local $offset (i32.const 0))
    (unreachable)
  )
  (func $test::set_r (param $target i64) (param $value i32)
    (local $offset i32)
    (set_local $offset (i32.const 0))
    (unreachable)
  )
  (func $test::get_g (param $target i64) (result i32)
    (local $offset i32)
    (set_local $offset (i32.const 0))
    (unreachable)
  )
  (func $test::set_g (param $target i64) (param $value i32)
    (local $offset i32)
    (set_local $offset (i32.const 0))
    (unreachable)
  )
  (func $test::get_b (param $target i64) (result i32)
    (local $offset i32)
    (set_local $offset (i32.const 0))
    (unreachable)
  )
  (func $test::set_b (param $target i64) (param $value i32)
    (local $offset i32)
    (set_local $offset (i32.const 0))
    (unreachable)
  )
  ...
  (func $test::isRed (param $color i64) (result i32)
    ...
    (block $unknown_block_2 (result i32)
      (block $B3 (result i32)
          ...
          (block $B3_0
              (block $B3_1
                  (br_if $B3_0 (call $test::is_2 (get_local $var$1)))
                )
              (i32.const 0)
              (br $B3)
            )
  ...
  (func $test::testColors
    (block $unknown_block_4
      (call $support::test::assert (call $system::core::==_32 (call $test::isRed (call $test::apply)) (i32.const 1)))
      (call $support::test::assert (call $system::core::==_32 (call $test::isRed (call $test::apply_2)) (i32.const 0)))
      (call $support::test::assert (call $system::core::==_32 (call $test::isRed (call $test::apply_4)) (i32.const 0)))
      (call $support::test::assert (call $system::core::==_32 (call $test::isRed (call $test::apply_6 (i32.const 5) (i32.const 5) (i32.const 5))) (i32.const 0)))
    )
  )
  (func $%%START%%
