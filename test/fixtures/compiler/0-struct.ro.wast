(module
  ...
  (func $test/fixtures/compiler/0-struct.ro::Custom.apply (param $r i32) (param $g i32) (param $b i32) (result i64)
    ...
    (block $unknown_block_2 (result i64)
      (set_local $ref (call $test/fixtures/compiler/0-struct.ro::Custom.fromPointer (call $system::memory::malloc (call $test/fixtures/compiler/0-struct.ro::Custom.sizeOf))))
