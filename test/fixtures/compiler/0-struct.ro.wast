(module
  ...
  (func $test/fixtures/compiler/0-struct.ro::== (param $a i64) (param $b i64) (result i32)
  ...
  (func $test/fixtures/compiler/0-struct.ro::==_2 (param $a i64) (param $b i64) (result i32)
    (i64.eq (get_local $a) (get_local $b))
  )
  (func $test/fixtures/compiler/0-struct.ro::!=_2 (param $a i64) (param $b i64) (result i32)
    (i64.ne (get_local $a) (get_local $b))
  ...
  (func $test/fixtures/compiler/0-struct.ro::==_4 (param $a i64) (param $b i64) (result i32)
    (i64.eq (get_local $a) (get_local $b))
  )
  (func $test/fixtures/compiler/0-struct.ro::!=_4 (param $a i64) (param $b i64) (result i32)
    (i64.ne (get_local $a) (get_local $b))
  ...
  (func $test/fixtures/compiler/0-struct.ro::apply_6 (param $r i32) (param $g i32) (param $b i32) (result i64)
    (call $test/fixtures/compiler/0-struct.ro::fromPointer_1 (call $system::memory::malloc (call $test/fixtures/compiler/0-struct.ro::sizeOf)))
  )
  ...
  (func $test/fixtures/compiler/0-struct.ro::get_r (param $target i64) (result i32)
    (local $offset i32)
    (set_local $offset (i32.const 0))
    (unreachable)
  )
  (func $test/fixtures/compiler/0-struct.ro::set_r (param $target i64) (param $value i32)
    (local $offset i32)
    (set_local $offset (i32.const 0))
    (unreachable)
  )
  (func $test/fixtures/compiler/0-struct.ro::get_g (param $target i64) (result i32)
    (local $offset i32)
    (set_local $offset (i32.const 0))
    (unreachable)
  )
  (func $test/fixtures/compiler/0-struct.ro::set_g (param $target i64) (param $value i32)
    (local $offset i32)
    (set_local $offset (i32.const 0))
    (unreachable)
  )
  (func $test/fixtures/compiler/0-struct.ro::get_b (param $target i64) (result i32)
    (local $offset i32)
    (set_local $offset (i32.const 0))
    (unreachable)
  )
  (func $test/fixtures/compiler/0-struct.ro::set_b (param $target i64) (param $value i32)
    (local $offset i32)
    (set_local $offset (i32.const 0))
    (unreachable)
  )
  ...
  (func $test/fixtures/compiler/0-struct.ro::isRed (param $color i64) (result i32)
    ...
    (block $unknown_block_2 (result i32)
      (block $B3 (result i32)
          ...
          (block $B3_0
              (block $B3_1
                  (br_if $B3_0 (call $test/fixtures/compiler/0-struct.ro::is_2 (get_local $var$1)))
                )
              (i32.const 0)
              (br $B3)
            )
