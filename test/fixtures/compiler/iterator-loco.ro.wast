(module
  ...
  (export "test" (func $test/fixtures/compiler/iterator-loco.ro::test))
  (func $test/fixtures/compiler/iterator-loco.ro::Iterator.discriminant (result i64)
    (i64.const 0x100000000)
  )
  (func $test/fixtures/compiler/iterator-loco.ro::Iterator.sizeOf (result i32)
    (call $system::core::i32.+ (i32.const 8) (i32.const 8))
  )
  (func $test/fixtures/compiler/iterator-loco.ro::Iterator.allocationSize (result i32)
    (call $system::core::ref.allocationSize)
  )
  (func $test/fixtures/compiler/iterator-loco.ro::Iterator.apply (param $current i32) (param $target i32) (result i64)
    (local $$ref i64)
    (block $B1 (result i64)
      (set_local $$ref (call $test/fixtures/compiler/iterator-loco.ro::Iterator.fromPointer (call $system::memory::calloc (i32.const 1) (call $test/fixtures/compiler/iterator-loco.ro::Iterator.sizeOf))))
      (call $test/fixtures/compiler/iterator-loco.ro::Iterator.set$current (get_local $$ref) (get_local $current))
      (call $test/fixtures/compiler/iterator-loco.ro::Iterator.set$target (get_local $$ref) (get_local $target))
      (get_local $$ref)
    )
  )
  (func $test/fixtures/compiler/iterator-loco.ro::Iterator.fromPointer (param $ptr i32) (result i64)
    (i64.or (i64.const 0x100000000) (i64.extend_u/i32 (get_local $ptr)))
  )
  (func $test/fixtures/compiler/iterator-loco.ro::Iterator.property_current (param $target i64) (result i32)
    (call $system::core::i32.load_1 (get_local $target) (i32.const 0))
  )
  (func $test/fixtures/compiler/iterator-loco.ro::Iterator.property_current_1 (param $target i64) (param $value i32)
    (call $test/fixtures/compiler/iterator-loco.ro::Iterator.set$current (get_local $target) (get_local $value))
  )
  (func $test/fixtures/compiler/iterator-loco.ro::Iterator.set$current (param $target i64) (param $value i32)
    (call $system::core::i32.store_1 (get_local $target) (get_local $value) (i32.const 0))
  )
  (func $test/fixtures/compiler/iterator-loco.ro::Iterator.property_target (param $target i64) (result i32)
    (call $system::core::i32.load_1 (get_local $target) (i32.const 8))
  )
  (func $test/fixtures/compiler/iterator-loco.ro::Iterator.property_target_1 (param $target i64) (param $value i32)
    (call $test/fixtures/compiler/iterator-loco.ro::Iterator.set$target (get_local $target) (get_local $value))
  )
  (func $test/fixtures/compiler/iterator-loco.ro::Iterator.set$target (param $target i64) (param $value i32)
    (call $system::core::i32.store_1 (get_local $target) (get_local $value) (i32.const 8))
  )
  (func $test/fixtures/compiler/iterator-loco.ro::Iterator.is (param $a i64) (result i32)
    (i64.eq (i64.and (i64.const 0xffffffff00000000) (get_local $a)) (i64.const 0x100000000))
  )
  (func $test/fixtures/compiler/iterator-loco.ro::Iterator.store (param $lhs i64) (param $rhs i64) (param $offset i32)
    (i64.store (i32.add (get_local $offset) (call $system::core::addressFromRef (get_local $lhs))) (get_local $rhs))
  )
  (func $test/fixtures/compiler/iterator-loco.ro::Iterator.load (param $lhs i64) (param $offset i32) (result i64)
    (i64.load (i32.add (get_local $offset) (call $system::core::addressFromRef (get_local $lhs))))
  )
  (func $test/fixtures/compiler/iterator-loco.ro::Maybe.is (param $a i64) (result i32)
    (block $B1 (result i32)
      (call $system::core::boolean.|| (call $test/fixtures/compiler/iterator-loco.ro::None.is (get_local $a)) (call $test/fixtures/compiler/iterator-loco.ro::Some.is (get_local $a)))
    )
  )
  (func $test/fixtures/compiler/iterator-loco.ro::Maybe.== (param $lhs i64) (param $rhs i64) (result i32)
    (call $system::core::ref.== (get_local $lhs) (get_local $rhs))
  )
  (func $test/fixtures/compiler/iterator-loco.ro::Maybe.!= (param $lhs i64) (param $rhs i64) (result i32)
    (call $system::core::ref.!= (get_local $lhs) (get_local $rhs))
  )
  (func $test/fixtures/compiler/iterator-loco.ro::Maybe.store (param $lhs i64) (param $rhs i64) (param $offset i32)
    (i64.store (i32.add (get_local $offset) (call $system::core::addressFromRef (get_local $lhs))) (get_local $rhs))
  )
  (func $test/fixtures/compiler/iterator-loco.ro::Maybe.load (param $lhs i64) (param $offset i32) (result i64)
    (i64.load (i32.add (get_local $offset) (call $system::core::addressFromRef (get_local $lhs))))
  )
  (func $test/fixtures/compiler/iterator-loco.ro::None.as (param $a i64) (result i64)
    (get_local $a)
  )
  (func $test/fixtures/compiler/iterator-loco.ro::Some.as (param $a i64) (result i64)
    (get_local $a)
  )
  (func $test/fixtures/compiler/iterator-loco.ro::Maybe.as (param $a i64) (result i64)
    (get_local $a)
  )
  (func $test/fixtures/compiler/iterator-loco.ro::Maybe.as_1 (param $a i64) (result i64)
    (get_local $a)
  )
  (func $test/fixtures/compiler/iterator-loco.ro::None.apply (result i64)
    (i64.const 0x300000000)
  )
  (func $test/fixtures/compiler/iterator-loco.ro::None.is (param $a i64) (result i32)
    (i64.eq (i64.and (i64.const 0xffffffff00000000) (get_local $a)) (i64.const 0x300000000))
  )
  (func $test/fixtures/compiler/iterator-loco.ro::None.== (param $a i64) (param $b i64) (result i32)
    (i64.eq (get_local $a) (get_local $b))
  )
  (func $test/fixtures/compiler/iterator-loco.ro::None.!= (param $a i64) (param $b i64) (result i32)
    (i64.ne (get_local $a) (get_local $b))
  )
  (func $test/fixtures/compiler/iterator-loco.ro::None.store (param $lhs i64) (param $rhs i64) (param $offset i32)
    (i64.store (i32.add (get_local $offset) (call $system::core::addressFromRef (get_local $lhs))) (get_local $rhs))
  )
  (func $test/fixtures/compiler/iterator-loco.ro::None.load (param $lhs i64) (param $offset i32) (result i64)
    (i64.load (i32.add (get_local $offset) (call $system::core::addressFromRef (get_local $lhs))))
  )
  (func $test/fixtures/compiler/iterator-loco.ro::Some.discriminant (result i64)
    (i64.const 0x400000000)
  )
  (func $test/fixtures/compiler/iterator-loco.ro::Some.sizeOf (result i32)
    (i32.const 8)
  )
  (func $test/fixtures/compiler/iterator-loco.ro::Some.allocationSize (result i32)
    (call $system::core::ref.allocationSize)
  )
  (func $test/fixtures/compiler/iterator-loco.ro::Some.apply (param $value i32) (result i64)
    (local $$ref i64)
    (block $B1 (result i64)
      (set_local $$ref (call $test/fixtures/compiler/iterator-loco.ro::Some.fromPointer (call $system::memory::calloc (i32.const 1) (call $test/fixtures/compiler/iterator-loco.ro::Some.sizeOf))))
      (call $test/fixtures/compiler/iterator-loco.ro::Some.set$value (get_local $$ref) (get_local $value))
      (get_local $$ref)
    )
  )
  (func $test/fixtures/compiler/iterator-loco.ro::Some.fromPointer (param $ptr i32) (result i64)
    (i64.or (i64.const 0x400000000) (i64.extend_u/i32 (get_local $ptr)))
  )
  (func $test/fixtures/compiler/iterator-loco.ro::Some.property_value (param $target i64) (result i32)
    (call $system::core::i32.load_1 (get_local $target) (i32.const 0))
  )
  (func $test/fixtures/compiler/iterator-loco.ro::Some.property_value_1 (param $target i64) (param $value i32)
    (call $test/fixtures/compiler/iterator-loco.ro::Some.set$value (get_local $target) (get_local $value))
  )
  (func $test/fixtures/compiler/iterator-loco.ro::Some.set$value (param $target i64) (param $value i32)
    (call $system::core::i32.store_1 (get_local $target) (get_local $value) (i32.const 0))
  )
  (func $test/fixtures/compiler/iterator-loco.ro::Some.is (param $a i64) (result i32)
    (i64.eq (i64.and (i64.const 0xffffffff00000000) (get_local $a)) (i64.const 0x400000000))
  )
  (func $test/fixtures/compiler/iterator-loco.ro::Some.store (param $lhs i64) (param $rhs i64) (param $offset i32)
    (i64.store (i32.add (get_local $offset) (call $system::core::addressFromRef (get_local $lhs))) (get_local $rhs))
  )
  (func $test/fixtures/compiler/iterator-loco.ro::Some.load (param $lhs i64) (param $offset i32) (result i64)
    (i64.load (i32.add (get_local $offset) (call $system::core::addressFromRef (get_local $lhs))))
  )
  (func $test/fixtures/compiler/iterator-loco.ro::Iterator.next (param $iter i64) (result i64)
    (local $r i64)
    (block $B1 (result i64)
      (if $IF2 (result i64) (call $system::core::i32.<= (call $test/fixtures/compiler/iterator-loco.ro::Iterator.property_current (get_local $iter)) (call $test/fixtures/compiler/iterator-loco.ro::Iterator.property_target (get_local $iter)))
          (then
            (block $B3 (result i64)
                (set_local $r (call $test/fixtures/compiler/iterator-loco.ro::Some.apply (call $test/fixtures/compiler/iterator-loco.ro::Iterator.property_current (get_local $iter))))
                (call $test/fixtures/compiler/iterator-loco.ro::Iterator.property_current_1 (get_local $iter) (call $system::core::i32.+ (call $test/fixtures/compiler/iterator-loco.ro::Iterator.property_current (get_local $iter)) (i32.const 1)))
                (get_local $r)
              )
          )
          (else
            (block $B4 (result i64)
                (call $test/fixtures/compiler/iterator-loco.ro::None.apply)
              )
          )
        )
    )
  )
  (func $test/fixtures/compiler/iterator-loco.ro::test (param $from i32) (param $to i32) (result i32)
    (local $ret i32)
    (local $$iter$ i64)
    (local $value i32)
    (local $var$5 i64)
    (block $B1 (result i32)
      ...
      (set_local $$iter$ (call $test/fixtures/compiler/iterator-loco.ro::Iterator.apply (get_local $from) (get_local $to)))
      (block $Break2
          (loop $Loop2
              (block $B3
                  (block $B5
                      (set_local $var$5 (call $test/fixtures/compiler/iterator-loco.ro::Iterator.next (get_local $$iter$)))
                      (block $B5_0
                          (block $B5_1
                              (br_if $B5_0 (call $test/fixtures/compiler/iterator-loco.ro::Some.is (get_local $var$5)))
                              (br_if $B5_1 (call $test/fixtures/compiler/iterator-loco.ro::None.is (get_local $var$5)))
                            )
                          (br $Break2)
                          (br $B5)
                        )
                      (block $B4
                          (set_local $value (call $test/fixtures/compiler/iterator-loco.ro::Some.property_value (get_local $var$5)))
