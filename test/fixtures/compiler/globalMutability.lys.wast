(module
  ...
  (func $test/fixtures/compiler/globalMutability.lys::main (result i32)
    (block $B1 (result i32)
      (block $tee_global_2 (result i32)
          (global.set $test/fixtures/compiler/globalMutability.lys::x (call $system::core::i32.- (call $system::core::i32.+ (global.get $test/fixtures/compiler/globalMutability.lys::x) (i32.const 1)) (global.get $test/fixtures/compiler/globalMutability.lys::a)))
  ...
  (func $%%START%%
    ...
    (global.set $test/fixtures/compiler/globalMutability.lys::a (block $B1 (result i32)
            (call $system::core::i32.- (global.get $test/fixtures/compiler/globalMutability.lys::bc) (global.get $test/fixtures/compiler/globalMutability.lys::x))
          ))
  )
  (start $%%START%%)
)
