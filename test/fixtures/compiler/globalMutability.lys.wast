(module
  ...
  (global $test/fixtures/compiler/globalMutability.lys::x_4 (mut i32) (i32.const 0))
  (global $test/fixtures/compiler/globalMutability.lys::bc_2 (mut i32) (i32.const 0))
  (global $test/fixtures/compiler/globalMutability.lys::a_2 (mut i32) (i32.const 0))
  (export "main" (func $test/fixtures/compiler/globalMutability.lys::main))
  (func $test/fixtures/compiler/globalMutability.lys::main (result i32)
    (block $B1 (result i32)
      (block $tee_global_2 (result i32)
          (set_global $test/fixtures/compiler/globalMutability.lys::x_4 (call $system::core::i32.- (call $system::core::i32.+ (get_global $test/fixtures/compiler/globalMutability.lys::x_4) (i32.const 1)) (get_global $test/fixtures/compiler/globalMutability.lys::a_2)))
          (get_global $test/fixtures/compiler/globalMutability.lys::x_4)
        )
    )
  )
  (func $%%START%%
    (set_global $test/fixtures/compiler/globalMutability.lys::x_4 (i32.const 2))
    (set_global $test/fixtures/compiler/globalMutability.lys::bc_2 (i32.const 1))
    (set_global $test/fixtures/compiler/globalMutability.lys::a_2 (block $B1 (result i32)
            (call $system::core::i32.- (get_global $test/fixtures/compiler/globalMutability.lys::bc_2) (get_global $test/fixtures/compiler/globalMutability.lys::x_4))
          ))
  )
  (start $%%START%%)
)
