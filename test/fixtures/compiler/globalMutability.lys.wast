(module
  ...
  (func $test::fixtures::compiler::globalMutability::main_1 (result i32)
    (block $B1 (result i32)
      (block $tee_global_2 (result i32)
          (global.set $test::fixtures::compiler::globalMutability::x (call $system::core::i32::i32.-_1 (call $system::core::i32::i32.+_1 (global.get $test::fixtures::compiler::globalMutability::x) (i32.const 1)) (global.get $test::fixtures::compiler::globalMutability::a)))
  ...
  (func $%%START%%
    ...
    (global.set $test::fixtures::compiler::globalMutability::a (block $B1 (result i32)
            (call $system::core::i32::i32.-_1 (global.get $test::fixtures::compiler::globalMutability::bc) (global.get $test::fixtures::compiler::globalMutability::x))
          ))
  )
  (start $%%START%%)
)
