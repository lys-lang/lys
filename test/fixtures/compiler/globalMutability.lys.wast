  ...
  (func $test/fixtures/compiler/globalMutability.lys::main (result i32)
    (block $B1 (result i32)
      (block $tee_global_2 (result i32)
          (global.set $test/fixtures/compiler/globalMutability.lys::x_4 (call $system::core::i32.- (call $system::core::i32.+ (global.get $test/fixtures/compiler/globalMutability.lys::x_4) (i32.const 1)) (global.get $test/fixtures/compiler/globalMutability.lys::a_2)))
          (global.get $test/fixtures/compiler/globalMutability.lys::x_4)
        )
    )
  )
  (func $%%START%%
    (global.set $test/fixtures/compiler/globalMutability.lys::x_4 (i32.const 2))
    (global.set $test/fixtures/compiler/globalMutability.lys::bc_2 (i32.const 1))
    (global.set $test/fixtures/compiler/globalMutability.lys::a_2 (block $B1 (result i32)
            (call $system::core::i32.- (global.get $test/fixtures/compiler/globalMutability.lys::bc_2) (global.get $test/fixtures/compiler/globalMutability.lys::x_4))
          ))
  )
  (start $%%START%%)
)
